...
func TestConformanceAllMatchesToSliceInt8(t *testing.T) {
	c := arraylist.Int8Of(int8(3), int8(1), int8(4), int8(1), int8(5), int8(9), int8(2))
...
func TestConformanceAllMatchesToSliceInt16(t *testing.T) {
	c := arraylist.Int16Of(int16(3), int16(1), int16(4), int16(1), int16(5), int16(9), int16(2))
	conformance.AllMatchesToSlice(t, c.All(), c.ToSlice(), true)
}
...
func TestConformanceAllMatchesToSliceInt32(t *testing.T) {
	c := arraylist.Int32Of(int32(3), int32(1), int32(4), int32(1), int32(5), int32(9), int32(2))
	conformance.AllMatchesToSlice(t, c.All(), c.ToSlice(), true)
}
...
func TestConformanceAllMatchesToSliceInt64(t *testing.T) {
	c := arraylist.Int64Of(int64(3), int64(1), int64(4), int64(1), int64(5), int64(9), int64(2))
	conformance.AllMatchesToSlice(t, c.All(), c.ToSlice(), true)
}
...
func TestConformanceAllMatchesToSliceChar(t *testing.T) {
	c := arraylist.CharOf(uint16(3), uint16(1), uint16(4), uint16(1), uint16(5), uint16(9), uint16(2))
	conformance.AllMatchesToSlice(t, c.All(), c.ToSlice(), true)
}
...
func TestConformanceAllMatchesToSliceFloat32(t *testing.T) {
	c := arraylist.Float32Of(float32(3), float32(1), float32(4), float32(1), float32(5), float32(9), float32(2))
	conformance.AllMatchesToSlice(t, c.All(), c.ToSlice(), true)
}
...
func TestConformanceAllMatchesToSliceFloat64(t *testing.T) {
	c := arraylist.Float64Of(float64(3), float64(1), float64(4), float64(1), float64(5), float64(9), float64(2))
	conformance.AllMatchesToSlice(t, c.All(), c.ToSlice(), true)
}
