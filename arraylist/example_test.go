...
func ExampleInt32ArrayList() {
	list := arraylist.Int32ArrayListOf(5, 3, 1, 4, 2)
...
func ExampleInt32ArrayList_Select() {
	list := arraylist.Int32ArrayListOf(1, 2, 3, 4, 5, 6, 7, 8)
...
func ExampleInt32ArrayList_All() {
	list := arraylist.Int32ArrayListOf(10, 20, 30)
...
func ExampleInt32ArrayList_BinarySearch() {
	list := arraylist.Int32ArrayListOf(10, 20, 30, 40, 50)
...
func ExampleInt32ArrayList_Min() {
	list := arraylist.Int32ArrayListOf(30, 10, 50, 20, 40)
	min, _ := list.Min()
	max, _ := list.Max()
