...
func TestImmutableChar_Generated_GetAndSize(t *testing.T) {
	m := CharOf(1, 2, 3)
	im := m.ToImmutable()
	if im.Len() != 3 {
...
func TestImmutableChar_Generated_IndexOf(t *testing.T) {
	im := CharOf(1, 2, 3).ToImmutable()
...
func TestImmutableChar_Generated_Reject(t *testing.T) {
	im := CharOf(1, 2, 3, 4, 5).ToImmutable()
...
func TestImmutableChar_Generated_Detect(t *testing.T) {
	im := CharOf(1, 2, 3).ToImmutable()
...
func TestImmutableChar_Generated_AnySatisfy(t *testing.T) {
	im := CharOf(1, 2, 3).ToImmutable()
...
func TestImmutableChar_Generated_Reversed(t *testing.T) {
	im := CharOf(1, 2, 3).ToImmutable()
	r := im.Reversed()
	v0 := r.Get(0)
	v2 := r.Get(2)
...
func TestImmutableChar_Generated_Distinct(t *testing.T) {
	im := CharOf(1, 2, 1).ToImmutable()
	d := im.Distinct()
	if d.Len() != 2 {
...
func TestImmutableChar_Generated_Equals(t *testing.T) {
	...
	im2 := CharOf(1, 2).ToImmutable()
	im3 := CharOf(1).ToImmutable()
	if !im1.Equals(im2) {
