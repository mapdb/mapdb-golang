...
func TestImmutableInt64_Generated_GetAndSize(t *testing.T) {
	m := Int64Of(1, 2, 3)
	im := m.ToImmutable()
	if im.Len() != 3 {
...
func TestImmutableInt64_Generated_IndexOf(t *testing.T) {
	im := Int64Of(1, 2, 3).ToImmutable()
...
func TestImmutableInt64_Generated_Select(t *testing.T) {
	im := Int64Of(1, 2, 3, 4, 5).ToImmutable()
	sel := im.Select(func(v int64) bool { return v > 3 })
	if sel.Len() != 2 {
		t.Errorf("Select size = %d, want 2", sel.Len())
	}
}
func TestImmutableInt64_Generated_Reject(t *testing.T) {
	im := Int64Of(1, 2, 3, 4, 5).ToImmutable()
...
func TestImmutableInt64_Generated_Detect(t *testing.T) {
	im := Int64Of(1, 2, 3).ToImmutable()
...
func TestImmutableInt64_Generated_AnySatisfy(t *testing.T) {
	im := Int64Of(1, 2, 3).ToImmutable()
...
func TestImmutableInt64_Generated_Reversed(t *testing.T) {
	im := Int64Of(1, 2, 3).ToImmutable()
	r := im.Reversed()
	v0 := r.Get(0)
	v2 := r.Get(2)
...
func TestImmutableInt64_Generated_Distinct(t *testing.T) {
	im := Int64Of(1, 2, 1).ToImmutable()
	d := im.Distinct()
	if d.Len() != 2 {
...
func TestImmutableInt64_Generated_Equals(t *testing.T) {
	im1 := Int64Of(1, 2).ToImmutable()
	im2 := Int64Of(1, 2).ToImmutable()
	im3 := Int64Of(1).ToImmutable()
	if !im1.Equals(im2) {
