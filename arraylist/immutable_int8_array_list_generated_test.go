...
func TestImmutableInt8_Generated_GetAndSize(t *testing.T) {
	m := Int8Of(1, 2, 3)
	im := m.ToImmutable()
	if im.Len() != 3 {
...
func TestImmutableInt8_Generated_IndexOf(t *testing.T) {
	im := Int8Of(1, 2, 3).ToImmutable()
...
func TestImmutableInt8_Generated_Select(t *testing.T) {
	im := Int8Of(1, 2, 3, 4, 5).ToImmutable()
	sel := im.Select(func(v int8) bool { return v > 3 })
	if sel.Len() != 2 {
		t.Errorf("Select size = %d, want 2", sel.Len())
	}
}
func TestImmutableInt8_Generated_Reject(t *testing.T) {
	im := Int8Of(1, 2, 3, 4, 5).ToImmutable()
...
func TestImmutableInt8_Generated_Detect(t *testing.T) {
	im := Int8Of(1, 2, 3).ToImmutable()
...
func TestImmutableInt8_Generated_AnySatisfy(t *testing.T) {
	im := Int8Of(1, 2, 3).ToImmutable()
...
func TestImmutableInt8_Generated_Reversed(t *testing.T) {
	im := Int8Of(1, 2, 3).ToImmutable()
	r := im.Reversed()
	v0 := r.Get(0)
	v2 := r.Get(2)
...
func TestImmutableInt8_Generated_Distinct(t *testing.T) {
	im := Int8Of(1, 2, 1).ToImmutable()
	d := im.Distinct()
	if d.Len() != 2 {
...
func TestImmutableInt8_Generated_Equals(t *testing.T) {
	im1 := Int8Of(1, 2).ToImmutable()
	im2 := Int8Of(1, 2).ToImmutable()
	im3 := Int8Of(1).ToImmutable()
	if !im1.Equals(im2) {
