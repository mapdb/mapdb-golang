...
func TestInt16_Generated_AddAndGet(t *testing.T) {
	l := NewInt16()
	l.Add(1)
	l.Add(2)
	l.Add(3)
...
func TestInt16_Generated_GetOutOfBounds(t *testing.T) {
	l := Int16Of(1, 2)
	assertPanics(t, func() { l.Get(-1) })
	assertPanics(t, func() { l.Get(2) })
}

func TestInt16_Generated_Of(t *testing.T) {
	l := Int16Of(1, 2, 3)
	if l.Len() != 3 {
...
func TestInt16_Generated_Set(t *testing.T) {
	l := Int16Of(1, 2, 3)
	old := l.Set(1, 4)
	if old != 2 {
...
func TestInt16_Generated_RemoveAtIndex(t *testing.T) {
	l := Int16Of(1, 2, 3)
...
func TestInt16_Generated_Contains(t *testing.T) {
	l := Int16Of(1, 2, 3)
	if !l.Contains(2) {
...
func TestInt16_Generated_IndexOf(t *testing.T) {
	l := Int16Of(1, 2, 3)
...
func TestInt16_Generated_AllWithIndex(t *testing.T) {
	l := Int16Of(1, 2, 3)
	indices := 0
...
func TestInt16_Generated_Count(t *testing.T) {
	l := Int16Of(1, 2, 3, 4, 5)
...
func TestInt16_Generated_Sum(t *testing.T) {
	l := Int16Of(1, 2, 3)
...
func TestInt16_Generated_MinMax(t *testing.T) {
	l := Int16Of(3, 1, 2)
...
func TestInt16_Generated_Sort(t *testing.T) {
	l := Int16Of(3, 1, 2)
	l.Sort()
	v0 := l.Get(0)
	v1 := l.Get(1)
...
func TestInt16_Generated_Reversed(t *testing.T) {
	l := Int16Of(1, 2, 3)
	r := l.Reversed()
	r0 := r.Get(0)
	r2 := r.Get(2)
...
func TestInt16_Generated_Distinct(t *testing.T) {
	l := Int16Of(1, 2, 1, 3, 2)
	d := l.Distinct()
	if d.Len() != 3 {
...
func TestInt16_Generated_Resize(t *testing.T) {
	l := NewInt16()
	...
	if v := l.Get(99); v != int16(99) {
		t.Errorf("Get(99) = %v, want 99", v)
	}
}

func TestInt16_Generated_InjectInto(t *testing.T) {
	l := Int16Of(1, 2, 3)
