...
func TestInt32_Generated_AddAndGet(t *testing.T) {
	l := NewInt32()
	l.Add(1)
	l.Add(2)
	l.Add(3)
...
func TestInt32_Generated_GetOutOfBounds(t *testing.T) {
	l := Int32Of(1, 2)
	assertPanics(t, func() { l.Get(-1) })
	assertPanics(t, func() { l.Get(2) })
}

func TestInt32_Generated_Of(t *testing.T) {
	l := Int32Of(1, 2, 3)
	if l.Len() != 3 {
...
func TestInt32_Generated_Set(t *testing.T) {
	l := Int32Of(1, 2, 3)
	old := l.Set(1, 4)
	if old != 2 {
...
func TestInt32_Generated_RemoveAtIndex(t *testing.T) {
	l := Int32Of(1, 2, 3)
...
func TestInt32_Generated_Contains(t *testing.T) {
	l := Int32Of(1, 2, 3)
	if !l.Contains(2) {
...
func TestInt32_Generated_IndexOf(t *testing.T) {
	l := Int32Of(1, 2, 3)
...
func TestInt32_Generated_IsEmpty(t *testing.T) {
	l := NewInt32()
	if l.Len() != 0 {
...
func TestInt32_Generated_AddAll(t *testing.T) {
	l := NewInt32()
	l.AddAll(1, 2, 3)
	if l.Len() != 3 {
...
func TestInt32_Generated_All(t *testing.T) {
	l := Int32Of(1, 2, 3)
	sum := int32(0)
	for v := range l.All() {
		sum += v
...
func TestInt32_Generated_AllWithIndex(t *testing.T) {
	l := Int32Of(1, 2, 3)
	indices := 0
...
func TestInt32_Generated_Reject(t *testing.T) {
	l := Int32Of(1, 2, 3, 4, 5)
...
func TestInt32_Generated_Detect(t *testing.T) {
	l := Int32Of(1, 2, 3)
...
func TestInt32_Generated_AnySatisfy(t *testing.T) {
	l := Int32Of(1, 2, 3)
...
func TestInt32_Generated_AllSatisfy(t *testing.T) {
	l := Int32Of(1, 2, 3)
...
func TestInt32_Generated_NoneSatisfy(t *testing.T) {
	l := Int32Of(1, 2, 3)
...
func TestInt32_Generated_Count(t *testing.T) {
	l := Int32Of(1, 2, 3, 4, 5)
...
func TestInt32_Generated_Sum(t *testing.T) {
	l := Int32Of(1, 2, 3)
...
func TestInt32_Generated_Sort(t *testing.T) {
	l := Int32Of(3, 1, 2)
	l.Sort()
	v0 := l.Get(0)
	v1 := l.Get(1)
...
func TestInt32_Generated_Reversed(t *testing.T) {
	l := Int32Of(1, 2, 3)
	r := l.Reversed()
	r0 := r.Get(0)
	r2 := r.Get(2)
...
func TestInt32_Generated_Distinct(t *testing.T) {
	l := Int32Of(1, 2, 1, 3, 2)
	d := l.Distinct()
	if d.Len() != 3 {
...
func TestInt32_Generated_With(t *testing.T) {
	l := Int32Of(1)
	l2 := l.AddReturning(2)
	if l2.Len() != 2 {
...
func TestInt32_Generated_Without(t *testing.T) {
	l := Int32Of(1, 2, 3)
...
func TestInt32_Generated_Equals(t *testing.T) {
	l1 := Int32Of(1, 2, 3)
	l2 := Int32Of(1, 2, 3)
	l3 := Int32Of(1, 2)
	if !l1.Equals(l2) {
...
func TestInt32_Generated_Resize(t *testing.T) {
	l := NewInt32()
	...
	if v := l.Get(99); v != int32(99) {
		t.Errorf("Get(99) = %v, want 99", v)
	}
}

func TestInt32_Generated_InjectInto(t *testing.T) {
	l := Int32Of(1, 2, 3)
