...
func TestInt32ArrayList_Generated_AddAndGet(t *testing.T) {
	l := NewInt32ArrayList()
	l.Add(1)
	l.Add(2)
	l.Add(3)
...
func TestInt32ArrayList_Generated_GetOutOfBounds(t *testing.T) {
	l := Int32ArrayListOf(1, 2)
...
func TestInt32ArrayList_Generated_Of(t *testing.T) {
...
func TestInt32ArrayList_Generated_Set(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	old, err := l.Set(1, 4)
	if err != nil || old != 2 {
...
func TestInt32ArrayList_Generated_RemoveAtIndex(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
...
func TestInt32ArrayList_Generated_Remove(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	if !l.Remove(2) {
...
func TestInt32ArrayList_Generated_Contains(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	if !l.Contains(2) {
...
func TestInt32ArrayList_Generated_IndexOf(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
...
func TestInt32ArrayList_Generated_IsEmpty(t *testing.T) {
	l := NewInt32ArrayList()
	if !l.IsEmpty() {
...
func TestInt32ArrayList_Generated_Clear(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	l.Clear()
...
func TestInt32ArrayList_Generated_AddAll(t *testing.T) {
	l := NewInt32ArrayList()
	l.AddAll(1, 2, 3)
	if l.Size() != 3 {
...
func TestInt32ArrayList_Generated_All(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	sum := int32(0)
	for v := range l.All() {
		sum += v
	}
	expected := int32(1) + int32(2) + int32(3)
	if sum != expected {
		t.Errorf("All sum = %v, want %v", sum, expected)
	}
}

func TestInt32ArrayList_Generated_AllWithIndex(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	indices := 0
...
func TestInt32ArrayList_Generated_Select(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3, 4, 5)
	selected := l.Select(func(v int32) bool { return v > 3 })
	if selected.Size() != 2 {
		t.Errorf("Select size = %d, want 2", selected.Size())
	}
}

func TestInt32ArrayList_Generated_Reject(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3, 4, 5)
	rejected := l.Reject(func(v int32) bool { return v > 3 })
	if rejected.Size() != 3 {
		t.Errorf("Reject size = %d, want 3", rejected.Size())
	}
}

func TestInt32ArrayList_Generated_Detect(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	val, found := l.Detect(func(v int32) bool { return v == 2 })
	if !found || val != 2 {
		t.Errorf("Detect = (%v, %v), want (2, true)", val, found)
	}
	_, found = l.Detect(func(v int32) bool { return v == 99 })
	if found {
		t.Error("Detect for missing should return false")
	}
}

func TestInt32ArrayList_Generated_AnySatisfy(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	if !l.AnySatisfy(func(v int32) bool { return v == 2 }) {
		t.Error("AnySatisfy should be true")
	}
	if l.AnySatisfy(func(v int32) bool { return v == 99 }) {
		t.Error("AnySatisfy should be false")
	}
}

func TestInt32ArrayList_Generated_AllSatisfy(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	if !l.AllSatisfy(func(v int32) bool { return v > 0 }) {
		t.Error("AllSatisfy should be true for > 0")
	}
	if l.AllSatisfy(func(v int32) bool { return v > 2 }) {
		t.Error("AllSatisfy should be false")
	}
}

func TestInt32ArrayList_Generated_NoneSatisfy(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	if !l.NoneSatisfy(func(v int32) bool { return v == 99 }) {
		t.Error("NoneSatisfy should be true for missing")
	}
	if l.NoneSatisfy(func(v int32) bool { return v == 1 }) {
		t.Error("NoneSatisfy should be false")
	}
}

func TestInt32ArrayList_Generated_Count(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3, 4, 5)
	if c := l.Count(func(v int32) bool { return v > 3 }); c != 2 {
		t.Errorf("Count = %d, want 2", c)
	}
}

func TestInt32ArrayList_Generated_Sum(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
...
func TestInt32ArrayList_Generated_MinMax(t *testing.T) {
	l := Int32ArrayListOf(3, 1, 2)
...
func TestInt32ArrayList_Generated_Sort(t *testing.T) {
	l := Int32ArrayListOf(3, 1, 2)
	l.Sort()
	v0, _ := l.Get(0)
	v1, _ := l.Get(1)
...
func TestInt32ArrayList_Generated_Reversed(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	r := l.Reversed()
	r0, _ := r.Get(0)
	r2, _ := r.Get(2)
...
func TestInt32ArrayList_Generated_Distinct(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 1, 3, 2)
	d := l.Distinct()
	if d.Size() != 3 {
...
func TestInt32ArrayList_Generated_ToSlice(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	s := l.ToSlice()
...
func TestInt32ArrayList_Generated_With(t *testing.T) {
	l := Int32ArrayListOf(1)
	l2 := l.With(2)
	if l2.Size() != 2 {
...
func TestInt32ArrayList_Generated_Without(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	l2 := l.Without(2)
	if l2.Contains(2) {
...
func TestInt32ArrayList_Generated_Equals(t *testing.T) {
	l1 := Int32ArrayListOf(1, 2, 3)
	l2 := Int32ArrayListOf(1, 2, 3)
	l3 := Int32ArrayListOf(1, 2)
	if !l1.Equals(l2) {
...
func TestInt32ArrayList_Generated_String(t *testing.T) {
	l := Int32ArrayListOf(1, 2)
	s := l.String()
	if s == "" {
...
func TestInt32ArrayList_Generated_Resize(t *testing.T) {
	l := NewInt32ArrayList()
	...
	if v, err := l.Get(99); err != nil || v != int32(99) {
		t.Errorf("Get(99) = (%v, %v), want (99, nil)", v, err)
	}
}

func TestInt32ArrayList_Generated_InjectInto(t *testing.T) {
	l := Int32ArrayListOf(1, 2, 3)
	result := l.InjectInto(int32(0), func(acc, v int32) int32 { return acc + v })
	expected := int32(1) + int32(2) + int32(3)
	if result != expected {
