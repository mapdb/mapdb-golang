...
func TestCharTreeBag_Generated_AddOccurrences(t *testing.T) {
	b := NewCharTreeBag()
	b.Add(1)
	b.Add(1)
	b.Add(2)
...
func TestCharTreeBag_Generated_Of(t *testing.T) {
	b := CharTreeBagOf(1, 1, 2)
	if b.Size() != 3 {
...
func TestCharTreeBag_Generated_Remove(t *testing.T) {
	b := CharTreeBagOf(1, 1, 1, 2)
	b.Remove(1)
	if b.OccurrencesOf(1) != 2 {
...
func TestCharTreeBag_Generated_RemoveAll(t *testing.T) {
	b := CharTreeBagOf(1, 1, 1, 2)
	b.RemoveAll(1)
	if b.Contains(1) {
...
func TestCharTreeBag_Generated_Contains(t *testing.T) {
	b := CharTreeBagOf(1, 2)
	if !b.Contains(1) {
...
func TestCharTreeBag_Generated_IsEmpty(t *testing.T) {
	b := NewCharTreeBag()
	if !b.IsEmpty() {
...
func TestCharTreeBag_Generated_Clear(t *testing.T) {
	b := CharTreeBagOf(1, 2)
	b.Clear()
...
func TestCharTreeBag_Generated_SortedIteration(t *testing.T) {
	b := CharTreeBagOf(3, 1, 2)
...
func TestCharTreeBag_Generated_MinMax(t *testing.T) {
	b := CharTreeBagOf(3, 1, 2)
	minVal, minOk := b.Min()
	if !minOk || minVal != 1 {
...
func TestCharTreeBag_Generated_ForEachWithOccurrences(t *testing.T) {
	b := CharTreeBagOf(1, 1, 2, 2, 2)
	total := 0
...
func TestCharTreeBag_Generated_TopOccurrences(t *testing.T) {
	b := CharTreeBagOf(1, 1, 1, 2, 2, 3)
...
func TestCharTreeBag_Generated_Select(t *testing.T) {
	b := CharTreeBagOf(1, 2, 3)
...
func TestCharTreeBag_Generated_AnySatisfy(t *testing.T) {
	b := CharTreeBagOf(1, 2, 3)
...
func TestCharTreeBag_Generated_String(t *testing.T) {
	b := CharTreeBagOf(1)
	str := b.String()
	if str == "" {
...
func TestCharTreeBag_Generated_Equals(t *testing.T) {
	b1 := CharTreeBagOf(1, 1, 2)
	b2 := CharTreeBagOf(1, 1, 2)
	if !b1.Equals(b2) {
		t.Error("Equal bags should be Equals")
	}
	b3 := CharTreeBagOf(1, 2)
	if b1.Equals(b3) {
