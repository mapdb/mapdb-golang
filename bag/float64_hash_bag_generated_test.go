...
func TestHashFloat64_Generated_AddOccurrences(t *testing.T) {
	b := NewHashFloat64()
	b.Add(1.0)
	b.Add(1.0)
	b.Add(2.0)
...
func TestHashFloat64_Generated_Of(t *testing.T) {
	b := HashFloat64Of(1.0, 1.0, 2.0)
	if b.Len() != 3 {
...
func TestHashFloat64_Generated_Remove(t *testing.T) {
	b := HashFloat64Of(1.0, 1.0, 1.0, 2.0)
	b.Remove(1.0)
	if b.OccurrencesOf(1.0) != 2 {
...
func TestHashFloat64_Generated_RemoveAll(t *testing.T) {
	b := HashFloat64Of(1.0, 1.0, 1.0, 2.0)
	b.RemoveAll(1.0)
	if b.Contains(1.0) {
...
func TestHashFloat64_Generated_Contains(t *testing.T) {
	b := HashFloat64Of(1.0, 2.0)
	if !b.Contains(1.0) {
...
func TestHashFloat64_Generated_IsEmpty(t *testing.T) {
	b := NewHashFloat64()
	if b.Len() != 0 {
...
func TestHashFloat64_Generated_Clear(t *testing.T) {
	b := HashFloat64Of(1.0, 2.0)
	b.Clear()
	if b.Len() != 0 {
...
func TestHashFloat64_Generated_ForEachWithOccurrences(t *testing.T) {
	b := HashFloat64Of(1.0, 1.0, 2.0, 2.0, 2.0)
	total := 0
...
func TestHashFloat64_Generated_TopOccurrences(t *testing.T) {
	b := HashFloat64Of(1.0, 1.0, 1.0, 2.0, 2.0, 3.0)
...
func TestHashFloat64_Generated_All(t *testing.T) {
	b := HashFloat64Of(1.0, 1.0, 2.0)
	count := 0
	for range b.All() {
		count++
...
func TestHashFloat64_Generated_Select(t *testing.T) {
	b := HashFloat64Of(1.0, 2.0, 3.0)
...
func TestHashFloat64_Generated_AnySatisfy(t *testing.T) {
	b := HashFloat64Of(1.0, 2.0, 3.0)
...
func TestHashFloat64_Generated_String(t *testing.T) {
	b := HashFloat64Of(1.0)
	if b.String() == "" {
