...
func TestInt8HashBag_Generated_AddOccurrences(t *testing.T) {
	b := NewInt8HashBag()
	b.Add(1)
	b.Add(1)
	b.Add(2)
...
func TestInt8HashBag_Generated_Of(t *testing.T) {
	b := Int8HashBagOf(1, 1, 2)
	if b.Size() != 3 {
...
func TestInt8HashBag_Generated_Remove(t *testing.T) {
	b := Int8HashBagOf(1, 1, 1, 2)
	b.Remove(1)
	if b.OccurrencesOf(1) != 2 {
...
func TestInt8HashBag_Generated_RemoveAll(t *testing.T) {
	b := Int8HashBagOf(1, 1, 1, 2)
	b.RemoveAll(1)
	if b.Contains(1) {
...
func TestInt8HashBag_Generated_Contains(t *testing.T) {
	b := Int8HashBagOf(1, 2)
	if !b.Contains(1) {
...
func TestInt8HashBag_Generated_IsEmpty(t *testing.T) {
	b := NewInt8HashBag()
	if !b.IsEmpty() {
...
func TestInt8HashBag_Generated_Clear(t *testing.T) {
	b := Int8HashBagOf(1, 2)
	b.Clear()
...
func TestInt8HashBag_Generated_ForEachWithOccurrences(t *testing.T) {
	b := Int8HashBagOf(1, 1, 2, 2, 2)
	total := 0
...
func TestInt8HashBag_Generated_TopOccurrences(t *testing.T) {
	b := Int8HashBagOf(1, 1, 1, 2, 2, 3)
...
func TestInt8HashBag_Generated_All(t *testing.T) {
	b := Int8HashBagOf(1, 1, 2)
	count := 0
	for range b.All() {
		count++
...
func TestInt8HashBag_Generated_Select(t *testing.T) {
	b := Int8HashBagOf(1, 2, 3)
...
func TestInt8HashBag_Generated_AnySatisfy(t *testing.T) {
	b := Int8HashBagOf(1, 2, 3)
...
func TestInt8HashBag_Generated_String(t *testing.T) {
	b := Int8HashBagOf(1)
	if b.String() == "" {
