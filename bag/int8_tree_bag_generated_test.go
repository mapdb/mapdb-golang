...
func TestInt8TreeBag_Generated_AddOccurrences(t *testing.T) {
	b := NewInt8TreeBag()
	b.Add(1)
	b.Add(1)
	b.Add(2)
...
func TestInt8TreeBag_Generated_Of(t *testing.T) {
	b := Int8TreeBagOf(1, 1, 2)
	if b.Size() != 3 {
...
func TestInt8TreeBag_Generated_Remove(t *testing.T) {
	b := Int8TreeBagOf(1, 1, 1, 2)
	b.Remove(1)
	if b.OccurrencesOf(1) != 2 {
...
func TestInt8TreeBag_Generated_RemoveAll(t *testing.T) {
	b := Int8TreeBagOf(1, 1, 1, 2)
	b.RemoveAll(1)
	if b.Contains(1) {
...
func TestInt8TreeBag_Generated_Contains(t *testing.T) {
	b := Int8TreeBagOf(1, 2)
	if !b.Contains(1) {
...
func TestInt8TreeBag_Generated_IsEmpty(t *testing.T) {
	b := NewInt8TreeBag()
	if !b.IsEmpty() {
...
func TestInt8TreeBag_Generated_Clear(t *testing.T) {
	b := Int8TreeBagOf(1, 2)
	b.Clear()
...
func TestInt8TreeBag_Generated_SortedIteration(t *testing.T) {
	b := Int8TreeBagOf(3, 1, 2)
...
func TestInt8TreeBag_Generated_MinMax(t *testing.T) {
	b := Int8TreeBagOf(3, 1, 2)
	minVal, minOk := b.Min()
	if !minOk || minVal != 1 {
...
func TestInt8TreeBag_Generated_ForEachWithOccurrences(t *testing.T) {
	b := Int8TreeBagOf(1, 1, 2, 2, 2)
	total := 0
...
func TestInt8TreeBag_Generated_TopOccurrences(t *testing.T) {
	b := Int8TreeBagOf(1, 1, 1, 2, 2, 3)
...
func TestInt8TreeBag_Generated_Select(t *testing.T) {
	b := Int8TreeBagOf(1, 2, 3)
	selected := b.Select(func(v int8) bool { return v > 1 })
	if selected.Size() != 2 {
		t.Errorf("Select size = %d, want 2", selected.Size())
	}
}

func TestInt8TreeBag_Generated_AnySatisfy(t *testing.T) {
	b := Int8TreeBagOf(1, 2, 3)
	if !b.AnySatisfy(func(v int8) bool { return v == 2 }) {
		t.Error("AnySatisfy should be true")
	}
	if b.AnySatisfy(func(v int8) bool { return v == 99 }) {
		t.Error("AnySatisfy should be false")
	}
}

func TestInt8TreeBag_Generated_String(t *testing.T) {
	b := Int8TreeBagOf(1)
	str := b.String()
	if str == "" {
...
func TestInt8TreeBag_Generated_Equals(t *testing.T) {
	b1 := Int8TreeBagOf(1, 1, 2)
	b2 := Int8TreeBagOf(1, 1, 2)
	if !b1.Equals(b2) {
		t.Error("Equal bags should be Equals")
	}
	b3 := Int8TreeBagOf(1, 2)
	if b1.Equals(b3) {
