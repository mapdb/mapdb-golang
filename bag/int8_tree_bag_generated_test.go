...
func TestTreeInt8_Generated_AddOccurrences(t *testing.T) {
	b := NewTreeInt8()
	b.Add(1)
	b.Add(1)
	b.Add(2)
...
func TestTreeInt8_Generated_Of(t *testing.T) {
	b := TreeInt8Of(1, 1, 2)
	if b.Len() != 3 {
...
func TestTreeInt8_Generated_Remove(t *testing.T) {
	b := TreeInt8Of(1, 1, 1, 2)
	b.Remove(1)
	if b.OccurrencesOf(1) != 2 {
...
func TestTreeInt8_Generated_RemoveAll(t *testing.T) {
	b := TreeInt8Of(1, 1, 1, 2)
	b.RemoveAll(1)
	if b.Contains(1) {
...
func TestTreeInt8_Generated_Contains(t *testing.T) {
	b := TreeInt8Of(1, 2)
	if !b.Contains(1) {
...
func TestTreeInt8_Generated_IsEmpty(t *testing.T) {
	b := NewTreeInt8()
	if b.Len() != 0 {
...
func TestTreeInt8_Generated_Clear(t *testing.T) {
	b := TreeInt8Of(1, 2)
	b.Clear()
	if b.Len() != 0 {
...
func TestTreeInt8_Generated_SortedIteration(t *testing.T) {
	b := TreeInt8Of(3, 1, 2)
...
func TestTreeInt8_Generated_MinMax(t *testing.T) {
	b := TreeInt8Of(3, 1, 2)
	minVal, minOk := b.Min()
	if !minOk || minVal != 1 {
...
func TestTreeInt8_Generated_ForEachWithOccurrences(t *testing.T) {
	b := TreeInt8Of(1, 1, 2, 2, 2)
	total := 0
...
func TestTreeInt8_Generated_TopOccurrences(t *testing.T) {
	b := TreeInt8Of(1, 1, 1, 2, 2, 3)
...
func TestTreeInt8_Generated_Select(t *testing.T) {
	b := TreeInt8Of(1, 2, 3)
...
func TestTreeInt8_Generated_AnySatisfy(t *testing.T) {
	b := TreeInt8Of(1, 2, 3)
...
func TestTreeInt8_Generated_String(t *testing.T) {
	b := TreeInt8Of(1)
	str := b.String()
	if str == "" {
...
func TestTreeInt8_Generated_Equals(t *testing.T) {
	b1 := TreeInt8Of(1, 1, 2)
	b2 := TreeInt8Of(1, 1, 2)
	if !b1.Equals(b2) {
