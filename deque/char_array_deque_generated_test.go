...
func TestChar_Generated_AddLastRemoveFirst(t *testing.T) {
	d := NewChar()
	d.AddLast(1)
	d.AddLast(2)
	d.AddLast(3)
...
func TestChar_Generated_AddFirstRemoveLast(t *testing.T) {
	d := NewChar()
	d.AddFirst(1)
	d.AddFirst(2)
	d.AddFirst(3)
...
func TestChar_Generated_RemoveEmpty(t *testing.T) {
	d := NewChar()
...
func TestChar_Generated_MixedOps(t *testing.T) {
	d := NewChar()
	d.AddLast(2)
	d.AddFirst(1)
	d.AddLast(3)
...
func TestChar_Generated_ContainsAndClear(t *testing.T) {
	d := NewChar()
	d.AddLast(1)
	d.AddLast(2)
	if !d.Contains(1) {
...
// TestChar_Generated_RingBufferWrapAround exercises the ring buffer's
...
func TestChar_Generated_RingBufferWrapAround(t *testing.T) {
	d := NewChar()
...
// TestChar_Generated_AddFirstIsO1 is a complexity sanity check.
...
func TestChar_Generated_AddFirstIsO1(t *testing.T) {
	const N = 10000
	d := NewChar()
	for i := 0; i < N; i++ {
		d.AddFirst(1)
...
// TestChar_Generated_AlternatingEndsGrow exercises the grow path while
...
func TestChar_Generated_AlternatingEndsGrow(t *testing.T) {
	d := NewChar()
