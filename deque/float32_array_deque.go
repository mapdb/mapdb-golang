...
// valid).
func (d *Float32) at(i int) float32 {
...
func (d *Float32) All() iter.Seq[float32] {
...
// whose concatenation reproduces All in order, so a *Float32 satisfies
// par.Segmenter[float32] and feeds par.From directly. Each view maps its
...
func (d *Float32) Segments(n int) []iter.Seq[float32] {
