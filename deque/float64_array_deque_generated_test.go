...
// TestFloat64ArrayDeque_Generated_RingBufferWrapAround exercises the ring buffer's
...
func TestFloat64ArrayDeque_Generated_RingBufferWrapAround(t *testing.T) {
	d := NewFloat64ArrayDeque()
...
// TestFloat64ArrayDeque_Generated_AddFirstIsO1 is a complexity sanity check.
...
func TestFloat64ArrayDeque_Generated_AddFirstIsO1(t *testing.T) {
	const N = 10000
	d := NewFloat64ArrayDeque()
	for i := 0; i < N; i++ {
		d.AddFirst(1.0)
...
// TestFloat64ArrayDeque_Generated_AlternatingEndsGrow exercises the grow path while
...
func TestFloat64ArrayDeque_Generated_AlternatingEndsGrow(t *testing.T) {
	d := NewFloat64ArrayDeque()
