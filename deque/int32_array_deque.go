...
func (d *Int32) All() iter.Seq[int32] {
...
// whose concatenation reproduces All in order, so a *Int32 satisfies
// par.Segmenter[int32] and feeds par.From directly. Each view maps its
...
func (d *Int32) Segments(n int) []iter.Seq[int32] {
