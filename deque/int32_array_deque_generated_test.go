...
func TestInt32_Generated_AddLastRemoveFirst(t *testing.T) {
	d := NewInt32()
	d.AddLast(1)
	d.AddLast(2)
	d.AddLast(3)
...
func TestInt32_Generated_AddFirstRemoveLast(t *testing.T) {
	d := NewInt32()
	d.AddFirst(1)
	d.AddFirst(2)
	d.AddFirst(3)
...
func TestInt32_Generated_RemoveEmpty(t *testing.T) {
	d := NewInt32()
...
func TestInt32_Generated_MixedOps(t *testing.T) {
	d := NewInt32()
	d.AddLast(2)
	d.AddFirst(1)
	d.AddLast(3)
...
func TestInt32_Generated_ContainsAndClear(t *testing.T) {
	d := NewInt32()
	d.AddLast(1)
	d.AddLast(2)
	if !d.Contains(1) {
...
// TestInt32_Generated_RingBufferWrapAround exercises the ring buffer's
...
func TestInt32_Generated_RingBufferWrapAround(t *testing.T) {
	d := NewInt32()
...
// TestInt32_Generated_AddFirstIsO1 is a complexity sanity check.
...
func TestInt32_Generated_AddFirstIsO1(t *testing.T) {
	const N = 10000
	d := NewInt32()
	for i := 0; i < N; i++ {
		d.AddFirst(1)
...
// TestInt32_Generated_AlternatingEndsGrow exercises the grow path while
...
func TestInt32_Generated_AlternatingEndsGrow(t *testing.T) {
	d := NewInt32()
