...
func TestInt64ArrayDeque_Generated_AddLastRemoveFirst(t *testing.T) {
	d := NewInt64ArrayDeque()
	d.AddLast(1)
	d.AddLast(2)
	d.AddLast(3)
	if d.Size() != 3 {
...
func TestInt64ArrayDeque_Generated_AddFirstRemoveLast(t *testing.T) {
	d := NewInt64ArrayDeque()
	d.AddFirst(1)
	d.AddFirst(2)
	d.AddFirst(3)
...
func TestInt64ArrayDeque_Generated_RemoveEmpty(t *testing.T) {
	d := NewInt64ArrayDeque()
...
func TestInt64ArrayDeque_Generated_MixedOps(t *testing.T) {
	d := NewInt64ArrayDeque()
	d.AddLast(2)
	d.AddFirst(1)
	d.AddLast(3)
...
func TestInt64ArrayDeque_Generated_ContainsAndClear(t *testing.T) {
	d := NewInt64ArrayDeque()
	d.AddLast(1)
	d.AddLast(2)
	if !d.Contains(1) {
...
func TestInt64ArrayDeque_Generated_ToSlice(t *testing.T) {
	d := Int64ArrayDequeOf(1, 2, 3)
	out := d.ToSlice()
	if len(out) != 3 {
...
func TestInt64ArrayDeque_Generated_Equals(t *testing.T) {
	a := Int64ArrayDequeOf(1, 2)
	b := Int64ArrayDequeOf(1, 2)
	if !a.Equals(b) {
		t.Errorf("Equals = false, want true")
	}
}

func TestInt64ArrayDeque_Generated_String(t *testing.T) {
	d := NewInt64ArrayDeque()
	d.AddLast(1)
	if d.String() == "" {
...
// TestInt64ArrayDeque_Generated_RingBufferWrapAround exercises the ring buffer's
...
func TestInt64ArrayDeque_Generated_RingBufferWrapAround(t *testing.T) {
	d := NewInt64ArrayDeque()
...
// TestInt64ArrayDeque_Generated_AddFirstIsO1 is a complexity sanity check.
...
func TestInt64ArrayDeque_Generated_AddFirstIsO1(t *testing.T) {
	const N = 10000
	d := NewInt64ArrayDeque()
	for i := 0; i < N; i++ {
		d.AddFirst(1)
...
// TestInt64ArrayDeque_Generated_AlternatingEndsGrow exercises the grow path while
...
func TestInt64ArrayDeque_Generated_AlternatingEndsGrow(t *testing.T) {
	d := NewInt64ArrayDeque()
