...
func TestSynchronizedInt64_Generated_AddRemove(t *testing.T) {
	d := NewSynchronizedInt64()
	d.AddLast(1)
	d.AddLast(2)
	d.AddFirst(3)
	if d.Len() != 3 {
...
func TestSynchronizedInt64_Generated_PeekContainsClear(t *testing.T) {
	d := NewSynchronizedInt64()
	d.AddLast(1)
...
func TestSynchronizedInt64_Generated_ConcurrentAccess(t *testing.T) {
	d := NewSynchronizedInt64()
