...
func BenchmarkInt32Int64HashMap_Put(b *testing.B) {
	m := NewInt32Int64HashMapWithCapacity(b.N * 2)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkInt32Int64HashMap_Get(b *testing.B) {
...
func BenchmarkInt32Int64HashMap_Iterate(b *testing.B) {
	m := NewInt32Int64HashMap()
	for i := int32(0); i < 10000; i++ {
		m.Put(i, int64(i))
	}
