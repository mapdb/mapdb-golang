...
func TestCharCharBiMap_Generated_PutGet(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestCharCharBiMap_Generated_GetKey(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharCharBiMap_Generated_PutOverwriteKey(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
...
func TestCharCharBiMap_Generated_PutOverwriteValue(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharCharBiMap_Generated_Remove(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharCharBiMap_Generated_RemoveValue(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharCharBiMap_Generated_ContainsKey(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestCharCharBiMap_Generated_ContainsValue(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	if !m.ContainsValue(1) {
...
func TestCharCharBiMap_Generated_IsEmpty(t *testing.T) {
	m := NewCharCharBiMap()
	if m.Len() != 0 {
...
func TestCharCharBiMap_Generated_Clear(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestCharCharBiMap_Generated_ForEach(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharCharBiMap_Generated_Keys(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharCharBiMap_Generated_Values(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharCharBiMap_Generated_Inverse(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharCharBiMap_Generated_Equals(t *testing.T) {
	m1 := NewCharCharBiMap()
	m1.Put(1, 1)
	m1.Put(2, 2)
...
func TestCharCharBiMap_Generated_String(t *testing.T) {
	m := NewCharCharBiMap()
	if m.String() != "{}" {
...
func TestCharCharBiMap_Generated_BijectiveInvariant(t *testing.T) {
	m := NewCharCharBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
