...
func TestCharChar_Generated_PutGet(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestCharChar_Generated_PutOverwrite(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
...
func TestCharChar_Generated_Remove(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharChar_Generated_ContainsKey(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestCharChar_Generated_ContainsValue(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
...
func TestCharChar_Generated_GetOrDefault(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
...
func TestCharChar_Generated_IsEmpty(t *testing.T) {
	m := NewCharChar()
	if m.Len() != 0 {
...
func TestCharChar_Generated_Clear(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestCharChar_Generated_All(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharChar_Generated_Keys(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharChar_Generated_Values(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharChar_Generated_Select(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestCharChar_Generated_Reject(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestCharChar_Generated_Detect(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharChar_Generated_AnySatisfy(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharChar_Generated_AllSatisfy(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharChar_Generated_NoneSatisfy(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharChar_Generated_Count(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestCharChar_Generated_Entry(t *testing.T) {
	m := NewCharChar()
...
// TestCharChar_Generated_AndModify_ResizeDetection forces a resize from
...
func TestCharChar_Generated_AndModify_ResizeDetection(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	defer func() {
		if r := recover(); r == nil {
...
func TestCharChar_Generated_PutReturning(t *testing.T) {
	m := NewCharChar()
...
func TestCharChar_Generated_RemoveKeyReturning(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharChar_Generated_Equals(t *testing.T) {
	m1 := NewCharChar()
	m1.Put(1, 1)
	m1.Put(2, 2)
...
func TestCharChar_Generated_String(t *testing.T) {
	m := NewCharChar()
	m.Put(1, 1)
	if m.String() == "" {
...
func TestCharChar_Generated_Resize(t *testing.T) {
	m := NewCharChar()
