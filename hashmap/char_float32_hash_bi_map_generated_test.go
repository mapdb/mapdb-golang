...
func TestCharFloat32BiMap_Generated_PutGet(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestCharFloat32BiMap_Generated_GetKey(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestCharFloat32BiMap_Generated_PutOverwriteKey(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
...
func TestCharFloat32BiMap_Generated_PutOverwriteValue(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestCharFloat32BiMap_Generated_Remove(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestCharFloat32BiMap_Generated_RemoveValue(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestCharFloat32BiMap_Generated_ContainsKey(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	if !m.ContainsKey(1) {
...
func TestCharFloat32BiMap_Generated_ContainsValue(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	if !m.ContainsValue(1.0) {
...
func TestCharFloat32BiMap_Generated_IsEmpty(t *testing.T) {
	m := NewCharFloat32BiMap()
	if m.Len() != 0 {
...
func TestCharFloat32BiMap_Generated_Clear(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Clear()
...
func TestCharFloat32BiMap_Generated_ForEach(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestCharFloat32BiMap_Generated_Keys(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestCharFloat32BiMap_Generated_Values(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestCharFloat32BiMap_Generated_Inverse(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestCharFloat32BiMap_Generated_Equals(t *testing.T) {
	m1 := NewCharFloat32BiMap()
	m1.Put(1, 1.0)
	m1.Put(2, 2.0)

	m2 := NewCharFloat32BiMap()
	m2.Put(2, 2.0)
	m2.Put(1, 1.0)
...
func TestCharFloat32BiMap_Generated_String(t *testing.T) {
	m := NewCharFloat32BiMap()
	if m.String() != "{}" {
...
func TestCharFloat32BiMap_Generated_BijectiveInvariant(t *testing.T) {
	m := NewCharFloat32BiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
