...
func TestCharFloat32HashMap_Generated_Detect(t *testing.T) {
	...
	_, val, found := m.Detect(func(k uint16, v float32) bool { return k == 2 })
	if !found || val != 2.0 {
...
func TestCharFloat32HashMap_Generated_AnySatisfy(t *testing.T) {
	...
	if m.AnySatisfy(func(k uint16, v float32) bool { return v == 99.0 }) {
...
func TestCharFloat32HashMap_Generated_AllSatisfy(t *testing.T) {
	...
	if !m.AllSatisfy(func(k uint16, v float32) bool { return v > 0.0 }) {
		t.Error("AllSatisfy should be true for > 0")
	}
	if m.AllSatisfy(func(k uint16, v float32) bool { return v > 1.0 }) {
...
func TestCharFloat32HashMap_Generated_NoneSatisfy(t *testing.T) {
	...
	if !m.NoneSatisfy(func(k uint16, v float32) bool { return v == 99.0 }) {
...
func TestCharFloat32HashMap_Generated_Count(t *testing.T) {
	...
	if c := m.Count(func(k uint16, v float32) bool { return v > 1.0 }); c != 2 {
