...
func CharFloat64BiMapBulkLoad(keys []uint16, values []float64, policy pump.DuplicatePolicy) (*CharFloat64BiMap, error) {
	...
	m := &CharFloat64BiMap{
		forward: NewCharFloat64WithCapacity(CharFloat64bulkCap(len(keys))),
		reverse: NewFloat64CharWithCapacity(Float64CharbulkCap(len(values))),
	}
...
func (m *CharFloat64BiMap) All() iter.Seq2[uint16, float64] {
