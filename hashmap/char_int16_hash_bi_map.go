...
func CharInt16BiMapBulkLoad(keys []uint16, values []int16, policy pump.DuplicatePolicy) (*CharInt16BiMap, error) {
	...
	m := &CharInt16BiMap{
		forward: NewCharInt16WithCapacity(CharInt16bulkCap(len(keys))),
		reverse: NewInt16CharWithCapacity(Int16CharbulkCap(len(values))),
	}
...
func (m *CharInt16BiMap) All() iter.Seq2[uint16, int16] {
