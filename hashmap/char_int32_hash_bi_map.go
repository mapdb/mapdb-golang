...
func CharInt32BiMapBulkLoad(keys []uint16, values []int32, policy pump.DuplicatePolicy) (*CharInt32BiMap, error) {
	...
	m := &CharInt32BiMap{
		forward: NewCharInt32WithCapacity(CharInt32bulkCap(len(keys))),
		reverse: NewInt32CharWithCapacity(Int32CharbulkCap(len(values))),
	}
...
func (m *CharInt32BiMap) All() iter.Seq2[uint16, int32] {
