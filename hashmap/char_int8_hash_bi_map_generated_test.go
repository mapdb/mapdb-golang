...
func TestCharInt8HashBiMap_Generated_PutGet(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestCharInt8HashBiMap_Generated_GetKey(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharInt8HashBiMap_Generated_PutOverwriteKey(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
...
func TestCharInt8HashBiMap_Generated_PutOverwriteValue(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharInt8HashBiMap_Generated_Remove(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharInt8HashBiMap_Generated_RemoveValue(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharInt8HashBiMap_Generated_ContainsKey(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestCharInt8HashBiMap_Generated_ContainsValue(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	if !m.ContainsValue(1) {
...
func TestCharInt8HashBiMap_Generated_IsEmpty(t *testing.T) {
	m := NewCharInt8HashBiMap()
	if !m.IsEmpty() {
...
func TestCharInt8HashBiMap_Generated_Clear(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestCharInt8HashBiMap_Generated_ForEach(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharInt8HashBiMap_Generated_Keys(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharInt8HashBiMap_Generated_Values(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharInt8HashBiMap_Generated_Inverse(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharInt8HashBiMap_Generated_Equals(t *testing.T) {
	m1 := NewCharInt8HashBiMap()
	m1.Put(1, 1)
	m1.Put(2, 2)

	m2 := NewCharInt8HashBiMap()
	m2.Put(2, 2)
	m2.Put(1, 1)
...
func TestCharInt8HashBiMap_Generated_String(t *testing.T) {
	m := NewCharInt8HashBiMap()
	if m.String() != "{}" {
...
func TestCharInt8HashBiMap_Generated_BijectiveInvariant(t *testing.T) {
	m := NewCharInt8HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
