...
func Float32CharBiMapBulkLoad(keys []float32, values []uint16, policy pump.DuplicatePolicy) (*Float32CharBiMap, error) {
	...
	m := &Float32CharBiMap{
		forward: NewFloat32CharWithCapacity(Float32CharbulkCap(len(keys))),
		reverse: NewCharFloat32WithCapacity(CharFloat32bulkCap(len(values))),
	}
...
func (m *Float32CharBiMap) All() iter.Seq2[float32, uint16] {
