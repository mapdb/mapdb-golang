...
func TestFloat32CharHashBiMap_Generated_PutGet(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
...
func TestFloat32CharHashBiMap_Generated_GetKey(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat32CharHashBiMap_Generated_PutOverwriteKey(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
...
func TestFloat32CharHashBiMap_Generated_PutOverwriteValue(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat32CharHashBiMap_Generated_Remove(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat32CharHashBiMap_Generated_RemoveValue(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat32CharHashBiMap_Generated_ContainsKey(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	if !m.ContainsKey(1.0) {
...
func TestFloat32CharHashBiMap_Generated_ContainsValue(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	if !m.ContainsValue(1) {
...
func TestFloat32CharHashBiMap_Generated_IsEmpty(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	if !m.IsEmpty() {
...
func TestFloat32CharHashBiMap_Generated_Clear(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Clear()
...
func TestFloat32CharHashBiMap_Generated_ForEach(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat32CharHashBiMap_Generated_Keys(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat32CharHashBiMap_Generated_Values(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat32CharHashBiMap_Generated_Inverse(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat32CharHashBiMap_Generated_Equals(t *testing.T) {
	m1 := NewFloat32CharHashBiMap()
	m1.Put(1.0, 1)
	m1.Put(2.0, 2)

	m2 := NewFloat32CharHashBiMap()
	m2.Put(2.0, 2)
	m2.Put(1.0, 1)
...
func TestFloat32CharHashBiMap_Generated_String(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	if m.String() != "{}" {
...
func TestFloat32CharHashBiMap_Generated_BijectiveInvariant(t *testing.T) {
	m := NewFloat32CharHashBiMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
