...
func TestFloat32Float32HashBiMap_Generated_PutGet(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	m.Put(3.0, 3.0)
...
func TestFloat32Float32HashBiMap_Generated_GetKey(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)

	if k, ok := m.GetKey(1.0); !ok || k != 1.0 {
		t.Errorf("GetKey(1.0) = (%v, %v), want (1.0, true)", k, ok)
	}
	if k, ok := m.GetKey(99.0); ok || k != 0.0 {
		t.Errorf("GetKey(99.0) = (%v, %v), want (0.0, false)", k, ok)
	}
}

func TestFloat32Float32HashBiMap_Generated_PutOverwriteKey(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	...
	if k, ok := m.GetKey(2.0); !ok || k != 1.0 {
		t.Errorf("GetKey(2.0) = (%v, %v), want (1.0, true)", k, ok)
	}
}

func TestFloat32Float32HashBiMap_Generated_PutOverwriteValue(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	...
	if v, ok := m.Get(3.0); !ok || v != 1.0 {
		t.Errorf("Get(3.0) = (%v, %v), want (1.0, true)", v, ok)
	}
	// Reverse should map value to new key
	if k, ok := m.GetKey(1.0); !ok || k != 3.0 {
		t.Errorf("GetKey(1.0) = (%v, %v), want (3.0, true)", k, ok)
	}
	if m.Size() != 2 {
...
func TestFloat32Float32HashBiMap_Generated_Remove(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
...
func TestFloat32Float32HashBiMap_Generated_RemoveValue(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	...
	if !ok || oldKey != 1.0 {
		t.Errorf("RemoveValue(1.0) = (%v, %v), want (1.0, true)", oldKey, ok)
	}
	if m.Size() != 1 {
...
func TestFloat32Float32HashBiMap_Generated_ContainsKey(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	if !m.ContainsKey(1.0) {
...
func TestFloat32Float32HashBiMap_Generated_ContainsValue(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	if !m.ContainsValue(1.0) {
...
func TestFloat32Float32HashBiMap_Generated_IsEmpty(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	if !m.IsEmpty() {
...
func TestFloat32Float32HashBiMap_Generated_Clear(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	m.Clear()
...
func TestFloat32Float32HashBiMap_Generated_ForEach(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
...
func TestFloat32Float32HashBiMap_Generated_Keys(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
...
func TestFloat32Float32HashBiMap_Generated_Values(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
...
func TestFloat32Float32HashBiMap_Generated_Inverse(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	...
	if v, ok := inv.Get(1.0); !ok || v != 1.0 {
		t.Errorf("Inverse.Get(1.0) = (%v, %v), want (1.0, true)", v, ok)
	}
}

func TestFloat32Float32HashBiMap_Generated_Equals(t *testing.T) {
	m1 := NewFloat32Float32HashBiMap()
	m1.Put(1.0, 1.0)
	m1.Put(2.0, 2.0)

	m2 := NewFloat32Float32HashBiMap()
	m2.Put(2.0, 2.0)
	m2.Put(1.0, 1.0)
...
func TestFloat32Float32HashBiMap_Generated_String(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	if m.String() != "{}" {
...
func TestFloat32Float32HashBiMap_Generated_BijectiveInvariant(t *testing.T) {
	m := NewFloat32Float32HashBiMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	m.Put(3.0, 3.0)
