...
func Float32Float64BiMapBulkLoad(keys []float32, values []float64, policy pump.DuplicatePolicy) (*Float32Float64BiMap, error) {
	...
	m := &Float32Float64BiMap{
		forward: NewFloat32Float64WithCapacity(Float32Float64bulkCap(len(keys))),
		reverse: NewFloat64Float32WithCapacity(Float64Float32bulkCap(len(values))),
	}
...
func (m *Float32Float64BiMap) All() iter.Seq2[float32, float64] {
