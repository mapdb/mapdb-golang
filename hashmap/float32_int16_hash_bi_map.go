...
// Float32Int16BiMap is a bidirectional map with float32 keys and int16 values.
// Both key-to-value and value-to-key lookups are O(1).
type Float32Int16BiMap struct {
	forward *Float32Int16
	reverse *Int16Float32
}

// NewFloat32Int16BiMap creates a new empty Float32Int16BiMap with default capacity.
func NewFloat32Int16BiMap() *Float32Int16BiMap {
	return &Float32Int16BiMap{
		forward: NewFloat32Int16(),
		reverse: NewInt16Float32(),
	}
}

// NewFloat32Int16BiMapWithCapacity creates a new empty Float32Int16BiMap with the given initial capacity.
func NewFloat32Int16BiMapWithCapacity(capacity int) *Float32Int16BiMap {
	return &Float32Int16BiMap{
		forward: NewFloat32Int16WithCapacity(capacity),
		reverse: NewInt16Float32WithCapacity(capacity),
	}
}

// Float32Int16BiMapBulkLoad builds a Float32Int16BiMap from keys/values in a
...
func Float32Int16BiMapBulkLoad(keys []float32, values []int16, policy pump.DuplicatePolicy) (*Float32Int16BiMap, error) {
	if len(keys) != len(values) {
		panic("mapdb: Float32Int16BiMapBulkLoad: len(keys) != len(values)")
	}
	m := &Float32Int16BiMap{
		forward: NewFloat32Int16WithCapacity(Float32Int16bulkCap(len(keys))),
		reverse: NewInt16Float32WithCapacity(Int16Float32bulkCap(len(values))),
	}
...
func (m *Float32Int16BiMap) Put(key float32, value int16) (int16, bool) {
...
func (m *Float32Int16BiMap) RemoveValue(value int16) (float32, bool) {
...
func (m *Float32Int16BiMap) ContainsKey(key float32) bool {
	return m.forward.ContainsKey(key)
}

// ContainsValue returns true if the map contains the given value.
func (m *Float32Int16BiMap) ContainsValue(value int16) bool {
	return m.reverse.ContainsKey(value)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Float32Int16BiMap) Len() int {
	return m.forward.Len()
}

// Clear removes all entries from both directions.
func (m *Float32Int16BiMap) Clear() {
	m.forward.Clear()
	m.reverse.Clear()
}

// ForEach calls the given function for each key-value pair.
func (m *Float32Int16BiMap) ForEach(f func(float32, int16)) {
	m.forward.ForEach(f)
}
...
func (m *Float32Int16BiMap) All() iter.Seq2[float32, int16] {
	return m.forward.All()
}

// Keys returns an iter.Seq that yields all keys.
func (m *Float32Int16BiMap) Keys() iter.Seq[float32] {
	return m.forward.Keys()
}

// Values returns an iter.Seq that yields all values.
func (m *Float32Int16BiMap) Values() iter.Seq[int16] {
	return m.forward.Values()
}

// Inverse returns a new Int16Float32BiMap with keys and values swapped.
func (m *Float32Int16BiMap) Inverse() *Int16Float32BiMap {
	result := NewInt16Float32BiMap()
...
func (m *Float32Int16BiMap) String() string {
	if m.forward.Len() == 0 {
		return "{}"
	}
...
func (m *Float32Int16BiMap) Equals(other *Float32Int16BiMap) bool {
