...
// has more distinct keys than expected — use Float32Int16BulkLoadExact for the
...
func Float32Int16BulkLoad(keys []float32, values []int16, policy pump.DuplicatePolicy) (*Float32Int16, error) {
	...
	m := &Float32Int16{entries: make([]float32Int16Entry, Float32Int16bulkCap(len(keys)))}
...
func Float32Int16BulkLoadExact(keys []float32, values []int16, n int, policy pump.DuplicatePolicy) (*Float32Int16, error) {
	...
	m := &Float32Int16{entries: make([]float32Int16Entry, Float32Int16bulkCap(n))}
	for i := range keys {
		if m.size >= n {
...
func (m *Float32Int16) bulkInsert(keys []float32, values []int16, policy pump.DuplicatePolicy) error {
	for i := range keys {
		if m.needsResize() {
			m.resize()
		}
...
func (m *Float32Int16) bulkPut(key float32, value int16, policy pump.DuplicatePolicy) (bool, error) {
