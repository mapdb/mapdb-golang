...
const (
	float32Int16HashMapDefaultCapacity = 16
	// Load factor 3/4 = 0.75, using integer math to avoid float conversion per insert.
)

// float32Int16HashMapEntry holds a single slot in the hash map for cache locality.
type float32Int16HashMapEntry struct {
	key      float32
	value    int16
	occupied bool
}

// Float32Int16HashMap is an open-addressing hash map with float32 keys and int16 values.
type Float32Int16HashMap struct {
	entries []float32Int16HashMapEntry
	size    int
}

// NewFloat32Int16HashMap creates a new empty Float32Int16HashMap with default capacity.
func NewFloat32Int16HashMap() *Float32Int16HashMap {
	return NewFloat32Int16HashMapWithCapacity(float32Int16HashMapDefaultCapacity)
}

// NewFloat32Int16HashMapWithCapacity creates a new empty Float32Int16HashMap with the given initial capacity.
func NewFloat32Int16HashMapWithCapacity(capacity int) *Float32Int16HashMap {
	cap := nextPowerOfTwoFloat32Int16HashMap(capacity)
	return &Float32Int16HashMap{
		entries: make([]float32Int16HashMapEntry, cap),
		size:    0,
	}
}

// Float32Int16HashMapOf creates a new Float32Int16HashMap from key-value pairs.
func Float32Int16HashMapOf(pairs ...struct {
	Key   float32
	Value int16
}) *Float32Int16HashMap {
...
func (m *Float32Int16HashMap) Put(key float32, value int16) (int16, bool) {
	if m.needsResize() {
		m.resize()
	}
	cap := len(m.entries)
...
func (m *Float32Int16HashMap) Get(key float32) (int16, bool) {
	cap := len(m.entries)
	if cap == 0 {
		return 0, false
	}
...
func (m *Float32Int16HashMap) GetOrDefault(key float32, defaultValue int16) int16 {
...
func (m *Float32Int16HashMap) Remove(key float32) (int16, bool) {
	cap := len(m.entries)
	if cap == 0 {
		return 0, false
	}
...
func (m *Float32Int16HashMap) ContainsKey(key float32) bool {
	_, ok := m.Get(key)
	return ok
}

// ContainsValue returns true if the map contains the given value.
func (m *Float32Int16HashMap) ContainsValue(value int16) bool {
...
func (m *Float32Int16HashMap) Size() int {
	return m.size
}

// IsEmpty returns true if the map contains no entries.
func (m *Float32Int16HashMap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the map.
func (m *Float32Int16HashMap) Clear() {
	for i := range m.entries {
		m.entries[i] = float32Int16HashMapEntry{}
	}
	m.size = 0
}

// All returns an iter.Seq2 that yields all key-value pairs.
func (m *Float32Int16HashMap) All() iter.Seq2[float32, int16] {
...
func (m *Float32Int16HashMap) Keys() iter.Seq[float32] {
...
func (m *Float32Int16HashMap) Values() iter.Seq[int16] {
...
func (m *Float32Int16HashMap) ForEach(f func(float32, int16)) {
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Float32Int16HashMap) ForEachKey(f func(float32)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].key)
		}
...
func (m *Float32Int16HashMap) ForEachValue(f func(int16)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].value)
		}
...
func (m *Float32Int16HashMap) Select(predicate func(float32, int16) bool) *Float32Int16HashMap {
...
func (m *Float32Int16HashMap) Reject(predicate func(float32, int16) bool) *Float32Int16HashMap {
	result := NewFloat32Int16HashMap()
	for i := range m.entries {
		if m.entries[i].occupied && !predicate(m.entries[i].key, m.entries[i].value) {
			result.Put(m.entries[i].key, m.entries[i].value)
...
func (m *Float32Int16HashMap) Detect(predicate func(float32, int16) bool) (float32, int16, bool) {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
...
func (m *Float32Int16HashMap) AnySatisfy(predicate func(float32, int16) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			return true
		}
...
func (m *Float32Int16HashMap) AllSatisfy(predicate func(float32, int16) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && !predicate(m.entries[i].key, m.entries[i].value) {
			return false
		}
...
func (m *Float32Int16HashMap) NoneSatisfy(predicate func(float32, int16) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			return false
		}
...
func (m *Float32Int16HashMap) Count(predicate func(float32, int16) bool) int {
	count := 0
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			count++
...
func (m *Float32Int16HashMap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Float32Int16HashMap) Equals(other *Float32Int16HashMap) bool {
...
func (m *Float32Int16HashMap) KeysToSlice() []float32 {
...
func (m *Float32Int16HashMap) ValuesToSlice() []int16 {
...
func (m *Float32Int16HashMap) ToImmutable() *ImmutableFloat32Int16HashMap {
	return ImmutableFloat32Int16HashMapFrom(m)
}

// InjectInto performs a left fold over all key-value pairs.
func (m *Float32Int16HashMap) InjectInto(initial int16, f func(int16, float32, int16) int16) int16 {
	result := initial
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Float32Int16HashMap) AddToValue(key float32, amount int16) int16 {
	if v, ok := m.Get(key); ok {
		newVal := v + amount
		m.Put(key, newVal)
		return newVal
...
// Returns the new value.
func (m *Float32Int16HashMap) UpdateValue(key float32, initialValue int16, f func(int16) int16) int16 {
	if v, ok := m.Get(key); ok {
		newVal := f(v)
		m.Put(key, newVal)
		return newVal
...
func (m *Float32Int16HashMap) WithKeyValue(key float32, value int16) *Float32Int16HashMap {
	m.Put(key, value)
	return m
}

// WithoutKey returns the map after removing the key (fluent API).
func (m *Float32Int16HashMap) WithoutKey(key float32) *Float32Int16HashMap {
	m.Remove(key)
	return m
}

// WithoutAllKeys removes all given keys (fluent API).
func (m *Float32Int16HashMap) WithoutAllKeys(keys []float32) *Float32Int16HashMap {
	for _, k := range keys {
		m.Remove(k)
	}
	return m
...
func (m *Float32Int16HashMap) SumOfValues() int16 {
	var sum int16
	for i := range m.entries {
		if m.entries[i].occupied {
...
// SynchronizedFloat32Int16HashMap wrapper's Lock / RLock, or your own mutex) is required
...
func (m *Float32Int16HashMap) hashKey(key float32) uint64 {
	return func() uint64 {
...
func (m *Float32Int16HashMap) needsResize() bool {
	return (m.size+1)*4 >= len(m.entries)*3 // 0.75 load factor, integer math
}

func (m *Float32Int16HashMap) resize() {
	oldEntries := m.entries
	newCap := len(oldEntries) * 2
	if newCap == 0 {
		newCap = float32Int16HashMapDefaultCapacity
	}
	m.entries = make([]float32Int16HashMapEntry, newCap)
	m.size = 0
...
func (m *Float32Int16HashMap) rehashFrom(deleted int, mask int) {
	c := len(m.entries)
	idx := (deleted + 1) & mask
	for m.entries[idx].occupied {
		...
		if distCurrent > distGap {
			...
			m.entries[idx] = float32Int16HashMapEntry{}
			deleted = idx
		}
		idx = (idx + 1) & mask
		if idx == deleted {
...
func nextPowerOfTwoFloat32Int16HashMap(n int) int {
	if n <= 0 {
		return 16
	}
	n--
