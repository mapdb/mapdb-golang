...
func Float32Int64BiMapBulkLoad(keys []float32, values []int64, policy pump.DuplicatePolicy) (*Float32Int64BiMap, error) {
	...
	m := &Float32Int64BiMap{
		forward: NewFloat32Int64WithCapacity(Float32Int64bulkCap(len(keys))),
		reverse: NewInt64Float32WithCapacity(Int64Float32bulkCap(len(values))),
	}
...
func (m *Float32Int64BiMap) All() iter.Seq2[float32, int64] {
