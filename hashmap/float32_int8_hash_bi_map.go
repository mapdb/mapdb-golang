...
func Float32Int8BiMapBulkLoad(keys []float32, values []int8, policy pump.DuplicatePolicy) (*Float32Int8BiMap, error) {
	...
	m := &Float32Int8BiMap{
		forward: NewFloat32Int8WithCapacity(Float32Int8bulkCap(len(keys))),
		reverse: NewInt8Float32WithCapacity(Int8Float32bulkCap(len(values))),
	}
...
func (m *Float32Int8BiMap) All() iter.Seq2[float32, int8] {
