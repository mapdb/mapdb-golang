...
func Float64CharBiMapBulkLoad(keys []float64, values []uint16, policy pump.DuplicatePolicy) (*Float64CharBiMap, error) {
	...
	m := &Float64CharBiMap{
		forward: NewFloat64CharWithCapacity(Float64CharbulkCap(len(keys))),
		reverse: NewCharFloat64WithCapacity(CharFloat64bulkCap(len(values))),
	}
...
func (m *Float64CharBiMap) All() iter.Seq2[float64, uint16] {
