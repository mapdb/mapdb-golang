...
func TestFloat64CharHashMap_Generated_PutGet(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
...
func TestFloat64CharHashMap_Generated_PutOverwrite(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
...
func TestFloat64CharHashMap_Generated_Remove(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64CharHashMap_Generated_ContainsKey(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	if !m.ContainsKey(1.0) {
...
func TestFloat64CharHashMap_Generated_ContainsValue(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
...
func TestFloat64CharHashMap_Generated_GetOrDefault(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
...
func TestFloat64CharHashMap_Generated_IsEmpty(t *testing.T) {
	m := NewFloat64CharHashMap()
	if !m.IsEmpty() {
...
func TestFloat64CharHashMap_Generated_Clear(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Clear()
...
func TestFloat64CharHashMap_Generated_All(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64CharHashMap_Generated_Keys(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64CharHashMap_Generated_Values(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64CharHashMap_Generated_Select(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
...
func TestFloat64CharHashMap_Generated_Reject(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
...
func TestFloat64CharHashMap_Generated_Detect(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64CharHashMap_Generated_AnySatisfy(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64CharHashMap_Generated_AllSatisfy(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64CharHashMap_Generated_NoneSatisfy(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64CharHashMap_Generated_Count(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
...
func TestFloat64CharHashMap_Generated_Entry(t *testing.T) {
	m := NewFloat64CharHashMap()
...
// TestFloat64CharHashMap_Generated_AndModify_ResizeDetection forces a resize from
...
func TestFloat64CharHashMap_Generated_AndModify_ResizeDetection(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	defer func() {
		if r := recover(); r == nil {
...
func TestFloat64CharHashMap_Generated_WithKeyValue(t *testing.T) {
	m := NewFloat64CharHashMap()
...
func TestFloat64CharHashMap_Generated_WithoutKey(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m2 := m.WithoutKey(1.0)
...
func TestFloat64CharHashMap_Generated_Equals(t *testing.T) {
	m1 := NewFloat64CharHashMap()
	m1.Put(1.0, 1)
	m1.Put(2.0, 2)

	m2 := NewFloat64CharHashMap()
	m2.Put(2.0, 2)
	m2.Put(1.0, 1)
...
func TestFloat64CharHashMap_Generated_String(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(1.0, 1)
	if m.String() == "" {
...
func TestFloat64CharHashMap_Generated_Resize(t *testing.T) {
	m := NewFloat64CharHashMap()
...
func TestFloat64CharHashMap_NaNKey_Findable(t *testing.T) {
	m := NewFloat64CharHashMap()
...
func TestFloat64CharHashMap_NaNKey_Replaces(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(float64(math.NaN()), uint16(1))
...
func TestFloat64CharHashMap_NaNKey_Remove(t *testing.T) {
	m := NewFloat64CharHashMap()
	m.Put(float64(math.NaN()), uint16(1))
...
func TestFloat64CharHashMap_NegativeZeroDistinct(t *testing.T) {
	m := NewFloat64CharHashMap()
...
func TestFloat64CharHashMap_InfinityKeys(t *testing.T) {
	m := NewFloat64CharHashMap()
