...
func Float64Float64BiMapBulkLoad(keys []float64, values []float64, policy pump.DuplicatePolicy) (*Float64Float64BiMap, error) {
	...
	m := &Float64Float64BiMap{
		forward: NewFloat64Float64WithCapacity(Float64Float64bulkCap(len(keys))),
		reverse: NewFloat64Float64WithCapacity(Float64Float64bulkCap(len(values))),
	}
...
func (m *Float64Float64BiMap) All() iter.Seq2[float64, float64] {
