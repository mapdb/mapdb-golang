...
// Float64Int32BiMap is a bidirectional map with float64 keys and int32 values.
// Both key-to-value and value-to-key lookups are O(1).
type Float64Int32BiMap struct {
	forward *Float64Int32
	reverse *Int32Float64
}

// NewFloat64Int32BiMap creates a new empty Float64Int32BiMap with default capacity.
func NewFloat64Int32BiMap() *Float64Int32BiMap {
	return &Float64Int32BiMap{
		forward: NewFloat64Int32(),
		reverse: NewInt32Float64(),
	}
}

// NewFloat64Int32BiMapWithCapacity creates a new empty Float64Int32BiMap with the given initial capacity.
func NewFloat64Int32BiMapWithCapacity(capacity int) *Float64Int32BiMap {
	return &Float64Int32BiMap{
		forward: NewFloat64Int32WithCapacity(capacity),
		reverse: NewInt32Float64WithCapacity(capacity),
	}
}

// Float64Int32BiMapBulkLoad builds a Float64Int32BiMap from keys/values in a
...
func Float64Int32BiMapBulkLoad(keys []float64, values []int32, policy pump.DuplicatePolicy) (*Float64Int32BiMap, error) {
	if len(keys) != len(values) {
		panic("mapdb: Float64Int32BiMapBulkLoad: len(keys) != len(values)")
	}
	m := &Float64Int32BiMap{
		forward: NewFloat64Int32WithCapacity(Float64Int32bulkCap(len(keys))),
		reverse: NewInt32Float64WithCapacity(Int32Float64bulkCap(len(values))),
	}
...
func (m *Float64Int32BiMap) Put(key float64, value int32) (int32, bool) {
...
func (m *Float64Int32BiMap) RemoveValue(value int32) (float64, bool) {
...
func (m *Float64Int32BiMap) ContainsKey(key float64) bool {
	return m.forward.ContainsKey(key)
}

// ContainsValue returns true if the map contains the given value.
func (m *Float64Int32BiMap) ContainsValue(value int32) bool {
	return m.reverse.ContainsKey(value)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Float64Int32BiMap) Len() int {
	return m.forward.Len()
}

// Clear removes all entries from both directions.
func (m *Float64Int32BiMap) Clear() {
	m.forward.Clear()
	m.reverse.Clear()
}

// ForEach calls the given function for each key-value pair.
func (m *Float64Int32BiMap) ForEach(f func(float64, int32)) {
	m.forward.ForEach(f)
}
...
func (m *Float64Int32BiMap) All() iter.Seq2[float64, int32] {
	return m.forward.All()
}

// Keys returns an iter.Seq that yields all keys.
func (m *Float64Int32BiMap) Keys() iter.Seq[float64] {
	return m.forward.Keys()
}

// Values returns an iter.Seq that yields all values.
func (m *Float64Int32BiMap) Values() iter.Seq[int32] {
	return m.forward.Values()
}

// Inverse returns a new Int32Float64BiMap with keys and values swapped.
func (m *Float64Int32BiMap) Inverse() *Int32Float64BiMap {
	result := NewInt32Float64BiMap()
...
func (m *Float64Int32BiMap) String() string {
	if m.forward.Len() == 0 {
		return "{}"
	}
...
func (m *Float64Int32BiMap) Equals(other *Float64Int32BiMap) bool {
