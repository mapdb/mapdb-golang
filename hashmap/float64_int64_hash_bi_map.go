...
func Float64Int64BiMapBulkLoad(keys []float64, values []int64, policy pump.DuplicatePolicy) (*Float64Int64BiMap, error) {
	...
	m := &Float64Int64BiMap{
		forward: NewFloat64Int64WithCapacity(Float64Int64bulkCap(len(keys))),
		reverse: NewInt64Float64WithCapacity(Int64Float64bulkCap(len(values))),
	}
...
func (m *Float64Int64BiMap) All() iter.Seq2[float64, int64] {
