...
func TestInt16Char_Generated_PutGet(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt16Char_Generated_PutOverwrite(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
...
func TestInt16Char_Generated_Remove(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Char_Generated_ContainsKey(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestInt16Char_Generated_ContainsValue(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
...
func TestInt16Char_Generated_GetOrDefault(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
...
func TestInt16Char_Generated_IsEmpty(t *testing.T) {
	m := NewInt16Char()
	if m.Len() != 0 {
...
func TestInt16Char_Generated_Clear(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestInt16Char_Generated_All(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Char_Generated_Keys(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Char_Generated_Values(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Char_Generated_Select(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt16Char_Generated_Reject(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt16Char_Generated_Detect(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Char_Generated_AnySatisfy(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Char_Generated_AllSatisfy(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Char_Generated_NoneSatisfy(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Char_Generated_Count(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt16Char_Generated_Entry(t *testing.T) {
	m := NewInt16Char()
...
// TestInt16Char_Generated_AndModify_ResizeDetection forces a resize from
...
func TestInt16Char_Generated_AndModify_ResizeDetection(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	defer func() {
		if r := recover(); r == nil {
...
func TestInt16Char_Generated_PutReturning(t *testing.T) {
	m := NewInt16Char()
...
func TestInt16Char_Generated_RemoveKeyReturning(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Char_Generated_Equals(t *testing.T) {
	m1 := NewInt16Char()
	m1.Put(1, 1)
	m1.Put(2, 2)
...
func TestInt16Char_Generated_String(t *testing.T) {
	m := NewInt16Char()
	m.Put(1, 1)
	if m.String() == "" {
...
func TestInt16Char_Generated_Resize(t *testing.T) {
	m := NewInt16Char()
