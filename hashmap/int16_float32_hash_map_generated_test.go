...
func TestInt16Float32HashMap_Generated_PutGet(t *testing.T) {
...
func TestInt16Float32HashMap_Generated_PutOverwrite(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
...
func TestInt16Float32HashMap_Generated_Remove(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt16Float32HashMap_Generated_ContainsKey(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	if !m.ContainsKey(1) {
...
func TestInt16Float32HashMap_Generated_ContainsValue(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
...
func TestInt16Float32HashMap_Generated_GetOrDefault(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
...
func TestInt16Float32HashMap_Generated_IsEmpty(t *testing.T) {
	m := NewInt16Float32HashMap()
	if !m.IsEmpty() {
...
func TestInt16Float32HashMap_Generated_Clear(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Clear()
...
func TestInt16Float32HashMap_Generated_All(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt16Float32HashMap_Generated_Keys(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt16Float32HashMap_Generated_Values(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt16Float32HashMap_Generated_Select(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestInt16Float32HashMap_Generated_Reject(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestInt16Float32HashMap_Generated_Detect(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt16Float32HashMap_Generated_AnySatisfy(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt16Float32HashMap_Generated_AllSatisfy(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt16Float32HashMap_Generated_NoneSatisfy(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt16Float32HashMap_Generated_Count(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestInt16Float32HashMap_Generated_Entry(t *testing.T) {
	m := NewInt16Float32HashMap()
...
// TestInt16Float32HashMap_Generated_AndModify_ResizeDetection forces a resize from
...
func TestInt16Float32HashMap_Generated_AndModify_ResizeDetection(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	defer func() {
		if r := recover(); r == nil {
...
func TestInt16Float32HashMap_Generated_WithKeyValue(t *testing.T) {
	m := NewInt16Float32HashMap()
...
func TestInt16Float32HashMap_Generated_WithoutKey(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m2 := m.WithoutKey(1)
...
func TestInt16Float32HashMap_Generated_Equals(t *testing.T) {
...
func TestInt16Float32HashMap_Generated_String(t *testing.T) {
	m := NewInt16Float32HashMap()
	m.Put(1, 1.0)
	if m.String() == "" {
...
func TestInt16Float32HashMap_Generated_Resize(t *testing.T) {
	m := NewInt16Float32HashMap()
...
func TestInt16Float32HashMap_NaNValue_ContainsValue(t *testing.T) {
	m := NewInt16Float32HashMap()
...
func TestInt16Float32HashMap_NaNValue_GetReturnsNaN(t *testing.T) {
	m := NewInt16Float32HashMap()
	nan := float32(math.NaN())
	m.Put(1, nan)
	v, ok := m.Get(1)
