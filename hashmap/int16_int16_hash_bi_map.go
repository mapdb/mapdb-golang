...
func Int16Int16BiMapBulkLoad(keys []int16, values []int16, policy pump.DuplicatePolicy) (*Int16Int16BiMap, error) {
	...
	m := &Int16Int16BiMap{
		forward: NewInt16Int16WithCapacity(Int16Int16bulkCap(len(keys))),
		reverse: NewInt16Int16WithCapacity(Int16Int16bulkCap(len(values))),
	}
...
func (m *Int16Int16BiMap) All() iter.Seq2[int16, int16] {
