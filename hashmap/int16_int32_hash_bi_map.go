...
// Int16Int32BiMap is a bidirectional map with int16 keys and int32 values.
// Both key-to-value and value-to-key lookups are O(1).
type Int16Int32BiMap struct {
	forward *Int16Int32
	reverse *Int32Int16
}

// NewInt16Int32BiMap creates a new empty Int16Int32BiMap with default capacity.
func NewInt16Int32BiMap() *Int16Int32BiMap {
	return &Int16Int32BiMap{
		forward: NewInt16Int32(),
		reverse: NewInt32Int16(),
	}
}

// NewInt16Int32BiMapWithCapacity creates a new empty Int16Int32BiMap with the given initial capacity.
func NewInt16Int32BiMapWithCapacity(capacity int) *Int16Int32BiMap {
	return &Int16Int32BiMap{
		forward: NewInt16Int32WithCapacity(capacity),
		reverse: NewInt32Int16WithCapacity(capacity),
	}
}

// Int16Int32BiMapBulkLoad builds a Int16Int32BiMap from keys/values in a
...
func Int16Int32BiMapBulkLoad(keys []int16, values []int32, policy pump.DuplicatePolicy) (*Int16Int32BiMap, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int16Int32BiMapBulkLoad: len(keys) != len(values)")
	}
	m := &Int16Int32BiMap{
		forward: NewInt16Int32WithCapacity(Int16Int32bulkCap(len(keys))),
		reverse: NewInt32Int16WithCapacity(Int32Int16bulkCap(len(values))),
	}
...
func (m *Int16Int32BiMap) Put(key int16, value int32) (int32, bool) {
...
func (m *Int16Int32BiMap) RemoveValue(value int32) (int16, bool) {
...
func (m *Int16Int32BiMap) ContainsKey(key int16) bool {
	return m.forward.ContainsKey(key)
}

// ContainsValue returns true if the map contains the given value.
func (m *Int16Int32BiMap) ContainsValue(value int32) bool {
	return m.reverse.ContainsKey(value)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int16Int32BiMap) Len() int {
	return m.forward.Len()
}

// Clear removes all entries from both directions.
func (m *Int16Int32BiMap) Clear() {
	m.forward.Clear()
	m.reverse.Clear()
}

// ForEach calls the given function for each key-value pair.
func (m *Int16Int32BiMap) ForEach(f func(int16, int32)) {
	m.forward.ForEach(f)
}
...
func (m *Int16Int32BiMap) All() iter.Seq2[int16, int32] {
	return m.forward.All()
}

// Keys returns an iter.Seq that yields all keys.
func (m *Int16Int32BiMap) Keys() iter.Seq[int16] {
	return m.forward.Keys()
}

// Values returns an iter.Seq that yields all values.
func (m *Int16Int32BiMap) Values() iter.Seq[int32] {
	return m.forward.Values()
}

// Inverse returns a new Int32Int16BiMap with keys and values swapped.
func (m *Int16Int32BiMap) Inverse() *Int32Int16BiMap {
	result := NewInt32Int16BiMap()
...
func (m *Int16Int32BiMap) String() string {
	if m.forward.Len() == 0 {
		return "{}"
	}
...
func (m *Int16Int32BiMap) Equals(other *Int16Int32BiMap) bool {
