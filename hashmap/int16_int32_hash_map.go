...
const (
	int16Int32HashMapDefaultCapacity = 16
	// Load factor 3/4 = 0.75, using integer math to avoid float conversion per insert.
)

// int16Int32HashMapEntry holds a single slot in the hash map for cache locality.
type int16Int32HashMapEntry struct {
	key      int16
	value    int32
	occupied bool
}

// Int16Int32HashMap is an open-addressing hash map with int16 keys and int32 values.
type Int16Int32HashMap struct {
	entries []int16Int32HashMapEntry
	size    int
}

// NewInt16Int32HashMap creates a new empty Int16Int32HashMap with default capacity.
func NewInt16Int32HashMap() *Int16Int32HashMap {
	return NewInt16Int32HashMapWithCapacity(int16Int32HashMapDefaultCapacity)
}

// NewInt16Int32HashMapWithCapacity creates a new empty Int16Int32HashMap with the given initial capacity.
func NewInt16Int32HashMapWithCapacity(capacity int) *Int16Int32HashMap {
	cap := nextPowerOfTwoInt16Int32HashMap(capacity)
	return &Int16Int32HashMap{
		entries: make([]int16Int32HashMapEntry, cap),
		size:    0,
	}
}

// Int16Int32HashMapOf creates a new Int16Int32HashMap from key-value pairs.
func Int16Int32HashMapOf(pairs ...struct {
	Key   int16
	Value int32
}) *Int16Int32HashMap {
...
func (m *Int16Int32HashMap) Put(key int16, value int32) (int32, bool) {
	if m.needsResize() {
		m.resize()
	}
	cap := len(m.entries)
...
func (m *Int16Int32HashMap) Get(key int16) (int32, bool) {
	cap := len(m.entries)
	if cap == 0 {
		return 0, false
	}
...
func (m *Int16Int32HashMap) GetOrDefault(key int16, defaultValue int32) int32 {
...
func (m *Int16Int32HashMap) Remove(key int16) (int32, bool) {
	cap := len(m.entries)
	if cap == 0 {
		return 0, false
	}
...
func (m *Int16Int32HashMap) ContainsKey(key int16) bool {
	_, ok := m.Get(key)
	return ok
}

// ContainsValue returns true if the map contains the given value.
func (m *Int16Int32HashMap) ContainsValue(value int32) bool {
...
func (m *Int16Int32HashMap) Size() int {
	return m.size
}

// IsEmpty returns true if the map contains no entries.
func (m *Int16Int32HashMap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the map.
func (m *Int16Int32HashMap) Clear() {
	for i := range m.entries {
		m.entries[i] = int16Int32HashMapEntry{}
	}
	m.size = 0
}

// All returns an iter.Seq2 that yields all key-value pairs.
func (m *Int16Int32HashMap) All() iter.Seq2[int16, int32] {
...
func (m *Int16Int32HashMap) Keys() iter.Seq[int16] {
...
func (m *Int16Int32HashMap) Values() iter.Seq[int32] {
...
func (m *Int16Int32HashMap) ForEach(f func(int16, int32)) {
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int16Int32HashMap) ForEachKey(f func(int16)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].key)
		}
...
func (m *Int16Int32HashMap) ForEachValue(f func(int32)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].value)
		}
...
func (m *Int16Int32HashMap) Select(predicate func(int16, int32) bool) *Int16Int32HashMap {
...
func (m *Int16Int32HashMap) Reject(predicate func(int16, int32) bool) *Int16Int32HashMap {
	result := NewInt16Int32HashMap()
	for i := range m.entries {
		if m.entries[i].occupied && !predicate(m.entries[i].key, m.entries[i].value) {
			result.Put(m.entries[i].key, m.entries[i].value)
...
func (m *Int16Int32HashMap) Detect(predicate func(int16, int32) bool) (int16, int32, bool) {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
...
func (m *Int16Int32HashMap) AnySatisfy(predicate func(int16, int32) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			return true
		}
...
func (m *Int16Int32HashMap) AllSatisfy(predicate func(int16, int32) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && !predicate(m.entries[i].key, m.entries[i].value) {
			return false
		}
...
func (m *Int16Int32HashMap) NoneSatisfy(predicate func(int16, int32) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			return false
		}
...
func (m *Int16Int32HashMap) Count(predicate func(int16, int32) bool) int {
	count := 0
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			count++
...
func (m *Int16Int32HashMap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int16Int32HashMap) Equals(other *Int16Int32HashMap) bool {
...
func (m *Int16Int32HashMap) KeysToSlice() []int16 {
...
func (m *Int16Int32HashMap) ValuesToSlice() []int32 {
...
func (m *Int16Int32HashMap) ToImmutable() *ImmutableInt16Int32HashMap {
	return ImmutableInt16Int32HashMapFrom(m)
}

// InjectInto performs a left fold over all key-value pairs.
func (m *Int16Int32HashMap) InjectInto(initial int32, f func(int32, int16, int32) int32) int32 {
	result := initial
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int16Int32HashMap) AddToValue(key int16, amount int32) int32 {
	if v, ok := m.Get(key); ok {
		newVal := v + amount
		m.Put(key, newVal)
		return newVal
...
// Returns the new value.
func (m *Int16Int32HashMap) UpdateValue(key int16, initialValue int32, f func(int32) int32) int32 {
	if v, ok := m.Get(key); ok {
		newVal := f(v)
		m.Put(key, newVal)
		return newVal
...
func (m *Int16Int32HashMap) WithKeyValue(key int16, value int32) *Int16Int32HashMap {
	m.Put(key, value)
	return m
}

// WithoutKey returns the map after removing the key (fluent API).
func (m *Int16Int32HashMap) WithoutKey(key int16) *Int16Int32HashMap {
	m.Remove(key)
	return m
}

// WithoutAllKeys removes all given keys (fluent API).
func (m *Int16Int32HashMap) WithoutAllKeys(keys []int16) *Int16Int32HashMap {
	for _, k := range keys {
		m.Remove(k)
	}
	return m
...
func (m *Int16Int32HashMap) SumOfValues() int32 {
	var sum int32
	for i := range m.entries {
		if m.entries[i].occupied {
...
// SynchronizedInt16Int32HashMap wrapper's Lock / RLock, or your own mutex) is required
...
func (m *Int16Int32HashMap) hashKey(key int16) uint64 {
	return func() uint64 { h := uint64(key) * 0x9E3779B97F4A7C15; return h ^ (h >> 32) }()
}

func (m *Int16Int32HashMap) needsResize() bool {
	return (m.size+1)*4 > len(m.entries)*3 // 0.75 load factor, integer math
}

func (m *Int16Int32HashMap) resize() {
	oldEntries := m.entries
	newCap := len(oldEntries) * 2
	if newCap == 0 {
		newCap = int16Int32HashMapDefaultCapacity
	}
	m.entries = make([]int16Int32HashMapEntry, newCap)
	m.size = 0
...
func (m *Int16Int32HashMap) rehashFrom(deleted int, mask int) {
	c := len(m.entries)
	idx := (deleted + 1) & mask
	for m.entries[idx].occupied {
		...
		if distCurrent > distGap {
			...
			m.entries[idx] = int16Int32HashMapEntry{}
			deleted = idx
		}
		idx = (idx + 1) & mask
		if idx == deleted {
...
func nextPowerOfTwoInt16Int32HashMap(n int) int {
	if n <= 0 {
		return 16
	}
	n--
