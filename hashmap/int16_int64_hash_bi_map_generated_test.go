...
func TestInt16Int64HashBiMap_Generated_PutGet(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt16Int64HashBiMap_Generated_GetKey(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)

	if k, ok := m.GetKey(1); !ok || k != 1 {
		t.Errorf("GetKey(1) = (%v, %v), want (1, true)", k, ok)
	}
	if k, ok := m.GetKey(99); ok || k != 0 {
		t.Errorf("GetKey(99) = (%v, %v), want (0, false)", k, ok)
	}
}

func TestInt16Int64HashBiMap_Generated_PutOverwriteKey(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	...
	if k, ok := m.GetKey(2); !ok || k != 1 {
		t.Errorf("GetKey(2) = (%v, %v), want (1, true)", k, ok)
	}
}

func TestInt16Int64HashBiMap_Generated_PutOverwriteValue(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	...
	if v, ok := m.Get(3); !ok || v != 1 {
		t.Errorf("Get(3) = (%v, %v), want (1, true)", v, ok)
	}
...
func TestInt16Int64HashBiMap_Generated_Remove(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Int64HashBiMap_Generated_RemoveValue(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Int64HashBiMap_Generated_ContainsKey(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestInt16Int64HashBiMap_Generated_ContainsValue(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	if !m.ContainsValue(1) {
...
func TestInt16Int64HashBiMap_Generated_IsEmpty(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	if !m.IsEmpty() {
...
func TestInt16Int64HashBiMap_Generated_Clear(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestInt16Int64HashBiMap_Generated_ForEach(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Int64HashBiMap_Generated_Keys(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Int64HashBiMap_Generated_Values(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Int64HashBiMap_Generated_Inverse(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt16Int64HashBiMap_Generated_Equals(t *testing.T) {
	m1 := NewInt16Int64HashBiMap()
	m1.Put(1, 1)
	m1.Put(2, 2)

	m2 := NewInt16Int64HashBiMap()
	m2.Put(2, 2)
	m2.Put(1, 1)
...
func TestInt16Int64HashBiMap_Generated_String(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	if m.String() != "{}" {
...
func TestInt16Int64HashBiMap_Generated_BijectiveInvariant(t *testing.T) {
	m := NewInt16Int64HashBiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
