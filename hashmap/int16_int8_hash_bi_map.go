...
// Int16Int8BiMap is a bidirectional map with int16 keys and int8 values.
// Both key-to-value and value-to-key lookups are O(1).
type Int16Int8BiMap struct {
	forward *Int16Int8
	reverse *Int8Int16
}

// NewInt16Int8BiMap creates a new empty Int16Int8BiMap with default capacity.
func NewInt16Int8BiMap() *Int16Int8BiMap {
	return &Int16Int8BiMap{
		forward: NewInt16Int8(),
		reverse: NewInt8Int16(),
	}
}

// NewInt16Int8BiMapWithCapacity creates a new empty Int16Int8BiMap with the given initial capacity.
func NewInt16Int8BiMapWithCapacity(capacity int) *Int16Int8BiMap {
	return &Int16Int8BiMap{
		forward: NewInt16Int8WithCapacity(capacity),
		reverse: NewInt8Int16WithCapacity(capacity),
	}
}

// Int16Int8BiMapBulkLoad builds a Int16Int8BiMap from keys/values in a
...
func Int16Int8BiMapBulkLoad(keys []int16, values []int8, policy pump.DuplicatePolicy) (*Int16Int8BiMap, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int16Int8BiMapBulkLoad: len(keys) != len(values)")
	}
	m := &Int16Int8BiMap{
		forward: NewInt16Int8WithCapacity(Int16Int8bulkCap(len(keys))),
		reverse: NewInt8Int16WithCapacity(Int8Int16bulkCap(len(values))),
	}
...
func (m *Int16Int8BiMap) Put(key int16, value int8) (int8, bool) {
...
func (m *Int16Int8BiMap) RemoveValue(value int8) (int16, bool) {
...
func (m *Int16Int8BiMap) ContainsKey(key int16) bool {
	return m.forward.ContainsKey(key)
}

// ContainsValue returns true if the map contains the given value.
func (m *Int16Int8BiMap) ContainsValue(value int8) bool {
	return m.reverse.ContainsKey(value)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int16Int8BiMap) Len() int {
	return m.forward.Len()
}

// Clear removes all entries from both directions.
func (m *Int16Int8BiMap) Clear() {
	m.forward.Clear()
	m.reverse.Clear()
}

// ForEach calls the given function for each key-value pair.
func (m *Int16Int8BiMap) ForEach(f func(int16, int8)) {
	m.forward.ForEach(f)
}
...
func (m *Int16Int8BiMap) All() iter.Seq2[int16, int8] {
	return m.forward.All()
}

// Keys returns an iter.Seq that yields all keys.
func (m *Int16Int8BiMap) Keys() iter.Seq[int16] {
	return m.forward.Keys()
}

// Values returns an iter.Seq that yields all values.
func (m *Int16Int8BiMap) Values() iter.Seq[int8] {
	return m.forward.Values()
}

// Inverse returns a new Int8Int16BiMap with keys and values swapped.
func (m *Int16Int8BiMap) Inverse() *Int8Int16BiMap {
	result := NewInt8Int16BiMap()
...
func (m *Int16Int8BiMap) String() string {
	if m.forward.Len() == 0 {
		return "{}"
	}
...
func (m *Int16Int8BiMap) Equals(other *Int16Int8BiMap) bool {
