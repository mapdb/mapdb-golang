...
const (
	int16Int8DefaultCapacity = 16
	// Load factor 3/4 = 0.75, using integer math to avoid float conversion per insert.
)

// int16Int8Entry holds a single slot in the hash map for cache locality.
...
// Int16Int8 is an open-addressing hash map with int16 keys and int8 values.
...
func NewInt16Int8() *Int16Int8 {
	return NewInt16Int8WithCapacity(int16Int8DefaultCapacity)
}

// NewInt16Int8WithCapacity creates a new empty Int16Int8 with the given initial capacity.
func NewInt16Int8WithCapacity(capacity int) *Int16Int8 {
	cap := nextPowerOfTwoInt16Int8(capacity)
	return &Int16Int8{
...
// Int16Int8Of creates a new Int16Int8 from key-value pairs.
func Int16Int8Of(pairs ...struct {
	Key   int16
	Value int8
}) *Int16Int8 {
	m := NewInt16Int8WithCapacity(len(pairs) * 2)
	for _, p := range pairs {
		m.Put(p.Key, p.Value)
	}
	return m
...
// Int16Int8BulkLoad builds a Int16Int8 from keys/values in a single pass,
...
// has more distinct keys than expected — use Int16Int8BulkLoadExact for the
// zero-rehash guarantee.
func Int16Int8BulkLoad(keys []int16, values []int8, policy pump.DuplicatePolicy) (*Int16Int8, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int16Int8BulkLoad: len(keys) != len(values)")
	}
	m := &Int16Int8{entries: make([]int16Int8Entry, Int16Int8bulkCap(len(keys)))}
...
// Int16Int8BulkLoadExact is like Int16Int8BulkLoad but guarantees zero
...
func Int16Int8BulkLoadExact(keys []int16, values []int8, n int, policy pump.DuplicatePolicy) (*Int16Int8, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int16Int8BulkLoadExact: len(keys) != len(values)")
	}
	if n < 0 {
		panic("mapdb: Int16Int8BulkLoadExact: negative n")
	}
	m := &Int16Int8{entries: make([]int16Int8Entry, Int16Int8bulkCap(n))}
	if len(keys) > n {
...
func (m *Int16Int8) bulkInsert(keys []int16, values []int8, policy pump.DuplicatePolicy) error {
	for i := range keys {
		if m.needsResize() {
			m.resize()
		}
...
// Int16Int8bulkCap returns the presized table capacity for n entries that
...
func Int16Int8bulkCap(n int) int {
	c := pump.HashCapacityFor(n)
	if c < int16Int8DefaultCapacity {
		return int16Int8DefaultCapacity
	}
	return c
}
...
func (m *Int16Int8) ContainsValue(value int8) bool {
...
func (m *Int16Int8) ForEachKey(f func(int16)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].key)
		}
...
func (m *Int16Int8) ForEachValue(f func(int8)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].value)
		}
...
func (m *Int16Int8) Equals(other *Int16Int8) bool {
...
func (m *Int16Int8) KeysToSlice() []int16 {
...
func (m *Int16Int8) ValuesToSlice() []int8 {
...
func (m *Int16Int8) ToImmutable() *ImmutableInt16Int8 {
	return ImmutableInt16Int8From(m)
}

// InjectInto performs a left fold over all key-value pairs.
func (m *Int16Int8) InjectInto(initial int8, f func(int8, int16, int8) int8) int8 {
	result := initial
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int16Int8) AddToValue(key int16, amount int8) int8 {
	if v, ok := m.Get(key); ok {
		newVal := v + amount
		m.Put(key, newVal)
		return newVal
...
// Returns the new value.
func (m *Int16Int8) UpdateValue(key int16, initialValue int8, f func(int8) int8) int8 {
	if v, ok := m.Get(key); ok {
		newVal := f(v)
		m.Put(key, newVal)
		return newVal
...
func (m *Int16Int8) PutReturning(key int16, value int8) *Int16Int8 {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning returns the map after removing the key (fluent API).
func (m *Int16Int8) RemoveKeyReturning(key int16) *Int16Int8 {
	m.Remove(key)
	return m
}

// WithoutAllKeys removes all given keys (fluent API).
func (m *Int16Int8) WithoutAllKeys(keys []int16) *Int16Int8 {
	for _, k := range keys {
		m.Remove(k)
	}
	return m
...
func (m *Int16Int8) SumOfValues() int8 {
	var sum int8
	for i := range m.entries {
		if m.entries[i].occupied {
...
// SynchronizedInt16Int8 wrapper's Lock / RLock, or your own mutex) is required
...
func (m *Int16Int8) rehashFrom(deleted int, mask int) {
	c := len(m.entries)
	idx := (deleted + 1) & mask
...
func nextPowerOfTwoInt16Int8(n int) int {
	if n <= 0 {
		return 16
	}
	n--
