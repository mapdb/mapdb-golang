...
func Int32CharBiMapBulkLoad(keys []int32, values []uint16, policy pump.DuplicatePolicy) (*Int32CharBiMap, error) {
	...
	m := &Int32CharBiMap{
		forward: NewInt32CharWithCapacity(Int32CharbulkCap(len(keys))),
		reverse: NewCharInt32WithCapacity(CharInt32bulkCap(len(values))),
	}
...
func (m *Int32CharBiMap) All() iter.Seq2[int32, uint16] {
