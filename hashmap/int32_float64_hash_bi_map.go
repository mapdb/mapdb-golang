...
// Int32Float64BiMap is a bidirectional map with int32 keys and float64 values.
// Both key-to-value and value-to-key lookups are O(1).
type Int32Float64BiMap struct {
	forward *Int32Float64
	reverse *Float64Int32
}

// NewInt32Float64BiMap creates a new empty Int32Float64BiMap with default capacity.
func NewInt32Float64BiMap() *Int32Float64BiMap {
	return &Int32Float64BiMap{
		forward: NewInt32Float64(),
		reverse: NewFloat64Int32(),
	}
}

// NewInt32Float64BiMapWithCapacity creates a new empty Int32Float64BiMap with the given initial capacity.
func NewInt32Float64BiMapWithCapacity(capacity int) *Int32Float64BiMap {
	return &Int32Float64BiMap{
		forward: NewInt32Float64WithCapacity(capacity),
		reverse: NewFloat64Int32WithCapacity(capacity),
	}
}

// Int32Float64BiMapBulkLoad builds a Int32Float64BiMap from keys/values in a
...
func Int32Float64BiMapBulkLoad(keys []int32, values []float64, policy pump.DuplicatePolicy) (*Int32Float64BiMap, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int32Float64BiMapBulkLoad: len(keys) != len(values)")
	}
	m := &Int32Float64BiMap{
		forward: NewInt32Float64WithCapacity(Int32Float64bulkCap(len(keys))),
		reverse: NewFloat64Int32WithCapacity(Float64Int32bulkCap(len(values))),
	}
...
func (m *Int32Float64BiMap) Put(key int32, value float64) (float64, bool) {
...
func (m *Int32Float64BiMap) RemoveValue(value float64) (int32, bool) {
...
func (m *Int32Float64BiMap) ContainsKey(key int32) bool {
	return m.forward.ContainsKey(key)
}

// ContainsValue returns true if the map contains the given value.
func (m *Int32Float64BiMap) ContainsValue(value float64) bool {
	return m.reverse.ContainsKey(value)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int32Float64BiMap) Len() int {
	return m.forward.Len()
}

// Clear removes all entries from both directions.
func (m *Int32Float64BiMap) Clear() {
	m.forward.Clear()
	m.reverse.Clear()
}

// ForEach calls the given function for each key-value pair.
func (m *Int32Float64BiMap) ForEach(f func(int32, float64)) {
	m.forward.ForEach(f)
}
...
func (m *Int32Float64BiMap) All() iter.Seq2[int32, float64] {
	return m.forward.All()
}

// Keys returns an iter.Seq that yields all keys.
func (m *Int32Float64BiMap) Keys() iter.Seq[int32] {
	return m.forward.Keys()
}

// Values returns an iter.Seq that yields all values.
func (m *Int32Float64BiMap) Values() iter.Seq[float64] {
	return m.forward.Values()
}

// Inverse returns a new Float64Int32BiMap with keys and values swapped.
func (m *Int32Float64BiMap) Inverse() *Float64Int32BiMap {
	result := NewFloat64Int32BiMap()
...
func (m *Int32Float64BiMap) String() string {
	if m.forward.Len() == 0 {
		return "{}"
	}
...
func (m *Int32Float64BiMap) Equals(other *Int32Float64BiMap) bool {
