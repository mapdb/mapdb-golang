...
const (
	int32Float64HashMapDefaultCapacity = 16
	// Load factor 3/4 = 0.75, using integer math to avoid float conversion per insert.
)

// int32Float64HashMapEntry holds a single slot in the hash map for cache locality.
type int32Float64HashMapEntry struct {
	key      int32
	value    float64
	occupied bool
}

// Int32Float64HashMap is an open-addressing hash map with int32 keys and float64 values.
type Int32Float64HashMap struct {
	entries []int32Float64HashMapEntry
	size    int
}

// NewInt32Float64HashMap creates a new empty Int32Float64HashMap with default capacity.
func NewInt32Float64HashMap() *Int32Float64HashMap {
	return NewInt32Float64HashMapWithCapacity(int32Float64HashMapDefaultCapacity)
}

// NewInt32Float64HashMapWithCapacity creates a new empty Int32Float64HashMap with the given initial capacity.
func NewInt32Float64HashMapWithCapacity(capacity int) *Int32Float64HashMap {
	cap := nextPowerOfTwoInt32Float64HashMap(capacity)
	return &Int32Float64HashMap{
		entries: make([]int32Float64HashMapEntry, cap),
		size:    0,
	}
}

// Int32Float64HashMapOf creates a new Int32Float64HashMap from key-value pairs.
func Int32Float64HashMapOf(pairs ...struct {
	Key   int32
	Value float64
}) *Int32Float64HashMap {
...
func (m *Int32Float64HashMap) Put(key int32, value float64) (float64, bool) {
	if m.needsResize() {
		m.resize()
	}
	cap := len(m.entries)
...
func (m *Int32Float64HashMap) Get(key int32) (float64, bool) {
	cap := len(m.entries)
	if cap == 0 {
		return 0.0, false
	}
...
func (m *Int32Float64HashMap) GetOrDefault(key int32, defaultValue float64) float64 {
...
func (m *Int32Float64HashMap) Remove(key int32) (float64, bool) {
	cap := len(m.entries)
	if cap == 0 {
		return 0.0, false
	}
...
func (m *Int32Float64HashMap) ContainsKey(key int32) bool {
	_, ok := m.Get(key)
	return ok
}

// ContainsValue returns true if the map contains the given value.
func (m *Int32Float64HashMap) ContainsValue(value float64) bool {
...
func (m *Int32Float64HashMap) Size() int {
	return m.size
}

// IsEmpty returns true if the map contains no entries.
func (m *Int32Float64HashMap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the map.
func (m *Int32Float64HashMap) Clear() {
	for i := range m.entries {
		m.entries[i] = int32Float64HashMapEntry{}
	}
	m.size = 0
}

// All returns an iter.Seq2 that yields all key-value pairs.
func (m *Int32Float64HashMap) All() iter.Seq2[int32, float64] {
...
func (m *Int32Float64HashMap) Keys() iter.Seq[int32] {
...
func (m *Int32Float64HashMap) Values() iter.Seq[float64] {
...
func (m *Int32Float64HashMap) ForEach(f func(int32, float64)) {
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int32Float64HashMap) ForEachKey(f func(int32)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].key)
		}
...
func (m *Int32Float64HashMap) ForEachValue(f func(float64)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].value)
		}
...
func (m *Int32Float64HashMap) Select(predicate func(int32, float64) bool) *Int32Float64HashMap {
	result := NewInt32Float64HashMap()
	for i := range m.entries {
...
func (m *Int32Float64HashMap) Reject(predicate func(int32, float64) bool) *Int32Float64HashMap {
	result := NewInt32Float64HashMap()
	for i := range m.entries {
		if m.entries[i].occupied && !predicate(m.entries[i].key, m.entries[i].value) {
			result.Put(m.entries[i].key, m.entries[i].value)
...
func (m *Int32Float64HashMap) Detect(predicate func(int32, float64) bool) (int32, float64, bool) {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
...
func (m *Int32Float64HashMap) AnySatisfy(predicate func(int32, float64) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			return true
		}
...
func (m *Int32Float64HashMap) AllSatisfy(predicate func(int32, float64) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && !predicate(m.entries[i].key, m.entries[i].value) {
			return false
		}
...
func (m *Int32Float64HashMap) NoneSatisfy(predicate func(int32, float64) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			return false
		}
...
func (m *Int32Float64HashMap) Count(predicate func(int32, float64) bool) int {
	count := 0
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			count++
...
func (m *Int32Float64HashMap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32Float64HashMap) Equals(other *Int32Float64HashMap) bool {
...
func (m *Int32Float64HashMap) KeysToSlice() []int32 {
...
func (m *Int32Float64HashMap) ValuesToSlice() []float64 {
...
func (m *Int32Float64HashMap) ToImmutable() *ImmutableInt32Float64HashMap {
	return ImmutableInt32Float64HashMapFrom(m)
}

// InjectInto performs a left fold over all key-value pairs.
func (m *Int32Float64HashMap) InjectInto(initial float64, f func(float64, int32, float64) float64) float64 {
	result := initial
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int32Float64HashMap) AddToValue(key int32, amount float64) float64 {
	if v, ok := m.Get(key); ok {
		newVal := v + amount
		m.Put(key, newVal)
		return newVal
...
// Returns the new value.
func (m *Int32Float64HashMap) UpdateValue(key int32, initialValue float64, f func(float64) float64) float64 {
	if v, ok := m.Get(key); ok {
		newVal := f(v)
		m.Put(key, newVal)
		return newVal
...
func (m *Int32Float64HashMap) WithKeyValue(key int32, value float64) *Int32Float64HashMap {
	m.Put(key, value)
	return m
}

// WithoutKey returns the map after removing the key (fluent API).
func (m *Int32Float64HashMap) WithoutKey(key int32) *Int32Float64HashMap {
	m.Remove(key)
	return m
}

// WithoutAllKeys removes all given keys (fluent API).
func (m *Int32Float64HashMap) WithoutAllKeys(keys []int32) *Int32Float64HashMap {
	for _, k := range keys {
		m.Remove(k)
	}
	return m
...
func (m *Int32Float64HashMap) SumOfValues() float64 {
	var sum float64
	for i := range m.entries {
		if m.entries[i].occupied {
...
// SynchronizedInt32Float64HashMap wrapper's Lock / RLock, or your own mutex) is required
...
func (m *Int32Float64HashMap) resize() {
	oldEntries := m.entries
	newCap := len(oldEntries) * 2
	if newCap == 0 {
		newCap = int32Float64HashMapDefaultCapacity
	}
	m.entries = make([]int32Float64HashMapEntry, newCap)
	m.size = 0
...
func (m *Int32Float64HashMap) rehashFrom(deleted int, mask int) {
	c := len(m.entries)
	idx := (deleted + 1) & mask
	for m.entries[idx].occupied {
		...
		if distCurrent > distGap {
			...
			m.entries[idx] = int32Float64HashMapEntry{}
			deleted = idx
		}
		idx = (idx + 1) & mask
		if idx == deleted {
...
func nextPowerOfTwoInt32Float64HashMap(n int) int {
	if n <= 0 {
		return 16
	}
	n--
