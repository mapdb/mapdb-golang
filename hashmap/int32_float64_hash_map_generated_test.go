...
func TestInt32Float64HashMap_Generated_PutGet(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestInt32Float64HashMap_Generated_PutOverwrite(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
...
func TestInt32Float64HashMap_Generated_Remove(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt32Float64HashMap_Generated_ContainsKey(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	if !m.ContainsKey(1) {
...
func TestInt32Float64HashMap_Generated_ContainsValue(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
...
func TestInt32Float64HashMap_Generated_GetOrDefault(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
...
func TestInt32Float64HashMap_Generated_IsEmpty(t *testing.T) {
	m := NewInt32Float64HashMap()
	if !m.IsEmpty() {
...
func TestInt32Float64HashMap_Generated_Clear(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Clear()
...
func TestInt32Float64HashMap_Generated_All(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt32Float64HashMap_Generated_Keys(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt32Float64HashMap_Generated_Values(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt32Float64HashMap_Generated_Select(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)

	selected := m.Select(func(k int32, v float64) bool { return v > 1.0 })
	if selected.Size() != 2 {
		t.Errorf("Select size = %d, want 2", selected.Size())
	}
}

func TestInt32Float64HashMap_Generated_Reject(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)

	rejected := m.Reject(func(k int32, v float64) bool { return v > 1.0 })
	if rejected.Size() != 1 {
		t.Errorf("Reject size = %d, want 1", rejected.Size())
	}
}

func TestInt32Float64HashMap_Generated_Detect(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)

	_, val, found := m.Detect(func(k int32, v float64) bool { return k == 2 })
	if !found || val != 2.0 {
		t.Errorf("Detect = (%v, %v), want (2.0, true)", val, found)
	}
}

func TestInt32Float64HashMap_Generated_AnySatisfy(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)

	if !m.AnySatisfy(func(k int32, v float64) bool { return v == 2.0 }) {
		t.Error("AnySatisfy should be true")
	}
	if m.AnySatisfy(func(k int32, v float64) bool { return v == 99.0 }) {
		t.Error("AnySatisfy should be false")
	}
}

func TestInt32Float64HashMap_Generated_AllSatisfy(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)

	if !m.AllSatisfy(func(k int32, v float64) bool { return v > 0.0 }) {
		t.Error("AllSatisfy should be true for > 0")
	}
	if m.AllSatisfy(func(k int32, v float64) bool { return v > 1.0 }) {
		t.Error("AllSatisfy should be false")
	}
}

func TestInt32Float64HashMap_Generated_NoneSatisfy(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)

	if !m.NoneSatisfy(func(k int32, v float64) bool { return v == 99.0 }) {
		t.Error("NoneSatisfy should be true")
	}
}

func TestInt32Float64HashMap_Generated_Count(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)

	if c := m.Count(func(k int32, v float64) bool { return v > 1.0 }); c != 2 {
		t.Errorf("Count = %d, want 2", c)
	}
}

func TestInt32Float64HashMap_Generated_Entry(t *testing.T) {
	m := NewInt32Float64HashMap()
...
// TestInt32Float64HashMap_Generated_AndModify_ResizeDetection forces a resize from
...
func TestInt32Float64HashMap_Generated_AndModify_ResizeDetection(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	defer func() {
		if r := recover(); r == nil {
...
func TestInt32Float64HashMap_Generated_WithKeyValue(t *testing.T) {
	m := NewInt32Float64HashMap()
...
func TestInt32Float64HashMap_Generated_WithoutKey(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m2 := m.WithoutKey(1)
...
func TestInt32Float64HashMap_Generated_Equals(t *testing.T) {
	m1 := NewInt32Float64HashMap()
	m1.Put(1, 1.0)
	m1.Put(2, 2.0)

	m2 := NewInt32Float64HashMap()
	m2.Put(2, 2.0)
	m2.Put(1, 1.0)
...
func TestInt32Float64HashMap_Generated_String(t *testing.T) {
	m := NewInt32Float64HashMap()
	m.Put(1, 1.0)
	if m.String() == "" {
...
func TestInt32Float64HashMap_Generated_Resize(t *testing.T) {
	m := NewInt32Float64HashMap()
...
func TestInt32Float64HashMap_NaNValue_ContainsValue(t *testing.T) {
	m := NewInt32Float64HashMap()
...
func TestInt32Float64HashMap_NaNValue_GetReturnsNaN(t *testing.T) {
	m := NewInt32Float64HashMap()
	nan := float64(math.NaN())
	m.Put(1, nan)
	v, ok := m.Get(1)
