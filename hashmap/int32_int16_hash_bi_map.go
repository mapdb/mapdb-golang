...
// Int32Int16BiMap is a bidirectional map with int32 keys and int16 values.
// Both key-to-value and value-to-key lookups are O(1).
type Int32Int16BiMap struct {
	forward *Int32Int16
	reverse *Int16Int32
}

// NewInt32Int16BiMap creates a new empty Int32Int16BiMap with default capacity.
func NewInt32Int16BiMap() *Int32Int16BiMap {
	return &Int32Int16BiMap{
		forward: NewInt32Int16(),
		reverse: NewInt16Int32(),
	}
}

// NewInt32Int16BiMapWithCapacity creates a new empty Int32Int16BiMap with the given initial capacity.
func NewInt32Int16BiMapWithCapacity(capacity int) *Int32Int16BiMap {
	return &Int32Int16BiMap{
		forward: NewInt32Int16WithCapacity(capacity),
		reverse: NewInt16Int32WithCapacity(capacity),
	}
}

// Int32Int16BiMapBulkLoad builds a Int32Int16BiMap from keys/values in a
...
func Int32Int16BiMapBulkLoad(keys []int32, values []int16, policy pump.DuplicatePolicy) (*Int32Int16BiMap, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int32Int16BiMapBulkLoad: len(keys) != len(values)")
	}
	m := &Int32Int16BiMap{
		forward: NewInt32Int16WithCapacity(Int32Int16bulkCap(len(keys))),
		reverse: NewInt16Int32WithCapacity(Int16Int32bulkCap(len(values))),
	}
...
func (m *Int32Int16BiMap) Put(key int32, value int16) (int16, bool) {
...
func (m *Int32Int16BiMap) RemoveValue(value int16) (int32, bool) {
...
func (m *Int32Int16BiMap) ContainsKey(key int32) bool {
	return m.forward.ContainsKey(key)
}

// ContainsValue returns true if the map contains the given value.
func (m *Int32Int16BiMap) ContainsValue(value int16) bool {
	return m.reverse.ContainsKey(value)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int32Int16BiMap) Len() int {
	return m.forward.Len()
}

// Clear removes all entries from both directions.
func (m *Int32Int16BiMap) Clear() {
	m.forward.Clear()
	m.reverse.Clear()
}

// ForEach calls the given function for each key-value pair.
func (m *Int32Int16BiMap) ForEach(f func(int32, int16)) {
	m.forward.ForEach(f)
}
...
func (m *Int32Int16BiMap) All() iter.Seq2[int32, int16] {
	return m.forward.All()
}

// Keys returns an iter.Seq that yields all keys.
func (m *Int32Int16BiMap) Keys() iter.Seq[int32] {
	return m.forward.Keys()
}

// Values returns an iter.Seq that yields all values.
func (m *Int32Int16BiMap) Values() iter.Seq[int16] {
	return m.forward.Values()
}

// Inverse returns a new Int16Int32BiMap with keys and values swapped.
func (m *Int32Int16BiMap) Inverse() *Int16Int32BiMap {
	result := NewInt16Int32BiMap()
...
func (m *Int32Int16BiMap) String() string {
	if m.forward.Len() == 0 {
		return "{}"
	}
...
func (m *Int32Int16BiMap) Equals(other *Int32Int16BiMap) bool {
