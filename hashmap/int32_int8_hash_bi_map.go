...
// Int32Int8BiMapBulkLoad builds a Int32Int8BiMap from keys/values in a
...
func Int32Int8BiMapBulkLoad(keys []int32, values []int8, policy pump.DuplicatePolicy) (*Int32Int8BiMap, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int32Int8BiMapBulkLoad: len(keys) != len(values)")
	}
	m := &Int32Int8BiMap{
		forward: NewInt32Int8WithCapacity(Int32Int8bulkCap(len(keys))),
		reverse: NewInt8Int32WithCapacity(Int8Int32bulkCap(len(values))),
	}
...
func (m *Int32Int8BiMap) All() iter.Seq2[int32, int8] {
