...
const (
	int32Int8DefaultCapacity = 16
	// Load factor 3/4 = 0.75, using integer math to avoid float conversion per insert.
)

// int32Int8Entry holds a single slot in the hash map for cache locality.
...
// Int32Int8 is an open-addressing hash map with int32 keys and int8 values.
type Int32Int8 struct {
	entries []int32Int8Entry
	size    int
}

// NewInt32Int8 creates a new empty Int32Int8 with default capacity.
func NewInt32Int8() *Int32Int8 {
	return NewInt32Int8WithCapacity(int32Int8DefaultCapacity)
}

// NewInt32Int8WithCapacity creates a new empty Int32Int8 with the given initial capacity.
func NewInt32Int8WithCapacity(capacity int) *Int32Int8 {
	cap := nextPowerOfTwoInt32Int8(capacity)
	return &Int32Int8{
		entries: make([]int32Int8Entry, cap),
		size:    0,
	}
}

// Int32Int8Of creates a new Int32Int8 from key-value pairs.
func Int32Int8Of(pairs ...struct {
	Key   int32
	Value int8
}) *Int32Int8 {
...
// Int32Int8BulkLoad builds a Int32Int8 from keys/values in a single pass,
...
// has more distinct keys than expected — use Int32Int8BulkLoadExact for the
// zero-rehash guarantee.
func Int32Int8BulkLoad(keys []int32, values []int8, policy pump.DuplicatePolicy) (*Int32Int8, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int32Int8BulkLoad: len(keys) != len(values)")
	}
	m := &Int32Int8{entries: make([]int32Int8Entry, Int32Int8bulkCap(len(keys)))}
...
// Int32Int8BulkLoadExact is like Int32Int8BulkLoad but guarantees zero
...
func Int32Int8BulkLoadExact(keys []int32, values []int8, n int, policy pump.DuplicatePolicy) (*Int32Int8, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int32Int8BulkLoadExact: len(keys) != len(values)")
	}
	if n < 0 {
		panic("mapdb: Int32Int8BulkLoadExact: negative n")
	}
	m := &Int32Int8{entries: make([]int32Int8Entry, Int32Int8bulkCap(n))}
	for i := range keys {
		if m.size >= n {
...
func (m *Int32Int8) bulkInsert(keys []int32, values []int8, policy pump.DuplicatePolicy) error {
	for i := range keys {
		if m.needsResize() {
			m.resize()
		}
...
func (m *Int32Int8) bulkPut(key int32, value int8, policy pump.DuplicatePolicy) (bool, error) {
...
// Int32Int8bulkCap returns the presized table capacity for n entries that
...
func Int32Int8bulkCap(n int) int {
	c := pump.HashCapacityFor(n)
	if c < int32Int8DefaultCapacity {
		return int32Int8DefaultCapacity
	}
	return c
}
...
func (m *Int32Int8) ContainsValue(value int8) bool {
...
func (m *Int32Int8) ForEachKey(f func(int32)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].key)
		}
...
func (m *Int32Int8) ForEachValue(f func(int8)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].value)
		}
...
func (m *Int32Int8) Equals(other *Int32Int8) bool {
...
func (m *Int32Int8) KeysToSlice() []int32 {
...
func (m *Int32Int8) ValuesToSlice() []int8 {
...
func (m *Int32Int8) ToImmutable() *ImmutableInt32Int8 {
	return ImmutableInt32Int8From(m)
}

// InjectInto performs a left fold over all key-value pairs.
func (m *Int32Int8) InjectInto(initial int8, f func(int8, int32, int8) int8) int8 {
	result := initial
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int32Int8) AddToValue(key int32, amount int8) int8 {
	if v, ok := m.Get(key); ok {
		newVal := v + amount
		m.Put(key, newVal)
		return newVal
...
// Returns the new value.
func (m *Int32Int8) UpdateValue(key int32, initialValue int8, f func(int8) int8) int8 {
	if v, ok := m.Get(key); ok {
		newVal := f(v)
		m.Put(key, newVal)
		return newVal
...
func (m *Int32Int8) PutReturning(key int32, value int8) *Int32Int8 {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning returns the map after removing the key (fluent API).
func (m *Int32Int8) RemoveKeyReturning(key int32) *Int32Int8 {
	m.Remove(key)
	return m
}

// WithoutAllKeys removes all given keys (fluent API).
func (m *Int32Int8) WithoutAllKeys(keys []int32) *Int32Int8 {
	for _, k := range keys {
		m.Remove(k)
	}
	return m
...
func (m *Int32Int8) SumOfValues() int8 {
	var sum int8
	for i := range m.entries {
		if m.entries[i].occupied {
...
// SynchronizedInt32Int8 wrapper's Lock / RLock, or your own mutex) is required
...
func (m *Int32Int8) hashKey(key int32) uint64 {
	h := uint64(uint32(key)) * 0x9E3779B97F4A7C15
	return h ^ (h >> 32)
}

func (m *Int32Int8) needsResize() bool {
	return (m.size+1)*4 >= len(m.entries)*3 // 0.75 load factor, integer math
}

func (m *Int32Int8) resize() {
	oldEntries := m.entries
	newCap := len(oldEntries) * 2
	if newCap == 0 {
		newCap = int32Int8DefaultCapacity
	}
	m.entries = make([]int32Int8Entry, newCap)
	m.size = 0
...
func (m *Int32Int8) rehashFrom(deleted int, mask int) {
	c := len(m.entries)
	idx := (deleted + 1) & mask
...
func nextPowerOfTwoInt32Int8(n int) int {
	if n <= 0 {
		return 16
	}
	n--
