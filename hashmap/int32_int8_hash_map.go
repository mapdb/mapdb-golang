...
const (
	int32Int8HashMapDefaultCapacity = 16
	// Load factor 3/4 = 0.75, using integer math to avoid float conversion per insert.
)

// int32Int8HashMapEntry holds a single slot in the hash map for cache locality.
type int32Int8HashMapEntry struct {
	key      int32
	value    int8
	occupied bool
}

// Int32Int8HashMap is an open-addressing hash map with int32 keys and int8 values.
type Int32Int8HashMap struct {
	entries []int32Int8HashMapEntry
	size    int
}

// NewInt32Int8HashMap creates a new empty Int32Int8HashMap with default capacity.
func NewInt32Int8HashMap() *Int32Int8HashMap {
	return NewInt32Int8HashMapWithCapacity(int32Int8HashMapDefaultCapacity)
}

// NewInt32Int8HashMapWithCapacity creates a new empty Int32Int8HashMap with the given initial capacity.
func NewInt32Int8HashMapWithCapacity(capacity int) *Int32Int8HashMap {
	cap := nextPowerOfTwoInt32Int8HashMap(capacity)
	return &Int32Int8HashMap{
		entries: make([]int32Int8HashMapEntry, cap),
		size:    0,
	}
}

// Int32Int8HashMapOf creates a new Int32Int8HashMap from key-value pairs.
func Int32Int8HashMapOf(pairs ...struct {
	Key   int32
	Value int8
}) *Int32Int8HashMap {
...
func (m *Int32Int8HashMap) Put(key int32, value int8) (int8, bool) {
	if m.needsResize() {
		m.resize()
	}
	cap := len(m.entries)
...
func (m *Int32Int8HashMap) Get(key int32) (int8, bool) {
	cap := len(m.entries)
	if cap == 0 {
		return 0, false
	}
...
func (m *Int32Int8HashMap) GetOrDefault(key int32, defaultValue int8) int8 {
...
func (m *Int32Int8HashMap) Remove(key int32) (int8, bool) {
	cap := len(m.entries)
	if cap == 0 {
		return 0, false
	}
...
func (m *Int32Int8HashMap) ContainsKey(key int32) bool {
	_, ok := m.Get(key)
	return ok
}

// ContainsValue returns true if the map contains the given value.
func (m *Int32Int8HashMap) ContainsValue(value int8) bool {
...
func (m *Int32Int8HashMap) Size() int {
	return m.size
}

// IsEmpty returns true if the map contains no entries.
func (m *Int32Int8HashMap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the map.
func (m *Int32Int8HashMap) Clear() {
	for i := range m.entries {
		m.entries[i] = int32Int8HashMapEntry{}
	}
	m.size = 0
}

// All returns an iter.Seq2 that yields all key-value pairs.
func (m *Int32Int8HashMap) All() iter.Seq2[int32, int8] {
...
func (m *Int32Int8HashMap) Keys() iter.Seq[int32] {
...
func (m *Int32Int8HashMap) Values() iter.Seq[int8] {
...
func (m *Int32Int8HashMap) ForEach(f func(int32, int8)) {
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int32Int8HashMap) ForEachKey(f func(int32)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].key)
		}
...
func (m *Int32Int8HashMap) ForEachValue(f func(int8)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].value)
		}
...
func (m *Int32Int8HashMap) Select(predicate func(int32, int8) bool) *Int32Int8HashMap {
	result := NewInt32Int8HashMap()
	for i := range m.entries {
...
func (m *Int32Int8HashMap) Reject(predicate func(int32, int8) bool) *Int32Int8HashMap {
	result := NewInt32Int8HashMap()
	for i := range m.entries {
		if m.entries[i].occupied && !predicate(m.entries[i].key, m.entries[i].value) {
			result.Put(m.entries[i].key, m.entries[i].value)
...
func (m *Int32Int8HashMap) Detect(predicate func(int32, int8) bool) (int32, int8, bool) {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
...
func (m *Int32Int8HashMap) AnySatisfy(predicate func(int32, int8) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			return true
		}
...
func (m *Int32Int8HashMap) AllSatisfy(predicate func(int32, int8) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && !predicate(m.entries[i].key, m.entries[i].value) {
			return false
		}
...
func (m *Int32Int8HashMap) NoneSatisfy(predicate func(int32, int8) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			return false
		}
...
func (m *Int32Int8HashMap) Count(predicate func(int32, int8) bool) int {
	count := 0
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			count++
...
func (m *Int32Int8HashMap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32Int8HashMap) Equals(other *Int32Int8HashMap) bool {
...
func (m *Int32Int8HashMap) KeysToSlice() []int32 {
...
func (m *Int32Int8HashMap) ValuesToSlice() []int8 {
...
func (m *Int32Int8HashMap) ToImmutable() *ImmutableInt32Int8HashMap {
	return ImmutableInt32Int8HashMapFrom(m)
}

// InjectInto performs a left fold over all key-value pairs.
func (m *Int32Int8HashMap) InjectInto(initial int8, f func(int8, int32, int8) int8) int8 {
	result := initial
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int32Int8HashMap) AddToValue(key int32, amount int8) int8 {
	if v, ok := m.Get(key); ok {
		newVal := v + amount
		m.Put(key, newVal)
		return newVal
...
// Returns the new value.
func (m *Int32Int8HashMap) UpdateValue(key int32, initialValue int8, f func(int8) int8) int8 {
	if v, ok := m.Get(key); ok {
		newVal := f(v)
		m.Put(key, newVal)
		return newVal
...
func (m *Int32Int8HashMap) WithKeyValue(key int32, value int8) *Int32Int8HashMap {
	m.Put(key, value)
	return m
}

// WithoutKey returns the map after removing the key (fluent API).
func (m *Int32Int8HashMap) WithoutKey(key int32) *Int32Int8HashMap {
	m.Remove(key)
	return m
}

// WithoutAllKeys removes all given keys (fluent API).
func (m *Int32Int8HashMap) WithoutAllKeys(keys []int32) *Int32Int8HashMap {
	for _, k := range keys {
		m.Remove(k)
	}
	return m
...
func (m *Int32Int8HashMap) SumOfValues() int8 {
	var sum int8
	for i := range m.entries {
		if m.entries[i].occupied {
...
// SynchronizedInt32Int8HashMap wrapper's Lock / RLock, or your own mutex) is required
...
func (m *Int32Int8HashMap) Entry(key int32) Int32Int8Entry {
	return Int32Int8Entry{m: m, key: key}
}

// Int32Int8Entry provides in-place check-and-modify operations for a single
// key. Not thread-safe — see Int32Int8HashMap.Entry.
type Int32Int8Entry struct {
	m   *Int32Int8HashMap
	key int32
}

// OrInsert inserts the default value if the key is absent, and returns the current value.
func (e Int32Int8Entry) OrInsert(defaultValue int8) int8 {
...
func (e Int32Int8Entry) OrInsertWith(f func() int8) int8 {
	if v, ok := e.m.Get(e.key); ok {
		return v
	}
	val := f()
...
func (e Int32Int8Entry) AndModify(f func(*int8)) Int32Int8Entry {
	cap := len(e.m.entries)
	if cap == 0 {
		return e
	}
	...
	for {
		...
		if e.m.entries[idx].key == e.key {
			...
			if prevLen != len(e.m.entries) || prevPtr != &e.m.entries[0] {
				panic("Int32Int8Entry.AndModify: map was resized during callback — do not mutate the map from within AndModify")
			}
			return e
		}
		idx = (idx + 1) & mask
...
func (m *Int32Int8HashMap) hashKey(key int32) uint64 {
	return func() uint64 { h := uint64(uint32(key)) * 0x9E3779B97F4A7C15; return h ^ (h >> 32) }()
}

func (m *Int32Int8HashMap) needsResize() bool {
	return (m.size+1)*4 >= len(m.entries)*3 // 0.75 load factor, integer math
}

func (m *Int32Int8HashMap) resize() {
	oldEntries := m.entries
	newCap := len(oldEntries) * 2
	if newCap == 0 {
		newCap = int32Int8HashMapDefaultCapacity
	}
	m.entries = make([]int32Int8HashMapEntry, newCap)
	m.size = 0
...
func (m *Int32Int8HashMap) rehashFrom(deleted int, mask int) {
	c := len(m.entries)
	idx := (deleted + 1) & mask
	for m.entries[idx].occupied {
		...
		if distCurrent > distGap {
			...
			m.entries[idx] = int32Int8HashMapEntry{}
			deleted = idx
		}
		idx = (idx + 1) & mask
		if idx == deleted {
...
func nextPowerOfTwoInt32Int8HashMap(n int) int {
	if n <= 0 {
		return 16
	}
	n--
