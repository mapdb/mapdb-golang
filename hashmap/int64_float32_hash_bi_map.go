...
func Int64Float32BiMapBulkLoad(keys []int64, values []float32, policy pump.DuplicatePolicy) (*Int64Float32BiMap, error) {
	...
	m := &Int64Float32BiMap{
		forward: NewInt64Float32WithCapacity(Int64Float32bulkCap(len(keys))),
		reverse: NewFloat32Int64WithCapacity(Float32Int64bulkCap(len(values))),
	}
...
func (m *Int64Float32BiMap) All() iter.Seq2[int64, float32] {
