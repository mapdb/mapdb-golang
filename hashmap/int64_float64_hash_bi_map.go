...
func Int64Float64BiMapBulkLoad(keys []int64, values []float64, policy pump.DuplicatePolicy) (*Int64Float64BiMap, error) {
	...
	m := &Int64Float64BiMap{
		forward: NewInt64Float64WithCapacity(Int64Float64bulkCap(len(keys))),
		reverse: NewFloat64Int64WithCapacity(Float64Int64bulkCap(len(values))),
	}
...
func (m *Int64Float64BiMap) All() iter.Seq2[int64, float64] {
