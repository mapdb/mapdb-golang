...
func TestInt64Float64HashBiMap_Generated_PutGet(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestInt64Float64HashBiMap_Generated_GetKey(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt64Float64HashBiMap_Generated_PutOverwriteKey(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
...
func TestInt64Float64HashBiMap_Generated_PutOverwriteValue(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt64Float64HashBiMap_Generated_Remove(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt64Float64HashBiMap_Generated_RemoveValue(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt64Float64HashBiMap_Generated_ContainsKey(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	if !m.ContainsKey(1) {
...
func TestInt64Float64HashBiMap_Generated_ContainsValue(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	if !m.ContainsValue(1.0) {
...
func TestInt64Float64HashBiMap_Generated_IsEmpty(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	if !m.IsEmpty() {
...
func TestInt64Float64HashBiMap_Generated_Clear(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Clear()
...
func TestInt64Float64HashBiMap_Generated_ForEach(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt64Float64HashBiMap_Generated_Keys(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt64Float64HashBiMap_Generated_Values(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt64Float64HashBiMap_Generated_Inverse(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt64Float64HashBiMap_Generated_Equals(t *testing.T) {
	m1 := NewInt64Float64HashBiMap()
	m1.Put(1, 1.0)
	m1.Put(2, 2.0)

	m2 := NewInt64Float64HashBiMap()
	m2.Put(2, 2.0)
	m2.Put(1, 1.0)
...
func TestInt64Float64HashBiMap_Generated_String(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	if m.String() != "{}" {
...
func TestInt64Float64HashBiMap_Generated_BijectiveInvariant(t *testing.T) {
	m := NewInt64Float64HashBiMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
