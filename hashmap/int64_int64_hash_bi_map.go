...
// Int64Int64BiMap is a bidirectional map with int64 keys and int64 values.
// Both key-to-value and value-to-key lookups are O(1).
type Int64Int64BiMap struct {
	forward *Int64Int64
	reverse *Int64Int64
}

// NewInt64Int64BiMap creates a new empty Int64Int64BiMap with default capacity.
func NewInt64Int64BiMap() *Int64Int64BiMap {
	return &Int64Int64BiMap{
		forward: NewInt64Int64(),
		reverse: NewInt64Int64(),
	}
}

// NewInt64Int64BiMapWithCapacity creates a new empty Int64Int64BiMap with the given initial capacity.
func NewInt64Int64BiMapWithCapacity(capacity int) *Int64Int64BiMap {
	return &Int64Int64BiMap{
		forward: NewInt64Int64WithCapacity(capacity),
		reverse: NewInt64Int64WithCapacity(capacity),
	}
}

// Int64Int64BiMapBulkLoad builds a Int64Int64BiMap from keys/values in a
...
func Int64Int64BiMapBulkLoad(keys []int64, values []int64, policy pump.DuplicatePolicy) (*Int64Int64BiMap, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int64Int64BiMapBulkLoad: len(keys) != len(values)")
	}
	m := &Int64Int64BiMap{
		forward: NewInt64Int64WithCapacity(Int64Int64bulkCap(len(keys))),
		reverse: NewInt64Int64WithCapacity(Int64Int64bulkCap(len(values))),
	}
...
func (m *Int64Int64BiMap) Put(key int64, value int64) (int64, bool) {
...
func (m *Int64Int64BiMap) RemoveValue(value int64) (int64, bool) {
...
func (m *Int64Int64BiMap) ContainsKey(key int64) bool {
	return m.forward.ContainsKey(key)
}

// ContainsValue returns true if the map contains the given value.
func (m *Int64Int64BiMap) ContainsValue(value int64) bool {
	return m.reverse.ContainsKey(value)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int64Int64BiMap) Len() int {
	return m.forward.Len()
}

// Clear removes all entries from both directions.
func (m *Int64Int64BiMap) Clear() {
	m.forward.Clear()
	m.reverse.Clear()
}

// ForEach calls the given function for each key-value pair.
func (m *Int64Int64BiMap) ForEach(f func(int64, int64)) {
	m.forward.ForEach(f)
}
...
func (m *Int64Int64BiMap) All() iter.Seq2[int64, int64] {
	return m.forward.All()
}

// Keys returns an iter.Seq that yields all keys.
func (m *Int64Int64BiMap) Keys() iter.Seq[int64] {
	return m.forward.Keys()
}

// Values returns an iter.Seq that yields all values.
func (m *Int64Int64BiMap) Values() iter.Seq[int64] {
	return m.forward.Values()
}

// Inverse returns a new Int64Int64BiMap with keys and values swapped.
func (m *Int64Int64BiMap) Inverse() *Int64Int64BiMap {
	result := NewInt64Int64BiMap()
...
func (m *Int64Int64BiMap) String() string {
	if m.forward.Len() == 0 {
		return "{}"
	}
...
func (m *Int64Int64BiMap) Equals(other *Int64Int64BiMap) bool {
