...
const (
	int64Int64HashMapDefaultCapacity = 16
	// Load factor 3/4 = 0.75, using integer math to avoid float conversion per insert.
)

// int64Int64HashMapEntry holds a single slot in the hash map for cache locality.
type int64Int64HashMapEntry struct {
	key      int64
	value    int64
	occupied bool
}

// Int64Int64HashMap is an open-addressing hash map with int64 keys and int64 values.
type Int64Int64HashMap struct {
	entries []int64Int64HashMapEntry
	size    int
}

// NewInt64Int64HashMap creates a new empty Int64Int64HashMap with default capacity.
func NewInt64Int64HashMap() *Int64Int64HashMap {
	return NewInt64Int64HashMapWithCapacity(int64Int64HashMapDefaultCapacity)
}

// NewInt64Int64HashMapWithCapacity creates a new empty Int64Int64HashMap with the given initial capacity.
func NewInt64Int64HashMapWithCapacity(capacity int) *Int64Int64HashMap {
	cap := nextPowerOfTwoInt64Int64HashMap(capacity)
	return &Int64Int64HashMap{
		entries: make([]int64Int64HashMapEntry, cap),
		size:    0,
	}
}

// Int64Int64HashMapOf creates a new Int64Int64HashMap from key-value pairs.
func Int64Int64HashMapOf(pairs ...struct {
	Key   int64
	Value int64
}) *Int64Int64HashMap {
...
func (m *Int64Int64HashMap) Put(key int64, value int64) (int64, bool) {
	if m.needsResize() {
		m.resize()
	}
	cap := len(m.entries)
...
func (m *Int64Int64HashMap) Get(key int64) (int64, bool) {
	cap := len(m.entries)
	if cap == 0 {
		return 0, false
	}
...
func (m *Int64Int64HashMap) GetOrDefault(key int64, defaultValue int64) int64 {
...
func (m *Int64Int64HashMap) Remove(key int64) (int64, bool) {
	cap := len(m.entries)
	if cap == 0 {
		return 0, false
	}
...
func (m *Int64Int64HashMap) ContainsKey(key int64) bool {
	_, ok := m.Get(key)
	return ok
}

// ContainsValue returns true if the map contains the given value.
func (m *Int64Int64HashMap) ContainsValue(value int64) bool {
...
func (m *Int64Int64HashMap) Size() int {
	return m.size
}

// IsEmpty returns true if the map contains no entries.
func (m *Int64Int64HashMap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the map.
func (m *Int64Int64HashMap) Clear() {
	for i := range m.entries {
		m.entries[i] = int64Int64HashMapEntry{}
	}
	m.size = 0
}

// All returns an iter.Seq2 that yields all key-value pairs.
func (m *Int64Int64HashMap) All() iter.Seq2[int64, int64] {
...
func (m *Int64Int64HashMap) Keys() iter.Seq[int64] {
...
func (m *Int64Int64HashMap) Values() iter.Seq[int64] {
	return func(yield func(int64) bool) {
		for i := range m.entries {
			if m.entries[i].occupied {
...
func (m *Int64Int64HashMap) ForEach(f func(int64, int64)) {
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int64Int64HashMap) ForEachKey(f func(int64)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].key)
		}
...
func (m *Int64Int64HashMap) ForEachValue(f func(int64)) {
	for i := range m.entries {
		if m.entries[i].occupied {
			f(m.entries[i].value)
		}
...
func (m *Int64Int64HashMap) Select(predicate func(int64, int64) bool) *Int64Int64HashMap {
...
func (m *Int64Int64HashMap) Reject(predicate func(int64, int64) bool) *Int64Int64HashMap {
	result := NewInt64Int64HashMap()
	for i := range m.entries {
		if m.entries[i].occupied && !predicate(m.entries[i].key, m.entries[i].value) {
			result.Put(m.entries[i].key, m.entries[i].value)
...
func (m *Int64Int64HashMap) Detect(predicate func(int64, int64) bool) (int64, int64, bool) {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
...
func (m *Int64Int64HashMap) AnySatisfy(predicate func(int64, int64) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			return true
		}
...
func (m *Int64Int64HashMap) AllSatisfy(predicate func(int64, int64) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && !predicate(m.entries[i].key, m.entries[i].value) {
			return false
		}
...
func (m *Int64Int64HashMap) NoneSatisfy(predicate func(int64, int64) bool) bool {
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			return false
		}
...
func (m *Int64Int64HashMap) Count(predicate func(int64, int64) bool) int {
	count := 0
	for i := range m.entries {
		if m.entries[i].occupied && predicate(m.entries[i].key, m.entries[i].value) {
			count++
...
func (m *Int64Int64HashMap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int64Int64HashMap) Equals(other *Int64Int64HashMap) bool {
...
func (m *Int64Int64HashMap) KeysToSlice() []int64 {
...
func (m *Int64Int64HashMap) ValuesToSlice() []int64 {
	result := make([]int64, 0, m.size)
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int64Int64HashMap) ToImmutable() *ImmutableInt64Int64HashMap {
	return ImmutableInt64Int64HashMapFrom(m)
}

// InjectInto performs a left fold over all key-value pairs.
func (m *Int64Int64HashMap) InjectInto(initial int64, f func(int64, int64, int64) int64) int64 {
	result := initial
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (m *Int64Int64HashMap) AddToValue(key int64, amount int64) int64 {
	if v, ok := m.Get(key); ok {
		newVal := v + amount
		m.Put(key, newVal)
		return newVal
...
// Returns the new value.
func (m *Int64Int64HashMap) UpdateValue(key int64, initialValue int64, f func(int64) int64) int64 {
	if v, ok := m.Get(key); ok {
		newVal := f(v)
		m.Put(key, newVal)
		return newVal
...
func (m *Int64Int64HashMap) WithKeyValue(key int64, value int64) *Int64Int64HashMap {
	m.Put(key, value)
	return m
}

// WithoutKey returns the map after removing the key (fluent API).
func (m *Int64Int64HashMap) WithoutKey(key int64) *Int64Int64HashMap {
	m.Remove(key)
	return m
}

// WithoutAllKeys removes all given keys (fluent API).
func (m *Int64Int64HashMap) WithoutAllKeys(keys []int64) *Int64Int64HashMap {
	for _, k := range keys {
		m.Remove(k)
	}
	return m
...
func (m *Int64Int64HashMap) SumOfValues() int64 {
	var sum int64
	for i := range m.entries {
		if m.entries[i].occupied {
...
func (e Int64Int64Entry) OrInsert(defaultValue int64) int64 {
...
func (m *Int64Int64HashMap) resize() {
	oldEntries := m.entries
	newCap := len(oldEntries) * 2
	if newCap == 0 {
		newCap = int64Int64HashMapDefaultCapacity
	}
	m.entries = make([]int64Int64HashMapEntry, newCap)
	m.size = 0
...
func (m *Int64Int64HashMap) rehashFrom(deleted int, mask int) {
	c := len(m.entries)
	idx := (deleted + 1) & mask
	for m.entries[idx].occupied {
		...
		if distCurrent > distGap {
			...
			m.entries[idx] = int64Int64HashMapEntry{}
			deleted = idx
		}
		idx = (idx + 1) & mask
		if idx == deleted {
...
func nextPowerOfTwoInt64Int64HashMap(n int) int {
	if n <= 0 {
		return 16
	}
	n--
