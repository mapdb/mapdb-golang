...
func TestInt64Int8HashMap_Generated_PutGet(t *testing.T) {
...
func TestInt64Int8HashMap_Generated_PutOverwrite(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
...
func TestInt64Int8HashMap_Generated_Remove(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt64Int8HashMap_Generated_ContainsKey(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestInt64Int8HashMap_Generated_ContainsValue(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
...
func TestInt64Int8HashMap_Generated_GetOrDefault(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
...
func TestInt64Int8HashMap_Generated_IsEmpty(t *testing.T) {
	m := NewInt64Int8HashMap()
	if !m.IsEmpty() {
...
func TestInt64Int8HashMap_Generated_Clear(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestInt64Int8HashMap_Generated_All(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt64Int8HashMap_Generated_Keys(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt64Int8HashMap_Generated_Values(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt64Int8HashMap_Generated_Select(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)

	selected := m.Select(func(k int64, v int8) bool { return v > 1 })
	if selected.Size() != 2 {
		t.Errorf("Select size = %d, want 2", selected.Size())
	}
}

func TestInt64Int8HashMap_Generated_Reject(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)

	rejected := m.Reject(func(k int64, v int8) bool { return v > 1 })
	if rejected.Size() != 1 {
		t.Errorf("Reject size = %d, want 1", rejected.Size())
	}
}

func TestInt64Int8HashMap_Generated_Detect(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)

	_, val, found := m.Detect(func(k int64, v int8) bool { return k == 2 })
	if !found || val != 2 {
		t.Errorf("Detect = (%v, %v), want (2, true)", val, found)
	}
}

func TestInt64Int8HashMap_Generated_AnySatisfy(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)

	if !m.AnySatisfy(func(k int64, v int8) bool { return v == 2 }) {
		t.Error("AnySatisfy should be true")
	}
	if m.AnySatisfy(func(k int64, v int8) bool { return v == 99 }) {
		t.Error("AnySatisfy should be false")
	}
}

func TestInt64Int8HashMap_Generated_AllSatisfy(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)

	if !m.AllSatisfy(func(k int64, v int8) bool { return v > 0 }) {
		t.Error("AllSatisfy should be true for > 0")
	}
	if m.AllSatisfy(func(k int64, v int8) bool { return v > 1 }) {
		t.Error("AllSatisfy should be false")
	}
}

func TestInt64Int8HashMap_Generated_NoneSatisfy(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)

	if !m.NoneSatisfy(func(k int64, v int8) bool { return v == 99 }) {
		t.Error("NoneSatisfy should be true")
	}
}

func TestInt64Int8HashMap_Generated_Count(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)

	if c := m.Count(func(k int64, v int8) bool { return v > 1 }); c != 2 {
		t.Errorf("Count = %d, want 2", c)
	}
}

func TestInt64Int8HashMap_Generated_Entry(t *testing.T) {
	m := NewInt64Int8HashMap()
...
// TestInt64Int8HashMap_Generated_AndModify_ResizeDetection forces a resize from
...
func TestInt64Int8HashMap_Generated_AndModify_ResizeDetection(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	defer func() {
		if r := recover(); r == nil {
...
func TestInt64Int8HashMap_Generated_WithKeyValue(t *testing.T) {
	m := NewInt64Int8HashMap()
...
func TestInt64Int8HashMap_Generated_WithoutKey(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m2 := m.WithoutKey(1)
...
func TestInt64Int8HashMap_Generated_Equals(t *testing.T) {
...
func TestInt64Int8HashMap_Generated_String(t *testing.T) {
	m := NewInt64Int8HashMap()
	m.Put(1, 1)
	if m.String() == "" {
...
func TestInt64Int8HashMap_Generated_Resize(t *testing.T) {
	m := NewInt64Int8HashMap()
