...
func TestInt8Char_Generated_GetOrDefault(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
...
func TestInt8Char_Generated_IsEmpty(t *testing.T) {
	m := NewInt8Char()
	if m.Len() != 0 {
...
func TestInt8Char_Generated_Keys(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Char_Generated_Values(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Char_Generated_Reject(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt8Char_Generated_Detect(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Char_Generated_AllSatisfy(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Char_Generated_NoneSatisfy(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Char_Generated_Count(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt8Char_Generated_Entry(t *testing.T) {
	m := NewInt8Char()
...
// TestInt8Char_Generated_AndModify_ResizeDetection forces a resize from
...
func TestInt8Char_Generated_AndModify_ResizeDetection(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	defer func() {
		if r := recover(); r == nil {
...
func TestInt8Char_Generated_PutReturning(t *testing.T) {
	m := NewInt8Char()
...
func TestInt8Char_Generated_RemoveKeyReturning(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Char_Generated_Equals(t *testing.T) {
	m1 := NewInt8Char()
	m1.Put(1, 1)
	m1.Put(2, 2)
