...
func TestInt8Float64_Generated_PutOverwrite(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
...
func TestInt8Float64_Generated_ContainsValue(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
...
func TestInt8Float64_Generated_GetOrDefault(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
...
func TestInt8Float64_Generated_IsEmpty(t *testing.T) {
	m := NewInt8Float64()
	if m.Len() != 0 {
...
func TestInt8Float64_Generated_Keys(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt8Float64_Generated_Values(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt8Float64_Generated_Reject(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestInt8Float64_Generated_Detect(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt8Float64_Generated_AnySatisfy(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt8Float64_Generated_AllSatisfy(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt8Float64_Generated_NoneSatisfy(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt8Float64_Generated_Count(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestInt8Float64_Generated_Entry(t *testing.T) {
	m := NewInt8Float64()
...
// TestInt8Float64_Generated_AndModify_ResizeDetection forces a resize from
...
func TestInt8Float64_Generated_AndModify_ResizeDetection(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
	defer func() {
		if r := recover(); r == nil {
...
func TestInt8Float64_Generated_PutReturning(t *testing.T) {
	m := NewInt8Float64()
...
func TestInt8Float64_Generated_RemoveKeyReturning(t *testing.T) {
	m := NewInt8Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt8Float64_Generated_Equals(t *testing.T) {
	m1 := NewInt8Float64()
	m1.Put(1, 1.0)
	m1.Put(2, 2.0)
...
func TestInt8Float64_Generated_Resize(t *testing.T) {
	m := NewInt8Float64()
...
func TestInt8Float64_NaNValue_ContainsValue(t *testing.T) {
	m := NewInt8Float64()
...
func TestInt8Float64_NaNValue_GetReturnsNaN(t *testing.T) {
	m := NewInt8Float64()
	nan := float64(math.NaN())
	m.Put(1, nan)
	v, ok := m.Get(1)
