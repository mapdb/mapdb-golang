...
// Int8Int16BiMap is a bidirectional map with int8 keys and int16 values.
// Both key-to-value and value-to-key lookups are O(1).
type Int8Int16BiMap struct {
	forward *Int8Int16
	reverse *Int16Int8
}

// NewInt8Int16BiMap creates a new empty Int8Int16BiMap with default capacity.
func NewInt8Int16BiMap() *Int8Int16BiMap {
	return &Int8Int16BiMap{
		forward: NewInt8Int16(),
		reverse: NewInt16Int8(),
	}
}

// NewInt8Int16BiMapWithCapacity creates a new empty Int8Int16BiMap with the given initial capacity.
func NewInt8Int16BiMapWithCapacity(capacity int) *Int8Int16BiMap {
	return &Int8Int16BiMap{
		forward: NewInt8Int16WithCapacity(capacity),
		reverse: NewInt16Int8WithCapacity(capacity),
	}
}

// Int8Int16BiMapBulkLoad builds a Int8Int16BiMap from keys/values in a
...
func Int8Int16BiMapBulkLoad(keys []int8, values []int16, policy pump.DuplicatePolicy) (*Int8Int16BiMap, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int8Int16BiMapBulkLoad: len(keys) != len(values)")
	}
	m := &Int8Int16BiMap{
		forward: NewInt8Int16WithCapacity(Int8Int16bulkCap(len(keys))),
		reverse: NewInt16Int8WithCapacity(Int16Int8bulkCap(len(values))),
	}
...
func (m *Int8Int16BiMap) Put(key int8, value int16) (int16, bool) {
...
func (m *Int8Int16BiMap) RemoveValue(value int16) (int8, bool) {
...
func (m *Int8Int16BiMap) ContainsKey(key int8) bool {
	return m.forward.ContainsKey(key)
}

// ContainsValue returns true if the map contains the given value.
func (m *Int8Int16BiMap) ContainsValue(value int16) bool {
	return m.reverse.ContainsKey(value)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int8Int16BiMap) Len() int {
	return m.forward.Len()
}

// Clear removes all entries from both directions.
func (m *Int8Int16BiMap) Clear() {
	m.forward.Clear()
	m.reverse.Clear()
}

// ForEach calls the given function for each key-value pair.
func (m *Int8Int16BiMap) ForEach(f func(int8, int16)) {
	m.forward.ForEach(f)
}
...
func (m *Int8Int16BiMap) All() iter.Seq2[int8, int16] {
	return m.forward.All()
}

// Keys returns an iter.Seq that yields all keys.
func (m *Int8Int16BiMap) Keys() iter.Seq[int8] {
	return m.forward.Keys()
}

// Values returns an iter.Seq that yields all values.
func (m *Int8Int16BiMap) Values() iter.Seq[int16] {
	return m.forward.Values()
}

// Inverse returns a new Int16Int8BiMap with keys and values swapped.
func (m *Int8Int16BiMap) Inverse() *Int16Int8BiMap {
	result := NewInt16Int8BiMap()
...
func (m *Int8Int16BiMap) String() string {
	if m.forward.Len() == 0 {
		return "{}"
	}
...
func (m *Int8Int16BiMap) Equals(other *Int8Int16BiMap) bool {
