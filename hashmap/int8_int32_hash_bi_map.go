...
// Int8Int32BiMapBulkLoad builds a Int8Int32BiMap from keys/values in a
...
func Int8Int32BiMapBulkLoad(keys []int8, values []int32, policy pump.DuplicatePolicy) (*Int8Int32BiMap, error) {
	if len(keys) != len(values) {
		panic("mapdb: Int8Int32BiMapBulkLoad: len(keys) != len(values)")
	}
	m := &Int8Int32BiMap{
		forward: NewInt8Int32WithCapacity(Int8Int32bulkCap(len(keys))),
		reverse: NewInt32Int8WithCapacity(Int32Int8bulkCap(len(values))),
	}
...
func (m *Int8Int32BiMap) All() iter.Seq2[int8, int32] {
