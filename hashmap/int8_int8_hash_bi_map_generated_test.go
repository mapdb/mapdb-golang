...
func TestInt8Int8BiMap_Generated_PutGet(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt8Int8BiMap_Generated_GetKey(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8BiMap_Generated_PutOverwriteKey(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
...
func TestInt8Int8BiMap_Generated_PutOverwriteValue(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8BiMap_Generated_Remove(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8BiMap_Generated_RemoveValue(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8BiMap_Generated_ContainsKey(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestInt8Int8BiMap_Generated_ContainsValue(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	if !m.ContainsValue(1) {
...
func TestInt8Int8BiMap_Generated_IsEmpty(t *testing.T) {
	m := NewInt8Int8BiMap()
	if m.Len() != 0 {
...
func TestInt8Int8BiMap_Generated_Clear(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestInt8Int8BiMap_Generated_ForEach(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8BiMap_Generated_Keys(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8BiMap_Generated_Values(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8BiMap_Generated_Inverse(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8BiMap_Generated_Equals(t *testing.T) {
	m1 := NewInt8Int8BiMap()
	m1.Put(1, 1)
	m1.Put(2, 2)
...
func TestInt8Int8BiMap_Generated_String(t *testing.T) {
	m := NewInt8Int8BiMap()
	if m.String() != "{}" {
...
func TestInt8Int8BiMap_Generated_BijectiveInvariant(t *testing.T) {
	m := NewInt8Int8BiMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
