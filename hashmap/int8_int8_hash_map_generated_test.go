...
func TestInt8Int8HashMap_Generated_PutGet(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt8Int8HashMap_Generated_PutOverwrite(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
...
func TestInt8Int8HashMap_Generated_Remove(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8HashMap_Generated_ContainsKey(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestInt8Int8HashMap_Generated_ContainsValue(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
...
func TestInt8Int8HashMap_Generated_GetOrDefault(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
...
func TestInt8Int8HashMap_Generated_IsEmpty(t *testing.T) {
	m := NewInt8Int8HashMap()
	if !m.IsEmpty() {
...
func TestInt8Int8HashMap_Generated_Clear(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestInt8Int8HashMap_Generated_All(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8HashMap_Generated_Keys(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8HashMap_Generated_Values(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8HashMap_Generated_Select(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt8Int8HashMap_Generated_Reject(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt8Int8HashMap_Generated_Detect(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8HashMap_Generated_AnySatisfy(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8HashMap_Generated_AllSatisfy(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8HashMap_Generated_NoneSatisfy(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int8HashMap_Generated_Count(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt8Int8HashMap_Generated_Entry(t *testing.T) {
	m := NewInt8Int8HashMap()
...
// TestInt8Int8HashMap_Generated_AndModify_ResizeDetection forces a resize from
...
func TestInt8Int8HashMap_Generated_AndModify_ResizeDetection(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	defer func() {
		if r := recover(); r == nil {
...
func TestInt8Int8HashMap_Generated_WithKeyValue(t *testing.T) {
	m := NewInt8Int8HashMap()
...
func TestInt8Int8HashMap_Generated_WithoutKey(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m2 := m.WithoutKey(1)
...
func TestInt8Int8HashMap_Generated_Equals(t *testing.T) {
	m1 := NewInt8Int8HashMap()
	m1.Put(1, 1)
	m1.Put(2, 2)

	m2 := NewInt8Int8HashMap()
	m2.Put(2, 2)
	m2.Put(1, 1)
...
func TestInt8Int8HashMap_Generated_String(t *testing.T) {
	m := NewInt8Int8HashMap()
	m.Put(1, 1)
	if m.String() == "" {
...
func TestInt8Int8HashMap_Generated_Resize(t *testing.T) {
	m := NewInt8Int8HashMap()
