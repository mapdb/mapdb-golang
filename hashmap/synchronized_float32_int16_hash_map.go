...
// SynchronizedFloat32Int16 is a thread-safe wrapper around Float32Int16.
//
...
type SynchronizedFloat32Int16 struct {
	delegate *Float32Int16
	mu       sync.RWMutex
}

// NewSynchronizedFloat32Int16 wraps a mutable map with synchronization.
func NewSynchronizedFloat32Int16() *SynchronizedFloat32Int16 {
	return &SynchronizedFloat32Int16{delegate: NewFloat32Int16()}
}

// NewSynchronizedFloat32Int16WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedFloat32Int16WithCapacity(capacity int) *SynchronizedFloat32Int16 {
	return &SynchronizedFloat32Int16{delegate: NewFloat32Int16WithCapacity(capacity)}
}

// NewSynchronizedFloat32Int16From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedFloat32Int16From(m *Float32Int16) *SynchronizedFloat32Int16 {
	return &SynchronizedFloat32Int16{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedFloat32Int16) snapshot() (keys []float32, values []int16) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) Put(key float32, value int16) (int16, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int16) Remove(key float32) (int16, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int16) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedFloat32Int16) AddToValue(key float32, amount int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int16) UpdateValue(key float32, initial int16, f func(int16) int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int16) Get(key float32) (int16, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) GetOrDefault(key float32, defaultValue int16) int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) ContainsKey(key float32) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) ContainsValue(value int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) SumOfValues() int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) KeysToSlice() []float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) ValuesToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) All() iter.Seq2[float32, int16] {
...
func (m *SynchronizedFloat32Int16) Keys() iter.Seq[float32] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedFloat32Int16) Values() iter.Seq[int16] {
	_, values := m.snapshot()
...
func (m *SynchronizedFloat32Int16) ForEach(f func(float32, int16)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedFloat32Int16) ForEachKey(f func(float32)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedFloat32Int16) ForEachValue(f func(int16)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedFloat32Int16) AnySatisfy(predicate func(float32, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedFloat32Int16) AllSatisfy(predicate func(float32, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedFloat32Int16) NoneSatisfy(predicate func(float32, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedFloat32Int16) Count(predicate func(float32, int16) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat32Int16) Detect(predicate func(float32, int16) bool) (float32, int16, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat32Int16) InjectInto(initial int16, f func(int16, float32, int16) int16) int16 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedFloat32Int16) Select(predicate func(float32, int16) bool) *Float32Int16 {
	keys, values := m.snapshot()
...
func (m *SynchronizedFloat32Int16) Reject(predicate func(float32, int16) bool) *Float32Int16 {
	keys, values := m.snapshot()
	result := NewFloat32Int16()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat32Int16) PutReturning(key float32, value int16) *SynchronizedFloat32Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int16) RemoveKeyReturning(key float32) *SynchronizedFloat32Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedFloat32Int16) WithoutAllKeys(keys ...float32) *SynchronizedFloat32Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int16) ToImmutable() *ImmutableFloat32Int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int16) Equals(other *SynchronizedFloat32Int16) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
