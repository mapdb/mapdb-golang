...
// SynchronizedFloat32Int64 is a thread-safe wrapper around Float32Int64.
//
...
type SynchronizedFloat32Int64 struct {
	delegate *Float32Int64
	mu       sync.RWMutex
}

// NewSynchronizedFloat32Int64 wraps a mutable map with synchronization.
func NewSynchronizedFloat32Int64() *SynchronizedFloat32Int64 {
	return &SynchronizedFloat32Int64{delegate: NewFloat32Int64()}
}

// NewSynchronizedFloat32Int64WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedFloat32Int64WithCapacity(capacity int) *SynchronizedFloat32Int64 {
	return &SynchronizedFloat32Int64{delegate: NewFloat32Int64WithCapacity(capacity)}
}

// NewSynchronizedFloat32Int64From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedFloat32Int64From(m *Float32Int64) *SynchronizedFloat32Int64 {
	return &SynchronizedFloat32Int64{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedFloat32Int64) snapshot() (keys []float32, values []int64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) Put(key float32, value int64) (int64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int64) Remove(key float32) (int64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int64) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedFloat32Int64) AddToValue(key float32, amount int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int64) UpdateValue(key float32, initial int64, f func(int64) int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int64) Get(key float32) (int64, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) GetOrDefault(key float32, defaultValue int64) int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) ContainsKey(key float32) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) ContainsValue(value int64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) SumOfValues() int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) KeysToSlice() []float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) ValuesToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) All() iter.Seq2[float32, int64] {
...
func (m *SynchronizedFloat32Int64) Keys() iter.Seq[float32] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedFloat32Int64) Values() iter.Seq[int64] {
	_, values := m.snapshot()
...
func (m *SynchronizedFloat32Int64) ForEach(f func(float32, int64)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedFloat32Int64) ForEachKey(f func(float32)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedFloat32Int64) ForEachValue(f func(int64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedFloat32Int64) AnySatisfy(predicate func(float32, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedFloat32Int64) AllSatisfy(predicate func(float32, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedFloat32Int64) NoneSatisfy(predicate func(float32, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedFloat32Int64) Count(predicate func(float32, int64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat32Int64) Detect(predicate func(float32, int64) bool) (float32, int64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat32Int64) InjectInto(initial int64, f func(int64, float32, int64) int64) int64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedFloat32Int64) Select(predicate func(float32, int64) bool) *Float32Int64 {
	keys, values := m.snapshot()
...
func (m *SynchronizedFloat32Int64) Reject(predicate func(float32, int64) bool) *Float32Int64 {
	keys, values := m.snapshot()
	result := NewFloat32Int64()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat32Int64) PutReturning(key float32, value int64) *SynchronizedFloat32Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int64) RemoveKeyReturning(key float32) *SynchronizedFloat32Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedFloat32Int64) WithoutAllKeys(keys ...float32) *SynchronizedFloat32Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int64) ToImmutable() *ImmutableFloat32Int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int64) Equals(other *SynchronizedFloat32Int64) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
