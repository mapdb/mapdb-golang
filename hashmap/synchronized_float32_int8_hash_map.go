...
// SynchronizedFloat32Int8 is a thread-safe wrapper around Float32Int8.
//
...
type SynchronizedFloat32Int8 struct {
	delegate *Float32Int8
	mu       sync.RWMutex
}

// NewSynchronizedFloat32Int8 wraps a mutable map with synchronization.
func NewSynchronizedFloat32Int8() *SynchronizedFloat32Int8 {
	return &SynchronizedFloat32Int8{delegate: NewFloat32Int8()}
}

// NewSynchronizedFloat32Int8WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedFloat32Int8WithCapacity(capacity int) *SynchronizedFloat32Int8 {
	return &SynchronizedFloat32Int8{delegate: NewFloat32Int8WithCapacity(capacity)}
}

// NewSynchronizedFloat32Int8From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedFloat32Int8From(m *Float32Int8) *SynchronizedFloat32Int8 {
	return &SynchronizedFloat32Int8{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedFloat32Int8) snapshot() (keys []float32, values []int8) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) Put(key float32, value int8) (int8, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int8) Remove(key float32) (int8, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int8) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedFloat32Int8) AddToValue(key float32, amount int8) int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int8) UpdateValue(key float32, initial int8, f func(int8) int8) int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int8) Get(key float32) (int8, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) GetOrDefault(key float32, defaultValue int8) int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) ContainsKey(key float32) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) ContainsValue(value int8) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) SumOfValues() int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) KeysToSlice() []float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) ValuesToSlice() []int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) All() iter.Seq2[float32, int8] {
...
func (m *SynchronizedFloat32Int8) Keys() iter.Seq[float32] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedFloat32Int8) Values() iter.Seq[int8] {
	_, values := m.snapshot()
...
func (m *SynchronizedFloat32Int8) ForEach(f func(float32, int8)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedFloat32Int8) ForEachKey(f func(float32)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedFloat32Int8) ForEachValue(f func(int8)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedFloat32Int8) AnySatisfy(predicate func(float32, int8) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedFloat32Int8) AllSatisfy(predicate func(float32, int8) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedFloat32Int8) NoneSatisfy(predicate func(float32, int8) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedFloat32Int8) Count(predicate func(float32, int8) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat32Int8) Detect(predicate func(float32, int8) bool) (float32, int8, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat32Int8) InjectInto(initial int8, f func(int8, float32, int8) int8) int8 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedFloat32Int8) Select(predicate func(float32, int8) bool) *Float32Int8 {
	keys, values := m.snapshot()
...
func (m *SynchronizedFloat32Int8) Reject(predicate func(float32, int8) bool) *Float32Int8 {
	keys, values := m.snapshot()
	result := NewFloat32Int8()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat32Int8) PutReturning(key float32, value int8) *SynchronizedFloat32Int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int8) RemoveKeyReturning(key float32) *SynchronizedFloat32Int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedFloat32Int8) WithoutAllKeys(keys ...float32) *SynchronizedFloat32Int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat32Int8) ToImmutable() *ImmutableFloat32Int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat32Int8) Equals(other *SynchronizedFloat32Int8) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
