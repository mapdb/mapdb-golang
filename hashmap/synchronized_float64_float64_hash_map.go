...
// SynchronizedFloat64Float64 is a thread-safe wrapper around Float64Float64.
//
...
type SynchronizedFloat64Float64 struct {
	delegate *Float64Float64
	mu       sync.RWMutex
}

// NewSynchronizedFloat64Float64 wraps a mutable map with synchronization.
func NewSynchronizedFloat64Float64() *SynchronizedFloat64Float64 {
	return &SynchronizedFloat64Float64{delegate: NewFloat64Float64()}
}

// NewSynchronizedFloat64Float64WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedFloat64Float64WithCapacity(capacity int) *SynchronizedFloat64Float64 {
	return &SynchronizedFloat64Float64{delegate: NewFloat64Float64WithCapacity(capacity)}
}

// NewSynchronizedFloat64Float64From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedFloat64Float64From(m *Float64Float64) *SynchronizedFloat64Float64 {
	return &SynchronizedFloat64Float64{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedFloat64Float64) snapshot() (keys []float64, values []float64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) Put(key float64, value float64) (float64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat64Float64) Remove(key float64) (float64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat64Float64) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedFloat64Float64) AddToValue(key float64, amount float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat64Float64) UpdateValue(key float64, initial float64, f func(float64) float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat64Float64) Get(key float64) (float64, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) GetOrDefault(key float64, defaultValue float64) float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) ContainsKey(key float64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) ContainsValue(value float64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) SumOfValues() float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) KeysToSlice() []float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) ValuesToSlice() []float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) All() iter.Seq2[float64, float64] {
...
func (m *SynchronizedFloat64Float64) Keys() iter.Seq[float64] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedFloat64Float64) Values() iter.Seq[float64] {
	_, values := m.snapshot()
	return func(yield func(float64) bool) {
...
func (m *SynchronizedFloat64Float64) ForEach(f func(float64, float64)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedFloat64Float64) ForEachKey(f func(float64)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedFloat64Float64) ForEachValue(f func(float64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedFloat64Float64) AnySatisfy(predicate func(float64, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedFloat64Float64) AllSatisfy(predicate func(float64, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedFloat64Float64) NoneSatisfy(predicate func(float64, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedFloat64Float64) Count(predicate func(float64, float64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat64Float64) Detect(predicate func(float64, float64) bool) (float64, float64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat64Float64) InjectInto(initial float64, f func(float64, float64, float64) float64) float64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedFloat64Float64) Select(predicate func(float64, float64) bool) *Float64Float64 {
	keys, values := m.snapshot()
...
func (m *SynchronizedFloat64Float64) Reject(predicate func(float64, float64) bool) *Float64Float64 {
	keys, values := m.snapshot()
	result := NewFloat64Float64()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat64Float64) PutReturning(key float64, value float64) *SynchronizedFloat64Float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat64Float64) RemoveKeyReturning(key float64) *SynchronizedFloat64Float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedFloat64Float64) WithoutAllKeys(keys ...float64) *SynchronizedFloat64Float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat64Float64) ToImmutable() *ImmutableFloat64Float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Float64) Equals(other *SynchronizedFloat64Float64) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
