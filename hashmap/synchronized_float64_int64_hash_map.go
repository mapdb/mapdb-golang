...
// NewSynchronizedFloat64Int64HashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedFloat64Int64HashMapWithCapacity(capacity int) *SynchronizedFloat64Int64HashMap {
	return &SynchronizedFloat64Int64HashMap{delegate: NewFloat64Int64HashMapWithCapacity(capacity)}
}
...
func (m *SynchronizedFloat64Int64HashMap) snapshot() (keys []float64, values []int64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Int64HashMap) AddToValue(key float64, amount int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat64Int64HashMap) UpdateValue(key float64, initial int64, f func(int64) int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat64Int64HashMap) ContainsValue(value int64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Int64HashMap) SumOfValues() int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Int64HashMap) KeysToSlice() []float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Int64HashMap) ValuesToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Int64HashMap) Keys() iter.Seq[float64] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedFloat64Int64HashMap) Values() iter.Seq[int64] {
	_, values := m.snapshot()
...
func (m *SynchronizedFloat64Int64HashMap) ForEachKey(f func(float64)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedFloat64Int64HashMap) ForEachValue(f func(int64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedFloat64Int64HashMap) AnySatisfy(predicate func(float64, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedFloat64Int64HashMap) AllSatisfy(predicate func(float64, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedFloat64Int64HashMap) NoneSatisfy(predicate func(float64, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedFloat64Int64HashMap) Count(predicate func(float64, int64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat64Int64HashMap) Detect(predicate func(float64, int64) bool) (float64, int64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat64Int64HashMap) InjectInto(initial int64, f func(int64, float64, int64) int64) int64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedFloat64Int64HashMap) Select(predicate func(float64, int64) bool) *Float64Int64HashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedFloat64Int64HashMap) Reject(predicate func(float64, int64) bool) *Float64Int64HashMap {
	keys, values := m.snapshot()
	result := NewFloat64Int64HashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedFloat64Int64HashMap) WithKeyValue(key float64, value int64) *SynchronizedFloat64Int64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat64Int64HashMap) WithoutKey(key float64) *SynchronizedFloat64Int64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedFloat64Int64HashMap) WithoutAllKeys(keys ...float64) *SynchronizedFloat64Int64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedFloat64Int64HashMap) ToImmutable() *ImmutableFloat64Int64HashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedFloat64Int64HashMap) Equals(other *SynchronizedFloat64Int64HashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
