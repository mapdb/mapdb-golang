...
// SynchronizedInt16CharHashMap is a thread-safe wrapper around Int16CharHashMap.
//
...
type SynchronizedInt16CharHashMap struct {
	delegate *Int16CharHashMap
	mu       sync.RWMutex
}

// NewSynchronizedInt16CharHashMap wraps a mutable map with synchronization.
func NewSynchronizedInt16CharHashMap() *SynchronizedInt16CharHashMap {
	return &SynchronizedInt16CharHashMap{delegate: NewInt16CharHashMap()}
}

// NewSynchronizedInt16CharHashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt16CharHashMapWithCapacity(capacity int) *SynchronizedInt16CharHashMap {
	return &SynchronizedInt16CharHashMap{delegate: NewInt16CharHashMapWithCapacity(capacity)}
}

// NewSynchronizedInt16CharHashMapFrom wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt16CharHashMapFrom(m *Int16CharHashMap) *SynchronizedInt16CharHashMap {
	return &SynchronizedInt16CharHashMap{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt16CharHashMap) snapshot() (keys []int16, values []uint16) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) Put(key int16, value uint16) (uint16, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16CharHashMap) Remove(key int16) (uint16, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16CharHashMap) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt16CharHashMap) AddToValue(key int16, amount uint16) uint16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16CharHashMap) UpdateValue(key int16, initial uint16, f func(uint16) uint16) uint16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16CharHashMap) Get(key int16) (uint16, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) GetOrDefault(key int16, defaultValue uint16) uint16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) ContainsKey(key int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) ContainsValue(value uint16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) Size() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) IsEmpty() bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) SumOfValues() uint16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) KeysToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) ValuesToSlice() []uint16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) All() iter.Seq2[int16, uint16] {
...
func (m *SynchronizedInt16CharHashMap) Keys() iter.Seq[int16] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt16CharHashMap) Values() iter.Seq[uint16] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt16CharHashMap) ForEach(f func(int16, uint16)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt16CharHashMap) ForEachKey(f func(int16)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt16CharHashMap) ForEachValue(f func(uint16)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt16CharHashMap) AnySatisfy(predicate func(int16, uint16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt16CharHashMap) AllSatisfy(predicate func(int16, uint16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16CharHashMap) NoneSatisfy(predicate func(int16, uint16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16CharHashMap) Count(predicate func(int16, uint16) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16CharHashMap) Detect(predicate func(int16, uint16) bool) (int16, uint16, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16CharHashMap) InjectInto(initial uint16, f func(uint16, int16, uint16) uint16) uint16 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt16CharHashMap) Select(predicate func(int16, uint16) bool) *Int16CharHashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt16CharHashMap) Reject(predicate func(int16, uint16) bool) *Int16CharHashMap {
	keys, values := m.snapshot()
	result := NewInt16CharHashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16CharHashMap) WithKeyValue(key int16, value uint16) *SynchronizedInt16CharHashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16CharHashMap) WithoutKey(key int16) *SynchronizedInt16CharHashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt16CharHashMap) WithoutAllKeys(keys ...int16) *SynchronizedInt16CharHashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16CharHashMap) ToImmutable() *ImmutableInt16CharHashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16CharHashMap) Equals(other *SynchronizedInt16CharHashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
