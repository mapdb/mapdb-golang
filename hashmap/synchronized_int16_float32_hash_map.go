...
// SynchronizedInt16Float32 is a thread-safe wrapper around Int16Float32.
//
...
type SynchronizedInt16Float32 struct {
	delegate *Int16Float32
	mu       sync.RWMutex
}

// NewSynchronizedInt16Float32 wraps a mutable map with synchronization.
func NewSynchronizedInt16Float32() *SynchronizedInt16Float32 {
	return &SynchronizedInt16Float32{delegate: NewInt16Float32()}
}

// NewSynchronizedInt16Float32WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt16Float32WithCapacity(capacity int) *SynchronizedInt16Float32 {
	return &SynchronizedInt16Float32{delegate: NewInt16Float32WithCapacity(capacity)}
}

// NewSynchronizedInt16Float32From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt16Float32From(m *Int16Float32) *SynchronizedInt16Float32 {
	return &SynchronizedInt16Float32{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt16Float32) snapshot() (keys []int16, values []float32) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) Put(key int16, value float32) (float32, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Float32) Remove(key int16) (float32, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Float32) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt16Float32) AddToValue(key int16, amount float32) float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Float32) UpdateValue(key int16, initial float32, f func(float32) float32) float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Float32) Get(key int16) (float32, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) GetOrDefault(key int16, defaultValue float32) float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) ContainsKey(key int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) ContainsValue(value float32) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) SumOfValues() float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) KeysToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) ValuesToSlice() []float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) All() iter.Seq2[int16, float32] {
...
func (m *SynchronizedInt16Float32) Keys() iter.Seq[int16] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt16Float32) Values() iter.Seq[float32] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt16Float32) ForEach(f func(int16, float32)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt16Float32) ForEachKey(f func(int16)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt16Float32) ForEachValue(f func(float32)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt16Float32) AnySatisfy(predicate func(int16, float32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt16Float32) AllSatisfy(predicate func(int16, float32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16Float32) NoneSatisfy(predicate func(int16, float32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16Float32) Count(predicate func(int16, float32) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Float32) Detect(predicate func(int16, float32) bool) (int16, float32, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Float32) InjectInto(initial float32, f func(float32, int16, float32) float32) float32 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt16Float32) Select(predicate func(int16, float32) bool) *Int16Float32 {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt16Float32) Reject(predicate func(int16, float32) bool) *Int16Float32 {
	keys, values := m.snapshot()
	result := NewInt16Float32()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Float32) PutReturning(key int16, value float32) *SynchronizedInt16Float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Float32) RemoveKeyReturning(key int16) *SynchronizedInt16Float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt16Float32) WithoutAllKeys(keys ...int16) *SynchronizedInt16Float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Float32) ToImmutable() *ImmutableInt16Float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Float32) Equals(other *SynchronizedInt16Float32) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
