...
// SynchronizedInt16Int16 is a thread-safe wrapper around Int16Int16.
//
...
type SynchronizedInt16Int16 struct {
	delegate *Int16Int16
	mu       sync.RWMutex
}

// NewSynchronizedInt16Int16 wraps a mutable map with synchronization.
func NewSynchronizedInt16Int16() *SynchronizedInt16Int16 {
	return &SynchronizedInt16Int16{delegate: NewInt16Int16()}
}

// NewSynchronizedInt16Int16WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt16Int16WithCapacity(capacity int) *SynchronizedInt16Int16 {
	return &SynchronizedInt16Int16{delegate: NewInt16Int16WithCapacity(capacity)}
}

// NewSynchronizedInt16Int16From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt16Int16From(m *Int16Int16) *SynchronizedInt16Int16 {
	return &SynchronizedInt16Int16{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt16Int16) snapshot() (keys []int16, values []int16) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) Put(key int16, value int16) (int16, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int16) Remove(key int16) (int16, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int16) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt16Int16) AddToValue(key int16, amount int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int16) UpdateValue(key int16, initial int16, f func(int16) int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int16) Get(key int16) (int16, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) GetOrDefault(key int16, defaultValue int16) int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) ContainsKey(key int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) ContainsValue(value int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) SumOfValues() int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) KeysToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) ValuesToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) All() iter.Seq2[int16, int16] {
...
func (m *SynchronizedInt16Int16) Keys() iter.Seq[int16] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt16Int16) Values() iter.Seq[int16] {
	_, values := m.snapshot()
	return func(yield func(int16) bool) {
...
func (m *SynchronizedInt16Int16) ForEach(f func(int16, int16)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt16Int16) ForEachKey(f func(int16)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt16Int16) ForEachValue(f func(int16)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt16Int16) AnySatisfy(predicate func(int16, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt16Int16) AllSatisfy(predicate func(int16, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16Int16) NoneSatisfy(predicate func(int16, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16Int16) Count(predicate func(int16, int16) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int16) Detect(predicate func(int16, int16) bool) (int16, int16, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int16) InjectInto(initial int16, f func(int16, int16, int16) int16) int16 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt16Int16) Select(predicate func(int16, int16) bool) *Int16Int16 {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt16Int16) Reject(predicate func(int16, int16) bool) *Int16Int16 {
	keys, values := m.snapshot()
	result := NewInt16Int16()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int16) PutReturning(key int16, value int16) *SynchronizedInt16Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int16) RemoveKeyReturning(key int16) *SynchronizedInt16Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt16Int16) WithoutAllKeys(keys ...int16) *SynchronizedInt16Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int16) ToImmutable() *ImmutableInt16Int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16) Equals(other *SynchronizedInt16Int16) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
