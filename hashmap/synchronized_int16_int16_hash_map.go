...
// NewSynchronizedInt16Int16HashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt16Int16HashMapWithCapacity(capacity int) *SynchronizedInt16Int16HashMap {
	return &SynchronizedInt16Int16HashMap{delegate: NewInt16Int16HashMapWithCapacity(capacity)}
}
...
func (m *SynchronizedInt16Int16HashMap) snapshot() (keys []int16, values []int16) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16HashMap) AddToValue(key int16, amount int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int16HashMap) UpdateValue(key int16, initial int16, f func(int16) int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int16HashMap) ContainsValue(value int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16HashMap) SumOfValues() int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16HashMap) KeysToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16HashMap) ValuesToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16HashMap) Keys() iter.Seq[int16] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt16Int16HashMap) Values() iter.Seq[int16] {
	_, values := m.snapshot()
	return func(yield func(int16) bool) {
...
func (m *SynchronizedInt16Int16HashMap) ForEachKey(f func(int16)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt16Int16HashMap) ForEachValue(f func(int16)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt16Int16HashMap) AnySatisfy(predicate func(int16, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt16Int16HashMap) AllSatisfy(predicate func(int16, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16Int16HashMap) NoneSatisfy(predicate func(int16, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16Int16HashMap) Count(predicate func(int16, int16) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int16HashMap) Detect(predicate func(int16, int16) bool) (int16, int16, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int16HashMap) InjectInto(initial int16, f func(int16, int16, int16) int16) int16 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt16Int16HashMap) Select(predicate func(int16, int16) bool) *Int16Int16HashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt16Int16HashMap) Reject(predicate func(int16, int16) bool) *Int16Int16HashMap {
	keys, values := m.snapshot()
	result := NewInt16Int16HashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int16HashMap) WithKeyValue(key int16, value int16) *SynchronizedInt16Int16HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int16HashMap) WithoutKey(key int16) *SynchronizedInt16Int16HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt16Int16HashMap) WithoutAllKeys(keys ...int16) *SynchronizedInt16Int16HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int16HashMap) ToImmutable() *ImmutableInt16Int16HashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int16HashMap) Equals(other *SynchronizedInt16Int16HashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
