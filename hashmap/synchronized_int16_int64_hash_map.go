...
// SynchronizedInt16Int64 is a thread-safe wrapper around Int16Int64.
//
...
type SynchronizedInt16Int64 struct {
	delegate *Int16Int64
	mu       sync.RWMutex
}

// NewSynchronizedInt16Int64 wraps a mutable map with synchronization.
func NewSynchronizedInt16Int64() *SynchronizedInt16Int64 {
	return &SynchronizedInt16Int64{delegate: NewInt16Int64()}
}

// NewSynchronizedInt16Int64WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt16Int64WithCapacity(capacity int) *SynchronizedInt16Int64 {
	return &SynchronizedInt16Int64{delegate: NewInt16Int64WithCapacity(capacity)}
}

// NewSynchronizedInt16Int64From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt16Int64From(m *Int16Int64) *SynchronizedInt16Int64 {
	return &SynchronizedInt16Int64{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt16Int64) snapshot() (keys []int16, values []int64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) Put(key int16, value int64) (int64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64) Remove(key int16) (int64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt16Int64) AddToValue(key int16, amount int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64) UpdateValue(key int16, initial int64, f func(int64) int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64) Get(key int16) (int64, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) GetOrDefault(key int16, defaultValue int64) int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) ContainsKey(key int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) ContainsValue(value int64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) SumOfValues() int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) KeysToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) ValuesToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) All() iter.Seq2[int16, int64] {
...
func (m *SynchronizedInt16Int64) Keys() iter.Seq[int16] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt16Int64) Values() iter.Seq[int64] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt16Int64) ForEach(f func(int16, int64)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt16Int64) ForEachKey(f func(int16)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt16Int64) ForEachValue(f func(int64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt16Int64) AnySatisfy(predicate func(int16, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt16Int64) AllSatisfy(predicate func(int16, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16Int64) NoneSatisfy(predicate func(int16, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16Int64) Count(predicate func(int16, int64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int64) Detect(predicate func(int16, int64) bool) (int16, int64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int64) InjectInto(initial int64, f func(int64, int16, int64) int64) int64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt16Int64) Select(predicate func(int16, int64) bool) *Int16Int64 {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt16Int64) Reject(predicate func(int16, int64) bool) *Int16Int64 {
	keys, values := m.snapshot()
	result := NewInt16Int64()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int64) PutReturning(key int16, value int64) *SynchronizedInt16Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64) RemoveKeyReturning(key int16) *SynchronizedInt16Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt16Int64) WithoutAllKeys(keys ...int16) *SynchronizedInt16Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64) ToImmutable() *ImmutableInt16Int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64) Equals(other *SynchronizedInt16Int64) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
