...
// SynchronizedInt16Int64HashMap is a thread-safe wrapper around Int16Int64HashMap.
//
...
type SynchronizedInt16Int64HashMap struct {
	delegate *Int16Int64HashMap
	mu       sync.RWMutex
}

// NewSynchronizedInt16Int64HashMap wraps a mutable map with synchronization.
func NewSynchronizedInt16Int64HashMap() *SynchronizedInt16Int64HashMap {
	return &SynchronizedInt16Int64HashMap{delegate: NewInt16Int64HashMap()}
}

// NewSynchronizedInt16Int64HashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt16Int64HashMapWithCapacity(capacity int) *SynchronizedInt16Int64HashMap {
	return &SynchronizedInt16Int64HashMap{delegate: NewInt16Int64HashMapWithCapacity(capacity)}
}

// NewSynchronizedInt16Int64HashMapFrom wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt16Int64HashMapFrom(m *Int16Int64HashMap) *SynchronizedInt16Int64HashMap {
	return &SynchronizedInt16Int64HashMap{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt16Int64HashMap) snapshot() (keys []int16, values []int64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) Put(key int16, value int64) (int64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64HashMap) Remove(key int16) (int64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64HashMap) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt16Int64HashMap) AddToValue(key int16, amount int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64HashMap) UpdateValue(key int16, initial int64, f func(int64) int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64HashMap) Get(key int16) (int64, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) GetOrDefault(key int16, defaultValue int64) int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) ContainsKey(key int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) ContainsValue(value int64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) Size() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) IsEmpty() bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) SumOfValues() int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) KeysToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) ValuesToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) All() iter.Seq2[int16, int64] {
...
func (m *SynchronizedInt16Int64HashMap) Keys() iter.Seq[int16] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt16Int64HashMap) Values() iter.Seq[int64] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt16Int64HashMap) ForEach(f func(int16, int64)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt16Int64HashMap) ForEachKey(f func(int16)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt16Int64HashMap) ForEachValue(f func(int64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt16Int64HashMap) AnySatisfy(predicate func(int16, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt16Int64HashMap) AllSatisfy(predicate func(int16, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16Int64HashMap) NoneSatisfy(predicate func(int16, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt16Int64HashMap) Count(predicate func(int16, int64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int64HashMap) Detect(predicate func(int16, int64) bool) (int16, int64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int64HashMap) InjectInto(initial int64, f func(int64, int16, int64) int64) int64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt16Int64HashMap) Select(predicate func(int16, int64) bool) *Int16Int64HashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt16Int64HashMap) Reject(predicate func(int16, int64) bool) *Int16Int64HashMap {
	keys, values := m.snapshot()
	result := NewInt16Int64HashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt16Int64HashMap) WithKeyValue(key int16, value int64) *SynchronizedInt16Int64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64HashMap) WithoutKey(key int16) *SynchronizedInt16Int64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt16Int64HashMap) WithoutAllKeys(keys ...int16) *SynchronizedInt16Int64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt16Int64HashMap) ToImmutable() *ImmutableInt16Int64HashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt16Int64HashMap) Equals(other *SynchronizedInt16Int64HashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
