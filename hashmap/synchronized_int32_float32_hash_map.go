...
// SynchronizedInt32Float32 is a thread-safe wrapper around Int32Float32.
//
...
type SynchronizedInt32Float32 struct {
	delegate *Int32Float32
	mu       sync.RWMutex
}

// NewSynchronizedInt32Float32 wraps a mutable map with synchronization.
func NewSynchronizedInt32Float32() *SynchronizedInt32Float32 {
	return &SynchronizedInt32Float32{delegate: NewInt32Float32()}
}

// NewSynchronizedInt32Float32WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt32Float32WithCapacity(capacity int) *SynchronizedInt32Float32 {
	return &SynchronizedInt32Float32{delegate: NewInt32Float32WithCapacity(capacity)}
}

// NewSynchronizedInt32Float32From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt32Float32From(m *Int32Float32) *SynchronizedInt32Float32 {
	return &SynchronizedInt32Float32{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt32Float32) snapshot() (keys []int32, values []float32) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) Put(key int32, value float32) (float32, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float32) Remove(key int32) (float32, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float32) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt32Float32) AddToValue(key int32, amount float32) float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float32) UpdateValue(key int32, initial float32, f func(float32) float32) float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float32) Get(key int32) (float32, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) GetOrDefault(key int32, defaultValue float32) float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) ContainsKey(key int32) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) ContainsValue(value float32) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) SumOfValues() float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) KeysToSlice() []int32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) ValuesToSlice() []float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) All() iter.Seq2[int32, float32] {
...
func (m *SynchronizedInt32Float32) Keys() iter.Seq[int32] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt32Float32) Values() iter.Seq[float32] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt32Float32) ForEach(f func(int32, float32)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt32Float32) ForEachKey(f func(int32)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt32Float32) ForEachValue(f func(float32)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt32Float32) AnySatisfy(predicate func(int32, float32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt32Float32) AllSatisfy(predicate func(int32, float32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Float32) NoneSatisfy(predicate func(int32, float32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Float32) Count(predicate func(int32, float32) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Float32) Detect(predicate func(int32, float32) bool) (int32, float32, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Float32) InjectInto(initial float32, f func(float32, int32, float32) float32) float32 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt32Float32) Select(predicate func(int32, float32) bool) *Int32Float32 {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt32Float32) Reject(predicate func(int32, float32) bool) *Int32Float32 {
	keys, values := m.snapshot()
	result := NewInt32Float32()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Float32) PutReturning(key int32, value float32) *SynchronizedInt32Float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float32) RemoveKeyReturning(key int32) *SynchronizedInt32Float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt32Float32) WithoutAllKeys(keys ...int32) *SynchronizedInt32Float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float32) ToImmutable() *ImmutableInt32Float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float32) Equals(other *SynchronizedInt32Float32) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
