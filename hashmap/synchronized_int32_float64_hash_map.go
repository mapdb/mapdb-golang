...
// SynchronizedInt32Float64 is a thread-safe wrapper around Int32Float64.
//
...
type SynchronizedInt32Float64 struct {
	delegate *Int32Float64
	mu       sync.RWMutex
}

// NewSynchronizedInt32Float64 wraps a mutable map with synchronization.
func NewSynchronizedInt32Float64() *SynchronizedInt32Float64 {
	return &SynchronizedInt32Float64{delegate: NewInt32Float64()}
}

// NewSynchronizedInt32Float64WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt32Float64WithCapacity(capacity int) *SynchronizedInt32Float64 {
	return &SynchronizedInt32Float64{delegate: NewInt32Float64WithCapacity(capacity)}
}

// NewSynchronizedInt32Float64From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt32Float64From(m *Int32Float64) *SynchronizedInt32Float64 {
	return &SynchronizedInt32Float64{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt32Float64) snapshot() (keys []int32, values []float64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) Put(key int32, value float64) (float64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float64) Remove(key int32) (float64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float64) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt32Float64) AddToValue(key int32, amount float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float64) UpdateValue(key int32, initial float64, f func(float64) float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float64) Get(key int32) (float64, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) GetOrDefault(key int32, defaultValue float64) float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) ContainsKey(key int32) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) ContainsValue(value float64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) SumOfValues() float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) KeysToSlice() []int32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) ValuesToSlice() []float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) All() iter.Seq2[int32, float64] {
...
func (m *SynchronizedInt32Float64) Keys() iter.Seq[int32] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt32Float64) Values() iter.Seq[float64] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt32Float64) ForEach(f func(int32, float64)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt32Float64) ForEachKey(f func(int32)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt32Float64) ForEachValue(f func(float64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt32Float64) AnySatisfy(predicate func(int32, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt32Float64) AllSatisfy(predicate func(int32, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Float64) NoneSatisfy(predicate func(int32, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Float64) Count(predicate func(int32, float64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Float64) Detect(predicate func(int32, float64) bool) (int32, float64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Float64) InjectInto(initial float64, f func(float64, int32, float64) float64) float64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt32Float64) Select(predicate func(int32, float64) bool) *Int32Float64 {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt32Float64) Reject(predicate func(int32, float64) bool) *Int32Float64 {
	keys, values := m.snapshot()
	result := NewInt32Float64()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Float64) PutReturning(key int32, value float64) *SynchronizedInt32Float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float64) RemoveKeyReturning(key int32) *SynchronizedInt32Float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt32Float64) WithoutAllKeys(keys ...int32) *SynchronizedInt32Float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float64) ToImmutable() *ImmutableInt32Float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64) Equals(other *SynchronizedInt32Float64) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
