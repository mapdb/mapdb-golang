...
// NewSynchronizedInt32Float64HashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt32Float64HashMapWithCapacity(capacity int) *SynchronizedInt32Float64HashMap {
	return &SynchronizedInt32Float64HashMap{delegate: NewInt32Float64HashMapWithCapacity(capacity)}
}
...
func (m *SynchronizedInt32Float64HashMap) snapshot() (keys []int32, values []float64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64HashMap) AddToValue(key int32, amount float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float64HashMap) UpdateValue(key int32, initial float64, f func(float64) float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float64HashMap) ContainsValue(value float64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64HashMap) SumOfValues() float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64HashMap) KeysToSlice() []int32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64HashMap) ValuesToSlice() []float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64HashMap) Keys() iter.Seq[int32] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt32Float64HashMap) Values() iter.Seq[float64] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt32Float64HashMap) ForEachKey(f func(int32)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt32Float64HashMap) ForEachValue(f func(float64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt32Float64HashMap) AnySatisfy(predicate func(int32, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt32Float64HashMap) AllSatisfy(predicate func(int32, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Float64HashMap) NoneSatisfy(predicate func(int32, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Float64HashMap) Count(predicate func(int32, float64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Float64HashMap) Detect(predicate func(int32, float64) bool) (int32, float64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Float64HashMap) InjectInto(initial float64, f func(float64, int32, float64) float64) float64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt32Float64HashMap) Select(predicate func(int32, float64) bool) *Int32Float64HashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt32Float64HashMap) Reject(predicate func(int32, float64) bool) *Int32Float64HashMap {
	keys, values := m.snapshot()
	result := NewInt32Float64HashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Float64HashMap) WithKeyValue(key int32, value float64) *SynchronizedInt32Float64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float64HashMap) WithoutKey(key int32) *SynchronizedInt32Float64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt32Float64HashMap) WithoutAllKeys(keys ...int32) *SynchronizedInt32Float64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Float64HashMap) ToImmutable() *ImmutableInt32Float64HashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Float64HashMap) Equals(other *SynchronizedInt32Float64HashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
