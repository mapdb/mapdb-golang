...
// NewSynchronizedInt32Int16HashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt32Int16HashMapWithCapacity(capacity int) *SynchronizedInt32Int16HashMap {
	return &SynchronizedInt32Int16HashMap{delegate: NewInt32Int16HashMapWithCapacity(capacity)}
}
...
func (m *SynchronizedInt32Int16HashMap) snapshot() (keys []int32, values []int16) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16HashMap) AddToValue(key int32, amount int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int16HashMap) UpdateValue(key int32, initial int16, f func(int16) int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int16HashMap) ContainsValue(value int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16HashMap) SumOfValues() int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16HashMap) KeysToSlice() []int32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16HashMap) ValuesToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16HashMap) Keys() iter.Seq[int32] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt32Int16HashMap) Values() iter.Seq[int16] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt32Int16HashMap) ForEachKey(f func(int32)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt32Int16HashMap) ForEachValue(f func(int16)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt32Int16HashMap) AnySatisfy(predicate func(int32, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt32Int16HashMap) AllSatisfy(predicate func(int32, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Int16HashMap) NoneSatisfy(predicate func(int32, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Int16HashMap) Count(predicate func(int32, int16) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Int16HashMap) Detect(predicate func(int32, int16) bool) (int32, int16, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Int16HashMap) InjectInto(initial int16, f func(int16, int32, int16) int16) int16 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt32Int16HashMap) Select(predicate func(int32, int16) bool) *Int32Int16HashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt32Int16HashMap) Reject(predicate func(int32, int16) bool) *Int32Int16HashMap {
	keys, values := m.snapshot()
	result := NewInt32Int16HashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Int16HashMap) WithKeyValue(key int32, value int16) *SynchronizedInt32Int16HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int16HashMap) WithoutKey(key int32) *SynchronizedInt32Int16HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt32Int16HashMap) WithoutAllKeys(keys ...int32) *SynchronizedInt32Int16HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int16HashMap) ToImmutable() *ImmutableInt32Int16HashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16HashMap) Equals(other *SynchronizedInt32Int16HashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
