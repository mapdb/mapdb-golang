...
// SynchronizedInt32Int16 is a thread-safe wrapper around Int32Int16.
//
...
type SynchronizedInt32Int16 struct {
	delegate *Int32Int16
	mu       sync.RWMutex
}

// NewSynchronizedInt32Int16 wraps a mutable map with synchronization.
func NewSynchronizedInt32Int16() *SynchronizedInt32Int16 {
	return &SynchronizedInt32Int16{delegate: NewInt32Int16()}
}

// NewSynchronizedInt32Int16WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt32Int16WithCapacity(capacity int) *SynchronizedInt32Int16 {
	return &SynchronizedInt32Int16{delegate: NewInt32Int16WithCapacity(capacity)}
}

// NewSynchronizedInt32Int16From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt32Int16From(m *Int32Int16) *SynchronizedInt32Int16 {
	return &SynchronizedInt32Int16{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt32Int16) snapshot() (keys []int32, values []int16) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) Put(key int32, value int16) (int16, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int16) Remove(key int32) (int16, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int16) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt32Int16) AddToValue(key int32, amount int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int16) UpdateValue(key int32, initial int16, f func(int16) int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int16) Get(key int32) (int16, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) GetOrDefault(key int32, defaultValue int16) int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) ContainsKey(key int32) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) ContainsValue(value int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) SumOfValues() int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) KeysToSlice() []int32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) ValuesToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) All() iter.Seq2[int32, int16] {
...
func (m *SynchronizedInt32Int16) Keys() iter.Seq[int32] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt32Int16) Values() iter.Seq[int16] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt32Int16) ForEach(f func(int32, int16)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt32Int16) ForEachKey(f func(int32)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt32Int16) ForEachValue(f func(int16)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt32Int16) AnySatisfy(predicate func(int32, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt32Int16) AllSatisfy(predicate func(int32, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Int16) NoneSatisfy(predicate func(int32, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Int16) Count(predicate func(int32, int16) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Int16) Detect(predicate func(int32, int16) bool) (int32, int16, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Int16) InjectInto(initial int16, f func(int16, int32, int16) int16) int16 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt32Int16) Select(predicate func(int32, int16) bool) *Int32Int16 {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt32Int16) Reject(predicate func(int32, int16) bool) *Int32Int16 {
	keys, values := m.snapshot()
	result := NewInt32Int16()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Int16) PutReturning(key int32, value int16) *SynchronizedInt32Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int16) RemoveKeyReturning(key int32) *SynchronizedInt32Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt32Int16) WithoutAllKeys(keys ...int32) *SynchronizedInt32Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int16) ToImmutable() *ImmutableInt32Int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int16) Equals(other *SynchronizedInt32Int16) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
