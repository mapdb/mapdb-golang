...
// NewSynchronizedInt32Int32HashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt32Int32HashMapWithCapacity(capacity int) *SynchronizedInt32Int32HashMap {
	return &SynchronizedInt32Int32HashMap{delegate: NewInt32Int32HashMapWithCapacity(capacity)}
}
...
func (m *SynchronizedInt32Int32HashMap) snapshot() (keys []int32, values []int32) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int32HashMap) AddToValue(key int32, amount int32) int32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int32HashMap) UpdateValue(key int32, initial int32, f func(int32) int32) int32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int32HashMap) ContainsValue(value int32) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int32HashMap) SumOfValues() int32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int32HashMap) KeysToSlice() []int32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int32HashMap) ValuesToSlice() []int32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int32HashMap) Keys() iter.Seq[int32] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt32Int32HashMap) Values() iter.Seq[int32] {
	_, values := m.snapshot()
	return func(yield func(int32) bool) {
...
func (m *SynchronizedInt32Int32HashMap) ForEachKey(f func(int32)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt32Int32HashMap) ForEachValue(f func(int32)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt32Int32HashMap) AnySatisfy(predicate func(int32, int32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt32Int32HashMap) AllSatisfy(predicate func(int32, int32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Int32HashMap) NoneSatisfy(predicate func(int32, int32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt32Int32HashMap) Count(predicate func(int32, int32) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Int32HashMap) Detect(predicate func(int32, int32) bool) (int32, int32, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Int32HashMap) InjectInto(initial int32, f func(int32, int32, int32) int32) int32 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt32Int32HashMap) Select(predicate func(int32, int32) bool) *Int32Int32HashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt32Int32HashMap) Reject(predicate func(int32, int32) bool) *Int32Int32HashMap {
	keys, values := m.snapshot()
	result := NewInt32Int32HashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt32Int32HashMap) WithKeyValue(key int32, value int32) *SynchronizedInt32Int32HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int32HashMap) WithoutKey(key int32) *SynchronizedInt32Int32HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt32Int32HashMap) WithoutAllKeys(keys ...int32) *SynchronizedInt32Int32HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt32Int32HashMap) ToImmutable() *ImmutableInt32Int32HashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt32Int32HashMap) Equals(other *SynchronizedInt32Int32HashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
