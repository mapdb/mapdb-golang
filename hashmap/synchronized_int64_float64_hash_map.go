...
// NewSynchronizedInt64Float64HashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt64Float64HashMapWithCapacity(capacity int) *SynchronizedInt64Float64HashMap {
	return &SynchronizedInt64Float64HashMap{delegate: NewInt64Float64HashMapWithCapacity(capacity)}
}
...
func (m *SynchronizedInt64Float64HashMap) snapshot() (keys []int64, values []float64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Float64HashMap) AddToValue(key int64, amount float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Float64HashMap) UpdateValue(key int64, initial float64, f func(float64) float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Float64HashMap) ContainsValue(value float64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Float64HashMap) SumOfValues() float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Float64HashMap) KeysToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Float64HashMap) ValuesToSlice() []float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Float64HashMap) Keys() iter.Seq[int64] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt64Float64HashMap) Values() iter.Seq[float64] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt64Float64HashMap) ForEachKey(f func(int64)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt64Float64HashMap) ForEachValue(f func(float64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt64Float64HashMap) AnySatisfy(predicate func(int64, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt64Float64HashMap) AllSatisfy(predicate func(int64, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt64Float64HashMap) NoneSatisfy(predicate func(int64, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt64Float64HashMap) Count(predicate func(int64, float64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Float64HashMap) Detect(predicate func(int64, float64) bool) (int64, float64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Float64HashMap) InjectInto(initial float64, f func(float64, int64, float64) float64) float64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt64Float64HashMap) Select(predicate func(int64, float64) bool) *Int64Float64HashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt64Float64HashMap) Reject(predicate func(int64, float64) bool) *Int64Float64HashMap {
	keys, values := m.snapshot()
	result := NewInt64Float64HashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Float64HashMap) WithKeyValue(key int64, value float64) *SynchronizedInt64Float64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Float64HashMap) WithoutKey(key int64) *SynchronizedInt64Float64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt64Float64HashMap) WithoutAllKeys(keys ...int64) *SynchronizedInt64Float64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Float64HashMap) ToImmutable() *ImmutableInt64Float64HashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Float64HashMap) Equals(other *SynchronizedInt64Float64HashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
