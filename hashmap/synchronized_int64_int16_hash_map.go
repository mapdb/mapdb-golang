...
// SynchronizedInt64Int16 is a thread-safe wrapper around Int64Int16.
//
...
type SynchronizedInt64Int16 struct {
	delegate *Int64Int16
	mu       sync.RWMutex
}

// NewSynchronizedInt64Int16 wraps a mutable map with synchronization.
func NewSynchronizedInt64Int16() *SynchronizedInt64Int16 {
	return &SynchronizedInt64Int16{delegate: NewInt64Int16()}
}

// NewSynchronizedInt64Int16WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt64Int16WithCapacity(capacity int) *SynchronizedInt64Int16 {
	return &SynchronizedInt64Int16{delegate: NewInt64Int16WithCapacity(capacity)}
}

// NewSynchronizedInt64Int16From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt64Int16From(m *Int64Int16) *SynchronizedInt64Int16 {
	return &SynchronizedInt64Int16{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt64Int16) snapshot() (keys []int64, values []int16) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) Put(key int64, value int16) (int16, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int16) Remove(key int64) (int16, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int16) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt64Int16) AddToValue(key int64, amount int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int16) UpdateValue(key int64, initial int16, f func(int16) int16) int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int16) Get(key int64) (int16, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) GetOrDefault(key int64, defaultValue int16) int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) ContainsKey(key int64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) ContainsValue(value int16) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) SumOfValues() int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) KeysToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) ValuesToSlice() []int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) All() iter.Seq2[int64, int16] {
...
func (m *SynchronizedInt64Int16) Keys() iter.Seq[int64] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt64Int16) Values() iter.Seq[int16] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt64Int16) ForEach(f func(int64, int16)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt64Int16) ForEachKey(f func(int64)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt64Int16) ForEachValue(f func(int16)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt64Int16) AnySatisfy(predicate func(int64, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt64Int16) AllSatisfy(predicate func(int64, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt64Int16) NoneSatisfy(predicate func(int64, int16) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt64Int16) Count(predicate func(int64, int16) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int16) Detect(predicate func(int64, int16) bool) (int64, int16, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int16) InjectInto(initial int16, f func(int16, int64, int16) int16) int16 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt64Int16) Select(predicate func(int64, int16) bool) *Int64Int16 {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt64Int16) Reject(predicate func(int64, int16) bool) *Int64Int16 {
	keys, values := m.snapshot()
	result := NewInt64Int16()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int16) PutReturning(key int64, value int16) *SynchronizedInt64Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int16) RemoveKeyReturning(key int64) *SynchronizedInt64Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt64Int16) WithoutAllKeys(keys ...int64) *SynchronizedInt64Int16 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int16) ToImmutable() *ImmutableInt64Int16 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int16) Equals(other *SynchronizedInt64Int16) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
