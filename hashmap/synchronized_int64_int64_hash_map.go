...
// SynchronizedInt64Int64 is a thread-safe wrapper around Int64Int64.
//
...
type SynchronizedInt64Int64 struct {
	delegate *Int64Int64
	mu       sync.RWMutex
}

// NewSynchronizedInt64Int64 wraps a mutable map with synchronization.
func NewSynchronizedInt64Int64() *SynchronizedInt64Int64 {
	return &SynchronizedInt64Int64{delegate: NewInt64Int64()}
}

// NewSynchronizedInt64Int64WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt64Int64WithCapacity(capacity int) *SynchronizedInt64Int64 {
	return &SynchronizedInt64Int64{delegate: NewInt64Int64WithCapacity(capacity)}
}

// NewSynchronizedInt64Int64From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt64Int64From(m *Int64Int64) *SynchronizedInt64Int64 {
	return &SynchronizedInt64Int64{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt64Int64) snapshot() (keys []int64, values []int64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) Put(key int64, value int64) (int64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int64) Remove(key int64) (int64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int64) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt64Int64) AddToValue(key int64, amount int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int64) UpdateValue(key int64, initial int64, f func(int64) int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int64) Get(key int64) (int64, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) GetOrDefault(key int64, defaultValue int64) int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) ContainsKey(key int64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) ContainsValue(value int64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) SumOfValues() int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) KeysToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) ValuesToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) All() iter.Seq2[int64, int64] {
...
func (m *SynchronizedInt64Int64) Keys() iter.Seq[int64] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt64Int64) Values() iter.Seq[int64] {
	_, values := m.snapshot()
	return func(yield func(int64) bool) {
...
func (m *SynchronizedInt64Int64) ForEach(f func(int64, int64)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt64Int64) ForEachKey(f func(int64)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt64Int64) ForEachValue(f func(int64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt64Int64) AnySatisfy(predicate func(int64, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt64Int64) AllSatisfy(predicate func(int64, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt64Int64) NoneSatisfy(predicate func(int64, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt64Int64) Count(predicate func(int64, int64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int64) Detect(predicate func(int64, int64) bool) (int64, int64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int64) InjectInto(initial int64, f func(int64, int64, int64) int64) int64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt64Int64) Select(predicate func(int64, int64) bool) *Int64Int64 {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt64Int64) Reject(predicate func(int64, int64) bool) *Int64Int64 {
	keys, values := m.snapshot()
	result := NewInt64Int64()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int64) PutReturning(key int64, value int64) *SynchronizedInt64Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int64) RemoveKeyReturning(key int64) *SynchronizedInt64Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt64Int64) WithoutAllKeys(keys ...int64) *SynchronizedInt64Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int64) ToImmutable() *ImmutableInt64Int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int64) Equals(other *SynchronizedInt64Int64) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
