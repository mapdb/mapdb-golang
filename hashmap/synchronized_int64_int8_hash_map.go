...
// NewSynchronizedInt64Int8HashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt64Int8HashMapWithCapacity(capacity int) *SynchronizedInt64Int8HashMap {
	return &SynchronizedInt64Int8HashMap{delegate: NewInt64Int8HashMapWithCapacity(capacity)}
}
...
func (m *SynchronizedInt64Int8HashMap) snapshot() (keys []int64, values []int8) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8HashMap) AddToValue(key int64, amount int8) int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int8HashMap) UpdateValue(key int64, initial int8, f func(int8) int8) int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int8HashMap) ContainsValue(value int8) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8HashMap) SumOfValues() int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8HashMap) KeysToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8HashMap) ValuesToSlice() []int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8HashMap) Keys() iter.Seq[int64] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt64Int8HashMap) Values() iter.Seq[int8] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt64Int8HashMap) ForEachKey(f func(int64)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt64Int8HashMap) ForEachValue(f func(int8)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt64Int8HashMap) AnySatisfy(predicate func(int64, int8) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt64Int8HashMap) AllSatisfy(predicate func(int64, int8) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt64Int8HashMap) NoneSatisfy(predicate func(int64, int8) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt64Int8HashMap) Count(predicate func(int64, int8) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int8HashMap) Detect(predicate func(int64, int8) bool) (int64, int8, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int8HashMap) InjectInto(initial int8, f func(int8, int64, int8) int8) int8 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt64Int8HashMap) Select(predicate func(int64, int8) bool) *Int64Int8HashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt64Int8HashMap) Reject(predicate func(int64, int8) bool) *Int64Int8HashMap {
	keys, values := m.snapshot()
	result := NewInt64Int8HashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int8HashMap) WithKeyValue(key int64, value int8) *SynchronizedInt64Int8HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int8HashMap) WithoutKey(key int64) *SynchronizedInt64Int8HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt64Int8HashMap) WithoutAllKeys(keys ...int64) *SynchronizedInt64Int8HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int8HashMap) ToImmutable() *ImmutableInt64Int8HashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8HashMap) Equals(other *SynchronizedInt64Int8HashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
