...
// SynchronizedInt64Int8 is a thread-safe wrapper around Int64Int8.
//
...
type SynchronizedInt64Int8 struct {
	delegate *Int64Int8
	mu       sync.RWMutex
}

// NewSynchronizedInt64Int8 wraps a mutable map with synchronization.
func NewSynchronizedInt64Int8() *SynchronizedInt64Int8 {
	return &SynchronizedInt64Int8{delegate: NewInt64Int8()}
}

// NewSynchronizedInt64Int8WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt64Int8WithCapacity(capacity int) *SynchronizedInt64Int8 {
	return &SynchronizedInt64Int8{delegate: NewInt64Int8WithCapacity(capacity)}
}

// NewSynchronizedInt64Int8From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt64Int8From(m *Int64Int8) *SynchronizedInt64Int8 {
	return &SynchronizedInt64Int8{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt64Int8) snapshot() (keys []int64, values []int8) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) Put(key int64, value int8) (int8, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int8) Remove(key int64) (int8, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int8) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt64Int8) AddToValue(key int64, amount int8) int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int8) UpdateValue(key int64, initial int8, f func(int8) int8) int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int8) Get(key int64) (int8, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) GetOrDefault(key int64, defaultValue int8) int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) ContainsKey(key int64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) ContainsValue(value int8) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) SumOfValues() int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) KeysToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) ValuesToSlice() []int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) All() iter.Seq2[int64, int8] {
...
func (m *SynchronizedInt64Int8) Keys() iter.Seq[int64] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt64Int8) Values() iter.Seq[int8] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt64Int8) ForEach(f func(int64, int8)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt64Int8) ForEachKey(f func(int64)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt64Int8) ForEachValue(f func(int8)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt64Int8) AnySatisfy(predicate func(int64, int8) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt64Int8) AllSatisfy(predicate func(int64, int8) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt64Int8) NoneSatisfy(predicate func(int64, int8) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt64Int8) Count(predicate func(int64, int8) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int8) Detect(predicate func(int64, int8) bool) (int64, int8, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int8) InjectInto(initial int8, f func(int8, int64, int8) int8) int8 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt64Int8) Select(predicate func(int64, int8) bool) *Int64Int8 {
	keys, values := m.snapshot()
	result := NewInt64Int8()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int8) Reject(predicate func(int64, int8) bool) *Int64Int8 {
	keys, values := m.snapshot()
	result := NewInt64Int8()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt64Int8) PutReturning(key int64, value int8) *SynchronizedInt64Int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int8) RemoveKeyReturning(key int64) *SynchronizedInt64Int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt64Int8) WithoutAllKeys(keys ...int64) *SynchronizedInt64Int8 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt64Int8) ToImmutable() *ImmutableInt64Int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt64Int8) Equals(other *SynchronizedInt64Int8) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
