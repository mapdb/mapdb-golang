...
// NewSynchronizedInt8Float32HashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt8Float32HashMapWithCapacity(capacity int) *SynchronizedInt8Float32HashMap {
	return &SynchronizedInt8Float32HashMap{delegate: NewInt8Float32HashMapWithCapacity(capacity)}
}
...
func (m *SynchronizedInt8Float32HashMap) snapshot() (keys []int8, values []float32) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float32HashMap) AddToValue(key int8, amount float32) float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float32HashMap) UpdateValue(key int8, initial float32, f func(float32) float32) float32 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float32HashMap) ContainsValue(value float32) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float32HashMap) SumOfValues() float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float32HashMap) KeysToSlice() []int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float32HashMap) ValuesToSlice() []float32 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float32HashMap) Keys() iter.Seq[int8] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt8Float32HashMap) Values() iter.Seq[float32] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt8Float32HashMap) ForEachKey(f func(int8)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt8Float32HashMap) ForEachValue(f func(float32)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt8Float32HashMap) AnySatisfy(predicate func(int8, float32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt8Float32HashMap) AllSatisfy(predicate func(int8, float32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt8Float32HashMap) NoneSatisfy(predicate func(int8, float32) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt8Float32HashMap) Count(predicate func(int8, float32) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Float32HashMap) Detect(predicate func(int8, float32) bool) (int8, float32, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Float32HashMap) InjectInto(initial float32, f func(float32, int8, float32) float32) float32 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt8Float32HashMap) Select(predicate func(int8, float32) bool) *Int8Float32HashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt8Float32HashMap) Reject(predicate func(int8, float32) bool) *Int8Float32HashMap {
	keys, values := m.snapshot()
	result := NewInt8Float32HashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Float32HashMap) WithKeyValue(key int8, value float32) *SynchronizedInt8Float32HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float32HashMap) WithoutKey(key int8) *SynchronizedInt8Float32HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt8Float32HashMap) WithoutAllKeys(keys ...int8) *SynchronizedInt8Float32HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float32HashMap) ToImmutable() *ImmutableInt8Float32HashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float32HashMap) Equals(other *SynchronizedInt8Float32HashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
