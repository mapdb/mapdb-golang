...
// SynchronizedInt8Float64 is a thread-safe wrapper around Int8Float64.
//
...
type SynchronizedInt8Float64 struct {
	delegate *Int8Float64
	mu       sync.RWMutex
}

// NewSynchronizedInt8Float64 wraps a mutable map with synchronization.
func NewSynchronizedInt8Float64() *SynchronizedInt8Float64 {
	return &SynchronizedInt8Float64{delegate: NewInt8Float64()}
}

// NewSynchronizedInt8Float64WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt8Float64WithCapacity(capacity int) *SynchronizedInt8Float64 {
	return &SynchronizedInt8Float64{delegate: NewInt8Float64WithCapacity(capacity)}
}

// NewSynchronizedInt8Float64From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt8Float64From(m *Int8Float64) *SynchronizedInt8Float64 {
	return &SynchronizedInt8Float64{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt8Float64) snapshot() (keys []int8, values []float64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) Put(key int8, value float64) (float64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64) Remove(key int8) (float64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt8Float64) AddToValue(key int8, amount float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64) UpdateValue(key int8, initial float64, f func(float64) float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64) Get(key int8) (float64, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) GetOrDefault(key int8, defaultValue float64) float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) ContainsKey(key int8) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) ContainsValue(value float64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) SumOfValues() float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) KeysToSlice() []int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) ValuesToSlice() []float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) All() iter.Seq2[int8, float64] {
...
func (m *SynchronizedInt8Float64) Keys() iter.Seq[int8] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt8Float64) Values() iter.Seq[float64] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt8Float64) ForEach(f func(int8, float64)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt8Float64) ForEachKey(f func(int8)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt8Float64) ForEachValue(f func(float64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt8Float64) AnySatisfy(predicate func(int8, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt8Float64) AllSatisfy(predicate func(int8, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt8Float64) NoneSatisfy(predicate func(int8, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt8Float64) Count(predicate func(int8, float64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Float64) Detect(predicate func(int8, float64) bool) (int8, float64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Float64) InjectInto(initial float64, f func(float64, int8, float64) float64) float64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt8Float64) Select(predicate func(int8, float64) bool) *Int8Float64 {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt8Float64) Reject(predicate func(int8, float64) bool) *Int8Float64 {
	keys, values := m.snapshot()
	result := NewInt8Float64()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Float64) PutReturning(key int8, value float64) *SynchronizedInt8Float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64) RemoveKeyReturning(key int8) *SynchronizedInt8Float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt8Float64) WithoutAllKeys(keys ...int8) *SynchronizedInt8Float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64) ToImmutable() *ImmutableInt8Float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64) Equals(other *SynchronizedInt8Float64) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
