...
// SynchronizedInt8Float64HashMap is a thread-safe wrapper around Int8Float64HashMap.
//
...
type SynchronizedInt8Float64HashMap struct {
	delegate *Int8Float64HashMap
	mu       sync.RWMutex
}

// NewSynchronizedInt8Float64HashMap wraps a mutable map with synchronization.
func NewSynchronizedInt8Float64HashMap() *SynchronizedInt8Float64HashMap {
	return &SynchronizedInt8Float64HashMap{delegate: NewInt8Float64HashMap()}
}

// NewSynchronizedInt8Float64HashMapWithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt8Float64HashMapWithCapacity(capacity int) *SynchronizedInt8Float64HashMap {
	return &SynchronizedInt8Float64HashMap{delegate: NewInt8Float64HashMapWithCapacity(capacity)}
}

// NewSynchronizedInt8Float64HashMapFrom wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt8Float64HashMapFrom(m *Int8Float64HashMap) *SynchronizedInt8Float64HashMap {
	return &SynchronizedInt8Float64HashMap{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt8Float64HashMap) snapshot() (keys []int8, values []float64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) Put(key int8, value float64) (float64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64HashMap) Remove(key int8) (float64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64HashMap) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt8Float64HashMap) AddToValue(key int8, amount float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64HashMap) UpdateValue(key int8, initial float64, f func(float64) float64) float64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64HashMap) Get(key int8) (float64, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) GetOrDefault(key int8, defaultValue float64) float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) ContainsKey(key int8) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) ContainsValue(value float64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) Size() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) IsEmpty() bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) SumOfValues() float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) KeysToSlice() []int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) ValuesToSlice() []float64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) All() iter.Seq2[int8, float64] {
...
func (m *SynchronizedInt8Float64HashMap) Keys() iter.Seq[int8] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt8Float64HashMap) Values() iter.Seq[float64] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt8Float64HashMap) ForEach(f func(int8, float64)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt8Float64HashMap) ForEachKey(f func(int8)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt8Float64HashMap) ForEachValue(f func(float64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt8Float64HashMap) AnySatisfy(predicate func(int8, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt8Float64HashMap) AllSatisfy(predicate func(int8, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt8Float64HashMap) NoneSatisfy(predicate func(int8, float64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt8Float64HashMap) Count(predicate func(int8, float64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Float64HashMap) Detect(predicate func(int8, float64) bool) (int8, float64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Float64HashMap) InjectInto(initial float64, f func(float64, int8, float64) float64) float64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt8Float64HashMap) Select(predicate func(int8, float64) bool) *Int8Float64HashMap {
	keys, values := m.snapshot()
...
func (m *SynchronizedInt8Float64HashMap) Reject(predicate func(int8, float64) bool) *Int8Float64HashMap {
	keys, values := m.snapshot()
	result := NewInt8Float64HashMap()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Float64HashMap) WithKeyValue(key int8, value float64) *SynchronizedInt8Float64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64HashMap) WithoutKey(key int8) *SynchronizedInt8Float64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt8Float64HashMap) WithoutAllKeys(keys ...int8) *SynchronizedInt8Float64HashMap {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Float64HashMap) ToImmutable() *ImmutableInt8Float64HashMap {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Float64HashMap) Equals(other *SynchronizedInt8Float64HashMap) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
