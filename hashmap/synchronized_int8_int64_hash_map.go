...
// SynchronizedInt8Int64 is a thread-safe wrapper around Int8Int64.
//
...
type SynchronizedInt8Int64 struct {
	delegate *Int8Int64
	mu       sync.RWMutex
}

// NewSynchronizedInt8Int64 wraps a mutable map with synchronization.
func NewSynchronizedInt8Int64() *SynchronizedInt8Int64 {
	return &SynchronizedInt8Int64{delegate: NewInt8Int64()}
}

// NewSynchronizedInt8Int64WithCapacity wraps a new map with the given initial capacity.
func NewSynchronizedInt8Int64WithCapacity(capacity int) *SynchronizedInt8Int64 {
	return &SynchronizedInt8Int64{delegate: NewInt8Int64WithCapacity(capacity)}
}

// NewSynchronizedInt8Int64From wraps an existing map with synchronization.
// The wrapper takes ownership — do not mutate the delegate directly.
func NewSynchronizedInt8Int64From(m *Int8Int64) *SynchronizedInt8Int64 {
	return &SynchronizedInt8Int64{delegate: m}
}

// snapshot returns (keys, values) slices in matching order, taken under RLock.
func (m *SynchronizedInt8Int64) snapshot() (keys []int8, values []int64) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) Put(key int8, value int64) (int64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Int64) Remove(key int8) (int64, bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Int64) Clear() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.delegate.Clear()
}
...
func (m *SynchronizedInt8Int64) AddToValue(key int8, amount int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Int64) UpdateValue(key int8, initial int64, f func(int64) int64) int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Int64) Get(key int8) (int64, bool) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) GetOrDefault(key int8, defaultValue int64) int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) ContainsKey(key int8) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) ContainsValue(value int64) bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) Len() int {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) SumOfValues() int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) KeysToSlice() []int8 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) ValuesToSlice() []int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) String() string {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) All() iter.Seq2[int8, int64] {
...
func (m *SynchronizedInt8Int64) Keys() iter.Seq[int8] {
	keys, _ := m.snapshot()
...
func (m *SynchronizedInt8Int64) Values() iter.Seq[int64] {
	_, values := m.snapshot()
...
func (m *SynchronizedInt8Int64) ForEach(f func(int8, int64)) {
	keys, values := m.snapshot()
	for i := range keys {
		f(keys[i], values[i])
	}
...
func (m *SynchronizedInt8Int64) ForEachKey(f func(int8)) {
	keys, _ := m.snapshot()
	for _, k := range keys {
		f(k)
	}
...
func (m *SynchronizedInt8Int64) ForEachValue(f func(int64)) {
	_, values := m.snapshot()
	for _, v := range values {
		f(v)
	}
...
func (m *SynchronizedInt8Int64) AnySatisfy(predicate func(int8, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
...
func (m *SynchronizedInt8Int64) AllSatisfy(predicate func(int8, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt8Int64) NoneSatisfy(predicate func(int8, int64) bool) bool {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
			return false
...
func (m *SynchronizedInt8Int64) Count(predicate func(int8, int64) bool) int {
	keys, values := m.snapshot()
	n := 0
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Int64) Detect(predicate func(int8, int64) bool) (int8, int64, bool) {
	keys, values := m.snapshot()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Int64) InjectInto(initial int64, f func(int64, int8, int64) int64) int64 {
	keys, values := m.snapshot()
	acc := initial
	for i := range keys {
...
func (m *SynchronizedInt8Int64) Select(predicate func(int8, int64) bool) *Int8Int64 {
	keys, values := m.snapshot()
	result := NewInt8Int64()
	for i := range keys {
		if predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Int64) Reject(predicate func(int8, int64) bool) *Int8Int64 {
	keys, values := m.snapshot()
	result := NewInt8Int64()
	for i := range keys {
		if !predicate(keys[i], values[i]) {
...
func (m *SynchronizedInt8Int64) PutReturning(key int8, value int64) *SynchronizedInt8Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Int64) RemoveKeyReturning(key int8) *SynchronizedInt8Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
// accepts a slice.
func (m *SynchronizedInt8Int64) WithoutAllKeys(keys ...int8) *SynchronizedInt8Int64 {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *SynchronizedInt8Int64) ToImmutable() *ImmutableInt8Int64 {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *SynchronizedInt8Int64) Equals(other *SynchronizedInt8Int64) bool {
	if m == other {
		m.mu.RLock()
		defer m.mu.RUnlock()
