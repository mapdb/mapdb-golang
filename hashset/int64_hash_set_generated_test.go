...
func TestInt64_Generated_AddContains(t *testing.T) {
	s := NewInt64()
	s.Add(1)
	s.Add(2)
	s.Add(3)
...
func TestInt64_Generated_AddDuplicate(t *testing.T) {
	s := NewInt64()
	added1 := s.Add(1)
	added2 := s.Add(1)
	if !added1 || added2 {
...
func TestInt64_Generated_Union(t *testing.T) {
	a := Int64Of(1, 2, 3)
	b := Int64Of(3, 4, 5)
	u := a.Union(b)
	if u.Len() != 5 {
...
func TestInt64_Generated_Intersect(t *testing.T) {
	a := Int64Of(1, 2, 3)
	b := Int64Of(2, 3, 4)
	i := a.Intersect(b)
	if i.Len() != 2 {
...
func TestInt64_Generated_Difference(t *testing.T) {
	a := Int64Of(1, 2, 3)
	b := Int64Of(2, 3, 4)
	d := a.Difference(b)
...
func TestInt64_Generated_SymmetricDifference(t *testing.T) {
	a := Int64Of(1, 2, 3)
	b := Int64Of(2, 3, 4)
