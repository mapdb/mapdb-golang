...
func TestCharFloat32ListMultimap_Generated_PutGet(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
...
func TestCharFloat32ListMultimap_Generated_GetAll(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	vals := m.GetAll(1)
...
func TestCharFloat32ListMultimap_Generated_GetDoesNotAlias(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	vals := m.Get(1)
...
func TestCharFloat32ListMultimap_Generated_RemoveAll(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
...
func TestCharFloat32ListMultimap_Generated_ContainsKey(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	if !m.ContainsKey(1) {
...
func TestCharFloat32ListMultimap_Generated_ContainsKeyValue(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
...
func TestCharFloat32ListMultimap_Generated_Clear(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Clear()
...
func TestCharFloat32ListMultimap_Generated_ForEach(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
	count := 0
	m.ForEach(func(_ uint16, _ float32) {
		count++
	})
	if count != 3 {
...
func TestCharFloat32ListMultimap_Generated_ForEachKeyValues(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
	keyCount := 0
	m.ForEachKeyValues(func(_ uint16, vals []float32) {
		keyCount++
		if len(vals) == 0 {
...
func TestCharFloat32ListMultimap_Generated_SelectReject(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
	sel := m.Select(func(_ uint16, v float32) bool { return v == 1.0 })
	if sel.Size() != 1 {
		t.Errorf("Select size = %d, want 1", sel.Size())
	}
	rej := m.Reject(func(_ uint16, v float32) bool { return v == 1.0 })
	if rej.Size() != 2 {
		t.Errorf("Reject size = %d, want 2", rej.Size())
	}
}

func TestCharFloat32ListMultimap_Generated_KeysValues(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
...
func TestCharFloat32ListMultimap_Generated_Equals(t *testing.T) {
	m1 := NewCharFloat32ListMultimap()
	m1.Put(1, 1.0)
	m1.Put(1, 2.0)
	m2 := NewCharFloat32ListMultimap()
	m2.Put(1, 1.0)
	m2.Put(1, 2.0)
	if !m1.Equals(m2) {
...
func TestCharFloat32ListMultimap_Generated_String(t *testing.T) {
	m := NewCharFloat32ListMultimap()
	m.Put(1, 1.0)
	s := m.String()
	if len(s) == 0 {
...
func TestCharFloat32ListMultimap_Generated_FluentAPI(t *testing.T) {
	m := NewCharFloat32ListMultimap()
