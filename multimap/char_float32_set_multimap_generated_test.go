...
func TestCharFloat32SetMultimap_Generated_PutGet(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
...
func TestCharFloat32SetMultimap_Generated_GetAll(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	vals := m.GetAll(1)
...
func TestCharFloat32SetMultimap_Generated_RemoveAll(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
...
func TestCharFloat32SetMultimap_Generated_ContainsKey(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	if !m.ContainsKey(1) {
...
func TestCharFloat32SetMultimap_Generated_ContainsKeyValue(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
...
func TestCharFloat32SetMultimap_Generated_Clear(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Clear()
...
func TestCharFloat32SetMultimap_Generated_ForEach(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
...
func TestCharFloat32SetMultimap_Generated_ForEachKeyValues(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
...
func TestCharFloat32SetMultimap_Generated_SelectReject(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
...
func TestCharFloat32SetMultimap_Generated_KeysValues(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	m.Put(1, 2.0)
	m.Put(2, 3.0)
...
func TestCharFloat32SetMultimap_Generated_Equals(t *testing.T) {
	m1 := NewCharFloat32SetMultimap()
	m1.Put(1, 1.0)
	m1.Put(1, 2.0)
	m2 := NewCharFloat32SetMultimap()
	m2.Put(1, 1.0)
	m2.Put(1, 2.0)
	if !m1.Equals(m2) {
...
func TestCharFloat32SetMultimap_Generated_String(t *testing.T) {
	m := NewCharFloat32SetMultimap()
	m.Put(1, 1.0)
	s := m.String()
	if len(s) == 0 {
...
func TestCharFloat32SetMultimap_Generated_FluentAPI(t *testing.T) {
	m := NewCharFloat32SetMultimap()
