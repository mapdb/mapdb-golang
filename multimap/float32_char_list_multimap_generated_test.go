...
func TestFloat32CharList_Generated_PutGet(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	m.Put(1.0, 2)
	m.Put(2.0, 3)
...
func TestFloat32CharList_Generated_GetAll(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	m.Put(1.0, 2)
	vals := m.GetAll(1.0)
...
func TestFloat32CharList_Generated_GetDoesNotAlias(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	m.Put(1.0, 2)
	vals := m.Get(1.0)
...
func TestFloat32CharList_Generated_RemoveAll(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	m.Put(1.0, 2)
	m.Put(2.0, 3)
...
func TestFloat32CharList_Generated_ContainsKey(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	if !m.ContainsKey(1.0) {
...
func TestFloat32CharList_Generated_ContainsKeyValue(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	m.Put(1.0, 2)
...
func TestFloat32CharList_Generated_Clear(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Clear()
...
func TestFloat32CharList_Generated_ForEach(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	m.Put(1.0, 2)
	m.Put(2.0, 3)
...
func TestFloat32CharList_Generated_ForEachKeyValues(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	m.Put(1.0, 2)
	m.Put(2.0, 3)
...
func TestFloat32CharList_Generated_SelectReject(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	m.Put(1.0, 2)
	m.Put(2.0, 3)
...
func TestFloat32CharList_Generated_KeysValues(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	m.Put(1.0, 2)
	m.Put(2.0, 3)
...
func TestFloat32CharList_Generated_Equals(t *testing.T) {
	m1 := NewFloat32CharList()
	m1.Put(1.0, 1)
	m1.Put(1.0, 2)
	m2 := NewFloat32CharList()
	m2.Put(1.0, 1)
	m2.Put(1.0, 2)
	if !m1.Equals(m2) {
...
func TestFloat32CharList_Generated_String(t *testing.T) {
	m := NewFloat32CharList()
	m.Put(1.0, 1)
	s := m.String()
	if len(s) == 0 {
...
func TestFloat32CharList_Generated_FluentAPI(t *testing.T) {
	m := NewFloat32CharList()
