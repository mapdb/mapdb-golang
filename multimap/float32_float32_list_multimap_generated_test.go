...
func TestFloat32Float32ListMultimap_Generated_PutGet(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat32Float32ListMultimap_Generated_GetAll(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	vals := m.GetAll(1.0)
...
func TestFloat32Float32ListMultimap_Generated_GetDoesNotAlias(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	vals := m.Get(1.0)
...
func TestFloat32Float32ListMultimap_Generated_RemoveAll(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat32Float32ListMultimap_Generated_ContainsKey(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	if !m.ContainsKey(1.0) {
...
func TestFloat32Float32ListMultimap_Generated_ContainsKeyValue(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
...
func TestFloat32Float32ListMultimap_Generated_Clear(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	m.Clear()
...
func TestFloat32Float32ListMultimap_Generated_ForEach(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat32Float32ListMultimap_Generated_ForEachKeyValues(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat32Float32ListMultimap_Generated_SelectReject(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat32Float32ListMultimap_Generated_KeysValues(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat32Float32ListMultimap_Generated_Equals(t *testing.T) {
	m1 := NewFloat32Float32ListMultimap()
	m1.Put(1.0, 1.0)
	m1.Put(1.0, 2.0)
	m2 := NewFloat32Float32ListMultimap()
	m2.Put(1.0, 1.0)
	m2.Put(1.0, 2.0)
	if !m1.Equals(m2) {
...
func TestFloat32Float32ListMultimap_Generated_String(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
	m.Put(1.0, 1.0)
	s := m.String()
	if len(s) == 0 {
...
func TestFloat32Float32ListMultimap_Generated_FluentAPI(t *testing.T) {
	m := NewFloat32Float32ListMultimap()
