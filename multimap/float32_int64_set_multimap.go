...
// Float32Int64SetBulkLoad builds a Float32Int64Set from keys/values in a single
...
func Float32Int64SetBulkLoad(keys []float32, values []int64) *Float32Int64Set {
	if len(keys) != len(values) {
		panic("mapdb: Float32Int64SetBulkLoad: len(keys) != len(values)")
	}
	m := &Float32Int64Set{
...
// NewFloat32Int64SetFromSortedKeyValues builds a Float32Int64Set from input sorted
...
// not sorted within each key, use Float32Int64SetBulkLoad instead.
func NewFloat32Int64SetFromSortedKeyValues(keys []float32, values []int64) (*Float32Int64Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewFloat32Int64SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Float32Int64Set{
		data: make(map[uint32][]int64),
		keys: make(map[uint32]float32),
...
func (m *Float32Int64Set) All() iter.Seq2[float32, int64] {
