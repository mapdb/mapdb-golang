...
// Float32Int8SetMultimap is a set multimap from float32 keys to int8 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Float32Int8SetMultimap struct {
	data map[float32][]int8
	size int
}

// NewFloat32Int8SetMultimap creates a new empty Float32Int8SetMultimap.
func NewFloat32Int8SetMultimap() *Float32Int8SetMultimap {
	return &Float32Int8SetMultimap{
...
func (m *Float32Int8SetMultimap) Put(key float32, value int8) {
...
func (m *Float32Int8SetMultimap) Get(key float32) []int8 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Float32Int8SetMultimap) GetAll(key float32) []int8 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Float32Int8SetMultimap) RemoveAll(key float32) []int8 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Float32Int8SetMultimap) ContainsKey(key float32) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Float32Int8SetMultimap) ContainsKeyValue(key float32, value int8) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Float32Int8SetMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Float32Int8SetMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Float32Int8SetMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Float32Int8SetMultimap) Clear() {
	m.data = make(map[float32][]int8)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Float32Int8SetMultimap) ForEach(f func(float32, int8)) {
...
func (m *Float32Int8SetMultimap) ForEachKeyValues(f func(float32, []int8)) {
	for key, vals := range m.data {
...
func (m *Float32Int8SetMultimap) Keys() []float32 {
...
func (m *Float32Int8SetMultimap) Values() []int8 {
...
func (m *Float32Int8SetMultimap) Select(predicate func(float32, int8) bool) *Float32Int8SetMultimap {
	result := NewFloat32Int8SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Float32Int8SetMultimap) Reject(predicate func(float32, int8) bool) *Float32Int8SetMultimap {
	result := NewFloat32Int8SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Float32Int8SetMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Float32Int8SetMultimap) Equals(other *Float32Int8SetMultimap) bool {
...
func (m *Float32Int8SetMultimap) KeysToSlice() []float32 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Float32Int8SetMultimap) ValuesToSlice() []int8 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Float32Int8SetMultimap) WithKeyValue(key float32, value int8) *Float32Int8SetMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Float32Int8SetMultimap) WithoutKey(key float32) *Float32Int8SetMultimap {
	m.RemoveAll(key)
	return m
}
