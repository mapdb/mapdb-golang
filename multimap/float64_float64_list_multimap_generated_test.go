...
func TestFloat64Float64List_Generated_PutGet(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat64Float64List_Generated_GetAll(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	vals := m.GetAll(1.0)
...
func TestFloat64Float64List_Generated_GetDoesNotAlias(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	vals := m.Get(1.0)
...
func TestFloat64Float64List_Generated_RemoveAll(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat64Float64List_Generated_ContainsKey(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	if !m.ContainsKey(1.0) {
...
func TestFloat64Float64List_Generated_ContainsKeyValue(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
...
func TestFloat64Float64List_Generated_Clear(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	m.Clear()
...
func TestFloat64Float64List_Generated_ForEach(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat64Float64List_Generated_ForEachKeyValues(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat64Float64List_Generated_SelectReject(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat64Float64List_Generated_KeysValues(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	m.Put(1.0, 2.0)
	m.Put(2.0, 3.0)
...
func TestFloat64Float64List_Generated_Equals(t *testing.T) {
	m1 := NewFloat64Float64List()
	m1.Put(1.0, 1.0)
	m1.Put(1.0, 2.0)
	m2 := NewFloat64Float64List()
	m2.Put(1.0, 1.0)
	m2.Put(1.0, 2.0)
	if !m1.Equals(m2) {
...
func TestFloat64Float64List_Generated_String(t *testing.T) {
	m := NewFloat64Float64List()
	m.Put(1.0, 1.0)
	s := m.String()
	if len(s) == 0 {
...
func TestFloat64Float64List_Generated_FluentAPI(t *testing.T) {
	m := NewFloat64Float64List()
