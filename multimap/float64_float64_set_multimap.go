...
// Float64Float64SetMultimap is a set multimap from float64 keys to float64 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Float64Float64SetMultimap struct {
	data map[float64][]float64
	size int
}

// NewFloat64Float64SetMultimap creates a new empty Float64Float64SetMultimap.
func NewFloat64Float64SetMultimap() *Float64Float64SetMultimap {
	return &Float64Float64SetMultimap{
...
func (m *Float64Float64SetMultimap) Put(key float64, value float64) {
...
func (m *Float64Float64SetMultimap) Get(key float64) []float64 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Float64Float64SetMultimap) GetAll(key float64) []float64 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Float64Float64SetMultimap) RemoveAll(key float64) []float64 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Float64Float64SetMultimap) ContainsKey(key float64) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Float64Float64SetMultimap) ContainsKeyValue(key float64, value float64) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Float64Float64SetMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Float64Float64SetMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Float64Float64SetMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Float64Float64SetMultimap) Clear() {
	m.data = make(map[float64][]float64)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Float64Float64SetMultimap) ForEach(f func(float64, float64)) {
...
func (m *Float64Float64SetMultimap) ForEachKeyValues(f func(float64, []float64)) {
	for key, vals := range m.data {
...
func (m *Float64Float64SetMultimap) Keys() []float64 {
...
func (m *Float64Float64SetMultimap) Values() []float64 {
...
func (m *Float64Float64SetMultimap) Select(predicate func(float64, float64) bool) *Float64Float64SetMultimap {
	result := NewFloat64Float64SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Float64Float64SetMultimap) Reject(predicate func(float64, float64) bool) *Float64Float64SetMultimap {
	result := NewFloat64Float64SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Float64Float64SetMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Float64Float64SetMultimap) Equals(other *Float64Float64SetMultimap) bool {
...
func (m *Float64Float64SetMultimap) KeysToSlice() []float64 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Float64Float64SetMultimap) ValuesToSlice() []float64 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Float64Float64SetMultimap) WithKeyValue(key float64, value float64) *Float64Float64SetMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Float64Float64SetMultimap) WithoutKey(key float64) *Float64Float64SetMultimap {
	m.RemoveAll(key)
	return m
}
