...
// Float64Int32List is a list multimap from float64 keys to int32 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Float64Int32List struct {
	data map[uint64][]int32
	keys map[uint64]float64
	size int
}

// NewFloat64Int32List creates a new empty Float64Int32List.
func NewFloat64Int32List() *Float64Int32List {
	return &Float64Int32List{
...
// Float64Int32ListBulkLoad builds a Float64Int32List from keys/values in a single
...
// every value).
func Float64Int32ListBulkLoad(keys []float64, values []int32) *Float64Int32List {
	if len(keys) != len(values) {
		panic("mapdb: Float64Int32ListBulkLoad: len(keys) != len(values)")
	}
	m := &Float64Int32List{
		data: make(map[uint64][]int32, len(keys)),
...
// NewFloat64Int32ListFromSortedKeys builds a Float64Int32List from input grouped
...
func NewFloat64Int32ListFromSortedKeys(keys []float64, values []int32) (*Float64Int32List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewFloat64Int32ListFromSortedKeys: len(keys) != len(values)")
	}
	m := &Float64Int32List{
		data: make(map[uint64][]int32),
		keys: make(map[uint64]float64),
...
// NewFloat64Int32ListFromSortedKeyValues builds a Float64Int32List from input
...
// not sorted within each key, use Float64Int32ListBulkLoad instead.
func NewFloat64Int32ListFromSortedKeyValues(keys []float64, values []int32) (*Float64Int32List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewFloat64Int32ListFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Float64Int32List{
		data: make(map[uint64][]int32),
		keys: make(map[uint64]float64),
...
func (m *Float64Int32List) Put(key float64, value int32) {
	if m.data == nil {
...
func (m *Float64Int32List) Get(key float64) []int32 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Float64Int32List) GetAll(key float64) []int32 {
...
func (m *Float64Int32List) RemoveAll(key float64) []int32 {
	kb := math.Float64bits(key)
	vals, ok := m.data[kb]
	if !ok {
		return nil
...
func (m *Float64Int32List) ContainsKey(key float64) bool {
	_, ok := m.data[math.Float64bits(key)]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Float64Int32List) ContainsKeyValue(key float64, value int32) bool {
...
func (m *Float64Int32List) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Float64Int32List) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Float64Int32List) Clear() {
	m.data = make(map[uint64][]int32)
	m.keys = make(map[uint64]float64)
	m.size = 0
}
...
func (m *Float64Int32List) ForEach(f func(float64, int32)) {
...
func (m *Float64Int32List) All() iter.Seq2[float64, int32] {
...
func (m *Float64Int32List) ForEachKeyValues(f func(float64, []int32)) {
	for kb, vals := range m.data {
		key := m.keys[kb]
...
func (m *Float64Int32List) Keys() []float64 {
...
func (m *Float64Int32List) Values() []int32 {
...
func (m *Float64Int32List) Select(predicate func(float64, int32) bool) *Float64Int32List {
	result := NewFloat64Int32List()
	for kb, vals := range m.data {
		key := m.keys[kb]
		for _, val := range vals {
...
func (m *Float64Int32List) Reject(predicate func(float64, int32) bool) *Float64Int32List {
	result := NewFloat64Int32List()
	for kb, vals := range m.data {
		key := m.keys[kb]
		for _, val := range vals {
...
func (m *Float64Int32List) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Float64Int32List) Equals(other *Float64Int32List) bool {
...
func (m *Float64Int32List) KeysToSlice() []float64 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Float64Int32List) ValuesToSlice() []int32 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Float64Int32List) PutReturning(key float64, value int32) *Float64Int32List {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Float64Int32List) RemoveKeyReturning(key float64) *Float64Int32List {
	m.RemoveAll(key)
	return m
}
