...
// Int16CharSet is a set multimap from int16 keys to uint16 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int16CharSet struct {
	data map[int16][]uint16
	size int
}

// NewInt16CharSet creates a new empty Int16CharSet.
func NewInt16CharSet() *Int16CharSet {
	return &Int16CharSet{
...
// Int16CharSetBulkLoad builds a Int16CharSet from keys/values in a single
...
func Int16CharSetBulkLoad(keys []int16, values []uint16) *Int16CharSet {
	if len(keys) != len(values) {
		panic("mapdb: Int16CharSetBulkLoad: len(keys) != len(values)")
	}
	m := &Int16CharSet{
...
// NewInt16CharSetFromSortedKeyValues builds a Int16CharSet from input sorted
...
// not sorted within each key, use Int16CharSetBulkLoad instead.
func NewInt16CharSetFromSortedKeyValues(keys []int16, values []uint16) (*Int16CharSet, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt16CharSetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int16CharSet{
		data: make(map[int16][]uint16),
	}
...
func (m *Int16CharSet) Put(key int16, value uint16) {
	if m.data == nil {
...
func (m *Int16CharSet) Get(key int16) []uint16 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int16CharSet) GetAll(key int16) []uint16 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int16CharSet) RemoveAll(key int16) []uint16 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int16CharSet) ContainsKey(key int16) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int16CharSet) ContainsKeyValue(key int16, value uint16) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int16CharSet) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int16CharSet) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int16CharSet) Clear() {
	m.data = make(map[int16][]uint16)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int16CharSet) ForEach(f func(int16, uint16)) {
...
func (m *Int16CharSet) All() iter.Seq2[int16, uint16] {
...
func (m *Int16CharSet) ForEachKeyValues(f func(int16, []uint16)) {
	for key, vals := range m.data {
...
func (m *Int16CharSet) Keys() []int16 {
...
func (m *Int16CharSet) Values() []uint16 {
...
func (m *Int16CharSet) Select(predicate func(int16, uint16) bool) *Int16CharSet {
	result := NewInt16CharSet()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int16CharSet) Reject(predicate func(int16, uint16) bool) *Int16CharSet {
	result := NewInt16CharSet()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int16CharSet) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int16CharSet) Equals(other *Int16CharSet) bool {
...
func (m *Int16CharSet) KeysToSlice() []int16 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int16CharSet) ValuesToSlice() []uint16 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int16CharSet) PutReturning(key int16, value uint16) *Int16CharSet {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int16CharSet) RemoveKeyReturning(key int16) *Int16CharSet {
	m.RemoveAll(key)
	return m
}
