...
// Int16CharSetMultimap is a set multimap from int16 keys to uint16 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int16CharSetMultimap struct {
	data map[int16][]uint16
	size int
}

// NewInt16CharSetMultimap creates a new empty Int16CharSetMultimap.
func NewInt16CharSetMultimap() *Int16CharSetMultimap {
	return &Int16CharSetMultimap{
...
func (m *Int16CharSetMultimap) Put(key int16, value uint16) {
...
func (m *Int16CharSetMultimap) Get(key int16) []uint16 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int16CharSetMultimap) GetAll(key int16) []uint16 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int16CharSetMultimap) RemoveAll(key int16) []uint16 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int16CharSetMultimap) ContainsKey(key int16) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int16CharSetMultimap) ContainsKeyValue(key int16, value uint16) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int16CharSetMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int16CharSetMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int16CharSetMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int16CharSetMultimap) Clear() {
	m.data = make(map[int16][]uint16)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int16CharSetMultimap) ForEach(f func(int16, uint16)) {
...
func (m *Int16CharSetMultimap) ForEachKeyValues(f func(int16, []uint16)) {
	for key, vals := range m.data {
...
func (m *Int16CharSetMultimap) Keys() []int16 {
...
func (m *Int16CharSetMultimap) Values() []uint16 {
...
func (m *Int16CharSetMultimap) Select(predicate func(int16, uint16) bool) *Int16CharSetMultimap {
	result := NewInt16CharSetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int16CharSetMultimap) Reject(predicate func(int16, uint16) bool) *Int16CharSetMultimap {
	result := NewInt16CharSetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int16CharSetMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int16CharSetMultimap) Equals(other *Int16CharSetMultimap) bool {
...
func (m *Int16CharSetMultimap) KeysToSlice() []int16 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int16CharSetMultimap) ValuesToSlice() []uint16 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int16CharSetMultimap) WithKeyValue(key int16, value uint16) *Int16CharSetMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int16CharSetMultimap) WithoutKey(key int16) *Int16CharSetMultimap {
	m.RemoveAll(key)
	return m
}
