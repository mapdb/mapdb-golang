...
// Int16Float32ListBulkLoad builds a Int16Float32List from keys/values in a single
...
// every value).
func Int16Float32ListBulkLoad(keys []int16, values []float32) *Int16Float32List {
	if len(keys) != len(values) {
		panic("mapdb: Int16Float32ListBulkLoad: len(keys) != len(values)")
	}
	m := &Int16Float32List{
...
// NewInt16Float32ListFromSortedKeys builds a Int16Float32List from input grouped
...
func NewInt16Float32ListFromSortedKeys(keys []int16, values []float32) (*Int16Float32List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt16Float32ListFromSortedKeys: len(keys) != len(values)")
	}
	m := &Int16Float32List{
		data: make(map[int16][]float32),
	}
...
// NewInt16Float32ListFromSortedKeyValues builds a Int16Float32List from input
...
// not sorted within each key, use Int16Float32ListBulkLoad instead.
func NewInt16Float32ListFromSortedKeyValues(keys []int16, values []float32) (*Int16Float32List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt16Float32ListFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int16Float32List{
		data: make(map[int16][]float32),
	}
...
func (m *Int16Float32List) All() iter.Seq2[int16, float32] {
