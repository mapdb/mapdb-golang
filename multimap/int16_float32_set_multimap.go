...
// Int16Float32SetMultimap is a set multimap from int16 keys to float32 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int16Float32SetMultimap struct {
	data map[int16][]float32
	size int
}

// NewInt16Float32SetMultimap creates a new empty Int16Float32SetMultimap.
func NewInt16Float32SetMultimap() *Int16Float32SetMultimap {
	return &Int16Float32SetMultimap{
...
func (m *Int16Float32SetMultimap) Put(key int16, value float32) {
...
func (m *Int16Float32SetMultimap) Get(key int16) []float32 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int16Float32SetMultimap) GetAll(key int16) []float32 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int16Float32SetMultimap) RemoveAll(key int16) []float32 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int16Float32SetMultimap) ContainsKey(key int16) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int16Float32SetMultimap) ContainsKeyValue(key int16, value float32) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int16Float32SetMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int16Float32SetMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int16Float32SetMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int16Float32SetMultimap) Clear() {
	m.data = make(map[int16][]float32)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int16Float32SetMultimap) ForEach(f func(int16, float32)) {
...
func (m *Int16Float32SetMultimap) ForEachKeyValues(f func(int16, []float32)) {
	for key, vals := range m.data {
...
func (m *Int16Float32SetMultimap) Keys() []int16 {
...
func (m *Int16Float32SetMultimap) Values() []float32 {
...
func (m *Int16Float32SetMultimap) Select(predicate func(int16, float32) bool) *Int16Float32SetMultimap {
	result := NewInt16Float32SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int16Float32SetMultimap) Reject(predicate func(int16, float32) bool) *Int16Float32SetMultimap {
	result := NewInt16Float32SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int16Float32SetMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int16Float32SetMultimap) Equals(other *Int16Float32SetMultimap) bool {
...
func (m *Int16Float32SetMultimap) KeysToSlice() []int16 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int16Float32SetMultimap) ValuesToSlice() []float32 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int16Float32SetMultimap) WithKeyValue(key int16, value float32) *Int16Float32SetMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int16Float32SetMultimap) WithoutKey(key int16) *Int16Float32SetMultimap {
	m.RemoveAll(key)
	return m
}
