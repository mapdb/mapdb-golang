...
// Int16Int16ListMultimap is a list multimap from int16 keys to int16 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int16Int16ListMultimap struct {
	data map[int16][]int16
	size int
}

// NewInt16Int16ListMultimap creates a new empty Int16Int16ListMultimap.
func NewInt16Int16ListMultimap() *Int16Int16ListMultimap {
	return &Int16Int16ListMultimap{
...
func (m *Int16Int16ListMultimap) Put(key int16, value int16) {
	m.data[key] = append(m.data[key], value)
	m.size++
}

// Get returns a copy of the values for the given key. Returns nil if the key is absent.
func (m *Int16Int16ListMultimap) Get(key int16) []int16 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int16Int16ListMultimap) GetAll(key int16) []int16 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int16Int16ListMultimap) RemoveAll(key int16) []int16 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int16Int16ListMultimap) ContainsKey(key int16) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int16Int16ListMultimap) ContainsKeyValue(key int16, value int16) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int16Int16ListMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int16Int16ListMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int16Int16ListMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int16Int16ListMultimap) Clear() {
	m.data = make(map[int16][]int16)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int16Int16ListMultimap) ForEach(f func(int16, int16)) {
...
func (m *Int16Int16ListMultimap) ForEachKeyValues(f func(int16, []int16)) {
	for key, vals := range m.data {
...
func (m *Int16Int16ListMultimap) Keys() []int16 {
...
func (m *Int16Int16ListMultimap) Values() []int16 {
...
func (m *Int16Int16ListMultimap) Select(predicate func(int16, int16) bool) *Int16Int16ListMultimap {
	result := NewInt16Int16ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int16Int16ListMultimap) Reject(predicate func(int16, int16) bool) *Int16Int16ListMultimap {
	result := NewInt16Int16ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int16Int16ListMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int16Int16ListMultimap) Equals(other *Int16Int16ListMultimap) bool {
...
func (m *Int16Int16ListMultimap) KeysToSlice() []int16 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int16Int16ListMultimap) ValuesToSlice() []int16 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int16Int16ListMultimap) WithKeyValue(key int16, value int16) *Int16Int16ListMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int16Int16ListMultimap) WithoutKey(key int16) *Int16Int16ListMultimap {
	m.RemoveAll(key)
	return m
}
