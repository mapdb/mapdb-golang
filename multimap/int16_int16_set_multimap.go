...
// Int16Int16SetMultimap is a set multimap from int16 keys to int16 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int16Int16SetMultimap struct {
	data map[int16][]int16
	size int
}

// NewInt16Int16SetMultimap creates a new empty Int16Int16SetMultimap.
func NewInt16Int16SetMultimap() *Int16Int16SetMultimap {
	return &Int16Int16SetMultimap{
...
func (m *Int16Int16SetMultimap) Put(key int16, value int16) {
...
func (m *Int16Int16SetMultimap) Get(key int16) []int16 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int16Int16SetMultimap) GetAll(key int16) []int16 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int16Int16SetMultimap) RemoveAll(key int16) []int16 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int16Int16SetMultimap) ContainsKey(key int16) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int16Int16SetMultimap) ContainsKeyValue(key int16, value int16) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int16Int16SetMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int16Int16SetMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int16Int16SetMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int16Int16SetMultimap) Clear() {
	m.data = make(map[int16][]int16)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int16Int16SetMultimap) ForEach(f func(int16, int16)) {
...
func (m *Int16Int16SetMultimap) ForEachKeyValues(f func(int16, []int16)) {
	for key, vals := range m.data {
...
func (m *Int16Int16SetMultimap) Keys() []int16 {
...
func (m *Int16Int16SetMultimap) Values() []int16 {
...
func (m *Int16Int16SetMultimap) Select(predicate func(int16, int16) bool) *Int16Int16SetMultimap {
	result := NewInt16Int16SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int16Int16SetMultimap) Reject(predicate func(int16, int16) bool) *Int16Int16SetMultimap {
	result := NewInt16Int16SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int16Int16SetMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int16Int16SetMultimap) Equals(other *Int16Int16SetMultimap) bool {
...
func (m *Int16Int16SetMultimap) KeysToSlice() []int16 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int16Int16SetMultimap) ValuesToSlice() []int16 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int16Int16SetMultimap) WithKeyValue(key int16, value int16) *Int16Int16SetMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int16Int16SetMultimap) WithoutKey(key int16) *Int16Int16SetMultimap {
	m.RemoveAll(key)
	return m
}
