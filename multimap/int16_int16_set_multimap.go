...
// Int16Int16SetBulkLoad builds a Int16Int16Set from keys/values in a single
...
func Int16Int16SetBulkLoad(keys []int16, values []int16) *Int16Int16Set {
	if len(keys) != len(values) {
		panic("mapdb: Int16Int16SetBulkLoad: len(keys) != len(values)")
	}
	m := &Int16Int16Set{
...
// NewInt16Int16SetFromSortedKeyValues builds a Int16Int16Set from input sorted
...
// not sorted within each key, use Int16Int16SetBulkLoad instead.
func NewInt16Int16SetFromSortedKeyValues(keys []int16, values []int16) (*Int16Int16Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt16Int16SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int16Int16Set{
		data: make(map[int16][]int16),
	}
...
func (m *Int16Int16Set) All() iter.Seq2[int16, int16] {
