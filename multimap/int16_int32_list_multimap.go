...
// Int16Int32ListMultimap is a list multimap from int16 keys to int32 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int16Int32ListMultimap struct {
	data map[int16][]int32
	size int
}

// NewInt16Int32ListMultimap creates a new empty Int16Int32ListMultimap.
func NewInt16Int32ListMultimap() *Int16Int32ListMultimap {
	return &Int16Int32ListMultimap{
...
func (m *Int16Int32ListMultimap) Put(key int16, value int32) {
	m.data[key] = append(m.data[key], value)
	m.size++
}

// Get returns a copy of the values for the given key. Returns nil if the key is absent.
func (m *Int16Int32ListMultimap) Get(key int16) []int32 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int16Int32ListMultimap) GetAll(key int16) []int32 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int16Int32ListMultimap) RemoveAll(key int16) []int32 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int16Int32ListMultimap) ContainsKey(key int16) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int16Int32ListMultimap) ContainsKeyValue(key int16, value int32) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int16Int32ListMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int16Int32ListMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int16Int32ListMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int16Int32ListMultimap) Clear() {
	m.data = make(map[int16][]int32)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int16Int32ListMultimap) ForEach(f func(int16, int32)) {
...
func (m *Int16Int32ListMultimap) ForEachKeyValues(f func(int16, []int32)) {
	for key, vals := range m.data {
...
func (m *Int16Int32ListMultimap) Keys() []int16 {
...
func (m *Int16Int32ListMultimap) Values() []int32 {
...
func (m *Int16Int32ListMultimap) Select(predicate func(int16, int32) bool) *Int16Int32ListMultimap {
	result := NewInt16Int32ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int16Int32ListMultimap) Reject(predicate func(int16, int32) bool) *Int16Int32ListMultimap {
	result := NewInt16Int32ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int16Int32ListMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int16Int32ListMultimap) Equals(other *Int16Int32ListMultimap) bool {
...
func (m *Int16Int32ListMultimap) KeysToSlice() []int16 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int16Int32ListMultimap) ValuesToSlice() []int32 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int16Int32ListMultimap) WithKeyValue(key int16, value int32) *Int16Int32ListMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int16Int32ListMultimap) WithoutKey(key int16) *Int16Int32ListMultimap {
	m.RemoveAll(key)
	return m
}
