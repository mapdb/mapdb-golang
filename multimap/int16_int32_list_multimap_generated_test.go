...
func TestInt16Int32ListMultimap_Generated_PutGet(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt16Int32ListMultimap_Generated_GetAll(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	vals := m.GetAll(1)
...
func TestInt16Int32ListMultimap_Generated_GetDoesNotAlias(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	vals := m.Get(1)
...
func TestInt16Int32ListMultimap_Generated_RemoveAll(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt16Int32ListMultimap_Generated_ContainsKey(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestInt16Int32ListMultimap_Generated_ContainsKeyValue(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
...
func TestInt16Int32ListMultimap_Generated_Clear(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestInt16Int32ListMultimap_Generated_ForEach(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
	count := 0
	m.ForEach(func(_ int16, _ int32) {
		count++
	})
	if count != 3 {
...
func TestInt16Int32ListMultimap_Generated_ForEachKeyValues(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
	keyCount := 0
	m.ForEachKeyValues(func(_ int16, vals []int32) {
		keyCount++
		if len(vals) == 0 {
...
func TestInt16Int32ListMultimap_Generated_SelectReject(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
	sel := m.Select(func(_ int16, v int32) bool { return v == 1 })
	if sel.Size() != 1 {
		t.Errorf("Select size = %d, want 1", sel.Size())
	}
	rej := m.Reject(func(_ int16, v int32) bool { return v == 1 })
	if rej.Size() != 2 {
		t.Errorf("Reject size = %d, want 2", rej.Size())
	}
}

func TestInt16Int32ListMultimap_Generated_KeysValues(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt16Int32ListMultimap_Generated_Equals(t *testing.T) {
	m1 := NewInt16Int32ListMultimap()
	m1.Put(1, 1)
	m1.Put(1, 2)
	m2 := NewInt16Int32ListMultimap()
	m2.Put(1, 1)
	m2.Put(1, 2)
	if !m1.Equals(m2) {
...
func TestInt16Int32ListMultimap_Generated_String(t *testing.T) {
	m := NewInt16Int32ListMultimap()
	m.Put(1, 1)
	s := m.String()
	if len(s) == 0 {
...
func TestInt16Int32ListMultimap_Generated_FluentAPI(t *testing.T) {
	m := NewInt16Int32ListMultimap()
