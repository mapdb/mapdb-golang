...
// Int16Int32Set is a set multimap from int16 keys to int32 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int16Int32Set struct {
	data map[int16][]int32
	size int
}

// NewInt16Int32Set creates a new empty Int16Int32Set.
func NewInt16Int32Set() *Int16Int32Set {
	return &Int16Int32Set{
		data: make(map[int16][]int32),
		size: 0,
	}
}

// Int16Int32SetBulkLoad builds a Int16Int32Set from keys/values in a single
...
func Int16Int32SetBulkLoad(keys []int16, values []int32) *Int16Int32Set {
	if len(keys) != len(values) {
		panic("mapdb: Int16Int32SetBulkLoad: len(keys) != len(values)")
	}
	m := &Int16Int32Set{
...
// NewInt16Int32SetFromSortedKeyValues builds a Int16Int32Set from input sorted
...
// not sorted within each key, use Int16Int32SetBulkLoad instead.
func NewInt16Int32SetFromSortedKeyValues(keys []int16, values []int32) (*Int16Int32Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt16Int32SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int16Int32Set{
		data: make(map[int16][]int32),
	}
...
func (m *Int16Int32Set) Put(key int16, value int32) {
	if m.data == nil {
...
func (m *Int16Int32Set) Get(key int16) []int32 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int16Int32Set) GetAll(key int16) []int32 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int16Int32Set) RemoveAll(key int16) []int32 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int16Int32Set) ContainsKey(key int16) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int16Int32Set) ContainsKeyValue(key int16, value int32) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int16Int32Set) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int16Int32Set) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int16Int32Set) Clear() {
	m.data = make(map[int16][]int32)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int16Int32Set) ForEach(f func(int16, int32)) {
...
func (m *Int16Int32Set) All() iter.Seq2[int16, int32] {
...
func (m *Int16Int32Set) ForEachKeyValues(f func(int16, []int32)) {
	for key, vals := range m.data {
...
func (m *Int16Int32Set) Keys() []int16 {
...
func (m *Int16Int32Set) Values() []int32 {
...
func (m *Int16Int32Set) Select(predicate func(int16, int32) bool) *Int16Int32Set {
	result := NewInt16Int32Set()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int16Int32Set) Reject(predicate func(int16, int32) bool) *Int16Int32Set {
	result := NewInt16Int32Set()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int16Int32Set) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int16Int32Set) Equals(other *Int16Int32Set) bool {
...
func (m *Int16Int32Set) KeysToSlice() []int16 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int16Int32Set) ValuesToSlice() []int32 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int16Int32Set) PutReturning(key int16, value int32) *Int16Int32Set {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int16Int32Set) RemoveKeyReturning(key int16) *Int16Int32Set {
	m.RemoveAll(key)
	return m
}
