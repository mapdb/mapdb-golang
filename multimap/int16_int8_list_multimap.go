...
// NewInt16Int8ListFromSortedKeyValues builds a Int16Int8List from input
...
// not sorted within each key, use Int16Int8ListBulkLoad instead.
func NewInt16Int8ListFromSortedKeyValues(keys []int16, values []int8) (*Int16Int8List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt16Int8ListFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int16Int8List{
		data: make(map[int16][]int8),
	}
...
func (m *Int16Int8List) All() iter.Seq2[int16, int8] {
