...
// Int16Int8ListMultimap is a list multimap from int16 keys to int8 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int16Int8ListMultimap struct {
	data map[int16][]int8
	size int
}

// NewInt16Int8ListMultimap creates a new empty Int16Int8ListMultimap.
func NewInt16Int8ListMultimap() *Int16Int8ListMultimap {
	return &Int16Int8ListMultimap{
...
func (m *Int16Int8ListMultimap) Get(key int16) []int8 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int16Int8ListMultimap) GetAll(key int16) []int8 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int16Int8ListMultimap) RemoveAll(key int16) []int8 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int16Int8ListMultimap) ContainsKey(key int16) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int16Int8ListMultimap) ContainsKeyValue(key int16, value int8) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int16Int8ListMultimap) KeysCount() int {
	return len(m.data)
}
...
func (m *Int16Int8ListMultimap) Clear() {
	m.data = make(map[int16][]int8)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int16Int8ListMultimap) ForEach(f func(int16, int8)) {
...
func (m *Int16Int8ListMultimap) ForEachKeyValues(f func(int16, []int8)) {
	for key, vals := range m.data {
...
func (m *Int16Int8ListMultimap) Keys() []int16 {
...
func (m *Int16Int8ListMultimap) Values() []int8 {
...
func (m *Int16Int8ListMultimap) Select(predicate func(int16, int8) bool) *Int16Int8ListMultimap {
	result := NewInt16Int8ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int16Int8ListMultimap) Reject(predicate func(int16, int8) bool) *Int16Int8ListMultimap {
	result := NewInt16Int8ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int16Int8ListMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int16Int8ListMultimap) Equals(other *Int16Int8ListMultimap) bool {
...
func (m *Int16Int8ListMultimap) KeysToSlice() []int16 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int16Int8ListMultimap) ValuesToSlice() []int8 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int16Int8ListMultimap) WithKeyValue(key int16, value int8) *Int16Int8ListMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int16Int8ListMultimap) WithoutKey(key int16) *Int16Int8ListMultimap {
	m.RemoveAll(key)
	return m
}
