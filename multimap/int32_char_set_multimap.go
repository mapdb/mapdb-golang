...
// Int32CharSet is a set multimap from int32 keys to uint16 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int32CharSet struct {
	data map[int32][]uint16
	size int
}

// NewInt32CharSet creates a new empty Int32CharSet.
func NewInt32CharSet() *Int32CharSet {
	return &Int32CharSet{
...
// Int32CharSetBulkLoad builds a Int32CharSet from keys/values in a single
...
func Int32CharSetBulkLoad(keys []int32, values []uint16) *Int32CharSet {
	if len(keys) != len(values) {
		panic("mapdb: Int32CharSetBulkLoad: len(keys) != len(values)")
	}
	m := &Int32CharSet{
...
// NewInt32CharSetFromSortedKeyValues builds a Int32CharSet from input sorted
...
// not sorted within each key, use Int32CharSetBulkLoad instead.
func NewInt32CharSetFromSortedKeyValues(keys []int32, values []uint16) (*Int32CharSet, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt32CharSetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int32CharSet{
		data: make(map[int32][]uint16),
	}
...
func (m *Int32CharSet) Put(key int32, value uint16) {
	if m.data == nil {
...
func (m *Int32CharSet) Get(key int32) []uint16 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int32CharSet) GetAll(key int32) []uint16 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int32CharSet) RemoveAll(key int32) []uint16 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int32CharSet) ContainsKey(key int32) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int32CharSet) ContainsKeyValue(key int32, value uint16) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int32CharSet) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int32CharSet) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int32CharSet) Clear() {
	m.data = make(map[int32][]uint16)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int32CharSet) ForEach(f func(int32, uint16)) {
...
func (m *Int32CharSet) All() iter.Seq2[int32, uint16] {
...
func (m *Int32CharSet) ForEachKeyValues(f func(int32, []uint16)) {
	for key, vals := range m.data {
...
func (m *Int32CharSet) Keys() []int32 {
...
func (m *Int32CharSet) Values() []uint16 {
...
func (m *Int32CharSet) Select(predicate func(int32, uint16) bool) *Int32CharSet {
	result := NewInt32CharSet()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int32CharSet) Reject(predicate func(int32, uint16) bool) *Int32CharSet {
	result := NewInt32CharSet()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int32CharSet) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32CharSet) Equals(other *Int32CharSet) bool {
...
func (m *Int32CharSet) KeysToSlice() []int32 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int32CharSet) ValuesToSlice() []uint16 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int32CharSet) PutReturning(key int32, value uint16) *Int32CharSet {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int32CharSet) RemoveKeyReturning(key int32) *Int32CharSet {
	m.RemoveAll(key)
	return m
}
