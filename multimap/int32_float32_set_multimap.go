...
// Int32Float32SetMultimap is a set multimap from int32 keys to float32 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int32Float32SetMultimap struct {
	data map[int32][]float32
	size int
}

// NewInt32Float32SetMultimap creates a new empty Int32Float32SetMultimap.
func NewInt32Float32SetMultimap() *Int32Float32SetMultimap {
	return &Int32Float32SetMultimap{
...
func (m *Int32Float32SetMultimap) Put(key int32, value float32) {
...
func (m *Int32Float32SetMultimap) Get(key int32) []float32 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int32Float32SetMultimap) GetAll(key int32) []float32 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int32Float32SetMultimap) RemoveAll(key int32) []float32 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int32Float32SetMultimap) ContainsKey(key int32) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int32Float32SetMultimap) ContainsKeyValue(key int32, value float32) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int32Float32SetMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int32Float32SetMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int32Float32SetMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int32Float32SetMultimap) Clear() {
	m.data = make(map[int32][]float32)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int32Float32SetMultimap) ForEach(f func(int32, float32)) {
...
func (m *Int32Float32SetMultimap) ForEachKeyValues(f func(int32, []float32)) {
	for key, vals := range m.data {
...
func (m *Int32Float32SetMultimap) Keys() []int32 {
...
func (m *Int32Float32SetMultimap) Values() []float32 {
...
func (m *Int32Float32SetMultimap) Select(predicate func(int32, float32) bool) *Int32Float32SetMultimap {
	result := NewInt32Float32SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int32Float32SetMultimap) Reject(predicate func(int32, float32) bool) *Int32Float32SetMultimap {
	result := NewInt32Float32SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int32Float32SetMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32Float32SetMultimap) Equals(other *Int32Float32SetMultimap) bool {
...
func (m *Int32Float32SetMultimap) KeysToSlice() []int32 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int32Float32SetMultimap) ValuesToSlice() []float32 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int32Float32SetMultimap) WithKeyValue(key int32, value float32) *Int32Float32SetMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int32Float32SetMultimap) WithoutKey(key int32) *Int32Float32SetMultimap {
	m.RemoveAll(key)
	return m
}
