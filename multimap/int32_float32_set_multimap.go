...
// Int32Float32Set is a set multimap from int32 keys to float32 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int32Float32Set struct {
	data map[int32][]float32
	size int
}

// NewInt32Float32Set creates a new empty Int32Float32Set.
func NewInt32Float32Set() *Int32Float32Set {
	return &Int32Float32Set{
		data: make(map[int32][]float32),
		size: 0,
	}
}

// Int32Float32SetBulkLoad builds a Int32Float32Set from keys/values in a single
...
func Int32Float32SetBulkLoad(keys []int32, values []float32) *Int32Float32Set {
	if len(keys) != len(values) {
		panic("mapdb: Int32Float32SetBulkLoad: len(keys) != len(values)")
	}
	m := &Int32Float32Set{
...
// NewInt32Float32SetFromSortedKeyValues builds a Int32Float32Set from input sorted
...
// not sorted within each key, use Int32Float32SetBulkLoad instead.
func NewInt32Float32SetFromSortedKeyValues(keys []int32, values []float32) (*Int32Float32Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt32Float32SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int32Float32Set{
		data: make(map[int32][]float32),
	}
...
func (m *Int32Float32Set) Put(key int32, value float32) {
	if m.data == nil {
...
func (m *Int32Float32Set) Get(key int32) []float32 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int32Float32Set) GetAll(key int32) []float32 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int32Float32Set) RemoveAll(key int32) []float32 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int32Float32Set) ContainsKey(key int32) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int32Float32Set) ContainsKeyValue(key int32, value float32) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int32Float32Set) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int32Float32Set) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int32Float32Set) Clear() {
	m.data = make(map[int32][]float32)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int32Float32Set) ForEach(f func(int32, float32)) {
...
func (m *Int32Float32Set) All() iter.Seq2[int32, float32] {
...
func (m *Int32Float32Set) ForEachKeyValues(f func(int32, []float32)) {
	for key, vals := range m.data {
...
func (m *Int32Float32Set) Keys() []int32 {
...
func (m *Int32Float32Set) Values() []float32 {
...
func (m *Int32Float32Set) Select(predicate func(int32, float32) bool) *Int32Float32Set {
	result := NewInt32Float32Set()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int32Float32Set) Reject(predicate func(int32, float32) bool) *Int32Float32Set {
	result := NewInt32Float32Set()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int32Float32Set) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32Float32Set) Equals(other *Int32Float32Set) bool {
...
func (m *Int32Float32Set) KeysToSlice() []int32 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int32Float32Set) ValuesToSlice() []float32 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int32Float32Set) PutReturning(key int32, value float32) *Int32Float32Set {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int32Float32Set) RemoveKeyReturning(key int32) *Int32Float32Set {
	m.RemoveAll(key)
	return m
}
