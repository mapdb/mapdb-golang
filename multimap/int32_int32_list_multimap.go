...
// Int32Int32List is a list multimap from int32 keys to int32 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int32Int32List struct {
	data map[int32][]int32
	size int
}

// NewInt32Int32List creates a new empty Int32Int32List.
func NewInt32Int32List() *Int32Int32List {
	return &Int32Int32List{
		data: make(map[int32][]int32),
		size: 0,
	}
}

// Int32Int32ListBulkLoad builds a Int32Int32List from keys/values in a single
...
// every value).
func Int32Int32ListBulkLoad(keys []int32, values []int32) *Int32Int32List {
	if len(keys) != len(values) {
		panic("mapdb: Int32Int32ListBulkLoad: len(keys) != len(values)")
	}
	m := &Int32Int32List{
		data: make(map[int32][]int32, len(keys)),
	}
	for i := range keys {
...
// NewInt32Int32ListFromSortedKeys builds a Int32Int32List from input grouped
...
func NewInt32Int32ListFromSortedKeys(keys []int32, values []int32) (*Int32Int32List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt32Int32ListFromSortedKeys: len(keys) != len(values)")
	}
	m := &Int32Int32List{
		data: make(map[int32][]int32),
	}
...
// NewInt32Int32ListFromSortedKeyValues builds a Int32Int32List from input
...
// not sorted within each key, use Int32Int32ListBulkLoad instead.
func NewInt32Int32ListFromSortedKeyValues(keys []int32, values []int32) (*Int32Int32List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt32Int32ListFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int32Int32List{
		data: make(map[int32][]int32),
	}
...
func (m *Int32Int32List) Put(key int32, value int32) {
	if m.data == nil {
...
func (m *Int32Int32List) Get(key int32) []int32 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int32Int32List) GetAll(key int32) []int32 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int32Int32List) RemoveAll(key int32) []int32 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int32Int32List) ContainsKey(key int32) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int32Int32List) ContainsKeyValue(key int32, value int32) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int32Int32List) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int32Int32List) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int32Int32List) Clear() {
	m.data = make(map[int32][]int32)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int32Int32List) ForEach(f func(int32, int32)) {
...
func (m *Int32Int32List) All() iter.Seq2[int32, int32] {
...
func (m *Int32Int32List) ForEachKeyValues(f func(int32, []int32)) {
	for key, vals := range m.data {
...
func (m *Int32Int32List) Keys() []int32 {
...
func (m *Int32Int32List) Values() []int32 {
...
func (m *Int32Int32List) Select(predicate func(int32, int32) bool) *Int32Int32List {
	result := NewInt32Int32List()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int32Int32List) Reject(predicate func(int32, int32) bool) *Int32Int32List {
	result := NewInt32Int32List()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int32Int32List) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32Int32List) Equals(other *Int32Int32List) bool {
...
func (m *Int32Int32List) KeysToSlice() []int32 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int32Int32List) ValuesToSlice() []int32 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int32Int32List) PutReturning(key int32, value int32) *Int32Int32List {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int32Int32List) RemoveKeyReturning(key int32) *Int32Int32List {
	m.RemoveAll(key)
	return m
}
