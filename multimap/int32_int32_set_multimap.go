...
// Int32Int32Set is a set multimap from int32 keys to int32 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int32Int32Set struct {
	data map[int32][]int32
	size int
}

// NewInt32Int32Set creates a new empty Int32Int32Set.
func NewInt32Int32Set() *Int32Int32Set {
	return &Int32Int32Set{
		data: make(map[int32][]int32),
		size: 0,
	}
}

// Int32Int32SetBulkLoad builds a Int32Int32Set from keys/values in a single
...
func Int32Int32SetBulkLoad(keys []int32, values []int32) *Int32Int32Set {
	if len(keys) != len(values) {
		panic("mapdb: Int32Int32SetBulkLoad: len(keys) != len(values)")
	}
	m := &Int32Int32Set{
...
// NewInt32Int32SetFromSortedKeyValues builds a Int32Int32Set from input sorted
...
// not sorted within each key, use Int32Int32SetBulkLoad instead.
func NewInt32Int32SetFromSortedKeyValues(keys []int32, values []int32) (*Int32Int32Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt32Int32SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int32Int32Set{
		data: make(map[int32][]int32),
	}
...
func (m *Int32Int32Set) Put(key int32, value int32) {
	if m.data == nil {
...
func (m *Int32Int32Set) Get(key int32) []int32 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int32Int32Set) GetAll(key int32) []int32 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int32Int32Set) RemoveAll(key int32) []int32 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int32Int32Set) ContainsKey(key int32) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int32Int32Set) ContainsKeyValue(key int32, value int32) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int32Int32Set) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int32Int32Set) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int32Int32Set) Clear() {
	m.data = make(map[int32][]int32)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int32Int32Set) ForEach(f func(int32, int32)) {
...
func (m *Int32Int32Set) All() iter.Seq2[int32, int32] {
...
func (m *Int32Int32Set) ForEachKeyValues(f func(int32, []int32)) {
	for key, vals := range m.data {
...
func (m *Int32Int32Set) Keys() []int32 {
...
func (m *Int32Int32Set) Values() []int32 {
...
func (m *Int32Int32Set) Select(predicate func(int32, int32) bool) *Int32Int32Set {
	result := NewInt32Int32Set()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int32Int32Set) Reject(predicate func(int32, int32) bool) *Int32Int32Set {
	result := NewInt32Int32Set()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int32Int32Set) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32Int32Set) Equals(other *Int32Int32Set) bool {
...
func (m *Int32Int32Set) KeysToSlice() []int32 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int32Int32Set) ValuesToSlice() []int32 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int32Int32Set) PutReturning(key int32, value int32) *Int32Int32Set {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int32Int32Set) RemoveKeyReturning(key int32) *Int32Int32Set {
	m.RemoveAll(key)
	return m
}
