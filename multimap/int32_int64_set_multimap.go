...
// Int32Int64SetBulkLoad builds a Int32Int64Set from keys/values in a single
...
func Int32Int64SetBulkLoad(keys []int32, values []int64) *Int32Int64Set {
	if len(keys) != len(values) {
		panic("mapdb: Int32Int64SetBulkLoad: len(keys) != len(values)")
	}
	m := &Int32Int64Set{
...
// NewInt32Int64SetFromSortedKeyValues builds a Int32Int64Set from input sorted
...
// not sorted within each key, use Int32Int64SetBulkLoad instead.
func NewInt32Int64SetFromSortedKeyValues(keys []int32, values []int64) (*Int32Int64Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt32Int64SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int32Int64Set{
		data: make(map[int32][]int64),
	}
...
func (m *Int32Int64Set) All() iter.Seq2[int32, int64] {
