...
// Int32Int64SetMultimap is a set multimap from int32 keys to int64 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int32Int64SetMultimap struct {
	data map[int32][]int64
	size int
}

// NewInt32Int64SetMultimap creates a new empty Int32Int64SetMultimap.
func NewInt32Int64SetMultimap() *Int32Int64SetMultimap {
	return &Int32Int64SetMultimap{
...
func (m *Int32Int64SetMultimap) Put(key int32, value int64) {
...
func (m *Int32Int64SetMultimap) Get(key int32) []int64 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int32Int64SetMultimap) GetAll(key int32) []int64 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int32Int64SetMultimap) RemoveAll(key int32) []int64 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int32Int64SetMultimap) ContainsKey(key int32) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int32Int64SetMultimap) ContainsKeyValue(key int32, value int64) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int32Int64SetMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int32Int64SetMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int32Int64SetMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int32Int64SetMultimap) Clear() {
	m.data = make(map[int32][]int64)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int32Int64SetMultimap) ForEach(f func(int32, int64)) {
...
func (m *Int32Int64SetMultimap) ForEachKeyValues(f func(int32, []int64)) {
	for key, vals := range m.data {
...
func (m *Int32Int64SetMultimap) Keys() []int32 {
...
func (m *Int32Int64SetMultimap) Values() []int64 {
...
func (m *Int32Int64SetMultimap) Select(predicate func(int32, int64) bool) *Int32Int64SetMultimap {
	result := NewInt32Int64SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int32Int64SetMultimap) Reject(predicate func(int32, int64) bool) *Int32Int64SetMultimap {
	result := NewInt32Int64SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int32Int64SetMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32Int64SetMultimap) Equals(other *Int32Int64SetMultimap) bool {
...
func (m *Int32Int64SetMultimap) KeysToSlice() []int32 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int32Int64SetMultimap) ValuesToSlice() []int64 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int32Int64SetMultimap) WithKeyValue(key int32, value int64) *Int32Int64SetMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int32Int64SetMultimap) WithoutKey(key int32) *Int32Int64SetMultimap {
	m.RemoveAll(key)
	return m
}
