...
// Int32Int8List is a list multimap from int32 keys to int8 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int32Int8List struct {
	data map[int32][]int8
	size int
}

// NewInt32Int8List creates a new empty Int32Int8List.
func NewInt32Int8List() *Int32Int8List {
	return &Int32Int8List{
		data: make(map[int32][]int8),
		size: 0,
	}
}

// Int32Int8ListBulkLoad builds a Int32Int8List from keys/values in a single
...
// every value).
func Int32Int8ListBulkLoad(keys []int32, values []int8) *Int32Int8List {
	if len(keys) != len(values) {
		panic("mapdb: Int32Int8ListBulkLoad: len(keys) != len(values)")
	}
	m := &Int32Int8List{
...
// NewInt32Int8ListFromSortedKeys builds a Int32Int8List from input grouped
...
func NewInt32Int8ListFromSortedKeys(keys []int32, values []int8) (*Int32Int8List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt32Int8ListFromSortedKeys: len(keys) != len(values)")
	}
	m := &Int32Int8List{
		data: make(map[int32][]int8),
	}
...
// NewInt32Int8ListFromSortedKeyValues builds a Int32Int8List from input
...
// not sorted within each key, use Int32Int8ListBulkLoad instead.
func NewInt32Int8ListFromSortedKeyValues(keys []int32, values []int8) (*Int32Int8List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt32Int8ListFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int32Int8List{
		data: make(map[int32][]int8),
	}
...
func (m *Int32Int8List) Put(key int32, value int8) {
	if m.data == nil {
...
func (m *Int32Int8List) Get(key int32) []int8 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int32Int8List) GetAll(key int32) []int8 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int32Int8List) RemoveAll(key int32) []int8 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int32Int8List) ContainsKey(key int32) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int32Int8List) ContainsKeyValue(key int32, value int8) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int32Int8List) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int32Int8List) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int32Int8List) Clear() {
	m.data = make(map[int32][]int8)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int32Int8List) ForEach(f func(int32, int8)) {
...
func (m *Int32Int8List) All() iter.Seq2[int32, int8] {
...
func (m *Int32Int8List) ForEachKeyValues(f func(int32, []int8)) {
	for key, vals := range m.data {
...
func (m *Int32Int8List) Keys() []int32 {
...
func (m *Int32Int8List) Values() []int8 {
...
func (m *Int32Int8List) Select(predicate func(int32, int8) bool) *Int32Int8List {
	result := NewInt32Int8List()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int32Int8List) Reject(predicate func(int32, int8) bool) *Int32Int8List {
	result := NewInt32Int8List()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int32Int8List) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32Int8List) Equals(other *Int32Int8List) bool {
...
func (m *Int32Int8List) KeysToSlice() []int32 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int32Int8List) ValuesToSlice() []int8 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int32Int8List) PutReturning(key int32, value int8) *Int32Int8List {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int32Int8List) RemoveKeyReturning(key int32) *Int32Int8List {
	m.RemoveAll(key)
	return m
}
