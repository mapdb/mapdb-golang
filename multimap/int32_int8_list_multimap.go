...
// Int32Int8ListMultimap is a list multimap from int32 keys to int8 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int32Int8ListMultimap struct {
	data map[int32][]int8
	size int
}

// NewInt32Int8ListMultimap creates a new empty Int32Int8ListMultimap.
func NewInt32Int8ListMultimap() *Int32Int8ListMultimap {
	return &Int32Int8ListMultimap{
...
func (m *Int32Int8ListMultimap) Put(key int32, value int8) {
	m.data[key] = append(m.data[key], value)
	m.size++
}

// Get returns a copy of the values for the given key. Returns nil if the key is absent.
func (m *Int32Int8ListMultimap) Get(key int32) []int8 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int32Int8ListMultimap) GetAll(key int32) []int8 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int32Int8ListMultimap) RemoveAll(key int32) []int8 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int32Int8ListMultimap) ContainsKey(key int32) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int32Int8ListMultimap) ContainsKeyValue(key int32, value int8) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int32Int8ListMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int32Int8ListMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int32Int8ListMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int32Int8ListMultimap) Clear() {
	m.data = make(map[int32][]int8)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int32Int8ListMultimap) ForEach(f func(int32, int8)) {
...
func (m *Int32Int8ListMultimap) ForEachKeyValues(f func(int32, []int8)) {
	for key, vals := range m.data {
...
func (m *Int32Int8ListMultimap) Keys() []int32 {
...
func (m *Int32Int8ListMultimap) Values() []int8 {
...
func (m *Int32Int8ListMultimap) Select(predicate func(int32, int8) bool) *Int32Int8ListMultimap {
	result := NewInt32Int8ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int32Int8ListMultimap) Reject(predicate func(int32, int8) bool) *Int32Int8ListMultimap {
	result := NewInt32Int8ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int32Int8ListMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32Int8ListMultimap) Equals(other *Int32Int8ListMultimap) bool {
...
func (m *Int32Int8ListMultimap) KeysToSlice() []int32 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int32Int8ListMultimap) ValuesToSlice() []int8 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int32Int8ListMultimap) WithKeyValue(key int32, value int8) *Int32Int8ListMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int32Int8ListMultimap) WithoutKey(key int32) *Int32Int8ListMultimap {
	m.RemoveAll(key)
	return m
}
