...
func TestInt64CharListMultimap_Generated_PutGet(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt64CharListMultimap_Generated_GetAll(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	vals := m.GetAll(1)
...
func TestInt64CharListMultimap_Generated_GetDoesNotAlias(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	vals := m.Get(1)
...
func TestInt64CharListMultimap_Generated_RemoveAll(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt64CharListMultimap_Generated_ContainsKey(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestInt64CharListMultimap_Generated_ContainsKeyValue(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
...
func TestInt64CharListMultimap_Generated_Clear(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestInt64CharListMultimap_Generated_ForEach(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
	count := 0
	m.ForEach(func(_ int64, _ uint16) {
		count++
	})
	if count != 3 {
...
func TestInt64CharListMultimap_Generated_ForEachKeyValues(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
	keyCount := 0
	m.ForEachKeyValues(func(_ int64, vals []uint16) {
		keyCount++
		if len(vals) == 0 {
...
func TestInt64CharListMultimap_Generated_SelectReject(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
	sel := m.Select(func(_ int64, v uint16) bool { return v == 1 })
	if sel.Size() != 1 {
		t.Errorf("Select size = %d, want 1", sel.Size())
	}
	rej := m.Reject(func(_ int64, v uint16) bool { return v == 1 })
	if rej.Size() != 2 {
		t.Errorf("Reject size = %d, want 2", rej.Size())
	}
}

func TestInt64CharListMultimap_Generated_KeysValues(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt64CharListMultimap_Generated_Equals(t *testing.T) {
	m1 := NewInt64CharListMultimap()
	m1.Put(1, 1)
	m1.Put(1, 2)
	m2 := NewInt64CharListMultimap()
	m2.Put(1, 1)
	m2.Put(1, 2)
	if !m1.Equals(m2) {
...
func TestInt64CharListMultimap_Generated_String(t *testing.T) {
	m := NewInt64CharListMultimap()
	m.Put(1, 1)
	s := m.String()
	if len(s) == 0 {
...
func TestInt64CharListMultimap_Generated_FluentAPI(t *testing.T) {
	m := NewInt64CharListMultimap()
