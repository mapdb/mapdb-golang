...
// Int64CharSetMultimap is a set multimap from int64 keys to uint16 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int64CharSetMultimap struct {
	data map[int64][]uint16
	size int
}

// NewInt64CharSetMultimap creates a new empty Int64CharSetMultimap.
func NewInt64CharSetMultimap() *Int64CharSetMultimap {
	return &Int64CharSetMultimap{
...
func (m *Int64CharSetMultimap) Put(key int64, value uint16) {
...
func (m *Int64CharSetMultimap) Get(key int64) []uint16 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int64CharSetMultimap) GetAll(key int64) []uint16 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int64CharSetMultimap) RemoveAll(key int64) []uint16 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int64CharSetMultimap) ContainsKey(key int64) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int64CharSetMultimap) ContainsKeyValue(key int64, value uint16) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int64CharSetMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int64CharSetMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int64CharSetMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int64CharSetMultimap) Clear() {
	m.data = make(map[int64][]uint16)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int64CharSetMultimap) ForEach(f func(int64, uint16)) {
...
func (m *Int64CharSetMultimap) ForEachKeyValues(f func(int64, []uint16)) {
	for key, vals := range m.data {
...
func (m *Int64CharSetMultimap) Keys() []int64 {
...
func (m *Int64CharSetMultimap) Values() []uint16 {
...
func (m *Int64CharSetMultimap) Select(predicate func(int64, uint16) bool) *Int64CharSetMultimap {
	result := NewInt64CharSetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int64CharSetMultimap) Reject(predicate func(int64, uint16) bool) *Int64CharSetMultimap {
	result := NewInt64CharSetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int64CharSetMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int64CharSetMultimap) Equals(other *Int64CharSetMultimap) bool {
...
func (m *Int64CharSetMultimap) KeysToSlice() []int64 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int64CharSetMultimap) ValuesToSlice() []uint16 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int64CharSetMultimap) WithKeyValue(key int64, value uint16) *Int64CharSetMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int64CharSetMultimap) WithoutKey(key int64) *Int64CharSetMultimap {
	m.RemoveAll(key)
	return m
}
