...
// Int64Float64ListMultimap is a list multimap from int64 keys to float64 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int64Float64ListMultimap struct {
	data map[int64][]float64
	size int
}

// NewInt64Float64ListMultimap creates a new empty Int64Float64ListMultimap.
func NewInt64Float64ListMultimap() *Int64Float64ListMultimap {
	return &Int64Float64ListMultimap{
...
func (m *Int64Float64ListMultimap) Put(key int64, value float64) {
	m.data[key] = append(m.data[key], value)
	m.size++
}

// Get returns a copy of the values for the given key. Returns nil if the key is absent.
func (m *Int64Float64ListMultimap) Get(key int64) []float64 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int64Float64ListMultimap) GetAll(key int64) []float64 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int64Float64ListMultimap) RemoveAll(key int64) []float64 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int64Float64ListMultimap) ContainsKey(key int64) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int64Float64ListMultimap) ContainsKeyValue(key int64, value float64) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int64Float64ListMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int64Float64ListMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int64Float64ListMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int64Float64ListMultimap) Clear() {
	m.data = make(map[int64][]float64)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int64Float64ListMultimap) ForEach(f func(int64, float64)) {
...
func (m *Int64Float64ListMultimap) ForEachKeyValues(f func(int64, []float64)) {
	for key, vals := range m.data {
...
func (m *Int64Float64ListMultimap) Keys() []int64 {
...
func (m *Int64Float64ListMultimap) Values() []float64 {
...
func (m *Int64Float64ListMultimap) Select(predicate func(int64, float64) bool) *Int64Float64ListMultimap {
	result := NewInt64Float64ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int64Float64ListMultimap) Reject(predicate func(int64, float64) bool) *Int64Float64ListMultimap {
	result := NewInt64Float64ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int64Float64ListMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int64Float64ListMultimap) Equals(other *Int64Float64ListMultimap) bool {
...
func (m *Int64Float64ListMultimap) KeysToSlice() []int64 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int64Float64ListMultimap) ValuesToSlice() []float64 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int64Float64ListMultimap) WithKeyValue(key int64, value float64) *Int64Float64ListMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int64Float64ListMultimap) WithoutKey(key int64) *Int64Float64ListMultimap {
	m.RemoveAll(key)
	return m
}
