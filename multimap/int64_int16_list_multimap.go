...
// Int64Int16List is a list multimap from int64 keys to int16 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int64Int16List struct {
	data map[int64][]int16
	size int
}

// NewInt64Int16List creates a new empty Int64Int16List.
func NewInt64Int16List() *Int64Int16List {
	return &Int64Int16List{
		data: make(map[int64][]int16),
		size: 0,
	}
}

// Int64Int16ListBulkLoad builds a Int64Int16List from keys/values in a single
...
// every value).
func Int64Int16ListBulkLoad(keys []int64, values []int16) *Int64Int16List {
	if len(keys) != len(values) {
		panic("mapdb: Int64Int16ListBulkLoad: len(keys) != len(values)")
	}
	m := &Int64Int16List{
		data: make(map[int64][]int16, len(keys)),
	}
	for i := range keys {
...
// NewInt64Int16ListFromSortedKeys builds a Int64Int16List from input grouped
...
func NewInt64Int16ListFromSortedKeys(keys []int64, values []int16) (*Int64Int16List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt64Int16ListFromSortedKeys: len(keys) != len(values)")
	}
	m := &Int64Int16List{
		data: make(map[int64][]int16),
	}
...
// NewInt64Int16ListFromSortedKeyValues builds a Int64Int16List from input
...
// not sorted within each key, use Int64Int16ListBulkLoad instead.
func NewInt64Int16ListFromSortedKeyValues(keys []int64, values []int16) (*Int64Int16List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt64Int16ListFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int64Int16List{
		data: make(map[int64][]int16),
	}
...
func (m *Int64Int16List) Put(key int64, value int16) {
	if m.data == nil {
...
func (m *Int64Int16List) Get(key int64) []int16 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int64Int16List) GetAll(key int64) []int16 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int64Int16List) RemoveAll(key int64) []int16 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int64Int16List) ContainsKey(key int64) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int64Int16List) ContainsKeyValue(key int64, value int16) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int64Int16List) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int64Int16List) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int64Int16List) Clear() {
	m.data = make(map[int64][]int16)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int64Int16List) ForEach(f func(int64, int16)) {
...
func (m *Int64Int16List) All() iter.Seq2[int64, int16] {
...
func (m *Int64Int16List) ForEachKeyValues(f func(int64, []int16)) {
	for key, vals := range m.data {
...
func (m *Int64Int16List) Keys() []int64 {
...
func (m *Int64Int16List) Values() []int16 {
...
func (m *Int64Int16List) Select(predicate func(int64, int16) bool) *Int64Int16List {
	result := NewInt64Int16List()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int64Int16List) Reject(predicate func(int64, int16) bool) *Int64Int16List {
	result := NewInt64Int16List()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int64Int16List) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int64Int16List) Equals(other *Int64Int16List) bool {
...
func (m *Int64Int16List) KeysToSlice() []int64 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int64Int16List) ValuesToSlice() []int16 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int64Int16List) PutReturning(key int64, value int16) *Int64Int16List {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int64Int16List) RemoveKeyReturning(key int64) *Int64Int16List {
	m.RemoveAll(key)
	return m
}
