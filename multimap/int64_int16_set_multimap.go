...
// Int64Int16Set is a set multimap from int64 keys to int16 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int64Int16Set struct {
	data map[int64][]int16
	size int
}

// NewInt64Int16Set creates a new empty Int64Int16Set.
func NewInt64Int16Set() *Int64Int16Set {
	return &Int64Int16Set{
		data: make(map[int64][]int16),
		size: 0,
	}
}

// Int64Int16SetBulkLoad builds a Int64Int16Set from keys/values in a single
...
func Int64Int16SetBulkLoad(keys []int64, values []int16) *Int64Int16Set {
	if len(keys) != len(values) {
		panic("mapdb: Int64Int16SetBulkLoad: len(keys) != len(values)")
	}
	m := &Int64Int16Set{
...
// NewInt64Int16SetFromSortedKeyValues builds a Int64Int16Set from input sorted
...
// not sorted within each key, use Int64Int16SetBulkLoad instead.
func NewInt64Int16SetFromSortedKeyValues(keys []int64, values []int16) (*Int64Int16Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt64Int16SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int64Int16Set{
		data: make(map[int64][]int16),
	}
...
func (m *Int64Int16Set) Put(key int64, value int16) {
	if m.data == nil {
...
func (m *Int64Int16Set) Get(key int64) []int16 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int64Int16Set) GetAll(key int64) []int16 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int64Int16Set) RemoveAll(key int64) []int16 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int64Int16Set) ContainsKey(key int64) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int64Int16Set) ContainsKeyValue(key int64, value int16) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int64Int16Set) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int64Int16Set) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int64Int16Set) Clear() {
	m.data = make(map[int64][]int16)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int64Int16Set) ForEach(f func(int64, int16)) {
...
func (m *Int64Int16Set) All() iter.Seq2[int64, int16] {
...
func (m *Int64Int16Set) ForEachKeyValues(f func(int64, []int16)) {
	for key, vals := range m.data {
...
func (m *Int64Int16Set) Keys() []int64 {
...
func (m *Int64Int16Set) Values() []int16 {
...
func (m *Int64Int16Set) Select(predicate func(int64, int16) bool) *Int64Int16Set {
	result := NewInt64Int16Set()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int64Int16Set) Reject(predicate func(int64, int16) bool) *Int64Int16Set {
	result := NewInt64Int16Set()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int64Int16Set) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int64Int16Set) Equals(other *Int64Int16Set) bool {
...
func (m *Int64Int16Set) KeysToSlice() []int64 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int64Int16Set) ValuesToSlice() []int16 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int64Int16Set) PutReturning(key int64, value int16) *Int64Int16Set {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int64Int16Set) RemoveKeyReturning(key int64) *Int64Int16Set {
	m.RemoveAll(key)
	return m
}
