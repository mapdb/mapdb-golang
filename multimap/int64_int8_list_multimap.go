...
// Int64Int8List is a list multimap from int64 keys to int8 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int64Int8List struct {
	data map[int64][]int8
	size int
}

// NewInt64Int8List creates a new empty Int64Int8List.
func NewInt64Int8List() *Int64Int8List {
	return &Int64Int8List{
		data: make(map[int64][]int8),
		size: 0,
	}
}

// Int64Int8ListBulkLoad builds a Int64Int8List from keys/values in a single
...
// every value).
func Int64Int8ListBulkLoad(keys []int64, values []int8) *Int64Int8List {
	if len(keys) != len(values) {
		panic("mapdb: Int64Int8ListBulkLoad: len(keys) != len(values)")
	}
	m := &Int64Int8List{
		data: make(map[int64][]int8, len(keys)),
	}
	for i := range keys {
...
// NewInt64Int8ListFromSortedKeys builds a Int64Int8List from input grouped
...
func NewInt64Int8ListFromSortedKeys(keys []int64, values []int8) (*Int64Int8List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt64Int8ListFromSortedKeys: len(keys) != len(values)")
	}
	m := &Int64Int8List{
		data: make(map[int64][]int8),
	}
...
// NewInt64Int8ListFromSortedKeyValues builds a Int64Int8List from input
...
// not sorted within each key, use Int64Int8ListBulkLoad instead.
func NewInt64Int8ListFromSortedKeyValues(keys []int64, values []int8) (*Int64Int8List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt64Int8ListFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int64Int8List{
		data: make(map[int64][]int8),
	}
...
func (m *Int64Int8List) Put(key int64, value int8) {
	if m.data == nil {
...
func (m *Int64Int8List) Get(key int64) []int8 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int64Int8List) GetAll(key int64) []int8 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int64Int8List) RemoveAll(key int64) []int8 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int64Int8List) ContainsKey(key int64) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int64Int8List) ContainsKeyValue(key int64, value int8) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int64Int8List) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int64Int8List) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int64Int8List) Clear() {
	m.data = make(map[int64][]int8)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int64Int8List) ForEach(f func(int64, int8)) {
...
func (m *Int64Int8List) All() iter.Seq2[int64, int8] {
...
func (m *Int64Int8List) ForEachKeyValues(f func(int64, []int8)) {
	for key, vals := range m.data {
...
func (m *Int64Int8List) Keys() []int64 {
...
func (m *Int64Int8List) Values() []int8 {
...
func (m *Int64Int8List) Select(predicate func(int64, int8) bool) *Int64Int8List {
	result := NewInt64Int8List()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int64Int8List) Reject(predicate func(int64, int8) bool) *Int64Int8List {
	result := NewInt64Int8List()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int64Int8List) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int64Int8List) Equals(other *Int64Int8List) bool {
...
func (m *Int64Int8List) KeysToSlice() []int64 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int64Int8List) ValuesToSlice() []int8 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int64Int8List) PutReturning(key int64, value int8) *Int64Int8List {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int64Int8List) RemoveKeyReturning(key int64) *Int64Int8List {
	m.RemoveAll(key)
	return m
}
