...
// Int64Int8Set is a set multimap from int64 keys to int8 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int64Int8Set struct {
	data map[int64][]int8
	size int
}

// NewInt64Int8Set creates a new empty Int64Int8Set.
func NewInt64Int8Set() *Int64Int8Set {
	return &Int64Int8Set{
...
// Int64Int8SetBulkLoad builds a Int64Int8Set from keys/values in a single
...
func Int64Int8SetBulkLoad(keys []int64, values []int8) *Int64Int8Set {
	if len(keys) != len(values) {
		panic("mapdb: Int64Int8SetBulkLoad: len(keys) != len(values)")
	}
	m := &Int64Int8Set{
...
// NewInt64Int8SetFromSortedKeyValues builds a Int64Int8Set from input sorted
...
// not sorted within each key, use Int64Int8SetBulkLoad instead.
func NewInt64Int8SetFromSortedKeyValues(keys []int64, values []int8) (*Int64Int8Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt64Int8SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int64Int8Set{
		data: make(map[int64][]int8),
	}
...
func (m *Int64Int8Set) Put(key int64, value int8) {
	if m.data == nil {
...
func (m *Int64Int8Set) Get(key int64) []int8 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int64Int8Set) GetAll(key int64) []int8 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int64Int8Set) RemoveAll(key int64) []int8 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int64Int8Set) ContainsKey(key int64) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int64Int8Set) ContainsKeyValue(key int64, value int8) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int64Int8Set) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int64Int8Set) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int64Int8Set) Clear() {
	m.data = make(map[int64][]int8)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int64Int8Set) ForEach(f func(int64, int8)) {
...
func (m *Int64Int8Set) All() iter.Seq2[int64, int8] {
...
func (m *Int64Int8Set) ForEachKeyValues(f func(int64, []int8)) {
	for key, vals := range m.data {
...
func (m *Int64Int8Set) Keys() []int64 {
...
func (m *Int64Int8Set) Values() []int8 {
...
func (m *Int64Int8Set) Select(predicate func(int64, int8) bool) *Int64Int8Set {
	result := NewInt64Int8Set()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int64Int8Set) Reject(predicate func(int64, int8) bool) *Int64Int8Set {
	result := NewInt64Int8Set()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int64Int8Set) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int64Int8Set) Equals(other *Int64Int8Set) bool {
...
func (m *Int64Int8Set) KeysToSlice() []int64 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int64Int8Set) ValuesToSlice() []int8 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int64Int8Set) PutReturning(key int64, value int8) *Int64Int8Set {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int64Int8Set) RemoveKeyReturning(key int64) *Int64Int8Set {
	m.RemoveAll(key)
	return m
}
