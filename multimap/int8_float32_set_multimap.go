...
// Int8Float32SetMultimap is a set multimap from int8 keys to float32 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int8Float32SetMultimap struct {
	data map[int8][]float32
	size int
}

// NewInt8Float32SetMultimap creates a new empty Int8Float32SetMultimap.
func NewInt8Float32SetMultimap() *Int8Float32SetMultimap {
	return &Int8Float32SetMultimap{
...
func (m *Int8Float32SetMultimap) Put(key int8, value float32) {
...
func (m *Int8Float32SetMultimap) Get(key int8) []float32 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int8Float32SetMultimap) GetAll(key int8) []float32 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int8Float32SetMultimap) RemoveAll(key int8) []float32 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int8Float32SetMultimap) ContainsKey(key int8) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int8Float32SetMultimap) ContainsKeyValue(key int8, value float32) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int8Float32SetMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int8Float32SetMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int8Float32SetMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int8Float32SetMultimap) Clear() {
	m.data = make(map[int8][]float32)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int8Float32SetMultimap) ForEach(f func(int8, float32)) {
...
func (m *Int8Float32SetMultimap) ForEachKeyValues(f func(int8, []float32)) {
	for key, vals := range m.data {
...
func (m *Int8Float32SetMultimap) Keys() []int8 {
...
func (m *Int8Float32SetMultimap) Values() []float32 {
...
func (m *Int8Float32SetMultimap) Select(predicate func(int8, float32) bool) *Int8Float32SetMultimap {
	result := NewInt8Float32SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int8Float32SetMultimap) Reject(predicate func(int8, float32) bool) *Int8Float32SetMultimap {
	result := NewInt8Float32SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int8Float32SetMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int8Float32SetMultimap) Equals(other *Int8Float32SetMultimap) bool {
...
func (m *Int8Float32SetMultimap) KeysToSlice() []int8 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int8Float32SetMultimap) ValuesToSlice() []float32 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int8Float32SetMultimap) WithKeyValue(key int8, value float32) *Int8Float32SetMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int8Float32SetMultimap) WithoutKey(key int8) *Int8Float32SetMultimap {
	m.RemoveAll(key)
	return m
}
