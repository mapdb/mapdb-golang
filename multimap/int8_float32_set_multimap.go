...
// Int8Float32Set is a set multimap from int8 keys to float32 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int8Float32Set struct {
	data map[int8][]float32
	size int
}

// NewInt8Float32Set creates a new empty Int8Float32Set.
func NewInt8Float32Set() *Int8Float32Set {
	return &Int8Float32Set{
		data: make(map[int8][]float32),
		size: 0,
	}
}

// Int8Float32SetBulkLoad builds a Int8Float32Set from keys/values in a single
...
func Int8Float32SetBulkLoad(keys []int8, values []float32) *Int8Float32Set {
	if len(keys) != len(values) {
		panic("mapdb: Int8Float32SetBulkLoad: len(keys) != len(values)")
	}
	m := &Int8Float32Set{
...
// NewInt8Float32SetFromSortedKeyValues builds a Int8Float32Set from input sorted
...
// not sorted within each key, use Int8Float32SetBulkLoad instead.
func NewInt8Float32SetFromSortedKeyValues(keys []int8, values []float32) (*Int8Float32Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt8Float32SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int8Float32Set{
		data: make(map[int8][]float32),
	}
...
func (m *Int8Float32Set) Put(key int8, value float32) {
	if m.data == nil {
...
func (m *Int8Float32Set) Get(key int8) []float32 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int8Float32Set) GetAll(key int8) []float32 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int8Float32Set) RemoveAll(key int8) []float32 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int8Float32Set) ContainsKey(key int8) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int8Float32Set) ContainsKeyValue(key int8, value float32) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int8Float32Set) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int8Float32Set) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int8Float32Set) Clear() {
	m.data = make(map[int8][]float32)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int8Float32Set) ForEach(f func(int8, float32)) {
...
func (m *Int8Float32Set) All() iter.Seq2[int8, float32] {
...
func (m *Int8Float32Set) ForEachKeyValues(f func(int8, []float32)) {
	for key, vals := range m.data {
...
func (m *Int8Float32Set) Keys() []int8 {
...
func (m *Int8Float32Set) Values() []float32 {
...
func (m *Int8Float32Set) Select(predicate func(int8, float32) bool) *Int8Float32Set {
	result := NewInt8Float32Set()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int8Float32Set) Reject(predicate func(int8, float32) bool) *Int8Float32Set {
	result := NewInt8Float32Set()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int8Float32Set) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int8Float32Set) Equals(other *Int8Float32Set) bool {
...
func (m *Int8Float32Set) KeysToSlice() []int8 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int8Float32Set) ValuesToSlice() []float32 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int8Float32Set) PutReturning(key int8, value float32) *Int8Float32Set {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int8Float32Set) RemoveKeyReturning(key int8) *Int8Float32Set {
	m.RemoveAll(key)
	return m
}
