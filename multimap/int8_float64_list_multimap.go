...
// Int8Float64ListMultimap is a list multimap from int8 keys to float64 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int8Float64ListMultimap struct {
	data map[int8][]float64
	size int
}

// NewInt8Float64ListMultimap creates a new empty Int8Float64ListMultimap.
func NewInt8Float64ListMultimap() *Int8Float64ListMultimap {
	return &Int8Float64ListMultimap{
...
func (m *Int8Float64ListMultimap) Put(key int8, value float64) {
	m.data[key] = append(m.data[key], value)
	m.size++
}

// Get returns a copy of the values for the given key. Returns nil if the key is absent.
func (m *Int8Float64ListMultimap) Get(key int8) []float64 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int8Float64ListMultimap) GetAll(key int8) []float64 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int8Float64ListMultimap) RemoveAll(key int8) []float64 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int8Float64ListMultimap) ContainsKey(key int8) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int8Float64ListMultimap) ContainsKeyValue(key int8, value float64) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int8Float64ListMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int8Float64ListMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int8Float64ListMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int8Float64ListMultimap) Clear() {
	m.data = make(map[int8][]float64)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int8Float64ListMultimap) ForEach(f func(int8, float64)) {
...
func (m *Int8Float64ListMultimap) ForEachKeyValues(f func(int8, []float64)) {
	for key, vals := range m.data {
...
func (m *Int8Float64ListMultimap) Keys() []int8 {
...
func (m *Int8Float64ListMultimap) Values() []float64 {
...
func (m *Int8Float64ListMultimap) Select(predicate func(int8, float64) bool) *Int8Float64ListMultimap {
	result := NewInt8Float64ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int8Float64ListMultimap) Reject(predicate func(int8, float64) bool) *Int8Float64ListMultimap {
	result := NewInt8Float64ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int8Float64ListMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int8Float64ListMultimap) Equals(other *Int8Float64ListMultimap) bool {
...
func (m *Int8Float64ListMultimap) KeysToSlice() []int8 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int8Float64ListMultimap) ValuesToSlice() []float64 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int8Float64ListMultimap) WithKeyValue(key int8, value float64) *Int8Float64ListMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int8Float64ListMultimap) WithoutKey(key int8) *Int8Float64ListMultimap {
	m.RemoveAll(key)
	return m
}
