...
// Int8Int16Set is a set multimap from int8 keys to int16 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int8Int16Set struct {
	data map[int8][]int16
	size int
}

// NewInt8Int16Set creates a new empty Int8Int16Set.
func NewInt8Int16Set() *Int8Int16Set {
	return &Int8Int16Set{
...
// Int8Int16SetBulkLoad builds a Int8Int16Set from keys/values in a single
...
func Int8Int16SetBulkLoad(keys []int8, values []int16) *Int8Int16Set {
	if len(keys) != len(values) {
		panic("mapdb: Int8Int16SetBulkLoad: len(keys) != len(values)")
	}
	m := &Int8Int16Set{
...
// NewInt8Int16SetFromSortedKeyValues builds a Int8Int16Set from input sorted
...
// not sorted within each key, use Int8Int16SetBulkLoad instead.
func NewInt8Int16SetFromSortedKeyValues(keys []int8, values []int16) (*Int8Int16Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt8Int16SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int8Int16Set{
		data: make(map[int8][]int16),
	}
...
func (m *Int8Int16Set) Put(key int8, value int16) {
	if m.data == nil {
...
func (m *Int8Int16Set) Get(key int8) []int16 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int8Int16Set) GetAll(key int8) []int16 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int8Int16Set) RemoveAll(key int8) []int16 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int8Int16Set) ContainsKey(key int8) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int8Int16Set) ContainsKeyValue(key int8, value int16) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int8Int16Set) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int8Int16Set) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int8Int16Set) Clear() {
	m.data = make(map[int8][]int16)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int8Int16Set) ForEach(f func(int8, int16)) {
...
func (m *Int8Int16Set) All() iter.Seq2[int8, int16] {
...
func (m *Int8Int16Set) ForEachKeyValues(f func(int8, []int16)) {
	for key, vals := range m.data {
...
func (m *Int8Int16Set) Values() []int16 {
...
func (m *Int8Int16Set) Select(predicate func(int8, int16) bool) *Int8Int16Set {
	result := NewInt8Int16Set()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int8Int16Set) Reject(predicate func(int8, int16) bool) *Int8Int16Set {
	result := NewInt8Int16Set()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int8Int16Set) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int8Int16Set) Equals(other *Int8Int16Set) bool {
...
func (m *Int8Int16Set) KeysToSlice() []int8 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int8Int16Set) ValuesToSlice() []int16 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int8Int16Set) PutReturning(key int8, value int16) *Int8Int16Set {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int8Int16Set) RemoveKeyReturning(key int8) *Int8Int16Set {
	m.RemoveAll(key)
	return m
}
