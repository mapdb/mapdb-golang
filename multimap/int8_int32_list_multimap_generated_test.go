...
func TestInt8Int32List_Generated_PutGet(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt8Int32List_Generated_GetAll(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	m.Put(1, 2)
	vals := m.GetAll(1)
...
func TestInt8Int32List_Generated_GetDoesNotAlias(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	m.Put(1, 2)
	vals := m.Get(1)
...
func TestInt8Int32List_Generated_RemoveAll(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt8Int32List_Generated_ContainsKey(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestInt8Int32List_Generated_ContainsKeyValue(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	m.Put(1, 2)
...
func TestInt8Int32List_Generated_Clear(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Clear()
...
func TestInt8Int32List_Generated_ForEach(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt8Int32List_Generated_ForEachKeyValues(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt8Int32List_Generated_SelectReject(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt8Int32List_Generated_KeysValues(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	m.Put(1, 2)
	m.Put(2, 3)
...
func TestInt8Int32List_Generated_Equals(t *testing.T) {
	m1 := NewInt8Int32List()
	m1.Put(1, 1)
	m1.Put(1, 2)
	m2 := NewInt8Int32List()
...
func TestInt8Int32List_Generated_String(t *testing.T) {
	m := NewInt8Int32List()
	m.Put(1, 1)
	s := m.String()
	if len(s) == 0 {
...
func TestInt8Int32List_Generated_FluentAPI(t *testing.T) {
	m := NewInt8Int32List()
