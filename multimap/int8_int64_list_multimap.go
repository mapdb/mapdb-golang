...
// NewInt8Int64ListFromSortedKeyValues builds a Int8Int64List from input
...
// not sorted within each key, use Int8Int64ListBulkLoad instead.
func NewInt8Int64ListFromSortedKeyValues(keys []int8, values []int64) (*Int8Int64List, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt8Int64ListFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int8Int64List{
		data: make(map[int8][]int64),
	}
...
func (m *Int8Int64List) All() iter.Seq2[int8, int64] {
