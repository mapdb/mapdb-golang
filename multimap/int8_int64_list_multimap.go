...
// Int8Int64ListMultimap is a list multimap from int8 keys to int64 values.
// Each key maps to a slice of values, preserving insertion order per key.
type Int8Int64ListMultimap struct {
	data map[int8][]int64
	size int
}

// NewInt8Int64ListMultimap creates a new empty Int8Int64ListMultimap.
func NewInt8Int64ListMultimap() *Int8Int64ListMultimap {
	return &Int8Int64ListMultimap{
...
func (m *Int8Int64ListMultimap) Put(key int8, value int64) {
	m.data[key] = append(m.data[key], value)
	m.size++
}

// Get returns a copy of the values for the given key. Returns nil if the key is absent.
func (m *Int8Int64ListMultimap) Get(key int8) []int64 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int8Int64ListMultimap) GetAll(key int8) []int64 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int8Int64ListMultimap) RemoveAll(key int8) []int64 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int8Int64ListMultimap) ContainsKey(key int8) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int8Int64ListMultimap) ContainsKeyValue(key int8, value int64) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int8Int64ListMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int8Int64ListMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int8Int64ListMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int8Int64ListMultimap) Clear() {
	m.data = make(map[int8][]int64)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int8Int64ListMultimap) ForEach(f func(int8, int64)) {
...
func (m *Int8Int64ListMultimap) ForEachKeyValues(f func(int8, []int64)) {
	for key, vals := range m.data {
...
func (m *Int8Int64ListMultimap) Keys() []int8 {
...
func (m *Int8Int64ListMultimap) Values() []int64 {
...
func (m *Int8Int64ListMultimap) Select(predicate func(int8, int64) bool) *Int8Int64ListMultimap {
	result := NewInt8Int64ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int8Int64ListMultimap) Reject(predicate func(int8, int64) bool) *Int8Int64ListMultimap {
	result := NewInt8Int64ListMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int8Int64ListMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int8Int64ListMultimap) Equals(other *Int8Int64ListMultimap) bool {
...
func (m *Int8Int64ListMultimap) KeysToSlice() []int8 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int8Int64ListMultimap) ValuesToSlice() []int64 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int8Int64ListMultimap) WithKeyValue(key int8, value int64) *Int8Int64ListMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int8Int64ListMultimap) WithoutKey(key int8) *Int8Int64ListMultimap {
	m.RemoveAll(key)
	return m
}
