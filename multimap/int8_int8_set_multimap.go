...
// Int8Int8SetMultimap is a set multimap from int8 keys to int8 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int8Int8SetMultimap struct {
	data map[int8][]int8
	size int
}

// NewInt8Int8SetMultimap creates a new empty Int8Int8SetMultimap.
func NewInt8Int8SetMultimap() *Int8Int8SetMultimap {
	return &Int8Int8SetMultimap{
...
func (m *Int8Int8SetMultimap) Put(key int8, value int8) {
...
func (m *Int8Int8SetMultimap) Get(key int8) []int8 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int8Int8SetMultimap) GetAll(key int8) []int8 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int8Int8SetMultimap) RemoveAll(key int8) []int8 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int8Int8SetMultimap) ContainsKey(key int8) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int8Int8SetMultimap) ContainsKeyValue(key int8, value int8) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int8Int8SetMultimap) KeysCount() int {
	return len(m.data)
}

// Size returns the total number of values across all keys.
func (m *Int8Int8SetMultimap) Size() int {
	return m.size
}

// IsEmpty returns true if the multimap contains no values.
func (m *Int8Int8SetMultimap) IsEmpty() bool {
	return m.size == 0
}

// Clear removes all entries from the multimap.
func (m *Int8Int8SetMultimap) Clear() {
	m.data = make(map[int8][]int8)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int8Int8SetMultimap) ForEach(f func(int8, int8)) {
...
func (m *Int8Int8SetMultimap) ForEachKeyValues(f func(int8, []int8)) {
	for key, vals := range m.data {
...
func (m *Int8Int8SetMultimap) Keys() []int8 {
...
func (m *Int8Int8SetMultimap) Values() []int8 {
...
func (m *Int8Int8SetMultimap) Select(predicate func(int8, int8) bool) *Int8Int8SetMultimap {
	result := NewInt8Int8SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int8Int8SetMultimap) Reject(predicate func(int8, int8) bool) *Int8Int8SetMultimap {
	result := NewInt8Int8SetMultimap()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int8Int8SetMultimap) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int8Int8SetMultimap) Equals(other *Int8Int8SetMultimap) bool {
...
func (m *Int8Int8SetMultimap) KeysToSlice() []int8 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int8Int8SetMultimap) ValuesToSlice() []int8 {
	return m.Values()
}

// WithKeyValue adds a key-value pair and returns the multimap (fluent API).
func (m *Int8Int8SetMultimap) WithKeyValue(key int8, value int8) *Int8Int8SetMultimap {
	m.Put(key, value)
	return m
}

// WithoutKey removes all values for the key and returns the multimap (fluent API).
func (m *Int8Int8SetMultimap) WithoutKey(key int8) *Int8Int8SetMultimap {
	m.RemoveAll(key)
	return m
}
