...
// Int8Int8Set is a set multimap from int8 keys to int8 values.
// Each key maps to a set of unique values (duplicates on Put are silently dropped).
type Int8Int8Set struct {
	data map[int8][]int8
	size int
}

// NewInt8Int8Set creates a new empty Int8Int8Set.
func NewInt8Int8Set() *Int8Int8Set {
	return &Int8Int8Set{
...
// Int8Int8SetBulkLoad builds a Int8Int8Set from keys/values in a single
...
func Int8Int8SetBulkLoad(keys []int8, values []int8) *Int8Int8Set {
	if len(keys) != len(values) {
		panic("mapdb: Int8Int8SetBulkLoad: len(keys) != len(values)")
	}
	m := &Int8Int8Set{
...
// NewInt8Int8SetFromSortedKeyValues builds a Int8Int8Set from input sorted
...
// not sorted within each key, use Int8Int8SetBulkLoad instead.
func NewInt8Int8SetFromSortedKeyValues(keys []int8, values []int8) (*Int8Int8Set, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt8Int8SetFromSortedKeyValues: len(keys) != len(values)")
	}
	m := &Int8Int8Set{
		data: make(map[int8][]int8),
	}
...
func (m *Int8Int8Set) Put(key int8, value int8) {
	if m.data == nil {
...
func (m *Int8Int8Set) Get(key int8) []int8 {
	return m.GetAll(key)
}

// GetAll returns a copy of the values for the given key.
func (m *Int8Int8Set) GetAll(key int8) []int8 {
	vals := m.data[key]
	if vals == nil {
		return nil
	}
...
func (m *Int8Int8Set) RemoveAll(key int8) []int8 {
	vals, ok := m.data[key]
	if !ok {
		return nil
	}
...
func (m *Int8Int8Set) ContainsKey(key int8) bool {
	_, ok := m.data[key]
	return ok
}

// ContainsKeyValue returns true if the multimap contains the given key-value pair.
func (m *Int8Int8Set) ContainsKeyValue(key int8, value int8) bool {
	vals, ok := m.data[key]
	if !ok {
		return false
	}
...
func (m *Int8Int8Set) KeysCount() int {
	return len(m.data)
}

// Len returns the number of elements. Use m.Len() == 0 to test for emptiness.
func (m *Int8Int8Set) Len() int {
	return m.size
}

// Clear removes all entries from the multimap.
func (m *Int8Int8Set) Clear() {
	m.data = make(map[int8][]int8)
	m.size = 0
}

// ForEach calls the given function for each key-value pair.
func (m *Int8Int8Set) ForEach(f func(int8, int8)) {
...
func (m *Int8Int8Set) All() iter.Seq2[int8, int8] {
...
func (m *Int8Int8Set) ForEachKeyValues(f func(int8, []int8)) {
	for key, vals := range m.data {
...
func (m *Int8Int8Set) Values() []int8 {
...
func (m *Int8Int8Set) Select(predicate func(int8, int8) bool) *Int8Int8Set {
	result := NewInt8Int8Set()
	for key, vals := range m.data {
		for _, val := range vals {
...
func (m *Int8Int8Set) Reject(predicate func(int8, int8) bool) *Int8Int8Set {
	result := NewInt8Int8Set()
	for key, vals := range m.data {
		for _, val := range vals {
			if !predicate(key, val) {
...
func (m *Int8Int8Set) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int8Int8Set) Equals(other *Int8Int8Set) bool {
...
func (m *Int8Int8Set) KeysToSlice() []int8 {
	return m.Keys()
}

// ValuesToSlice returns all values as a slice.
func (m *Int8Int8Set) ValuesToSlice() []int8 {
	return m.Values()
}

// PutReturning adds a key-value pair and returns the multimap (fluent API).
func (m *Int8Int8Set) PutReturning(key int8, value int8) *Int8Int8Set {
	m.Put(key, value)
	return m
}

// RemoveKeyReturning removes all values for the key and returns the multimap (fluent API).
func (m *Int8Int8Set) RemoveKeyReturning(key int8) *Int8Int8Set {
	m.RemoveAll(key)
	return m
}
