...
func TestCharPriorityQueue_Generated_PushPopMin(t *testing.T) {
	q := NewCharPriorityQueue()
	q.Push(3)
	q.Push(1)
	q.Push(2)
	if q.Size() != 3 {
...
func TestCharPriorityQueue_Generated_Peek(t *testing.T) {
	q := CharPriorityQueueOf(3, 1, 2)
	got, err := q.Peek()
	if err != nil {
...
func TestCharPriorityQueue_Generated_EmptyPeekPop(t *testing.T) {
	q := NewCharPriorityQueue()
...
func TestCharPriorityQueue_Generated_ContainsClear(t *testing.T) {
	q := NewCharPriorityQueue()
	q.Push(1)
	if !q.Contains(1) {
...
func TestCharPriorityQueue_Generated_DrainSorted(t *testing.T) {
	q := CharPriorityQueueOf(3, 1, 2)
