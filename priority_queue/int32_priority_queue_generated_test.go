...
func TestInt32PriorityQueue_Generated_PushPopMin(t *testing.T) {
	q := NewInt32PriorityQueue()
	q.Push(3)
	q.Push(1)
	q.Push(2)
	if q.Size() != 3 {
...
func TestInt32PriorityQueue_Generated_Peek(t *testing.T) {
	q := Int32PriorityQueueOf(3, 1, 2)
	got, err := q.Peek()
	if err != nil {
...
func TestInt32PriorityQueue_Generated_EmptyPeekPop(t *testing.T) {
	q := NewInt32PriorityQueue()
...
func TestInt32PriorityQueue_Generated_ContainsClear(t *testing.T) {
	q := NewInt32PriorityQueue()
	q.Push(1)
	if !q.Contains(1) {
...
func TestInt32PriorityQueue_Generated_DrainSorted(t *testing.T) {
	q := Int32PriorityQueueOf(3, 1, 2)
