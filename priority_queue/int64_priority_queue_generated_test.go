...
func TestInt64PriorityQueue_Generated_PushPopMin(t *testing.T) {
	q := NewInt64PriorityQueue()
	q.Push(3)
	q.Push(1)
	q.Push(2)
	if q.Size() != 3 {
...
func TestInt64PriorityQueue_Generated_Peek(t *testing.T) {
	q := Int64PriorityQueueOf(3, 1, 2)
	got, err := q.Peek()
	if err != nil {
...
func TestInt64PriorityQueue_Generated_EmptyPeekPop(t *testing.T) {
	q := NewInt64PriorityQueue()
...
func TestInt64PriorityQueue_Generated_ContainsClear(t *testing.T) {
	q := NewInt64PriorityQueue()
	q.Push(1)
	if !q.Contains(1) {
...
func TestInt64PriorityQueue_Generated_DrainSorted(t *testing.T) {
	q := Int64PriorityQueueOf(3, 1, 2)
