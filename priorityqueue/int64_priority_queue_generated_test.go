...
func TestInt64_Generated_PushPopMin(t *testing.T) {
	q := NewInt64()
	q.Push(3)
	q.Push(1)
	q.Push(2)
...
func TestInt64_Generated_Peek(t *testing.T) {
	q := Int64Of(3, 1, 2)
	got, ok := q.Peek()
	if !ok {
...
func TestInt64_Generated_EmptyPeekPop(t *testing.T) {
	q := NewInt64()
	if _, ok := q.Peek(); ok {
...
func TestInt64_Generated_ContainsClear(t *testing.T) {
	q := NewInt64()
	q.Push(1)
	if !q.Contains(1) {
...
func TestInt64_Generated_DrainSorted(t *testing.T) {
	q := Int64Of(3, 1, 2)
