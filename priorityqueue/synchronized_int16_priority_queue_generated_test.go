...
func TestSynchronizedInt16_Generated_EmptyPeekPop(t *testing.T) {
	q := NewSynchronizedInt16()
	if _, ok := q.Peek(); ok {
...
func TestSynchronizedInt16_Generated_ContainsClear(t *testing.T) {
	q := NewSynchronizedInt16()
	q.Push(1)
	if !q.Contains(1) {
...
func TestSynchronizedInt16_Generated_DrainSorted(t *testing.T) {
	q := NewSynchronizedInt16()
	q.Push(3)
	q.Push(1)
	q.Push(2)
