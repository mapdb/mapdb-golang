...
func TestSynchronizedInt64_Generated_EmptyPeekPop(t *testing.T) {
	q := NewSynchronizedInt64()
	if _, ok := q.Peek(); ok {
...
func TestSynchronizedInt64_Generated_ContainsClear(t *testing.T) {
	q := NewSynchronizedInt64()
	q.Push(1)
	if !q.Contains(1) {
...
func TestSynchronizedInt64_Generated_DrainSorted(t *testing.T) {
	q := NewSynchronizedInt64()
	q.Push(3)
	q.Push(1)
	q.Push(2)
