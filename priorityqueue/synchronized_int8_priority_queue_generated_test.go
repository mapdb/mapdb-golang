...
func TestSynchronizedInt8_Generated_PushPopPeek(t *testing.T) {
	q := NewSynchronizedInt8()
	q.Push(3)
	q.Push(1)
	q.Push(2)
	if q.Len() != 3 {
...
func TestSynchronizedInt8_Generated_EmptyPeekPop(t *testing.T) {
	q := NewSynchronizedInt8()
	if _, ok := q.Peek(); ok {
...
func TestSynchronizedInt8_Generated_ContainsClear(t *testing.T) {
	q := NewSynchronizedInt8()
	q.Push(1)
	if !q.Contains(1) {
...
func TestSynchronizedInt8_Generated_DrainSorted(t *testing.T) {
	q := NewSynchronizedInt8()
	q.Push(3)
	q.Push(1)
	q.Push(2)
