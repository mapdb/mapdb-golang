...
// The size is a hint; use Float64Int64BulkLoadExact for the zero-rehash
// guarantee.
func Float64Int64BulkLoad(keys []float64, values []int64, policy pump.DuplicatePolicy) (*Float64Int64, error) {
	...
	m := NewFloat64Int64WithCapacity(Float64Int64bulkCap(len(keys)))
	for i := range keys {
...
func Float64Int64BulkLoadExact(keys []float64, values []int64, n int, policy pump.DuplicatePolicy) (*Float64Int64, error) {
	...
	m := NewFloat64Int64WithCapacity(Float64Int64bulkCap(n))
	if len(keys) > n {
...
// rehashes.
func (m *Float64Int64) bulkPut(key float64, value int64, policy pump.DuplicatePolicy) error {
...
func (m *Float64Int64) needsRehash() bool {
...
func (m *Float64Int64) resize(newCap int) {
	oldKeys := m.keys
	oldValues := m.values
	if newCap == 0 {
