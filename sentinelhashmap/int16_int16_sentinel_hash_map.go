...
const (
	...
	int16Int16EmptyKey   = int16(0)
	int16Int16RemovedKey = int16(1)
)

// Int16Int16 is a sentinel-based open-addressing hash map with int16 keys and int16 values.
...
// The size is a hint; use Int16Int16BulkLoadExact for the zero-rehash
// guarantee.
func Int16Int16BulkLoad(keys []int16, values []int16, policy pump.DuplicatePolicy) (*Int16Int16, error) {
	...
	m := NewInt16Int16WithCapacity(Int16Int16bulkCap(len(keys)))
	for i := range keys {
...
func Int16Int16BulkLoadExact(keys []int16, values []int16, n int, policy pump.DuplicatePolicy) (*Int16Int16, error) {
	...
	m := NewInt16Int16WithCapacity(Int16Int16bulkCap(n))
	if len(keys) > n {
...
// rehashes.
func (m *Int16Int16) bulkPut(key int16, value int16, policy pump.DuplicatePolicy) error {
...
func (m *Int16Int16) putRegular(key int16, value int16) (int16, bool) {
	if m.needsResize() {
	...
	empty := int16Int16EmptyKey
	removed := int16Int16RemovedKey
	firstRemoved := -1
...
func (m *Int16Int16) removeRegular(key int16) (int16, bool) {
	cap := len(m.keys)
	if cap == 0 {
		return 0, false
	}
	...
	for probes := 0; probes < cap; probes++ {
		...
		if k == key {
			old := m.values[idx]
			m.keys[idx] = int16Int16RemovedKey
			m.values[idx] = 0
			m.size--
			m.tombstones++
			return old, true
...
func (m *Int16Int16) All() iter.Seq2[int16, int16] {
	return func(yield func(int16, int16) bool) {
		...
		if m.oneKeyPresent {
			if !yield(int16Int16RemovedKey, m.oneKeyValue) {
				return
			}
		}
		empty := int16Int16EmptyKey
...
func (m *Int16Int16) needsRehash() bool {
...
func (m *Int16Int16) resize(newCap int) {
	oldKeys := m.keys
	oldValues := m.values
	if newCap == 0 {
	...
	if savedOnePresent {
		m.Put(int16Int16RemovedKey, savedOneValue)
	}
