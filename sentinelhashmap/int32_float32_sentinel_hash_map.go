...
// The size is a hint; use Int32Float32BulkLoadExact for the zero-rehash
// guarantee.
func Int32Float32BulkLoad(keys []int32, values []float32, policy pump.DuplicatePolicy) (*Int32Float32, error) {
	...
	m := NewInt32Float32WithCapacity(Int32Float32bulkCap(len(keys)))
	for i := range keys {
...
func Int32Float32BulkLoadExact(keys []int32, values []float32, n int, policy pump.DuplicatePolicy) (*Int32Float32, error) {
	...
	m := NewInt32Float32WithCapacity(Int32Float32bulkCap(n))
	if len(keys) > n {
...
// rehashes.
func (m *Int32Float32) bulkPut(key int32, value float32, policy pump.DuplicatePolicy) error {
...
func (m *Int32Float32) needsRehash() bool {
...
func (m *Int32Float32) resize(newCap int) {
	oldKeys := m.keys
	oldValues := m.values
	if newCap == 0 {
