...
const (
	...
	int32Int32EmptyKey   = int32(0)
	int32Int32RemovedKey = int32(1)
)

// Int32Int32 is a sentinel-based open-addressing hash map with int32 keys and int32 values.
...
// The size is a hint; use Int32Int32BulkLoadExact for the zero-rehash
// guarantee.
func Int32Int32BulkLoad(keys []int32, values []int32, policy pump.DuplicatePolicy) (*Int32Int32, error) {
	...
	m := NewInt32Int32WithCapacity(Int32Int32bulkCap(len(keys)))
	for i := range keys {
...
func Int32Int32BulkLoadExact(keys []int32, values []int32, n int, policy pump.DuplicatePolicy) (*Int32Int32, error) {
	...
	m := NewInt32Int32WithCapacity(Int32Int32bulkCap(n))
	if len(keys) > n {
...
// rehashes.
func (m *Int32Int32) bulkPut(key int32, value int32, policy pump.DuplicatePolicy) error {
...
func (m *Int32Int32) putRegular(key int32, value int32) (int32, bool) {
	if m.needsResize() {
	...
	empty := int32Int32EmptyKey
	removed := int32Int32RemovedKey
	firstRemoved := -1
...
func (m *Int32Int32) removeRegular(key int32) (int32, bool) {
	cap := len(m.keys)
	if cap == 0 {
		return 0, false
	}
	...
	for probes := 0; probes < cap; probes++ {
		...
		if k == key {
			old := m.values[idx]
			m.keys[idx] = int32Int32RemovedKey
			m.values[idx] = 0
			m.size--
			m.tombstones++
			return old, true
...
func (m *Int32Int32) All() iter.Seq2[int32, int32] {
	return func(yield func(int32, int32) bool) {
		...
		if m.oneKeyPresent {
			if !yield(int32Int32RemovedKey, m.oneKeyValue) {
				return
			}
		}
		empty := int32Int32EmptyKey
...
func (m *Int32Int32) needsRehash() bool {
...
func (m *Int32Int32) resize(newCap int) {
	oldKeys := m.keys
	oldValues := m.values
	if newCap == 0 {
	...
	if savedOnePresent {
		m.Put(int32Int32RemovedKey, savedOneValue)
	}
