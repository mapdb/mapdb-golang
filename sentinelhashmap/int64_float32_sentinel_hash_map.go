...
// The size is a hint; use Int64Float32BulkLoadExact for the zero-rehash
// guarantee.
func Int64Float32BulkLoad(keys []int64, values []float32, policy pump.DuplicatePolicy) (*Int64Float32, error) {
	...
	m := NewInt64Float32WithCapacity(Int64Float32bulkCap(len(keys)))
	for i := range keys {
...
func Int64Float32BulkLoadExact(keys []int64, values []float32, n int, policy pump.DuplicatePolicy) (*Int64Float32, error) {
	...
	m := NewInt64Float32WithCapacity(Int64Float32bulkCap(n))
	if len(keys) > n {
...
// rehashes.
func (m *Int64Float32) bulkPut(key int64, value float32, policy pump.DuplicatePolicy) error {
...
func (m *Int64Float32) needsRehash() bool {
...
func (m *Int64Float32) resize(newCap int) {
	oldKeys := m.keys
	oldValues := m.values
	if newCap == 0 {
