...
// The size is a hint; use Int64Int16BulkLoadExact for the zero-rehash
// guarantee.
func Int64Int16BulkLoad(keys []int64, values []int16, policy pump.DuplicatePolicy) (*Int64Int16, error) {
	...
	m := NewInt64Int16WithCapacity(Int64Int16bulkCap(len(keys)))
	for i := range keys {
...
func Int64Int16BulkLoadExact(keys []int64, values []int16, n int, policy pump.DuplicatePolicy) (*Int64Int16, error) {
	...
	m := NewInt64Int16WithCapacity(Int64Int16bulkCap(n))
	if len(keys) > n {
...
// rehashes.
func (m *Int64Int16) bulkPut(key int64, value int16, policy pump.DuplicatePolicy) error {
...
func (m *Int64Int16) needsRehash() bool {
...
func (m *Int64Int16) resize(newCap int) {
	oldKeys := m.keys
	oldValues := m.values
	if newCap == 0 {
