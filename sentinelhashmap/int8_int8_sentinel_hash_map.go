...
// The size is a hint; use Int8Int8BulkLoadExact for the zero-rehash
// guarantee.
func Int8Int8BulkLoad(keys []int8, values []int8, policy pump.DuplicatePolicy) (*Int8Int8, error) {
	...
	m := NewInt8Int8WithCapacity(Int8Int8bulkCap(len(keys)))
	for i := range keys {
...
func Int8Int8BulkLoadExact(keys []int8, values []int8, n int, policy pump.DuplicatePolicy) (*Int8Int8, error) {
	...
	m := NewInt8Int8WithCapacity(Int8Int8bulkCap(n))
	if len(keys) > n {
...
// rehashes.
func (m *Int8Int8) bulkPut(key int8, value int8, policy pump.DuplicatePolicy) error {
...
func (m *Int8Int8) needsRehash() bool {
...
func (m *Int8Int8) resize(newCap int) {
	oldKeys := m.keys
	oldValues := m.values
	if newCap == 0 {
