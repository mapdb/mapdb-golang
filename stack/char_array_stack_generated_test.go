...
func TestChar_Generated_PushPeekPop(t *testing.T) {
	s := NewChar()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestChar_Generated_PopPeekEmpty(t *testing.T) {
	s := NewChar()
	if _, ok := s.Pop(); ok {
...
func TestChar_Generated_ForEach(t *testing.T) {
	s := NewChar()
	s.Push(1)
	s.Push(2)
	sum := uint16(0)
...
func TestChar_Generated_LIFO_Order(t *testing.T) {
	s := NewChar()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestChar_Generated_PeekAtPanics(t *testing.T) {
	s := CharOf(1, 2, 3)
