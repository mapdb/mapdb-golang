...
func TestFloat32_Generated_PushPeekPop(t *testing.T) {
	s := NewFloat32()
	s.Push(1.0)
	s.Push(2.0)
	s.Push(3.0)
...
func TestFloat32_Generated_PopPeekEmpty(t *testing.T) {
	s := NewFloat32()
	if _, ok := s.Pop(); ok {
...
func TestFloat32_Generated_ForEach(t *testing.T) {
	s := NewFloat32()
	s.Push(1.0)
	s.Push(2.0)
	sum := float32(0)
...
func TestFloat32_Generated_LIFO_Order(t *testing.T) {
	s := NewFloat32()
	s.Push(1.0)
	s.Push(2.0)
	s.Push(3.0)
...
func TestFloat32_Generated_PeekAtPanics(t *testing.T) {
	s := Float32Of(1, 2, 3)
