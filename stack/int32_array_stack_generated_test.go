...
func TestInt32_Generated_PushPeekPop(t *testing.T) {
	s := NewInt32()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt32_Generated_PopPeekEmpty(t *testing.T) {
	s := NewInt32()
	if _, ok := s.Pop(); ok {
...
func TestInt32_Generated_ForEach(t *testing.T) {
	s := NewInt32()
	s.Push(1)
	s.Push(2)
	sum := int32(0)
...
func TestInt32_Generated_LIFO_Order(t *testing.T) {
	s := NewInt32()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt32_Generated_PeekAtPanics(t *testing.T) {
	s := Int32Of(1, 2, 3)
