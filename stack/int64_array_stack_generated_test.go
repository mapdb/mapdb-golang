...
func TestInt64_Generated_PushPeekPop(t *testing.T) {
	s := NewInt64()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt64_Generated_PopPeekEmpty(t *testing.T) {
	s := NewInt64()
	if _, ok := s.Pop(); ok {
...
func TestInt64_Generated_ForEach(t *testing.T) {
	s := NewInt64()
	s.Push(1)
	s.Push(2)
	sum := int64(0)
...
func TestInt64_Generated_LIFO_Order(t *testing.T) {
	s := NewInt64()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt64_Generated_PeekAtPanics(t *testing.T) {
	s := Int64Of(1, 2, 3)
