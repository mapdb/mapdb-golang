...
func TestInt64ArrayStack_Generated_PushPeekPop(t *testing.T) {
	s := NewInt64ArrayStack()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt64ArrayStack_Generated_PopPeekEmpty(t *testing.T) {
	s := NewInt64ArrayStack()
...
func TestInt64ArrayStack_Generated_IsEmpty(t *testing.T) {
	s := NewInt64ArrayStack()
	if !s.IsEmpty() {
...
func TestInt64ArrayStack_Generated_Clear(t *testing.T) {
	s := NewInt64ArrayStack()
	s.Push(1)
	s.Push(2)
	s.Clear()
...
func TestInt64ArrayStack_Generated_Contains(t *testing.T) {
	s := NewInt64ArrayStack()
	s.Push(1)
	s.Push(2)
	if !s.Contains(1) {
...
func TestInt64ArrayStack_Generated_All(t *testing.T) {
	s := NewInt64ArrayStack()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt64ArrayStack_Generated_ForEach(t *testing.T) {
	s := NewInt64ArrayStack()
	s.Push(1)
	s.Push(2)
	sum := int64(0)
	s.ForEach(func(v int64) {
		sum += v
	})
...
func TestInt64ArrayStack_Generated_ToSlice(t *testing.T) {
	s := NewInt64ArrayStack()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt64ArrayStack_Generated_LIFO_Order(t *testing.T) {
	s := NewInt64ArrayStack()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt64ArrayStack_Generated_String(t *testing.T) {
	s := NewInt64ArrayStack()
	s.Push(1)
	if s.String() == "" {
