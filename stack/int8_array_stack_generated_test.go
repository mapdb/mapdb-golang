...
func TestInt8ArrayStack_Generated_PushPeekPop(t *testing.T) {
	s := NewInt8ArrayStack()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt8ArrayStack_Generated_PopPeekEmpty(t *testing.T) {
	s := NewInt8ArrayStack()
...
func TestInt8ArrayStack_Generated_IsEmpty(t *testing.T) {
	s := NewInt8ArrayStack()
	if !s.IsEmpty() {
...
func TestInt8ArrayStack_Generated_Clear(t *testing.T) {
	s := NewInt8ArrayStack()
	s.Push(1)
	s.Push(2)
	s.Clear()
...
func TestInt8ArrayStack_Generated_Contains(t *testing.T) {
	s := NewInt8ArrayStack()
	s.Push(1)
	s.Push(2)
	if !s.Contains(1) {
...
func TestInt8ArrayStack_Generated_All(t *testing.T) {
	s := NewInt8ArrayStack()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt8ArrayStack_Generated_ForEach(t *testing.T) {
	s := NewInt8ArrayStack()
	s.Push(1)
	s.Push(2)
	sum := int8(0)
...
func TestInt8ArrayStack_Generated_ToSlice(t *testing.T) {
	s := NewInt8ArrayStack()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt8ArrayStack_Generated_LIFO_Order(t *testing.T) {
	s := NewInt8ArrayStack()
	s.Push(1)
	s.Push(2)
	s.Push(3)
...
func TestInt8ArrayStack_Generated_String(t *testing.T) {
	s := NewInt8ArrayStack()
	s.Push(1)
	if s.String() == "" {
