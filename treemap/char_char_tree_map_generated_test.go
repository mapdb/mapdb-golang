...
func TestCharCharTreeMap_Generated_PutGet(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
	if m.Size() != 3 {
...
func TestCharCharTreeMap_Generated_Remove(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	old, ok := m.Remove(1)
...
func TestCharCharTreeMap_Generated_ContainsKey(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestCharCharTreeMap_Generated_MinMax(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharCharTreeMap_Generated_FloorCeiling(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestCharCharTreeMap_Generated_Clear(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(1, 1)
	m.Clear()
	if !m.IsEmpty() {
...
func TestCharCharTreeMap_Generated_All(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	count := 0
...
func TestCharCharTreeMap_Generated_SortedOrder(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharCharTreeMap_Generated_Select(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestCharCharTreeMap_Generated_String(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(1, 1)
	if m.String() == "" {
		t.Error("empty")
...
func TestCharCharTreeMap_Generated_HigherLower(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(1, 1)
	m.Put(3, 3)
	m.Put(5, 5)
...
func TestCharCharTreeMap_Generated_HeadTailSubMap(t *testing.T) {
	m := NewCharCharTreeMap()
...
func TestCharCharTreeMap_Generated_FirstLastEntry(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(2, 2)
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestCharCharTreeMap_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestCharCharTreeMap_Generated_DescendingOrder(t *testing.T) {
	m := NewCharCharTreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
