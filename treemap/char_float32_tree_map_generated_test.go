...
func TestCharFloat32_Generated_MinMax(t *testing.T) {
	m := NewCharFloat32()
	m.Put(3, 3.0)
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestCharFloat32_Generated_FloorCeiling(t *testing.T) {
	m := NewCharFloat32()
	m.Put(1, 1.0)
	m.Put(3, 3.0)
...
func TestCharFloat32_Generated_SortedOrder(t *testing.T) {
	m := NewCharFloat32()
	m.Put(3, 3.0)
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestCharFloat32_Generated_HigherLower(t *testing.T) {
	m := NewCharFloat32()
	m.Put(1, 1.0)
	m.Put(3, 3.0)
	m.Put(5, 5.0)
...
func TestCharFloat32_Generated_HeadTailSubMap(t *testing.T) {
	m := NewCharFloat32()
...
func TestCharFloat32_Generated_FirstLastEntry(t *testing.T) {
	m := NewCharFloat32()
	m.Put(2, 2.0)
	m.Put(1, 1.0)
	m.Put(3, 3.0)
...
func TestCharFloat32_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewCharFloat32()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestCharFloat32_Generated_DescendingOrder(t *testing.T) {
	m := NewCharFloat32()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
