...
func TestCharInt16_Generated_MinMax(t *testing.T) {
	m := NewCharInt16()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharInt16_Generated_FloorCeiling(t *testing.T) {
	m := NewCharInt16()
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestCharInt16_Generated_SortedOrder(t *testing.T) {
	m := NewCharInt16()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestCharInt16_Generated_HigherLower(t *testing.T) {
	m := NewCharInt16()
	m.Put(1, 1)
	m.Put(3, 3)
	m.Put(5, 5)
...
func TestCharInt16_Generated_HeadTailSubMap(t *testing.T) {
	m := NewCharInt16()
...
func TestCharInt16_Generated_FirstLastEntry(t *testing.T) {
	m := NewCharInt16()
	m.Put(2, 2)
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestCharInt16_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewCharInt16()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestCharInt16_Generated_DescendingOrder(t *testing.T) {
	m := NewCharInt16()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
