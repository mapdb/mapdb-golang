...
func TestFloat32Int64TreeMap_Generated_HigherLower(t *testing.T) {
	m := NewFloat32Int64TreeMap()
	m.Put(1.0, 1)
	m.Put(3.0, 3)
	m.Put(5.0, 5)
...
func TestFloat32Int64TreeMap_Generated_HeadTailSubMap(t *testing.T) {
	m := NewFloat32Int64TreeMap()
...
func TestFloat32Int64TreeMap_Generated_FirstLastEntry(t *testing.T) {
	m := NewFloat32Int64TreeMap()
	m.Put(2.0, 2)
	m.Put(1.0, 1)
	m.Put(3.0, 3)
...
func TestFloat32Int64TreeMap_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewFloat32Int64TreeMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
...
func TestFloat32Int64TreeMap_Generated_DescendingOrder(t *testing.T) {
	m := NewFloat32Int64TreeMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
