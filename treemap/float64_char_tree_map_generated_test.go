...
func TestFloat64Char_Generated_MinMax(t *testing.T) {
	m := NewFloat64Char()
	m.Put(3.0, 3)
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64Char_Generated_FloorCeiling(t *testing.T) {
	m := NewFloat64Char()
	m.Put(1.0, 1)
	m.Put(3.0, 3)
...
func TestFloat64Char_Generated_SortedOrder(t *testing.T) {
	m := NewFloat64Char()
	m.Put(3.0, 3)
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64Char_Generated_HigherLower(t *testing.T) {
	m := NewFloat64Char()
	m.Put(1.0, 1)
	m.Put(3.0, 3)
	m.Put(5.0, 5)
...
func TestFloat64Char_Generated_HeadTailSubMap(t *testing.T) {
	m := NewFloat64Char()
...
func TestFloat64Char_Generated_FirstLastEntry(t *testing.T) {
	m := NewFloat64Char()
	m.Put(2.0, 2)
	m.Put(1.0, 1)
	m.Put(3.0, 3)
...
func TestFloat64Char_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewFloat64Char()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
...
func TestFloat64Char_Generated_DescendingOrder(t *testing.T) {
	m := NewFloat64Char()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
