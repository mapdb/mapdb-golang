...
func TestFloat64CharTreeMap_Generated_PutGet(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(3.0, 3)
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	if m.Size() != 3 {
...
func TestFloat64CharTreeMap_Generated_Remove(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	old, ok := m.Remove(1.0)
...
func TestFloat64CharTreeMap_Generated_ContainsKey(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(1.0, 1)
...
func TestFloat64CharTreeMap_Generated_MinMax(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(3.0, 3)
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64CharTreeMap_Generated_FloorCeiling(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(1.0, 1)
	m.Put(3.0, 3)
...
func TestFloat64CharTreeMap_Generated_Clear(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(1.0, 1)
	m.Clear()
	if !m.IsEmpty() {
...
func TestFloat64CharTreeMap_Generated_All(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	count := 0
...
func TestFloat64CharTreeMap_Generated_SortedOrder(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(3.0, 3)
	m.Put(1.0, 1)
	m.Put(2.0, 2)
...
func TestFloat64CharTreeMap_Generated_Select(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
	sel := m.Select(func(k float64, v uint16) bool { return v > 1 })
	if sel.Size() != 2 {
		t.Errorf("Select size = %d", sel.Size())
	}
}
func TestFloat64CharTreeMap_Generated_String(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(1.0, 1)
	if m.String() == "" {
		t.Error("empty")
...
func TestFloat64CharTreeMap_Generated_HigherLower(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(1.0, 1)
	m.Put(3.0, 3)
	m.Put(5.0, 5)
...
func TestFloat64CharTreeMap_Generated_HeadTailSubMap(t *testing.T) {
	m := NewFloat64CharTreeMap()
...
func TestFloat64CharTreeMap_Generated_FirstLastEntry(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(2.0, 2)
	m.Put(1.0, 1)
	m.Put(3.0, 3)
...
func TestFloat64CharTreeMap_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
...
func TestFloat64CharTreeMap_Generated_DescendingOrder(t *testing.T) {
	m := NewFloat64CharTreeMap()
	m.Put(1.0, 1)
	m.Put(2.0, 2)
	m.Put(3.0, 3)
