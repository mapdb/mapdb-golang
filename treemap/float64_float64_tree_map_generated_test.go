...
func TestFloat64Float64TreeMap_Generated_PutGet(t *testing.T) {
...
func TestFloat64Float64TreeMap_Generated_Remove(t *testing.T) {
	m := NewFloat64Float64TreeMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	old, ok := m.Remove(1.0)
...
func TestFloat64Float64TreeMap_Generated_ContainsKey(t *testing.T) {
	m := NewFloat64Float64TreeMap()
	m.Put(1.0, 1.0)
...
func TestFloat64Float64TreeMap_Generated_MinMax(t *testing.T) {
	m := NewFloat64Float64TreeMap()
	m.Put(3.0, 3.0)
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
...
func TestFloat64Float64TreeMap_Generated_FloorCeiling(t *testing.T) {
	m := NewFloat64Float64TreeMap()
	m.Put(1.0, 1.0)
	m.Put(3.0, 3.0)
...
func TestFloat64Float64TreeMap_Generated_Clear(t *testing.T) {
	m := NewFloat64Float64TreeMap()
	m.Put(1.0, 1.0)
	m.Clear()
	if !m.IsEmpty() {
...
func TestFloat64Float64TreeMap_Generated_All(t *testing.T) {
	m := NewFloat64Float64TreeMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	count := 0
...
func TestFloat64Float64TreeMap_Generated_SortedOrder(t *testing.T) {
	m := NewFloat64Float64TreeMap()
	m.Put(3.0, 3.0)
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
...
func TestFloat64Float64TreeMap_Generated_Select(t *testing.T) {
	m := NewFloat64Float64TreeMap()
	m.Put(1.0, 1.0)
	m.Put(2.0, 2.0)
	m.Put(3.0, 3.0)
...
func TestFloat64Float64TreeMap_Generated_String(t *testing.T) {
	m := NewFloat64Float64TreeMap()
	m.Put(1.0, 1.0)
	if m.String() == "" {
		t.Error("empty")
