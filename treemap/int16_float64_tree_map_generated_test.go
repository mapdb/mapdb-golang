...
func TestInt16Float64TreeMap_Generated_PutGet(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(3, 3.0)
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	if m.Size() != 3 {
...
func TestInt16Float64TreeMap_Generated_Remove(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	old, ok := m.Remove(1)
...
func TestInt16Float64TreeMap_Generated_ContainsKey(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(1, 1.0)
	if !m.ContainsKey(1) {
...
func TestInt16Float64TreeMap_Generated_MinMax(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(3, 3.0)
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt16Float64TreeMap_Generated_FloorCeiling(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(1, 1.0)
	m.Put(3, 3.0)
...
func TestInt16Float64TreeMap_Generated_Clear(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(1, 1.0)
	m.Clear()
	if !m.IsEmpty() {
...
func TestInt16Float64TreeMap_Generated_All(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	count := 0
...
func TestInt16Float64TreeMap_Generated_SortedOrder(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(3, 3.0)
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt16Float64TreeMap_Generated_Select(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
	sel := m.Select(func(k int16, v float64) bool { return v > 1.0 })
	if sel.Size() != 2 {
		t.Errorf("Select size = %d", sel.Size())
	}
}
func TestInt16Float64TreeMap_Generated_String(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(1, 1.0)
	if m.String() == "" {
		t.Error("empty")
...
func TestInt16Float64TreeMap_Generated_HigherLower(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(1, 1.0)
	m.Put(3, 3.0)
	m.Put(5, 5.0)
...
func TestInt16Float64TreeMap_Generated_HeadTailSubMap(t *testing.T) {
	m := NewInt16Float64TreeMap()
...
func TestInt16Float64TreeMap_Generated_FirstLastEntry(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(2, 2.0)
	m.Put(1, 1.0)
	m.Put(3, 3.0)
...
func TestInt16Float64TreeMap_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestInt16Float64TreeMap_Generated_DescendingOrder(t *testing.T) {
	m := NewInt16Float64TreeMap()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
