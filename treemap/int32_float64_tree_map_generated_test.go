...
func TestInt32Float64_Generated_MinMax(t *testing.T) {
	m := NewInt32Float64()
	m.Put(3, 3.0)
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt32Float64_Generated_FloorCeiling(t *testing.T) {
	m := NewInt32Float64()
	m.Put(1, 1.0)
	m.Put(3, 3.0)
...
func TestInt32Float64_Generated_SortedOrder(t *testing.T) {
	m := NewInt32Float64()
	m.Put(3, 3.0)
	m.Put(1, 1.0)
	m.Put(2, 2.0)
...
func TestInt32Float64_Generated_HigherLower(t *testing.T) {
	m := NewInt32Float64()
	m.Put(1, 1.0)
	m.Put(3, 3.0)
	m.Put(5, 5.0)
...
func TestInt32Float64_Generated_HeadTailSubMap(t *testing.T) {
	m := NewInt32Float64()
...
func TestInt32Float64_Generated_FirstLastEntry(t *testing.T) {
	m := NewInt32Float64()
	m.Put(2, 2.0)
	m.Put(1, 1.0)
	m.Put(3, 3.0)
...
func TestInt32Float64_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewInt32Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
...
func TestInt32Float64_Generated_DescendingOrder(t *testing.T) {
	m := NewInt32Float64()
	m.Put(1, 1.0)
	m.Put(2, 2.0)
	m.Put(3, 3.0)
