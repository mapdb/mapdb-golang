...
func TestInt32Int16TreeMap_Generated_PutGet(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
	if m.Size() != 3 {
...
func TestInt32Int16TreeMap_Generated_Remove(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	old, ok := m.Remove(1)
...
func TestInt32Int16TreeMap_Generated_ContainsKey(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(1, 1)
	if !m.ContainsKey(1) {
...
func TestInt32Int16TreeMap_Generated_MinMax(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt32Int16TreeMap_Generated_FloorCeiling(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestInt32Int16TreeMap_Generated_Clear(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(1, 1)
	m.Clear()
	if !m.IsEmpty() {
...
func TestInt32Int16TreeMap_Generated_All(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	count := 0
...
func TestInt32Int16TreeMap_Generated_SortedOrder(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt32Int16TreeMap_Generated_Select(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
	sel := m.Select(func(k int32, v int16) bool { return v > 1 })
	if sel.Size() != 2 {
		t.Errorf("Select size = %d", sel.Size())
	}
}
func TestInt32Int16TreeMap_Generated_String(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(1, 1)
	if m.String() == "" {
		t.Error("empty")
...
func TestInt32Int16TreeMap_Generated_HigherLower(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(1, 1)
	m.Put(3, 3)
	m.Put(5, 5)
...
func TestInt32Int16TreeMap_Generated_HeadTailSubMap(t *testing.T) {
	m := NewInt32Int16TreeMap()
...
func TestInt32Int16TreeMap_Generated_FirstLastEntry(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(2, 2)
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestInt32Int16TreeMap_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt32Int16TreeMap_Generated_DescendingOrder(t *testing.T) {
	m := NewInt32Int16TreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
