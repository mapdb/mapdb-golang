...
// int32Int32TreeNodeSize returns the subtree size of a node link (0 if nil).
func int32Int32TreeNodeSize(n *int32Int32TreeNode) int {
	if n == nil {
		return 0
	}
	return n.size
...
// int32Int32TreeNodeFixSize recomputes a node's cached subtree size from its
// children. Called after any rotation or child relink so the augmentation stays
// consistent.
func int32Int32TreeNodeFixSize(n *int32Int32TreeNode) {
	n.size = 1 + int32Int32TreeNodeSize(n.left) + int32Int32TreeNodeSize(n.right)
}

// Int32Int32 is a sorted map with int32 keys and int32 values, backed by a red-black tree.
...
// NewInt32Int32 creates a new empty sorted map.
func NewInt32Int32() *Int32Int32 {
	return &Int32Int32{}
}

// Put inserts or updates a key-value pair. Returns the previous value and true if the key existed.
func (m *Int32Int32) Put(key int32, value int32) (int32, bool) {
	if m.root == nil {
		m.root = &int32Int32TreeNode{key: key, value: value, color: int32Int32TreeNodeBlack, size: 1}
		m.size++
		return 0, false
	}
	node := m.root
	for {
		if key < node.key {
			if node.left == nil {
				node.left = &int32Int32TreeNode{key: key, value: value, parent: node, color: int32Int32TreeNodeRed, size: 1}
			...
			if node.right == nil {
				node.right = &int32Int32TreeNode{key: key, value: value, parent: node, color: int32Int32TreeNodeRed, size: 1}
				m.incSizeToRoot(node)
...
func (m *Int32Int32) Get(key int32) (int32, bool) {
	node := m.findNode(key)
	if node == nil {
		return 0, false
	}
...
func (m *Int32Int32) GetOrDefault(key int32, defaultValue int32) int32 {
...
func (m *Int32Int32) Len() int {
	return m.size
}

// Clear removes all entries.
func (m *Int32Int32) Clear() {
	m.root = nil
	m.size = 0
}

// Min returns the smallest key and its value, or zero values and false if empty.
func (m *Int32Int32) Min() (int32, int32, bool) {
	if m.root == nil {
		return 0, 0, false
	}
...
func (m *Int32Int32) Max() (int32, int32, bool) {
	if m.root == nil {
		return 0, 0, false
	}
...
func (m *Int32Int32) Floor(key int32) (int32, int32, bool) {
...
func (m *Int32Int32) Ceiling(key int32) (int32, int32, bool) {
	var result *int32Int32TreeNode
	node := m.root
	for node != nil {
		if key == node.key {
...
func (m *Int32Int32) All() iter.Seq2[int32, int32] {
...
// reproduces All in ascending key order — so a *Int32Int32 satisfies
// par.Segmenter2[int32, int32] and feeds par.From2 with ORDERED
...
func (m *Int32Int32) Segments2(n int) []iter.Seq2[int32, int32] {
	ranges := segment.SplitRanges(m.size, n)
	segs := make([]iter.Seq2[int32, int32], len(ranges))
	for i := range ranges {
		lo, hi := ranges[i][0], ranges[i][1] // per-iteration copies for this view's closure
		segs[i] = func(yield func(int32, int32) bool) {
			// In-order walk yielding pairs whose 0-based key rank is in [lo, hi).
			// base is the rank of the first element in node's subtree.
			var walk func(node *int32Int32TreeNode, base int) bool
			walk = func(node *int32Int32TreeNode, base int) bool {
				if node == nil {
					return true
				}
				rank := base + int32Int32TreeNodeSize(node.left)
...
func (m *Int32Int32) Keys() iter.Seq[int32] {
...
func (m *Int32Int32) Values() iter.Seq[int32] {
	return func(yield func(int32) bool) {
		for _, v := range m.All() {
			if !yield(v) {
				return
...
func (m *Int32Int32) RangeKeys(fromKey, toKey int32) iter.Seq2[int32, int32] {
	return func(yield func(int32, int32) bool) {
		for k, v := range m.All() {
			if k < fromKey {
				continue
...
func (m *Int32Int32) Higher(key int32) (int32, int32, bool) {
	var result *int32Int32TreeNode
	node := m.root
	for node != nil {
		if key < node.key {
...
func (m *Int32Int32) Lower(key int32) (int32, int32, bool) {
	var result *int32Int32TreeNode
	node := m.root
	for node != nil {
		if key > node.key {
...
func (m *Int32Int32) HeadMap(toKey int32) iter.Seq2[int32, int32] {
	return func(yield func(int32, int32) bool) {
		for k, v := range m.All() {
			if k >= toKey {
				return
...
func (m *Int32Int32) TailMap(fromKey int32) iter.Seq2[int32, int32] {
	return func(yield func(int32, int32) bool) {
		for k, v := range m.All() {
			if k < fromKey {
				continue
...
func (m *Int32Int32) PollLastEntry() (int32, int32, bool) {
	k, v, ok := m.Max()
	if !ok {
		return 0, 0, false
	}
...
func (m *Int32Int32) DescendingMap() iter.Seq2[int32, int32] {
	return func(yield func(int32, int32) bool) {
...
func (m *Int32Int32) DescendingKeys() iter.Seq[int32] {
	return func(yield func(int32) bool) {
...
func (m *Int32Int32) ForEach(f func(int32, int32)) {
	for k, v := range m.All() {
		f(k, v)
	}
}
...
func (m *Int32Int32) Select(predicate func(int32, int32) bool) *Int32Int32 {
...
func (m *Int32Int32) Reject(predicate func(int32, int32) bool) *Int32Int32 {
	result := NewInt32Int32()
	for k, v := range m.All() {
		if !predicate(k, v) {
			result.Put(k, v)
...
func (m *Int32Int32) Detect(predicate func(int32, int32) bool) (int32, int32, bool) {
	for k, v := range m.All() {
		if predicate(k, v) {
			return k, v, true
		}
...
func (m *Int32Int32) AnySatisfy(predicate func(int32, int32) bool) bool {
	for k, v := range m.All() {
		if predicate(k, v) {
			return true
		}
...
func (m *Int32Int32) AllSatisfy(predicate func(int32, int32) bool) bool {
	for k, v := range m.All() {
		if !predicate(k, v) {
			return false
		}
...
func (m *Int32Int32) NoneSatisfy(predicate func(int32, int32) bool) bool {
	for k, v := range m.All() {
		if predicate(k, v) {
			return false
		}
...
func (m *Int32Int32) Count(predicate func(int32, int32) bool) int {
	c := 0
	for k, v := range m.All() {
		if predicate(k, v) {
			c++
...
// query; never mutates.
func (m *Int32Int32) Rank(key int32) int {
	rank := 0
	node := m.root
	for node != nil {
		if key < node.key {
			...
			rank += 1 + int32Int32TreeNodeSize(node.left)
			node = node.right
		} else {
			// key == node.key: exactly the left subtree is strictly less.
			return rank + int32Int32TreeNodeSize(node.left)
		}
	}
	return rank
}
...
func (m *Int32Int32) SelectKey(i int) (int32, bool) {
	node := m.selectNode(i)
	if node == nil {
		return 0, false
	}
...
func (m *Int32Int32) SelectEntry(i int) (int32, int32, bool) {
	node := m.selectNode(i)
	if node == nil {
		return 0, 0, false
	}
...
// O(log n).
func (m *Int32Int32) selectNode(i int) *int32Int32TreeNode {
	if i < 0 {
		return nil
	}
	node := m.root
	for node != nil {
		left := int32Int32TreeNodeSize(node.left)
		if i < left {
			node = node.left
		} else if i == left {
			return node
...
func (m *Int32Int32) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int32Int32) findNode(key int32) *int32Int32TreeNode {
	node := m.root
	for node != nil {
		if key < node.key {
			node = node.left
...
func (m *Int32Int32) minNode(node *int32Int32TreeNode) *int32Int32TreeNode {
	for node.left != nil {
		node = node.left
	}
	return node
...
func (m *Int32Int32) maxNode(node *int32Int32TreeNode) *int32Int32TreeNode {
	for node.right != nil {
		node = node.right
	}
	return node
...
func (m *Int32Int32) rotateLeft(x *int32Int32TreeNode) {
	y := x.right
	x.right = y.left
	if y.left != nil {
		y.left.parent = x
	...
	int32Int32TreeNodeFixSize(x)
	int32Int32TreeNodeFixSize(y)
}

func (m *Int32Int32) rotateRight(x *int32Int32TreeNode) {
	y := x.left
	x.left = y.right
	if y.right != nil {
		y.right.parent = x
...
func (m *Int32Int32) incSizeToRoot(n *int32Int32TreeNode) {
...
func (m *Int32Int32) fixSizeToRoot(n *int32Int32TreeNode) {
	for ; n != nil; n = n.parent {
		int32Int32TreeNodeFixSize(n)
	}
}

func (m *Int32Int32) fixAfterInsert(z *int32Int32TreeNode) {
...
func (m *Int32Int32) deleteNode(z *int32Int32TreeNode) {
	...
	var fixSizeFrom *int32Int32TreeNode
...
// NewInt32Int32FromSorted builds a Int32Int32 from presorted, ascending keys
...
func NewInt32Int32FromSorted(keys []int32, values []int32, policy pump.DuplicatePolicy) (*Int32Int32, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt32Int32FromSorted: len(keys) != len(values)")
	}
	dk, dv, err := dedupInt32Int32Sorted(keys, values, policy)
	if err != nil {
		return nil, err
	}
	m := NewInt32Int32()
	m.root = m.buildint32Int32(dk, dv, 0, len(dk)-1, 0, pump.RedBlackRedLevel(len(dk)), nil)
	m.size = len(dk)
	return m, nil
}

// dedupInt32Int32Sorted validates ascending order and applies the duplicate
// policy, returning compacted key/value slices. Equal adjacent keys are the only
// duplicates possible in sorted input.
func dedupInt32Int32Sorted(keys []int32, values []int32, policy pump.DuplicatePolicy) ([]int32, []int32, error) {
	if len(keys) == 0 {
	...
	for i := 1; i < len(keys); i++ {
		cmp := cmpInt32Int32(keys[i], keys[i-1])
		if cmp < 0 {
...
// cmpInt32Int32 is the three-way ordering used by the bulk-load validator for
// integer/char keys (float keys use the IEEE total-order helper instead).
func cmpInt32Int32(a, b int32) int {
	switch {
	case a < b:
		return -1
	case a > b:
...
// buildint32Int32 recursively builds a perfectly balanced subtree from the
...
func (m *Int32Int32) buildint32Int32(keys []int32, values []int32, lo, hi, level, redLevel int, parent *int32Int32TreeNode) *int32Int32TreeNode {
	if lo > hi {
		return nil
	}
	mid := (lo + hi) / 2
	node := &int32Int32TreeNode{key: keys[mid], value: values[mid], parent: parent, color: int32Int32TreeNodeBlack}
	if level == redLevel {
		node.color = int32Int32TreeNodeRed
	}
...
// Int32Int32Sink is a streaming builder for a Int32Int32: callers Put
// ascending entries one at a time, then Build the finished map. It is a thin
// wrapper over NewInt32Int32FromSorted (entries are buffered, then built in one
...
// NewInt32Int32Sink creates a streaming sink with the given duplicate policy.
func NewInt32Int32Sink(policy pump.DuplicatePolicy) *Int32Int32Sink {
	return &Int32Int32Sink{policy: policy}
}
...
func (s *Int32Int32Sink) Put(key int32, value int32) {
	if s.done {
		panic("mapdb: Put on a finished Int32Int32Sink")
	}
...
func (s *Int32Int32Sink) Build() (*Int32Int32, error) {
	if s.done {
		panic("mapdb: Build on a finished Int32Int32Sink")
	}
	s.done = true
	return NewInt32Int32FromSorted(s.keys, s.values, s.policy)
}

func (m *Int32Int32) fixAfterDelete(x *int32Int32TreeNode) {
