...
// int64Float64TreeNodeSize returns the subtree size of a node link (0 if nil).
func int64Float64TreeNodeSize(n *int64Float64TreeNode) int {
	if n == nil {
		return 0
	}
	return n.size
...
// int64Float64TreeNodeFixSize recomputes a node's cached subtree size from its
// children. Called after any rotation or child relink so the augmentation stays
// consistent.
func int64Float64TreeNodeFixSize(n *int64Float64TreeNode) {
	n.size = 1 + int64Float64TreeNodeSize(n.left) + int64Float64TreeNodeSize(n.right)
}

// Int64Float64 is a sorted map with int64 keys and float64 values, backed by a red-black tree.
// Keys are maintained in ascending order.
type Int64Float64 struct {
	root *int64Float64TreeNode
	size int
}

// NewInt64Float64 creates a new empty sorted map.
func NewInt64Float64() *Int64Float64 {
	return &Int64Float64{}
}

// Put inserts or updates a key-value pair. Returns the previous value and true if the key existed.
func (m *Int64Float64) Put(key int64, value float64) (float64, bool) {
	if m.root == nil {
		m.root = &int64Float64TreeNode{key: key, value: value, color: int64Float64TreeNodeBlack, size: 1}
		m.size++
		return 0.0, false
	}
	node := m.root
	for {
		if key < node.key {
			if node.left == nil {
				node.left = &int64Float64TreeNode{key: key, value: value, parent: node, color: int64Float64TreeNodeRed, size: 1}
			...
			if node.right == nil {
				node.right = &int64Float64TreeNode{key: key, value: value, parent: node, color: int64Float64TreeNodeRed, size: 1}
				m.incSizeToRoot(node)
...
func (m *Int64Float64) Get(key int64) (float64, bool) {
	node := m.findNode(key)
	if node == nil {
		return 0.0, false
	}
...
func (m *Int64Float64) GetOrDefault(key int64, defaultValue float64) float64 {
...
func (m *Int64Float64) Len() int {
	return m.size
}

// Clear removes all entries.
func (m *Int64Float64) Clear() {
	m.root = nil
	m.size = 0
}

// Min returns the smallest key and its value, or zero values and false if empty.
func (m *Int64Float64) Min() (int64, float64, bool) {
	if m.root == nil {
		return 0, 0.0, false
	}
...
func (m *Int64Float64) Max() (int64, float64, bool) {
	if m.root == nil {
		return 0, 0.0, false
	}
...
func (m *Int64Float64) Floor(key int64) (int64, float64, bool) {
...
func (m *Int64Float64) Ceiling(key int64) (int64, float64, bool) {
	var result *int64Float64TreeNode
	node := m.root
	for node != nil {
		if key == node.key {
...
func (m *Int64Float64) All() iter.Seq2[int64, float64] {
...
// reproduces All in ascending key order — so a *Int64Float64 satisfies
// par.Segmenter2[int64, float64] and feeds par.From2 with ORDERED
...
func (m *Int64Float64) Segments2(n int) []iter.Seq2[int64, float64] {
	ranges := segment.SplitRanges(m.size, n)
	segs := make([]iter.Seq2[int64, float64], len(ranges))
	for i := range ranges {
		lo, hi := ranges[i][0], ranges[i][1] // per-iteration copies for this view's closure
		segs[i] = func(yield func(int64, float64) bool) {
			// In-order walk yielding pairs whose 0-based key rank is in [lo, hi).
			// base is the rank of the first element in node's subtree.
			var walk func(node *int64Float64TreeNode, base int) bool
			walk = func(node *int64Float64TreeNode, base int) bool {
				if node == nil {
					return true
				}
				rank := base + int64Float64TreeNodeSize(node.left)
...
func (m *Int64Float64) Keys() iter.Seq[int64] {
...
func (m *Int64Float64) Values() iter.Seq[float64] {
...
func (m *Int64Float64) RangeKeys(fromKey, toKey int64) iter.Seq2[int64, float64] {
	return func(yield func(int64, float64) bool) {
		for k, v := range m.All() {
			if k < fromKey {
				continue
...
func (m *Int64Float64) Higher(key int64) (int64, float64, bool) {
	var result *int64Float64TreeNode
	node := m.root
	for node != nil {
		if key < node.key {
...
func (m *Int64Float64) Lower(key int64) (int64, float64, bool) {
	var result *int64Float64TreeNode
	node := m.root
	for node != nil {
		if key > node.key {
...
func (m *Int64Float64) HeadMap(toKey int64) iter.Seq2[int64, float64] {
	return func(yield func(int64, float64) bool) {
		for k, v := range m.All() {
			if k >= toKey {
				return
...
func (m *Int64Float64) TailMap(fromKey int64) iter.Seq2[int64, float64] {
	return func(yield func(int64, float64) bool) {
		for k, v := range m.All() {
			if k < fromKey {
				continue
...
func (m *Int64Float64) PollLastEntry() (int64, float64, bool) {
	k, v, ok := m.Max()
	if !ok {
		return 0, 0.0, false
	}
...
func (m *Int64Float64) DescendingMap() iter.Seq2[int64, float64] {
	return func(yield func(int64, float64) bool) {
...
func (m *Int64Float64) DescendingKeys() iter.Seq[int64] {
	return func(yield func(int64) bool) {
...
func (m *Int64Float64) ForEach(f func(int64, float64)) {
	for k, v := range m.All() {
		f(k, v)
	}
}
...
func (m *Int64Float64) Select(predicate func(int64, float64) bool) *Int64Float64 {
...
func (m *Int64Float64) Reject(predicate func(int64, float64) bool) *Int64Float64 {
	result := NewInt64Float64()
	for k, v := range m.All() {
		if !predicate(k, v) {
			result.Put(k, v)
...
func (m *Int64Float64) Detect(predicate func(int64, float64) bool) (int64, float64, bool) {
	for k, v := range m.All() {
		if predicate(k, v) {
			return k, v, true
		}
...
func (m *Int64Float64) AnySatisfy(predicate func(int64, float64) bool) bool {
	for k, v := range m.All() {
		if predicate(k, v) {
			return true
		}
...
func (m *Int64Float64) AllSatisfy(predicate func(int64, float64) bool) bool {
	for k, v := range m.All() {
		if !predicate(k, v) {
			return false
		}
...
func (m *Int64Float64) NoneSatisfy(predicate func(int64, float64) bool) bool {
	for k, v := range m.All() {
		if predicate(k, v) {
			return false
		}
...
func (m *Int64Float64) Count(predicate func(int64, float64) bool) int {
	c := 0
	for k, v := range m.All() {
		if predicate(k, v) {
			c++
...
// query; never mutates.
func (m *Int64Float64) Rank(key int64) int {
	rank := 0
	node := m.root
	for node != nil {
		if key < node.key {
			...
			rank += 1 + int64Float64TreeNodeSize(node.left)
			node = node.right
		} else {
			// key == node.key: exactly the left subtree is strictly less.
			return rank + int64Float64TreeNodeSize(node.left)
		}
	}
	return rank
}
...
func (m *Int64Float64) SelectKey(i int) (int64, bool) {
	node := m.selectNode(i)
	if node == nil {
		return 0, false
	}
...
func (m *Int64Float64) SelectEntry(i int) (int64, float64, bool) {
	node := m.selectNode(i)
	if node == nil {
		return 0, 0.0, false
	}
...
// O(log n).
func (m *Int64Float64) selectNode(i int) *int64Float64TreeNode {
	if i < 0 {
		return nil
	}
	node := m.root
	for node != nil {
		left := int64Float64TreeNodeSize(node.left)
		if i < left {
			node = node.left
		} else if i == left {
			return node
...
func (m *Int64Float64) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int64Float64) findNode(key int64) *int64Float64TreeNode {
	node := m.root
	for node != nil {
		if key < node.key {
			node = node.left
...
func (m *Int64Float64) minNode(node *int64Float64TreeNode) *int64Float64TreeNode {
	for node.left != nil {
		node = node.left
	}
	return node
...
func (m *Int64Float64) maxNode(node *int64Float64TreeNode) *int64Float64TreeNode {
	for node.right != nil {
		node = node.right
	}
	return node
...
func (m *Int64Float64) rotateLeft(x *int64Float64TreeNode) {
	y := x.right
	x.right = y.left
	if y.left != nil {
		y.left.parent = x
	...
	int64Float64TreeNodeFixSize(x)
	int64Float64TreeNodeFixSize(y)
}

func (m *Int64Float64) rotateRight(x *int64Float64TreeNode) {
	y := x.left
	x.left = y.right
	if y.right != nil {
		y.right.parent = x
...
func (m *Int64Float64) incSizeToRoot(n *int64Float64TreeNode) {
...
func (m *Int64Float64) fixSizeToRoot(n *int64Float64TreeNode) {
	for ; n != nil; n = n.parent {
		int64Float64TreeNodeFixSize(n)
	}
}

func (m *Int64Float64) fixAfterInsert(z *int64Float64TreeNode) {
...
func (m *Int64Float64) deleteNode(z *int64Float64TreeNode) {
	...
	var fixSizeFrom *int64Float64TreeNode
...
// NewInt64Float64FromSorted builds a Int64Float64 from presorted, ascending keys
...
func NewInt64Float64FromSorted(keys []int64, values []float64, policy pump.DuplicatePolicy) (*Int64Float64, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt64Float64FromSorted: len(keys) != len(values)")
	}
	dk, dv, err := dedupInt64Float64Sorted(keys, values, policy)
	if err != nil {
		return nil, err
	}
	m := NewInt64Float64()
	m.root = m.buildint64Float64(dk, dv, 0, len(dk)-1, 0, pump.RedBlackRedLevel(len(dk)), nil)
	m.size = len(dk)
	return m, nil
}

// dedupInt64Float64Sorted validates ascending order and applies the duplicate
// policy, returning compacted key/value slices. Equal adjacent keys are the only
// duplicates possible in sorted input.
func dedupInt64Float64Sorted(keys []int64, values []float64, policy pump.DuplicatePolicy) ([]int64, []float64, error) {
	if len(keys) == 0 {
	...
	for i := 1; i < len(keys); i++ {
		cmp := cmpInt64Float64(keys[i], keys[i-1])
		if cmp < 0 {
...
// cmpInt64Float64 is the three-way ordering used by the bulk-load validator for
// integer/char keys (float keys use the IEEE total-order helper instead).
func cmpInt64Float64(a, b int64) int {
	switch {
	case a < b:
		return -1
	case a > b:
...
// buildint64Float64 recursively builds a perfectly balanced subtree from the
...
func (m *Int64Float64) buildint64Float64(keys []int64, values []float64, lo, hi, level, redLevel int, parent *int64Float64TreeNode) *int64Float64TreeNode {
	if lo > hi {
		return nil
	}
	mid := (lo + hi) / 2
	node := &int64Float64TreeNode{key: keys[mid], value: values[mid], parent: parent, color: int64Float64TreeNodeBlack}
	if level == redLevel {
		node.color = int64Float64TreeNodeRed
	}
	node.left = m.buildint64Float64(keys, values, lo, mid-1, level+1, redLevel, node)
	node.right = m.buildint64Float64(keys, values, mid+1, hi, level+1, redLevel, node)
	...
	node.size = 1 + int64Float64TreeNodeSize(node.left) + int64Float64TreeNodeSize(node.right)
	return node
}

// Int64Float64Sink is a streaming builder for a Int64Float64: callers Put
// ascending entries one at a time, then Build the finished map. It is a thin
// wrapper over NewInt64Float64FromSorted (entries are buffered, then built in one
...
// NewInt64Float64Sink creates a streaming sink with the given duplicate policy.
func NewInt64Float64Sink(policy pump.DuplicatePolicy) *Int64Float64Sink {
	return &Int64Float64Sink{policy: policy}
}
...
func (s *Int64Float64Sink) Put(key int64, value float64) {
	if s.done {
		panic("mapdb: Put on a finished Int64Float64Sink")
	}
...
func (s *Int64Float64Sink) Build() (*Int64Float64, error) {
	if s.done {
		panic("mapdb: Build on a finished Int64Float64Sink")
	}
	s.done = true
	return NewInt64Float64FromSorted(s.keys, s.values, s.policy)
}

func (m *Int64Float64) fixAfterDelete(x *int64Float64TreeNode) {
