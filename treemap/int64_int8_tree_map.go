...
// int64Int8TreeNodeSize returns the subtree size of a node link (0 if nil).
func int64Int8TreeNodeSize(n *int64Int8TreeNode) int {
	if n == nil {
		return 0
	}
	return n.size
...
// int64Int8TreeNodeFixSize recomputes a node's cached subtree size from its
// children. Called after any rotation or child relink so the augmentation stays
// consistent.
func int64Int8TreeNodeFixSize(n *int64Int8TreeNode) {
	n.size = 1 + int64Int8TreeNodeSize(n.left) + int64Int8TreeNodeSize(n.right)
}

// Int64Int8 is a sorted map with int64 keys and int8 values, backed by a red-black tree.
// Keys are maintained in ascending order.
type Int64Int8 struct {
	root *int64Int8TreeNode
	size int
}

// NewInt64Int8 creates a new empty sorted map.
func NewInt64Int8() *Int64Int8 {
	return &Int64Int8{}
}

// Put inserts or updates a key-value pair. Returns the previous value and true if the key existed.
func (m *Int64Int8) Put(key int64, value int8) (int8, bool) {
	if m.root == nil {
		m.root = &int64Int8TreeNode{key: key, value: value, color: int64Int8TreeNodeBlack, size: 1}
		m.size++
		return 0, false
	}
	node := m.root
	for {
		if key < node.key {
			if node.left == nil {
				node.left = &int64Int8TreeNode{key: key, value: value, parent: node, color: int64Int8TreeNodeRed, size: 1}
			...
			if node.right == nil {
				node.right = &int64Int8TreeNode{key: key, value: value, parent: node, color: int64Int8TreeNodeRed, size: 1}
				m.incSizeToRoot(node)
...
func (m *Int64Int8) Get(key int64) (int8, bool) {
	node := m.findNode(key)
	if node == nil {
		return 0, false
	}
...
func (m *Int64Int8) GetOrDefault(key int64, defaultValue int8) int8 {
...
func (m *Int64Int8) Len() int {
	return m.size
}

// Clear removes all entries.
func (m *Int64Int8) Clear() {
	m.root = nil
	m.size = 0
}

// Min returns the smallest key and its value, or zero values and false if empty.
func (m *Int64Int8) Min() (int64, int8, bool) {
	if m.root == nil {
		return 0, 0, false
	}
...
func (m *Int64Int8) Max() (int64, int8, bool) {
	if m.root == nil {
		return 0, 0, false
	}
...
func (m *Int64Int8) Floor(key int64) (int64, int8, bool) {
...
func (m *Int64Int8) Ceiling(key int64) (int64, int8, bool) {
	var result *int64Int8TreeNode
	node := m.root
	for node != nil {
		if key == node.key {
...
func (m *Int64Int8) All() iter.Seq2[int64, int8] {
...
// reproduces All in ascending key order — so a *Int64Int8 satisfies
// par.Segmenter2[int64, int8] and feeds par.From2 with ORDERED
...
func (m *Int64Int8) Segments2(n int) []iter.Seq2[int64, int8] {
	ranges := segment.SplitRanges(m.size, n)
	segs := make([]iter.Seq2[int64, int8], len(ranges))
	for i := range ranges {
		lo, hi := ranges[i][0], ranges[i][1] // per-iteration copies for this view's closure
		segs[i] = func(yield func(int64, int8) bool) {
			// In-order walk yielding pairs whose 0-based key rank is in [lo, hi).
			// base is the rank of the first element in node's subtree.
			var walk func(node *int64Int8TreeNode, base int) bool
			walk = func(node *int64Int8TreeNode, base int) bool {
				if node == nil {
					return true
				}
				rank := base + int64Int8TreeNodeSize(node.left)
...
func (m *Int64Int8) Keys() iter.Seq[int64] {
...
func (m *Int64Int8) Values() iter.Seq[int8] {
...
func (m *Int64Int8) RangeKeys(fromKey, toKey int64) iter.Seq2[int64, int8] {
	return func(yield func(int64, int8) bool) {
		for k, v := range m.All() {
			if k < fromKey {
				continue
...
func (m *Int64Int8) Higher(key int64) (int64, int8, bool) {
	var result *int64Int8TreeNode
	node := m.root
	for node != nil {
		if key < node.key {
...
func (m *Int64Int8) Lower(key int64) (int64, int8, bool) {
	var result *int64Int8TreeNode
	node := m.root
	for node != nil {
		if key > node.key {
...
func (m *Int64Int8) HeadMap(toKey int64) iter.Seq2[int64, int8] {
	return func(yield func(int64, int8) bool) {
		for k, v := range m.All() {
			if k >= toKey {
				return
...
func (m *Int64Int8) TailMap(fromKey int64) iter.Seq2[int64, int8] {
	return func(yield func(int64, int8) bool) {
		for k, v := range m.All() {
			if k < fromKey {
				continue
...
func (m *Int64Int8) PollLastEntry() (int64, int8, bool) {
	k, v, ok := m.Max()
	if !ok {
		return 0, 0, false
	}
...
func (m *Int64Int8) DescendingMap() iter.Seq2[int64, int8] {
	return func(yield func(int64, int8) bool) {
...
func (m *Int64Int8) DescendingKeys() iter.Seq[int64] {
	return func(yield func(int64) bool) {
...
func (m *Int64Int8) ForEach(f func(int64, int8)) {
	for k, v := range m.All() {
		f(k, v)
	}
}
...
func (m *Int64Int8) Select(predicate func(int64, int8) bool) *Int64Int8 {
	result := NewInt64Int8()
	for k, v := range m.All() {
		if predicate(k, v) {
			result.Put(k, v)
...
func (m *Int64Int8) Reject(predicate func(int64, int8) bool) *Int64Int8 {
	result := NewInt64Int8()
	for k, v := range m.All() {
		if !predicate(k, v) {
			result.Put(k, v)
...
func (m *Int64Int8) Detect(predicate func(int64, int8) bool) (int64, int8, bool) {
	for k, v := range m.All() {
		if predicate(k, v) {
			return k, v, true
		}
...
func (m *Int64Int8) AnySatisfy(predicate func(int64, int8) bool) bool {
	for k, v := range m.All() {
		if predicate(k, v) {
			return true
		}
...
func (m *Int64Int8) AllSatisfy(predicate func(int64, int8) bool) bool {
	for k, v := range m.All() {
		if !predicate(k, v) {
			return false
		}
...
func (m *Int64Int8) NoneSatisfy(predicate func(int64, int8) bool) bool {
	for k, v := range m.All() {
		if predicate(k, v) {
			return false
		}
...
func (m *Int64Int8) Count(predicate func(int64, int8) bool) int {
	c := 0
	for k, v := range m.All() {
		if predicate(k, v) {
			c++
...
// query; never mutates.
func (m *Int64Int8) Rank(key int64) int {
	rank := 0
	node := m.root
	for node != nil {
		if key < node.key {
			...
			rank += 1 + int64Int8TreeNodeSize(node.left)
			node = node.right
		} else {
			// key == node.key: exactly the left subtree is strictly less.
			return rank + int64Int8TreeNodeSize(node.left)
		}
	}
	return rank
}
...
func (m *Int64Int8) SelectKey(i int) (int64, bool) {
	node := m.selectNode(i)
	if node == nil {
		return 0, false
	}
...
func (m *Int64Int8) SelectEntry(i int) (int64, int8, bool) {
	node := m.selectNode(i)
	if node == nil {
		return 0, 0, false
	}
...
// O(log n).
func (m *Int64Int8) selectNode(i int) *int64Int8TreeNode {
	if i < 0 {
		return nil
	}
	node := m.root
	for node != nil {
		left := int64Int8TreeNodeSize(node.left)
		if i < left {
			node = node.left
		} else if i == left {
			return node
...
func (m *Int64Int8) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int64Int8) findNode(key int64) *int64Int8TreeNode {
	node := m.root
	for node != nil {
		if key < node.key {
			node = node.left
...
func (m *Int64Int8) minNode(node *int64Int8TreeNode) *int64Int8TreeNode {
	for node.left != nil {
		node = node.left
	}
	return node
...
func (m *Int64Int8) maxNode(node *int64Int8TreeNode) *int64Int8TreeNode {
	for node.right != nil {
		node = node.right
	}
	return node
...
func (m *Int64Int8) rotateLeft(x *int64Int8TreeNode) {
	y := x.right
	x.right = y.left
	if y.left != nil {
		y.left.parent = x
	...
	int64Int8TreeNodeFixSize(x)
	int64Int8TreeNodeFixSize(y)
}

func (m *Int64Int8) rotateRight(x *int64Int8TreeNode) {
	y := x.left
	x.left = y.right
	if y.right != nil {
		y.right.parent = x
...
func (m *Int64Int8) incSizeToRoot(n *int64Int8TreeNode) {
...
func (m *Int64Int8) fixSizeToRoot(n *int64Int8TreeNode) {
	for ; n != nil; n = n.parent {
		int64Int8TreeNodeFixSize(n)
	}
}

func (m *Int64Int8) fixAfterInsert(z *int64Int8TreeNode) {
...
func (m *Int64Int8) deleteNode(z *int64Int8TreeNode) {
	...
	var fixSizeFrom *int64Int8TreeNode
...
// NewInt64Int8FromSorted builds a Int64Int8 from presorted, ascending keys
...
func NewInt64Int8FromSorted(keys []int64, values []int8, policy pump.DuplicatePolicy) (*Int64Int8, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt64Int8FromSorted: len(keys) != len(values)")
	}
	dk, dv, err := dedupInt64Int8Sorted(keys, values, policy)
	if err != nil {
		return nil, err
	}
	m := NewInt64Int8()
	m.root = m.buildint64Int8(dk, dv, 0, len(dk)-1, 0, pump.RedBlackRedLevel(len(dk)), nil)
	m.size = len(dk)
	return m, nil
}

// dedupInt64Int8Sorted validates ascending order and applies the duplicate
// policy, returning compacted key/value slices. Equal adjacent keys are the only
// duplicates possible in sorted input.
func dedupInt64Int8Sorted(keys []int64, values []int8, policy pump.DuplicatePolicy) ([]int64, []int8, error) {
	if len(keys) == 0 {
	...
	for i := 1; i < len(keys); i++ {
		cmp := cmpInt64Int8(keys[i], keys[i-1])
		if cmp < 0 {
...
// cmpInt64Int8 is the three-way ordering used by the bulk-load validator for
// integer/char keys (float keys use the IEEE total-order helper instead).
func cmpInt64Int8(a, b int64) int {
	switch {
	case a < b:
		return -1
	case a > b:
...
// buildint64Int8 recursively builds a perfectly balanced subtree from the
...
func (m *Int64Int8) buildint64Int8(keys []int64, values []int8, lo, hi, level, redLevel int, parent *int64Int8TreeNode) *int64Int8TreeNode {
	if lo > hi {
		return nil
	}
	mid := (lo + hi) / 2
	node := &int64Int8TreeNode{key: keys[mid], value: values[mid], parent: parent, color: int64Int8TreeNodeBlack}
	if level == redLevel {
		node.color = int64Int8TreeNodeRed
	}
	node.left = m.buildint64Int8(keys, values, lo, mid-1, level+1, redLevel, node)
	node.right = m.buildint64Int8(keys, values, mid+1, hi, level+1, redLevel, node)
	...
	node.size = 1 + int64Int8TreeNodeSize(node.left) + int64Int8TreeNodeSize(node.right)
	return node
}

// Int64Int8Sink is a streaming builder for a Int64Int8: callers Put
// ascending entries one at a time, then Build the finished map. It is a thin
// wrapper over NewInt64Int8FromSorted (entries are buffered, then built in one
...
// NewInt64Int8Sink creates a streaming sink with the given duplicate policy.
func NewInt64Int8Sink(policy pump.DuplicatePolicy) *Int64Int8Sink {
	return &Int64Int8Sink{policy: policy}
}
...
func (s *Int64Int8Sink) Put(key int64, value int8) {
	if s.done {
		panic("mapdb: Put on a finished Int64Int8Sink")
	}
...
func (s *Int64Int8Sink) Build() (*Int64Int8, error) {
	if s.done {
		panic("mapdb: Build on a finished Int64Int8Sink")
	}
	s.done = true
	return NewInt64Int8FromSorted(s.keys, s.values, s.policy)
}

func (m *Int64Int8) fixAfterDelete(x *int64Int8TreeNode) {
