...
func TestInt8Char_Generated_MinMax(t *testing.T) {
	m := NewInt8Char()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Char_Generated_FloorCeiling(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestInt8Char_Generated_SortedOrder(t *testing.T) {
	m := NewInt8Char()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Char_Generated_HigherLower(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(3, 3)
	m.Put(5, 5)
...
func TestInt8Char_Generated_HeadTailSubMap(t *testing.T) {
	m := NewInt8Char()
...
func TestInt8Char_Generated_FirstLastEntry(t *testing.T) {
	m := NewInt8Char()
	m.Put(2, 2)
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestInt8Char_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt8Char_Generated_DescendingOrder(t *testing.T) {
	m := NewInt8Char()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
