...
func TestInt8Int32_Generated_MinMax(t *testing.T) {
	m := NewInt8Int32()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int32_Generated_FloorCeiling(t *testing.T) {
	m := NewInt8Int32()
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestInt8Int32_Generated_SortedOrder(t *testing.T) {
	m := NewInt8Int32()
	m.Put(3, 3)
	m.Put(1, 1)
	m.Put(2, 2)
...
func TestInt8Int32_Generated_HigherLower(t *testing.T) {
	m := NewInt8Int32()
	m.Put(1, 1)
	m.Put(3, 3)
	m.Put(5, 5)
...
func TestInt8Int32_Generated_HeadTailSubMap(t *testing.T) {
	m := NewInt8Int32()
...
func TestInt8Int32_Generated_FirstLastEntry(t *testing.T) {
	m := NewInt8Int32()
	m.Put(2, 2)
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestInt8Int32_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewInt8Int32()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt8Int32_Generated_DescendingOrder(t *testing.T) {
	m := NewInt8Int32()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
