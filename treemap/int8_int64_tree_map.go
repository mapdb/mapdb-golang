...
// int8Int64TreeNodeSize returns the subtree size of a node link (0 if nil).
func int8Int64TreeNodeSize(n *int8Int64TreeNode) int {
	if n == nil {
		return 0
	}
	return n.size
...
// int8Int64TreeNodeFixSize recomputes a node's cached subtree size from its
// children. Called after any rotation or child relink so the augmentation stays
// consistent.
func int8Int64TreeNodeFixSize(n *int8Int64TreeNode) {
	n.size = 1 + int8Int64TreeNodeSize(n.left) + int8Int64TreeNodeSize(n.right)
}

// Int8Int64 is a sorted map with int8 keys and int64 values, backed by a red-black tree.
...
// NewInt8Int64 creates a new empty sorted map.
func NewInt8Int64() *Int8Int64 {
	return &Int8Int64{}
}

// Put inserts or updates a key-value pair. Returns the previous value and true if the key existed.
func (m *Int8Int64) Put(key int8, value int64) (int64, bool) {
	if m.root == nil {
		m.root = &int8Int64TreeNode{key: key, value: value, color: int8Int64TreeNodeBlack, size: 1}
		m.size++
		return 0, false
	}
	node := m.root
	for {
		if key < node.key {
			if node.left == nil {
				node.left = &int8Int64TreeNode{key: key, value: value, parent: node, color: int8Int64TreeNodeRed, size: 1}
			...
			if node.right == nil {
				node.right = &int8Int64TreeNode{key: key, value: value, parent: node, color: int8Int64TreeNodeRed, size: 1}
				m.incSizeToRoot(node)
...
func (m *Int8Int64) Get(key int8) (int64, bool) {
	node := m.findNode(key)
	if node == nil {
		return 0, false
	}
...
func (m *Int8Int64) GetOrDefault(key int8, defaultValue int64) int64 {
...
func (m *Int8Int64) Len() int {
	return m.size
}

// Clear removes all entries.
func (m *Int8Int64) Clear() {
	m.root = nil
	m.size = 0
}

// Min returns the smallest key and its value, or zero values and false if empty.
func (m *Int8Int64) Min() (int8, int64, bool) {
	if m.root == nil {
		return 0, 0, false
	}
...
func (m *Int8Int64) Max() (int8, int64, bool) {
	if m.root == nil {
		return 0, 0, false
	}
...
func (m *Int8Int64) Floor(key int8) (int8, int64, bool) {
...
func (m *Int8Int64) Ceiling(key int8) (int8, int64, bool) {
	var result *int8Int64TreeNode
	node := m.root
	for node != nil {
		if key == node.key {
...
func (m *Int8Int64) All() iter.Seq2[int8, int64] {
...
// reproduces All in ascending key order — so a *Int8Int64 satisfies
// par.Segmenter2[int8, int64] and feeds par.From2 with ORDERED
...
func (m *Int8Int64) Segments2(n int) []iter.Seq2[int8, int64] {
	ranges := segment.SplitRanges(m.size, n)
	segs := make([]iter.Seq2[int8, int64], len(ranges))
	for i := range ranges {
		lo, hi := ranges[i][0], ranges[i][1] // per-iteration copies for this view's closure
		segs[i] = func(yield func(int8, int64) bool) {
			// In-order walk yielding pairs whose 0-based key rank is in [lo, hi).
			// base is the rank of the first element in node's subtree.
			var walk func(node *int8Int64TreeNode, base int) bool
			walk = func(node *int8Int64TreeNode, base int) bool {
				if node == nil {
					return true
				}
				rank := base + int8Int64TreeNodeSize(node.left)
...
func (m *Int8Int64) Keys() iter.Seq[int8] {
...
func (m *Int8Int64) Values() iter.Seq[int64] {
...
func (m *Int8Int64) RangeKeys(fromKey, toKey int8) iter.Seq2[int8, int64] {
	return func(yield func(int8, int64) bool) {
		for k, v := range m.All() {
			if k < fromKey {
				continue
...
func (m *Int8Int64) Higher(key int8) (int8, int64, bool) {
	var result *int8Int64TreeNode
	node := m.root
	for node != nil {
		if key < node.key {
...
func (m *Int8Int64) Lower(key int8) (int8, int64, bool) {
	var result *int8Int64TreeNode
	node := m.root
	for node != nil {
		if key > node.key {
...
func (m *Int8Int64) HeadMap(toKey int8) iter.Seq2[int8, int64] {
	return func(yield func(int8, int64) bool) {
		for k, v := range m.All() {
			if k >= toKey {
				return
...
func (m *Int8Int64) TailMap(fromKey int8) iter.Seq2[int8, int64] {
	return func(yield func(int8, int64) bool) {
		for k, v := range m.All() {
			if k < fromKey {
				continue
...
func (m *Int8Int64) PollLastEntry() (int8, int64, bool) {
	k, v, ok := m.Max()
	if !ok {
		return 0, 0, false
	}
...
func (m *Int8Int64) DescendingMap() iter.Seq2[int8, int64] {
	return func(yield func(int8, int64) bool) {
...
func (m *Int8Int64) DescendingKeys() iter.Seq[int8] {
	return func(yield func(int8) bool) {
...
func (m *Int8Int64) ForEach(f func(int8, int64)) {
	for k, v := range m.All() {
		f(k, v)
	}
}
...
func (m *Int8Int64) Select(predicate func(int8, int64) bool) *Int8Int64 {
	result := NewInt8Int64()
	for k, v := range m.All() {
		if predicate(k, v) {
			result.Put(k, v)
...
func (m *Int8Int64) Reject(predicate func(int8, int64) bool) *Int8Int64 {
	result := NewInt8Int64()
	for k, v := range m.All() {
		if !predicate(k, v) {
			result.Put(k, v)
...
func (m *Int8Int64) Detect(predicate func(int8, int64) bool) (int8, int64, bool) {
	for k, v := range m.All() {
		if predicate(k, v) {
			return k, v, true
		}
...
func (m *Int8Int64) AnySatisfy(predicate func(int8, int64) bool) bool {
	for k, v := range m.All() {
		if predicate(k, v) {
			return true
		}
...
func (m *Int8Int64) AllSatisfy(predicate func(int8, int64) bool) bool {
	for k, v := range m.All() {
		if !predicate(k, v) {
			return false
		}
...
func (m *Int8Int64) NoneSatisfy(predicate func(int8, int64) bool) bool {
	for k, v := range m.All() {
		if predicate(k, v) {
			return false
		}
...
func (m *Int8Int64) Count(predicate func(int8, int64) bool) int {
	c := 0
	for k, v := range m.All() {
		if predicate(k, v) {
			c++
...
// query; never mutates.
func (m *Int8Int64) Rank(key int8) int {
	rank := 0
	node := m.root
	for node != nil {
		if key < node.key {
			...
			rank += 1 + int8Int64TreeNodeSize(node.left)
			node = node.right
		} else {
			// key == node.key: exactly the left subtree is strictly less.
			return rank + int8Int64TreeNodeSize(node.left)
		}
	}
	return rank
}
...
func (m *Int8Int64) SelectKey(i int) (int8, bool) {
	node := m.selectNode(i)
	if node == nil {
		return 0, false
	}
...
func (m *Int8Int64) SelectEntry(i int) (int8, int64, bool) {
	node := m.selectNode(i)
	if node == nil {
		return 0, 0, false
	}
...
// O(log n).
func (m *Int8Int64) selectNode(i int) *int8Int64TreeNode {
	if i < 0 {
		return nil
	}
	node := m.root
	for node != nil {
		left := int8Int64TreeNodeSize(node.left)
		if i < left {
			node = node.left
		} else if i == left {
			return node
...
func (m *Int8Int64) String() string {
	if m.size == 0 {
		return "{}"
	}
...
func (m *Int8Int64) findNode(key int8) *int8Int64TreeNode {
	node := m.root
	for node != nil {
		if key < node.key {
			node = node.left
...
func (m *Int8Int64) minNode(node *int8Int64TreeNode) *int8Int64TreeNode {
	for node.left != nil {
		node = node.left
	}
	return node
...
func (m *Int8Int64) maxNode(node *int8Int64TreeNode) *int8Int64TreeNode {
	for node.right != nil {
		node = node.right
	}
	return node
...
func (m *Int8Int64) rotateLeft(x *int8Int64TreeNode) {
	y := x.right
	x.right = y.left
	if y.left != nil {
		y.left.parent = x
	...
	int8Int64TreeNodeFixSize(x)
	int8Int64TreeNodeFixSize(y)
}

func (m *Int8Int64) rotateRight(x *int8Int64TreeNode) {
	y := x.left
	x.left = y.right
	if y.right != nil {
		y.right.parent = x
...
func (m *Int8Int64) incSizeToRoot(n *int8Int64TreeNode) {
...
func (m *Int8Int64) fixSizeToRoot(n *int8Int64TreeNode) {
	for ; n != nil; n = n.parent {
		int8Int64TreeNodeFixSize(n)
	}
}

func (m *Int8Int64) fixAfterInsert(z *int8Int64TreeNode) {
...
func (m *Int8Int64) deleteNode(z *int8Int64TreeNode) {
	...
	var fixSizeFrom *int8Int64TreeNode
...
// NewInt8Int64FromSorted builds a Int8Int64 from presorted, ascending keys
...
func NewInt8Int64FromSorted(keys []int8, values []int64, policy pump.DuplicatePolicy) (*Int8Int64, error) {
	if len(keys) != len(values) {
		panic("mapdb: NewInt8Int64FromSorted: len(keys) != len(values)")
	}
	dk, dv, err := dedupInt8Int64Sorted(keys, values, policy)
	if err != nil {
		return nil, err
	}
	m := NewInt8Int64()
	m.root = m.buildint8Int64(dk, dv, 0, len(dk)-1, 0, pump.RedBlackRedLevel(len(dk)), nil)
	m.size = len(dk)
	return m, nil
}

// dedupInt8Int64Sorted validates ascending order and applies the duplicate
// policy, returning compacted key/value slices. Equal adjacent keys are the only
// duplicates possible in sorted input.
func dedupInt8Int64Sorted(keys []int8, values []int64, policy pump.DuplicatePolicy) ([]int8, []int64, error) {
	if len(keys) == 0 {
	...
	for i := 1; i < len(keys); i++ {
		cmp := cmpInt8Int64(keys[i], keys[i-1])
		if cmp < 0 {
...
// cmpInt8Int64 is the three-way ordering used by the bulk-load validator for
// integer/char keys (float keys use the IEEE total-order helper instead).
func cmpInt8Int64(a, b int8) int {
	switch {
	case a < b:
		return -1
	case a > b:
...
// buildint8Int64 recursively builds a perfectly balanced subtree from the
...
func (m *Int8Int64) buildint8Int64(keys []int8, values []int64, lo, hi, level, redLevel int, parent *int8Int64TreeNode) *int8Int64TreeNode {
	if lo > hi {
		return nil
	}
	mid := (lo + hi) / 2
	node := &int8Int64TreeNode{key: keys[mid], value: values[mid], parent: parent, color: int8Int64TreeNodeBlack}
	if level == redLevel {
		node.color = int8Int64TreeNodeRed
	}
	...
	node.size = 1 + int8Int64TreeNodeSize(node.left) + int8Int64TreeNodeSize(node.right)
	return node
}

// Int8Int64Sink is a streaming builder for a Int8Int64: callers Put
// ascending entries one at a time, then Build the finished map. It is a thin
// wrapper over NewInt8Int64FromSorted (entries are buffered, then built in one
...
// NewInt8Int64Sink creates a streaming sink with the given duplicate policy.
func NewInt8Int64Sink(policy pump.DuplicatePolicy) *Int8Int64Sink {
	return &Int8Int64Sink{policy: policy}
}
...
func (s *Int8Int64Sink) Put(key int8, value int64) {
	if s.done {
		panic("mapdb: Put on a finished Int8Int64Sink")
	}
...
func (s *Int8Int64Sink) Build() (*Int8Int64, error) {
	if s.done {
		panic("mapdb: Build on a finished Int8Int64Sink")
	}
	s.done = true
	return NewInt8Int64FromSorted(s.keys, s.values, s.policy)
}

func (m *Int8Int64) fixAfterDelete(x *int8Int64TreeNode) {
