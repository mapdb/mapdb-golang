...
func TestInt8Int64TreeMap_Generated_HigherLower(t *testing.T) {
	m := NewInt8Int64TreeMap()
	m.Put(1, 1)
	m.Put(3, 3)
	m.Put(5, 5)
...
func TestInt8Int64TreeMap_Generated_HeadTailSubMap(t *testing.T) {
	m := NewInt8Int64TreeMap()
...
func TestInt8Int64TreeMap_Generated_FirstLastEntry(t *testing.T) {
	m := NewInt8Int64TreeMap()
	m.Put(2, 2)
	m.Put(1, 1)
	m.Put(3, 3)
...
func TestInt8Int64TreeMap_Generated_PollFirstLastEntry(t *testing.T) {
	m := NewInt8Int64TreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
...
func TestInt8Int64TreeMap_Generated_DescendingOrder(t *testing.T) {
	m := NewInt8Int64TreeMap()
	m.Put(1, 1)
	m.Put(2, 2)
	m.Put(3, 3)
