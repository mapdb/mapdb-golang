...
func TestInt64_Generated_FloorCeiling(t *testing.T) {
	s := NewInt64()
	s.Add(1)
	s.Add(3)
...
func TestInt64_Generated_SortedIteration(t *testing.T) {
	s := NewInt64()
	s.Add(3)
	s.Add(1)
	s.Add(2)
...
func TestInt64_Generated_SelectWhere(t *testing.T) {
	s := NewInt64()
	s.Add(1)
	s.Add(2)
	s.Add(3)
	sel := s.SelectWhere(func(v int64) bool { return v > 1 })
	if sel.Len() != 2 {
